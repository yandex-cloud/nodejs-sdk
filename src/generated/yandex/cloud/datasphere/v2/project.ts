...
export const Project_Settings = {
    ...
    fromJSON(object: any): Project_Settings {
        ...
        message.defaultDedicatedSpec =
            object.defaultDedicatedSpec !== undefined && object.defaultDedicatedSpec !== null
    ...
    toJSON(message: Project_Settings): unknown {
        ...
        message.earlyAccess !== undefined && (obj.earlyAccess = message.earlyAccess);
        message.ide !== undefined && (obj.ide = project_Settings_IdeToJSON(message.ide));
        message.defaultFolderId !== undefined && (obj.defaultFolderId = message.defaultFolderId);
