...
export const CreateProjectJobRequest = {
  ...
  decode(
    ...
    const message = {
      ...baseCreateProjectJobRequest,
    } as CreateProjectJobRequest;
  ...
  toJSON(message: CreateProjectJobRequest): unknown {
    ...
    message.dataTtl !== undefined &&
      (obj.dataTtl = message.dataTtl
        ? Duration.toJSON(message.dataTtl)
        : undefined);
    return obj;
  },
...
export const CreateProjectJobMetadata = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCreateProjectJobMetadata,
    } as CreateProjectJobMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const CreateProjectJobResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCreateProjectJobResponse,
    } as CreateProjectJobResponse;
    message.uploadFiles = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromJSON(object: any): CreateProjectJobResponse {
    ...
    message.jobId =
      object.jobId !== undefined && object.jobId !== null
        ? String(object.jobId)
        : "";
    message.uploadFiles = (object.uploadFiles ?? []).map((e: any) =>
  ...
  fromPartial<I extends Exact<DeepPartial<CreateProjectJobResponse>, I>>(
    ...
    message.jobId = object.jobId ?? "";
    message.uploadFiles =
      object.uploadFiles?.map((e) => StorageFile.fromPartial(e)) || [];
    return message;
  },
};

messageTypeRegistry.set(
  CreateProjectJobResponse.$type,
  CreateProjectJobResponse
);
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.jobParametersOverrides = JobParameters.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): CloneProjectJobRequest {
    ...
    message.sourceJobId =
      object.sourceJobId !== undefined && object.sourceJobId !== null
        ...
        : "";
    message.jobParametersOverrides =
      object.jobParametersOverrides !== undefined &&
      object.jobParametersOverrides !== null
...
export const CloneProjectJobResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCloneProjectJobResponse,
    } as CloneProjectJobResponse;
    message.uploadFiles = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
export const CloneProjectJobMetadata = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCloneProjectJobMetadata,
    } as CloneProjectJobMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const ExecuteProjectJobRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseExecuteProjectJobRequest,
    } as ExecuteProjectJobRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const ExecuteProjectJobResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseExecuteProjectJobResponse,
    } as ExecuteProjectJobResponse;
    message.outputFiles = [];
  ...
  toJSON(message: ExecuteProjectJobResponse): unknown {
    ...
    message.result !== undefined &&
      (obj.result = message.result
        ? JobResult.toJSON(message.result)
        : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ExecuteProjectJobResponse>, I>>(
    ...
    message.outputFiles =
      object.outputFiles?.map((e) => StorageFile.fromPartial(e)) || [];
    message.outputDatasets =
...
messageTypeRegistry.set(
  ExecuteProjectJobResponse.$type,
  ExecuteProjectJobResponse
);
...
export const ExecuteProjectJobMetadata = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseExecuteProjectJobMetadata,
    } as ExecuteProjectJobMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  ExecuteProjectJobMetadata.$type,
  ExecuteProjectJobMetadata
);
...
export const CancelProjectJobRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCancelProjectJobRequest,
    } as CancelProjectJobRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const ReadProjectJobStdLogsRequest = {
  $type:
    "yandex.cloud.datasphere.v2.jobs.ReadProjectJobStdLogsRequest" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseReadProjectJobStdLogsRequest,
    } as ReadProjectJobStdLogsRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  ReadProjectJobStdLogsRequest.$type,
  ReadProjectJobStdLogsRequest
);
...
export const ReadProjectJobStdLogsResponse = {
  $type:
    "yandex.cloud.datasphere.v2.jobs.ReadProjectJobStdLogsResponse" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseReadProjectJobStdLogsResponse,
    } as ReadProjectJobStdLogsResponse;
    message.logs = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
messageTypeRegistry.set(
  ReadProjectJobStdLogsResponse.$type,
  ReadProjectJobStdLogsResponse
);
...
export const ReadProjectJobLogsRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseReadProjectJobLogsRequest,
    } as ReadProjectJobLogsRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  ReadProjectJobLogsRequest.$type,
  ReadProjectJobLogsRequest
);
...
export const ReadProjectJobLogsResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseReadProjectJobLogsResponse,
    } as ReadProjectJobLogsResponse;
    message.logs = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
messageTypeRegistry.set(
  ReadProjectJobLogsResponse.$type,
  ReadProjectJobLogsResponse
);
...
export const DownloadProjectJobFilesRequest = {
  $type:
    "yandex.cloud.datasphere.v2.jobs.DownloadProjectJobFilesRequest" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseDownloadProjectJobFilesRequest,
    } as DownloadProjectJobFilesRequest;
    message.files = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
messageTypeRegistry.set(
  DownloadProjectJobFilesRequest.$type,
  DownloadProjectJobFilesRequest
);
...
export const DownloadProjectJobFilesResponse = {
  $type:
    "yandex.cloud.datasphere.v2.jobs.DownloadProjectJobFilesResponse" as const,
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.downloadFiles.push(
            StorageFile.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  fromPartial<I extends Exact<DeepPartial<DownloadProjectJobFilesResponse>, I>>(
    ...
    message.downloadFiles =
      object.downloadFiles?.map((e) => StorageFile.fromPartial(e)) || [];
    return message;
  },
};

messageTypeRegistry.set(
  DownloadProjectJobFilesResponse.$type,
  DownloadProjectJobFilesResponse
);
...
export const DeleteProjectJobRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseDeleteProjectJobRequest,
    } as DeleteProjectJobRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const DeleteProjectJobMetadata = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseDeleteProjectJobMetadata,
    } as DeleteProjectJobMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const DeleteProjectJobDataRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseDeleteProjectJobDataRequest,
    } as DeleteProjectJobDataRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  DeleteProjectJobDataRequest.$type,
  DeleteProjectJobDataRequest
);
...
export const DeleteProjectJobDataMetadata = {
  $type:
    "yandex.cloud.datasphere.v2.jobs.DeleteProjectJobDataMetadata" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseDeleteProjectJobDataMetadata,
    } as DeleteProjectJobDataMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  DeleteProjectJobDataMetadata.$type,
  DeleteProjectJobDataMetadata
);
...
export const DeleteProjectJobDataResponse = {
  $type:
    "yandex.cloud.datasphere.v2.jobs.DeleteProjectJobDataResponse" as const,

  encode(
    _: DeleteProjectJobDataResponse,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    return writer;
  },
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseDeleteProjectJobDataResponse,
    } as DeleteProjectJobDataResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
...
messageTypeRegistry.set(
  DeleteProjectJobDataResponse.$type,
  DeleteProjectJobDataResponse
);
...
export const DeleteAllProjectJobDataRequest = {
  $type:
    "yandex.cloud.datasphere.v2.jobs.DeleteAllProjectJobDataRequest" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseDeleteAllProjectJobDataRequest,
    } as DeleteAllProjectJobDataRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  DeleteAllProjectJobDataRequest.$type,
  DeleteAllProjectJobDataRequest
);
...
export const DeleteAllProjectJobDataMetadata = {
  $type:
    "yandex.cloud.datasphere.v2.jobs.DeleteAllProjectJobDataMetadata" as const,
...
messageTypeRegistry.set(
  DeleteAllProjectJobDataMetadata.$type,
  DeleteAllProjectJobDataMetadata
);
...
export const DeleteAllProjectJobDataResponse = {
  $type:
    "yandex.cloud.datasphere.v2.jobs.DeleteAllProjectJobDataResponse" as const,
...
messageTypeRegistry.set(
  DeleteAllProjectJobDataResponse.$type,
  DeleteAllProjectJobDataResponse
);
...
export const SetProjectJobDataTtlRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseSetProjectJobDataTtlRequest,
    } as SetProjectJobDataTtlRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  SetProjectJobDataTtlRequest.$type,
  SetProjectJobDataTtlRequest
);
...
export const SetProjectJobDataTtlResponse = {
  $type:
    "yandex.cloud.datasphere.v2.jobs.SetProjectJobDataTtlResponse" as const,

  encode(
    _: SetProjectJobDataTtlResponse,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    return writer;
  },
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseSetProjectJobDataTtlResponse,
    } as SetProjectJobDataTtlResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
...
messageTypeRegistry.set(
  SetProjectJobDataTtlResponse.$type,
  SetProjectJobDataTtlResponse
);

const baseStdLog: object = {
  $type: "yandex.cloud.datasphere.v2.jobs.StdLog",
  type: 0,
};
...
export const ProjectJobServiceService = {
  ...
  create: {
    ...
    requestDeserialize: (value: Buffer) =>
      CreateProjectJobRequest.decode(value),
  ...
  execute: {
    ...
    requestDeserialize: (value: Buffer) =>
      ExecuteProjectJobRequest.decode(value),
    responseSerialize: (value: Operation) =>
      Buffer.from(Operation.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Operation.decode(value),
  },
  ...
  cancel: {
    ...
    requestDeserialize: (value: Buffer) =>
      CancelProjectJobRequest.decode(value),
  ...
  list: {
    ...
    responseDeserialize: (value: Buffer) =>
      ListProjectJobResponse.decode(value),
  },
  /** Returns job by id. */
  get: {
  ...
  delete: {
    ...
    requestDeserialize: (value: Buffer) =>
      DeleteProjectJobRequest.decode(value),
    responseSerialize: (value: Operation) =>
      Buffer.from(Operation.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Operation.decode(value),
  },
  ...
  deleteData: {
    ...
    requestDeserialize: (value: Buffer) =>
      DeleteProjectJobDataRequest.decode(value),
    responseSerialize: (value: Operation) =>
      Buffer.from(Operation.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Operation.decode(value),
  },
  ...
  deleteAllData: {
    ...
    requestDeserialize: (value: Buffer) =>
      DeleteAllProjectJobDataRequest.decode(value),
    responseSerialize: (value: Operation) =>
      Buffer.from(Operation.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Operation.decode(value),
  },
...
export interface ProjectJobServiceClient extends Client {
  ...
  downloadJobFiles(
    ...
    callback: (
      ...
      response: DownloadProjectJobFilesResponse
    ) => void
  ): ClientUnaryCall;
  downloadJobFiles(
    request: DownloadProjectJobFilesRequest,
  ...
  list(
    ...
    callback: (
      error: ServiceError | null,
      response: ListProjectJobResponse
    ) => void
  ): ClientUnaryCall;
  list(
    request: ListProjectJobRequest,
  ...
  setDataTtl(
    ...
    callback: (
      error: ServiceError | null,
      response: SetProjectJobDataTtlResponse
    ) => void
  ): ClientUnaryCall;
  setDataTtl(
    request: SetProjectJobDataTtlRequest,
