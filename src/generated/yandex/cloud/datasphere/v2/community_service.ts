...
export const CreateCommunityMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): CreateCommunityMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseCreateCommunityMetadata } as CreateCommunityMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const UpdateCommunityMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): UpdateCommunityMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseUpdateCommunityMetadata } as UpdateCommunityMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const DeleteCommunityMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): DeleteCommunityMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseDeleteCommunityMetadata } as DeleteCommunityMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListCommunitiesResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListCommunitiesResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListCommunitiesResponse } as ListCommunitiesResponse;
        message.communities = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object: any): ListCommunitiesResponse {
        const message = { ...baseListCommunitiesResponse } as ListCommunitiesResponse;
        message.communities = (object.communities ?? []).map((e: any) => Community.fromJSON(e));
...
export const AddCommunityResourceRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): AddCommunityResourceRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseAddCommunityResourceRequest } as AddCommunityResourceRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const RemoveCommunityResourceRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): RemoveCommunityResourceRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseRemoveCommunityResourceRequest } as RemoveCommunityResourceRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const CommunityServiceService = {
    ...
    getRestrictions: {
        ...
        requestDeserialize: (value: Buffer) => GetCommunityRestrictionsRequest.decode(value),
    ...
    setRestrictions: {
        ...
        requestDeserialize: (value: Buffer) => SetCommunityRestrictionsRequest.decode(value),
        responseSerialize: (value: Operation) => Buffer.from(Operation.encode(value).finish()),
        responseDeserialize: (value: Buffer) => Operation.decode(value),
    },
} as const;
...
export interface CommunityServiceServer extends UntypedServiceImplementation {
    ...
    /** Get current community restrictions. */
    getRestrictions: handleUnaryCall<GetCommunityRestrictionsRequest, RestrictionsResponse>;
    /** Set community restrictions. */
