  ...
  encode(
    ...
    Object.entries(message.properties).forEach(([key, value]) => {
      MapreduceJob_PropertiesEntry.encode(
        {
          $type:
            "yandex.cloud.dataproc.manager.v1.MapreduceJob.PropertiesEntry",
          key: key as any,
          value,
        },
        writer.uint32(42).fork()
...
export const MapreduceJob_PropertiesEntry = {
  $type:
    "yandex.cloud.dataproc.manager.v1.MapreduceJob.PropertiesEntry" as const,
  ...
  encode(
    ...
    Object.entries(message.scriptVariables).forEach(([key, value]) => {
      HiveJob_ScriptVariablesEntry.encode(
        {
          $type:
            "yandex.cloud.dataproc.manager.v1.HiveJob.ScriptVariablesEntry",
          key: key as any,
          value,
        },
        writer.uint32(26).fork()
...
export const HiveJob_ScriptVariablesEntry = {
  $type:
    "yandex.cloud.dataproc.manager.v1.HiveJob.ScriptVariablesEntry" as const,
...
export const SupportJob = {
  ...
  fromPartial<I extends Exact<DeepPartial<SupportJob>, I>>(
    object: I
  ): SupportJob {
    const message = { ...baseSupportJob } as SupportJob;
    message.id = object.id ?? "";
