...
export const Job = {
    ...
    toJSON(message: Job): unknown {
        ...
        message.hiveJob !== undefined &&
            (obj.hiveJob = message.hiveJob ? HiveJob.toJSON(message.hiveJob) : undefined);
...
export const ApplicationAttempt = {
    ...
    toJSON(message: ApplicationAttempt): unknown {
        const obj: any = {};
        message.id !== undefined && (obj.id = message.id);
        message.amContainerId !== undefined && (obj.amContainerId = message.amContainerId);
        return obj;
    },
...
export const ApplicationInfo = {
    ...
    fromJSON(object: any): ApplicationInfo {
        const message = { ...baseApplicationInfo } as ApplicationInfo;
        message.id = object.id !== undefined && object.id !== null ? String(object.id) : '';
        message.applicationAttempts = (object.applicationAttempts ?? []).map((e: any) =>
    ...
    fromPartial<I extends Exact<DeepPartial<ApplicationInfo>, I>>(object: I): ApplicationInfo {
        ...
        message.id = object.id ?? '';
        message.applicationAttempts =
            object.applicationAttempts?.map((e) => ApplicationAttempt.fromPartial(e)) || [];
        return message;
    },
};
...
export const MapreduceJob_PropertiesEntry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): MapreduceJob_PropertiesEntry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMapreduceJob_PropertiesEntry } as MapreduceJob_PropertiesEntry;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseQueryList: object = { $type: 'yandex.cloud.dataproc.manager.v1.QueryList', queries: '' };
...
export const HiveJob = {
    ...
    fromJSON(object: any): HiveJob {
        ...
        message.continueOnFailure =
            object.continueOnFailure !== undefined && object.continueOnFailure !== null
                ? Boolean(object.continueOnFailure)
                : false;
        message.scriptVariables = Object.entries(object.scriptVariables ?? {}).reduce<{
            [key: string]: string;
        }>((acc, [key, value]) => {
            acc[key] = String(value);
            return acc;
    ...
    toJSON(message: HiveJob): unknown {
        ...
        message.queryFileUri !== undefined && (obj.queryFileUri = message.queryFileUri);
        message.queryList !== undefined &&
            (obj.queryList = message.queryList ? QueryList.toJSON(message.queryList) : undefined);
        return obj;
    },
...
export const HiveJob_PropertiesEntry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): HiveJob_PropertiesEntry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseHiveJob_PropertiesEntry } as HiveJob_PropertiesEntry;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const HiveJob_ScriptVariablesEntry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): HiveJob_ScriptVariablesEntry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseHiveJob_ScriptVariablesEntry } as HiveJob_ScriptVariablesEntry;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const SupportJob = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): SupportJob {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseSupportJob } as SupportJob;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object: any): SupportJob {
        ...
        message.timeout =
            object.timeout !== undefined && object.timeout !== null ? Number(object.timeout) : 0;
        message.createdBy =
            object.createdBy !== undefined && object.createdBy !== null
                ? String(object.createdBy)
                : '';
    ...
    toJSON(message: SupportJob): unknown {
        ...
        message.startedAt !== undefined && (obj.startedAt = message.startedAt.toISOString());
        message.finishedAt !== undefined && (obj.finishedAt = message.finishedAt.toISOString());
        message.status !== undefined && (obj.status = supportJob_StatusToJSON(message.status));
