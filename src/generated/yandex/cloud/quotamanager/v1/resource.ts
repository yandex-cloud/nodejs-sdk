...
export interface Resource {
    $type: 'yandex.cloud.quotamanager.v1.Resource';
...
const baseResource: object = { $type: 'yandex.cloud.quotamanager.v1.Resource', id: '', type: '' };

export const Resource = {
    $type: 'yandex.cloud.quotamanager.v1.Resource' as const,
