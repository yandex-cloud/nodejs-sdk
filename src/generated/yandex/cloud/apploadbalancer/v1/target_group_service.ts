  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      UpdateTargetGroupRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.apploadbalancer.v1.UpdateTargetGroupRequest.LabelsEntry",
          key: key as any,
          value,
        },
...
export const UpdateTargetGroupRequest_LabelsEntry = {
  $type:
    "yandex.cloud.apploadbalancer.v1.UpdateTargetGroupRequest.LabelsEntry" as const,
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      CreateTargetGroupRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.apploadbalancer.v1.CreateTargetGroupRequest.LabelsEntry",
          key: key as any,
          value,
        },
...
export const CreateTargetGroupRequest_LabelsEntry = {
  $type:
    "yandex.cloud.apploadbalancer.v1.CreateTargetGroupRequest.LabelsEntry" as const,
...
export const ListTargetGroupOperationsRequest = {
  $type:
    "yandex.cloud.apploadbalancer.v1.ListTargetGroupOperationsRequest" as const,
...
export const ListTargetGroupOperationsResponse = {
  $type:
    "yandex.cloud.apploadbalancer.v1.ListTargetGroupOperationsResponse" as const,
