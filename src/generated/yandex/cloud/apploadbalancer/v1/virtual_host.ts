...
export const VirtualHost = {
    ...
    fromJSON(object: any): VirtualHost {
        ...
        message.modifyRequestHeaders = (object.modifyRequestHeaders ?? []).map((e: any) =>
            HeaderModification.fromJSON(e),
        );
        message.modifyResponseHeaders = (object.modifyResponseHeaders ?? []).map((e: any) =>
            HeaderModification.fromJSON(e),
        );
    ...
    fromPartial<I extends Exact<DeepPartial<VirtualHost>, I>>(object: I): VirtualHost {
        ...
        message.modifyRequestHeaders =
            object.modifyRequestHeaders?.map((e) => HeaderModification.fromPartial(e)) || [];
        message.modifyResponseHeaders =
            object.modifyResponseHeaders?.map((e) => HeaderModification.fromPartial(e)) || [];
        message.routeOptions =
            object.routeOptions !== undefined && object.routeOptions !== null
    ...
    fromJSON(object: any): RBAC {
        ...
        message.action =
            object.action !== undefined && object.action !== null
                ...
                : 0;
        message.principals = (object.principals ?? []).map((e: any) => Principals.fromJSON(e));
        return message;
    },

    toJSON(message: RBAC): unknown {
        const obj: any = {};
        message.action !== undefined && (obj.action = rBAC_ActionToJSON(message.action));
        if (message.principals) {
            obj.principals = message.principals.map((e) => (e ? Principals.toJSON(e) : undefined));
        } else {
            obj.principals = [];
        }
        return obj;
...
export const Principals = {
    ...
    fromJSON(object: any): Principals {
        const message = { ...basePrincipals } as Principals;
        message.andPrincipals = (object.andPrincipals ?? []).map((e: any) => Principal.fromJSON(e));
        return message;
    },
    ...
    fromJSON(object: any): Principal {
        ...
        message.remoteIp =
            object.remoteIp !== undefined && object.remoteIp !== null
                ...
                : undefined;
        message.any =
            object.any !== undefined && object.any !== null ? Boolean(object.any) : undefined;
        return message;
    },
...
export const Principal_HeaderMatcher = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Principal_HeaderMatcher {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...basePrincipal_HeaderMatcher } as Principal_HeaderMatcher;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const HttpRoute = {
    ...
    toJSON(message: HttpRoute): unknown {
        ...
        message.match !== undefined &&
            (obj.match = message.match ? HttpRouteMatch.toJSON(message.match) : undefined);
        message.route !== undefined &&
            (obj.route = message.route ? HttpRouteAction.toJSON(message.route) : undefined);
        message.redirect !== undefined &&
            (obj.redirect = message.redirect ? RedirectAction.toJSON(message.redirect) : undefined);
...
export const GrpcRoute = {
    ...
    toJSON(message: GrpcRoute): unknown {
        const obj: any = {};
        message.match !== undefined &&
            (obj.match = message.match ? GrpcRouteMatch.toJSON(message.match) : undefined);
        message.route !== undefined &&
            (obj.route = message.route ? GrpcRouteAction.toJSON(message.route) : undefined);
...
export const RedirectAction = {
    ...
    toJSON(message: RedirectAction): unknown {
        const obj: any = {};
        message.replaceScheme !== undefined && (obj.replaceScheme = message.replaceScheme);
        message.replaceHost !== undefined && (obj.replaceHost = message.replaceHost);
        message.replacePort !== undefined && (obj.replacePort = Math.round(message.replacePort));
        message.replacePath !== undefined && (obj.replacePath = message.replacePath);
        message.replacePrefix !== undefined && (obj.replacePrefix = message.replacePrefix);
        message.removeQuery !== undefined && (obj.removeQuery = message.removeQuery);
...
export const GrpcStatusResponseAction = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): GrpcStatusResponseAction {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseGrpcStatusResponseAction } as GrpcStatusResponseAction;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const HttpRouteAction = {
    ...
    toJSON(message: HttpRouteAction): unknown {
        ...
        message.prefixRewrite !== undefined && (obj.prefixRewrite = message.prefixRewrite);
...
export const GrpcRouteAction = {
    ...
    toJSON(message: GrpcRouteAction): unknown {
        ...
        message.maxTimeout !== undefined &&
            (obj.maxTimeout = message.maxTimeout ? Duration.toJSON(message.maxTimeout) : undefined);
        message.idleTimeout !== undefined &&
            (obj.idleTimeout = message.idleTimeout
                ? Duration.toJSON(message.idleTimeout)
                : undefined);
