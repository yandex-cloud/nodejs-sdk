...
export const LoadBalancer = {
    ...
    fromJSON(object: any): LoadBalancer {
        ...
        message.networkId =
            object.networkId !== undefined && object.networkId !== null
                ...
                : '';
        message.listeners = (object.listeners ?? []).map((e: any) => Listener.fromJSON(e));
    ...
    toJSON(message: LoadBalancer): unknown {
        ...
        message.status !== undefined && (obj.status = loadBalancer_StatusToJSON(message.status));
...
export const LoadBalancer_LabelsEntry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): LoadBalancer_LabelsEntry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseLoadBalancer_LabelsEntry } as LoadBalancer_LabelsEntry;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object: any): Address {
        ...
        message.internalIpv4Address =
            object.internalIpv4Address !== undefined && object.internalIpv4Address !== null
                ...
                : undefined;
        message.externalIpv6Address =
            object.externalIpv6Address !== undefined && object.externalIpv6Address !== null
...
export const HttpListener = {
    ...
    toJSON(message: HttpListener): unknown {
        ...
        message.handler !== undefined &&
            (obj.handler = message.handler ? HttpHandler.toJSON(message.handler) : undefined);
        message.redirects !== undefined &&
            (obj.redirects = message.redirects ? Redirects.toJSON(message.redirects) : undefined);
        return obj;
    },
    ...
    fromJSON(object: any): TlsListener {
        ...
        message.defaultHandler =
            object.defaultHandler !== undefined && object.defaultHandler !== null
                ...
                : undefined;
        message.sniHandlers = (object.sniHandlers ?? []).map((e: any) => SniMatch.fromJSON(e));
        return message;
    },
...
export const StreamListener = {
    ...
    toJSON(message: StreamListener): unknown {
        const obj: any = {};
        message.handler !== undefined &&
            (obj.handler = message.handler ? StreamHandler.toJSON(message.handler) : undefined);
        return obj;
    },
...
export const Http2Options = {
    ...
    fromJSON(object: any): Http2Options {
        ...
        message.maxConcurrentStreams =
            object.maxConcurrentStreams !== undefined && object.maxConcurrentStreams !== null
...
export const HttpHandler = {
    ...
    toJSON(message: HttpHandler): unknown {
        const obj: any = {};
        message.httpRouterId !== undefined && (obj.httpRouterId = message.httpRouterId);
...
export const Redirects = {
    ...
    toJSON(message: Redirects): unknown {
        const obj: any = {};
        message.httpToHttps !== undefined && (obj.httpToHttps = message.httpToHttps);
        return obj;
    },
...
export const TargetState_HealthcheckStatus = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): TargetState_HealthcheckStatus {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseTargetState_HealthcheckStatus } as TargetState_HealthcheckStatus;
    ...
    fromPartial<I extends Exact<DeepPartial<TargetState_HealthcheckStatus>, I>>(
        ...
        const message = { ...baseTargetState_HealthcheckStatus } as TargetState_HealthcheckStatus;
        message.zoneStatuses =
            object.zoneStatuses?.map((e) => TargetState_ZoneHealthcheckStatus.fromPartial(e)) || [];
        return message;
    },
};
...
export const TargetState_ZoneHealthcheckStatus = {
    ...
    toJSON(message: TargetState_ZoneHealthcheckStatus): unknown {
        ...
        message.failedActiveHc !== undefined && (obj.failedActiveHc = message.failedActiveHc);
        return obj;
    },
