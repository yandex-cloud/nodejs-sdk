...
export const ResolveServiceAgentRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ResolveServiceAgentRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseResolveServiceAgentRequest } as ResolveServiceAgentRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    toJSON(message: ResolveServiceAgentRequest): unknown {
        const obj: any = {};
        message.serviceId !== undefined && (obj.serviceId = message.serviceId);
        message.microserviceId !== undefined && (obj.microserviceId = message.microserviceId);
        message.resource !== undefined &&
            (obj.resource = message.resource ? Resource.toJSON(message.resource) : undefined);
        return obj;
    },
...
export const ServiceControlServiceService = {
    ...
    resolveAgent: {
        ...
        requestDeserialize: (value: Buffer) => ResolveServiceAgentRequest.decode(value),
...
export interface ServiceControlServiceServer extends UntypedServiceImplementation {
    /**
     * Returns the Service information in the specified resource container.
     *
     * To get the list of available Services, make a [List] request.
