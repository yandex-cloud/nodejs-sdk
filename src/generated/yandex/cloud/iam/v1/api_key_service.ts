...
export const ListApiKeysResponse = {
    ...
    fromJSON(object: any): ListApiKeysResponse {
        const message = { ...baseListApiKeysResponse } as ListApiKeysResponse;
        message.apiKeys = (object.apiKeys ?? []).map((e: any) => ApiKey.fromJSON(e));
...
export const ListApiKeyOperationsRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListApiKeyOperationsRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListApiKeyOperationsRequest } as ListApiKeyOperationsRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListApiKeyOperationsResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListApiKeyOperationsResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListApiKeyOperationsResponse } as ListApiKeyOperationsResponse;
        message.operations = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
export const ListApiKeyScopesRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListApiKeyScopesRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListApiKeyScopesRequest } as ListApiKeyScopesRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListApiKeyScopesResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListApiKeyScopesResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListApiKeyScopesResponse } as ListApiKeyScopesResponse;
        message.scopes = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
export const ApiKeyServiceService = {
    ...
    listScopes: {
        ...
        requestDeserialize: (value: Buffer) => ListApiKeyScopesRequest.decode(value),
        responseSerialize: (value: ListApiKeyScopesResponse) =>
            Buffer.from(ListApiKeyScopesResponse.encode(value).finish()),
        responseDeserialize: (value: Buffer) => ListApiKeyScopesResponse.decode(value),
    },
} as const;
...
export interface ApiKeyServiceServer extends UntypedServiceImplementation {
    ...
    /** Retrieves the list of scopes. */
    listScopes: handleUnaryCall<ListApiKeyScopesRequest, ListApiKeyScopesResponse>;
}
...
export interface ApiKeyServiceClient extends Client {
    ...
    listScopes(
        ...
        callback: (error: ServiceError | null, response: ListApiKeyScopesResponse) => void,
    ): ClientUnaryCall;
    listScopes(
        request: ListApiKeyScopesRequest,
        metadata: Metadata,
