...
export interface RefreshToken {
  $type: "yandex.cloud.iam.v1.RefreshToken";
  /** Refresh Token id. */
  id: string;
...
export function refreshToken_ProtectionLevelFromJSON(
  object: any
): RefreshToken_ProtectionLevel {
  switch (object) {
    case 0:
...
export function refreshToken_ProtectionLevelToJSON(
  object: RefreshToken_ProtectionLevel
): string {
  switch (object) {
...
export const RefreshToken = {
  $type: "yandex.cloud.iam.v1.RefreshToken" as const,
  ...
  toJSON(message: RefreshToken): unknown {
    ...
    message.protectionLevel !== undefined &&
      (obj.protectionLevel = refreshToken_ProtectionLevelToJSON(
        message.protectionLevel
      ));
    return obj;
  },
...
messageTypeRegistry.set(RefreshToken.$type, RefreshToken);
