...
export const GetKeyRequest = {
    ...
    toJSON(message: GetKeyRequest): unknown {
        ...
        message.format !== undefined && (obj.format = keyFormatToJSON(message.format));
        return obj;
    },
...
export const CreateKeyResponse = {
    ...
    fromJSON(object: any): CreateKeyResponse {
        const message = { ...baseCreateKeyResponse } as CreateKeyResponse;
        message.key =
            object.key !== undefined && object.key !== null ? Key.fromJSON(object.key) : undefined;
        message.privateKey =
...
export const ListKeyOperationsRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListKeyOperationsRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListKeyOperationsRequest } as ListKeyOperationsRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListKeyOperationsResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListKeyOperationsResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListKeyOperationsResponse } as ListKeyOperationsResponse;
        message.operations = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
