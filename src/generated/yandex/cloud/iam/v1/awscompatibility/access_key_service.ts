...
export const ListAccessKeysResponse = {
  ...
  fromJSON(object: any): ListAccessKeysResponse {
    const message = { ...baseListAccessKeysResponse } as ListAccessKeysResponse;
    message.accessKeys = (object.accessKeys ?? []).map((e: any) =>
      AccessKey.fromJSON(e)
    );
  ...
  fromPartial<I extends Exact<DeepPartial<ListAccessKeysResponse>, I>>(
    ...
    const message = { ...baseListAccessKeysResponse } as ListAccessKeysResponse;
    message.accessKeys =
      object.accessKeys?.map((e) => AccessKey.fromPartial(e)) || [];
...
export const CreateAccessKeyResponse = {
  $type:
    "yandex.cloud.iam.v1.awscompatibility.CreateAccessKeyResponse" as const,
...
export const UpdateAccessKeyMetadata = {
  $type:
    "yandex.cloud.iam.v1.awscompatibility.UpdateAccessKeyMetadata" as const,
...
export const DeleteAccessKeyMetadata = {
  $type:
    "yandex.cloud.iam.v1.awscompatibility.DeleteAccessKeyMetadata" as const,
...
export const ListAccessKeyOperationsRequest = {
  $type:
    "yandex.cloud.iam.v1.awscompatibility.ListAccessKeyOperationsRequest" as const,
...
export const ListAccessKeyOperationsResponse = {
  $type:
    "yandex.cloud.iam.v1.awscompatibility.ListAccessKeyOperationsResponse" as const,
