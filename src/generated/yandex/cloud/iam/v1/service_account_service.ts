...
export const CreateServiceAccountRequest_LabelsEntry = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<CreateServiceAccountRequest_LabelsEntry>, I>
  >(object: I): CreateServiceAccountRequest_LabelsEntry {
    const message = {
      ...baseCreateServiceAccountRequest_LabelsEntry,
    } as CreateServiceAccountRequest_LabelsEntry;
...
export const UpdateServiceAccountRequest_LabelsEntry = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<UpdateServiceAccountRequest_LabelsEntry>, I>
  >(object: I): UpdateServiceAccountRequest_LabelsEntry {
    const message = {
      ...baseUpdateServiceAccountRequest_LabelsEntry,
    } as UpdateServiceAccountRequest_LabelsEntry;
    message.key = object.key ?? "";
...
export const ListServiceAccountOperationsRequest = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<ListServiceAccountOperationsRequest>, I>
  >(object: I): ListServiceAccountOperationsRequest {
    const message = {
      ...baseListServiceAccountOperationsRequest,
    } as ListServiceAccountOperationsRequest;
    message.serviceAccountId = object.serviceAccountId ?? "";
...
export const ListServiceAccountOperationsResponse = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<ListServiceAccountOperationsResponse>, I>
  >(object: I): ListServiceAccountOperationsResponse {
    const message = {
      ...baseListServiceAccountOperationsResponse,
    } as ListServiceAccountOperationsResponse;
    message.operations =
