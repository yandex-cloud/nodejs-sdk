    ...
    fromJSON(object: any): RevokeRefreshTokenMetadata {
        ...
        message.subjectId =
            object.subjectId !== undefined && object.subjectId !== null
                ...
                : '';
        message.refreshTokenIds = (object.refreshTokenIds ?? []).map((e: any) => String(e));
        return message;
    },
...
export const ListRefreshTokensRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListRefreshTokensRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListRefreshTokensRequest } as ListRefreshTokensRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListRefreshTokensResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListRefreshTokensResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListRefreshTokensResponse } as ListRefreshTokensResponse;
        message.refreshTokens = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.refreshTokens.push(RefreshToken.decode(reader, reader.uint32()));
                    break;
                case 2:
    ...
    fromPartial<I extends Exact<DeepPartial<ListRefreshTokensResponse>, I>>(
        ...
        const message = { ...baseListRefreshTokensResponse } as ListRefreshTokensResponse;
        message.refreshTokens = object.refreshTokens?.map((e) => RefreshToken.fromPartial(e)) || [];
...
export const RevokeRefreshTokenRequest = {
    ...
    encode(
        ...
        if (message.revokeFilter !== undefined) {
            RevokeFilter.encode(message.revokeFilter, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): RevokeRefreshTokenRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseRevokeRefreshTokenRequest } as RevokeRefreshTokenRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    toJSON(message: RevokeRefreshTokenRequest): unknown {
        const obj: any = {};
        message.refreshTokenId !== undefined && (obj.refreshTokenId = message.refreshTokenId);
...
export const RevokeRefreshTokenResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): RevokeRefreshTokenResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseRevokeRefreshTokenResponse } as RevokeRefreshTokenResponse;
        message.refreshTokenIds = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
export const RefreshTokenServiceService = {
    ...
    list: {
        ...
        requestDeserialize: (value: Buffer) => ListRefreshTokensRequest.decode(value),
        responseSerialize: (value: ListRefreshTokensResponse) =>
            Buffer.from(ListRefreshTokensResponse.encode(value).finish()),
        responseDeserialize: (value: Buffer) => ListRefreshTokensResponse.decode(value),
    },
    ...
    revoke: {
        ...
        requestDeserialize: (value: Buffer) => RevokeRefreshTokenRequest.decode(value),
...
export interface RefreshTokenServiceClient extends Client {
    ...
    list(
        ...
        callback: (error: ServiceError | null, response: ListRefreshTokensResponse) => void,
    ): ClientUnaryCall;
    list(
        request: ListRefreshTokensRequest,
        metadata: Metadata,
