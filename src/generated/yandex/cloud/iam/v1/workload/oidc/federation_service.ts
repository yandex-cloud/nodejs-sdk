  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      CreateFederationRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.iam.v1.workload.oidc.CreateFederationRequest.LabelsEntry",
          key: key as any,
          value,
        },
...
export const CreateFederationRequest_LabelsEntry = {
  $type:
    "yandex.cloud.iam.v1.workload.oidc.CreateFederationRequest.LabelsEntry" as const,
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      UpdateFederationRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.iam.v1.workload.oidc.UpdateFederationRequest.LabelsEntry",
          key: key as any,
          value,
        },
...
export const UpdateFederationRequest_LabelsEntry = {
  $type:
    "yandex.cloud.iam.v1.workload.oidc.UpdateFederationRequest.LabelsEntry" as const,
