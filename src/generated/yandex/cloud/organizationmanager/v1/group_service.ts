...
export function memberDelta_MemberActionFromJSON(
  object: any
): MemberDelta_MemberAction {
  switch (object) {
    case 0:
...
export function memberDelta_MemberActionToJSON(
  object: MemberDelta_MemberAction
): string {
  switch (object) {
...
export const GetGroupRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetGroupRequest>, I>>(
    object: I
  ): GetGroupRequest {
    const message = { ...baseGetGroupRequest } as GetGroupRequest;
...
export const ListGroupsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListGroupsRequest>, I>>(
    object: I
  ): ListGroupsRequest {
    const message = { ...baseListGroupsRequest } as ListGroupsRequest;
...
export const ListGroupOperationsRequest = {
  $type:
    "yandex.cloud.organizationmanager.v1.ListGroupOperationsRequest" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListGroupOperationsRequest,
    } as ListGroupOperationsRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  ListGroupOperationsRequest.$type,
  ListGroupOperationsRequest
);
...
export const ListGroupOperationsResponse = {
  $type:
    "yandex.cloud.organizationmanager.v1.ListGroupOperationsResponse" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListGroupOperationsResponse,
    } as ListGroupOperationsResponse;
    message.operations = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
messageTypeRegistry.set(
  ListGroupOperationsResponse.$type,
  ListGroupOperationsResponse
);
...
export const ListGroupMembersResponse = {
  $type:
    "yandex.cloud.organizationmanager.v1.ListGroupMembersResponse" as const,
...
export const UpdateGroupMembersRequest = {
  $type:
    "yandex.cloud.organizationmanager.v1.UpdateGroupMembersRequest" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpdateGroupMembersRequest,
    } as UpdateGroupMembersRequest;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.memberDeltas.push(
            MemberDelta.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  fromJSON(object: any): UpdateGroupMembersRequest {
    ...
    message.groupId =
      object.groupId !== undefined && object.groupId !== null
        ? String(object.groupId)
        : "";
    message.memberDeltas = (object.memberDeltas ?? []).map((e: any) =>
      MemberDelta.fromJSON(e)
    );
    return message;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<UpdateGroupMembersRequest>, I>>(
    ...
    message.groupId = object.groupId ?? "";
    message.memberDeltas =
      object.memberDeltas?.map((e) => MemberDelta.fromPartial(e)) || [];
    return message;
  },
};

messageTypeRegistry.set(
  UpdateGroupMembersRequest.$type,
  UpdateGroupMembersRequest
);
...
export const UpdateGroupMembersMetadata = {
  $type:
    "yandex.cloud.organizationmanager.v1.UpdateGroupMembersMetadata" as const,
...
messageTypeRegistry.set(
  UpdateGroupMembersMetadata.$type,
  UpdateGroupMembersMetadata
);
...
export const MemberDelta = {
  ...
  fromPartial<I extends Exact<DeepPartial<MemberDelta>, I>>(
    object: I
  ): MemberDelta {
    const message = { ...baseMemberDelta } as MemberDelta;
...
export const GroupServiceService = {
  ...
  get: {
    ...
    responseSerialize: (value: Group) =>
      Buffer.from(Group.encode(value).finish()),
  ...
  updateMembers: {
    ...
    requestDeserialize: (value: Buffer) =>
      UpdateGroupMembersRequest.decode(value),
    responseSerialize: (value: Operation) =>
      Buffer.from(Operation.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Operation.decode(value),
  },
...
export interface GroupServiceClient extends Client {
  ...
  listOperations(
    ...
    callback: (
      ...
      response: ListGroupOperationsResponse
    ) => void
  ): ClientUnaryCall;
  listOperations(
    request: ListGroupOperationsRequest,
