...
export const YandexPassportUserAccount = {
  $type:
    "yandex.cloud.organizationmanager.v1.YandexPassportUserAccount" as const,
  ...
  encode(
    ...
    Object.entries(message.attributes).forEach(([key, value]) => {
      SamlUserAccount_AttributesEntry.encode(
        {
          $type:
            "yandex.cloud.organizationmanager.v1.SamlUserAccount.AttributesEntry",
          key: key as any,
          value,
        },
        writer.uint32(26).fork()
...
export const SamlUserAccount_Attribute = {
  $type:
    "yandex.cloud.organizationmanager.v1.SamlUserAccount.Attribute" as const,
...
export const SamlUserAccount_AttributesEntry = {
  $type:
    "yandex.cloud.organizationmanager.v1.SamlUserAccount.AttributesEntry" as const,
