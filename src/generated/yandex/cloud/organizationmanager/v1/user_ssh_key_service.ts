...
export const GetUserSshKeyRequest = {
  ...
  toJSON(message: GetUserSshKeyRequest): unknown {
    const obj: any = {};
    message.userSshKeyId !== undefined &&
      (obj.userSshKeyId = message.userSshKeyId);
    return obj;
  },
...
export const ListUserSshKeysResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListUserSshKeysResponse,
    } as ListUserSshKeysResponse;
    message.sshKeys = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromJSON(object: any): ListUserSshKeysResponse {
    ...
    message.sshKeys = (object.sshKeys ?? []).map((e: any) =>
      UserSshKey.fromJSON(e)
    );
  ...
  toJSON(message: ListUserSshKeysResponse): unknown {
    const obj: any = {};
    if (message.sshKeys) {
      obj.sshKeys = message.sshKeys.map((e) =>
        e ? UserSshKey.toJSON(e) : undefined
      );
    } else {
      obj.sshKeys = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<ListUserSshKeysResponse>, I>>(
    ...
    message.sshKeys =
      object.sshKeys?.map((e) => UserSshKey.fromPartial(e)) || [];
...
export const CreateUserSshKeyRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCreateUserSshKeyRequest,
    } as CreateUserSshKeyRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const CreateUserSshKeyMetadata = {
  $type:
    "yandex.cloud.organizationmanager.v1.CreateUserSshKeyMetadata" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCreateUserSshKeyMetadata,
    } as CreateUserSshKeyMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const UpdateUserSshKeyRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpdateUserSshKeyRequest,
    } as UpdateUserSshKeyRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const UpdateUserSshKeyMetadata = {
  $type:
    "yandex.cloud.organizationmanager.v1.UpdateUserSshKeyMetadata" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpdateUserSshKeyMetadata,
    } as UpdateUserSshKeyMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const DeleteUserSshKeyRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseDeleteUserSshKeyRequest,
    } as DeleteUserSshKeyRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const DeleteUserSshKeyMetadata = {
  $type:
    "yandex.cloud.organizationmanager.v1.DeleteUserSshKeyMetadata" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseDeleteUserSshKeyMetadata,
    } as DeleteUserSshKeyMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const UserSshKeyServiceService = {
  get: {
    ...
    responseSerialize: (value: UserSshKey) =>
      Buffer.from(UserSshKey.encode(value).finish()),
  ...
  list: {
    ...
    responseDeserialize: (value: Buffer) =>
      ListUserSshKeysResponse.decode(value),
  },
  create: {
    ...
    requestDeserialize: (value: Buffer) =>
      CreateUserSshKeyRequest.decode(value),
  ...
  update: {
    ...
    requestDeserialize: (value: Buffer) =>
      UpdateUserSshKeyRequest.decode(value),
    responseSerialize: (value: Operation) =>
      Buffer.from(Operation.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Operation.decode(value),
  },
  delete: {
    ...
    requestDeserialize: (value: Buffer) =>
      DeleteUserSshKeyRequest.decode(value),
    responseSerialize: (value: Operation) =>
      Buffer.from(Operation.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Operation.decode(value),
  },
