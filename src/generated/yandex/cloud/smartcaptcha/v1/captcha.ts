...
export function captchaChallengeTypeFromJSON(
  object: any
...
export function captchaChallengeTypeToJSON(
  object: CaptchaChallengeType
): string {
  switch (object) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 22:
          ...
          break;
        case 23:
          message.overrideVariants.push(
            OverrideVariant.decode(reader, reader.uint32())
          );
          break;
        default:
  ...
  fromJSON(object: any): Captcha {
    ...
    message.name =
      object.name !== undefined && object.name !== null
        ? String(object.name)
        : "";
    message.allowedSites = (object.allowedSites ?? []).map((e: any) =>
      String(e)
    );
    message.complexity =
    ...
    message.turnOffHostnameCheck =
      object.turnOffHostnameCheck !== undefined &&
      object.turnOffHostnameCheck !== null
...
export const OverrideVariant = {
  ...
  fromPartial<I extends Exact<DeepPartial<OverrideVariant>, I>>(
    object: I
  ): OverrideVariant {
    const message = { ...baseOverrideVariant } as OverrideVariant;
...
export const CaptchaSecretKey = {
  ...
  fromPartial<I extends Exact<DeepPartial<CaptchaSecretKey>, I>>(
    object: I
  ): CaptchaSecretKey {
    const message = { ...baseCaptchaSecretKey } as CaptchaSecretKey;
...
export const SecurityRule = {
  ...
  fromJSON(object: any): SecurityRule {
    ...
    message.overrideVariantUuid =
      object.overrideVariantUuid !== undefined &&
      object.overrideVariantUuid !== null
...
export const Condition = {
  ...
  encode(
    ...
    if (message.host !== undefined) {
      Condition_HostMatcher.encode(
        message.host,
        writer.uint32(10).fork()
      ).ldelim();
    }
    if (message.uri !== undefined) {
      Condition_UriMatcher.encode(
        message.uri,
  ...
  toJSON(message: Condition): unknown {
    ...
    message.host !== undefined &&
      (obj.host = message.host
        ? Condition_HostMatcher.toJSON(message.host)
        : undefined);
    message.uri !== undefined &&
      (obj.uri = message.uri
        ? Condition_UriMatcher.toJSON(message.uri)
        : undefined);
    if (message.headers) {
...
export const Condition_HostMatcher = {
  ...
  fromJSON(object: any): Condition_HostMatcher {
    const message = { ...baseCondition_HostMatcher } as Condition_HostMatcher;
    message.hosts = (object.hosts ?? []).map((e: any) =>
  ...
  fromPartial<I extends Exact<DeepPartial<Condition_HostMatcher>, I>>(
    ...
    const message = { ...baseCondition_HostMatcher } as Condition_HostMatcher;
    message.hosts =
      object.hosts?.map((e) => Condition_StringMatcher.fromPartial(e)) || [];
    return message;
  },
};
