...
export const CreateTrailRequest = {
    encode(message: CreateTrailRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.destination !== undefined) {
            Trail_Destination.encode(message.destination, writer.uint32(42).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    const entry4 = CreateTrailRequest_LabelsEntry.decode(reader, reader.uint32());
...
export const CreateTrailRequest_LabelsEntry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): CreateTrailRequest_LabelsEntry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseCreateTrailRequest_LabelsEntry } as CreateTrailRequest_LabelsEntry;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const UpdateTrailRequest = {
    encode(message: UpdateTrailRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.destination !== undefined) {
            Trail_Destination.encode(message.destination, writer.uint32(50).fork()).ldelim();
        }
        if (message.serviceAccountId !== '') {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    const entry5 = UpdateTrailRequest_LabelsEntry.decode(reader, reader.uint32());
...
export const UpdateTrailRequest_LabelsEntry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): UpdateTrailRequest_LabelsEntry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseUpdateTrailRequest_LabelsEntry } as UpdateTrailRequest_LabelsEntry;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListTrailOperationsRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListTrailOperationsRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListTrailOperationsRequest } as ListTrailOperationsRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListTrailOperationsResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListTrailOperationsResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListTrailOperationsResponse } as ListTrailOperationsResponse;
        message.operations = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
export const TrailServiceService = {
    ...
    get: {
        ...
        responseSerialize: (value: Trail) => Buffer.from(Trail.encode(value).finish()),
    ...
    listOperations: {
        ...
        requestDeserialize: (value: Buffer) => ListTrailOperationsRequest.decode(value),
        responseSerialize: (value: ListTrailOperationsResponse) =>
            Buffer.from(ListTrailOperationsResponse.encode(value).finish()),
        responseDeserialize: (value: Buffer) => ListTrailOperationsResponse.decode(value),
    },
...
export interface TrailServiceServer extends UntypedServiceImplementation {
    ...
    /** Lists operations for the specified trail. */
    listOperations: handleUnaryCall<ListTrailOperationsRequest, ListTrailOperationsResponse>;
    /** Lists existing access bindings for the specified trail. */
...
export interface TrailServiceClient extends Client {
    ...
    listOperations(
        ...
        callback: (error: ServiceError | null, response: ListTrailOperationsResponse) => void,
    ): ClientUnaryCall;
    listOperations(
        request: ListTrailOperationsRequest,
        metadata: Metadata,
