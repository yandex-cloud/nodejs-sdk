...
import { ResourcePreset } from '../../../../yandex/cloud/k8s/v1/resource_preset';
...
export const ResourcePresetServiceService = {
    ...
    get: {
        path: '/yandex.cloud.k8s.v1.ResourcePresetService/Get',
        requestStream: false,
    ...
    list: {
        path: '/yandex.cloud.k8s.v1.ResourcePresetService/List',
        requestStream: false,
        responseStream: false,
...
export const ResourcePresetServiceClient = makeGenericClientConstructor(
    ...
    'yandex.cloud.k8s.v1.ResourcePresetService',
) as unknown as {
    new (
        address: string,
