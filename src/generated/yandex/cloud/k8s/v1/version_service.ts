...
const baseListVersionsRequest: object = { $type: 'yandex.cloud.k8s.v1.ListVersionsRequest' };
...
const baseListVersionsResponse: object = { $type: 'yandex.cloud.k8s.v1.ListVersionsResponse' };
