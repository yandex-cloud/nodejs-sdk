...
export const MasterUpdateSpec = {
    ...
    toJSON(message: MasterUpdateSpec): unknown {
        ...
        message.version !== undefined &&
            (obj.version = message.version ? UpdateVersionSpec.toJSON(message.version) : undefined);
        ...
        if (message.locations) {
            obj.locations = message.locations.map((e) => (e ? LocationSpec.toJSON(e) : undefined));
        } else {
            obj.locations = [];
        }
...
export const AutoUpgradeMasterMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): AutoUpgradeMasterMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseAutoUpgradeMasterMetadata } as AutoUpgradeMasterMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListClusterNodeGroupsRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListClusterNodeGroupsRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListClusterNodeGroupsRequest } as ListClusterNodeGroupsRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListClusterNodeGroupsResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListClusterNodeGroupsResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListClusterNodeGroupsResponse } as ListClusterNodeGroupsResponse;
        message.nodeGroups = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object: any): ListClusterNodeGroupsResponse {
        const message = { ...baseListClusterNodeGroupsResponse } as ListClusterNodeGroupsResponse;
        message.nodeGroups = (object.nodeGroups ?? []).map((e: any) => NodeGroup.fromJSON(e));
        message.nextPageToken =
            object.nextPageToken !== undefined && object.nextPageToken !== null
                ? String(object.nextPageToken)
                : '';
...
export const ListClusterNodesRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListClusterNodesRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListClusterNodesRequest } as ListClusterNodesRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListClusterNodesResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListClusterNodesResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListClusterNodesResponse } as ListClusterNodesResponse;
        message.nodes = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object: any): MasterSpec {
        ...
        message.zonalMasterSpec =
            object.zonalMasterSpec !== undefined && object.zonalMasterSpec !== null
                ...
                : undefined;
        message.regionalMasterSpec =
            object.regionalMasterSpec !== undefined && object.regionalMasterSpec !== null
...
const baseZonalMasterSpec: object = { $type: 'yandex.cloud.k8s.v1.ZonalMasterSpec', zoneId: '' };
    ...
    fromJSON(object: any): RegionalMasterSpec {
        ...
        message.regionId =
            object.regionId !== undefined && object.regionId !== null
                ...
                : '';
        message.locations = (object.locations ?? []).map((e: any) => MasterLocation.fromJSON(e));
        message.externalV4AddressSpec =
            object.externalV4AddressSpec !== undefined && object.externalV4AddressSpec !== null
                ? ExternalAddressSpec.fromJSON(object.externalV4AddressSpec)
                : undefined;
...
const baseMasterLocation: object = { $type: 'yandex.cloud.k8s.v1.MasterLocation', zoneId: '' };
