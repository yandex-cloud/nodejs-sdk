...
export const Cluster = {
    ...
    fromJSON(object: any): Cluster {
        ...
        message.gatewayIpv4Address =
            object.gatewayIpv4Address !== undefined && object.gatewayIpv4Address !== null
        ...
        message.nodeServiceAccountId =
            object.nodeServiceAccountId !== undefined && object.nodeServiceAccountId !== null
    ...
    fromJSON(object: any): Master {
        ...
        message.regionalMaster =
            object.regionalMaster !== undefined && object.regionalMaster !== null
                ...
                : undefined;
        message.locations = (object.locations ?? []).map((e: any) => Location.fromJSON(e));
...
export const MasterAuth = {
    ...
    fromJSON(object: any): MasterAuth {
        ...
        message.clusterCaCertificate =
            object.clusterCaCertificate !== undefined && object.clusterCaCertificate !== null
...
export const ZonalMaster = {
    ...
    fromJSON(object: any): ZonalMaster {
        ...
        message.internalV4Address =
            object.internalV4Address !== undefined && object.internalV4Address !== null
                ? String(object.internalV4Address)
                : '';
        message.externalV4Address =
            object.externalV4Address !== undefined && object.externalV4Address !== null
...
export const RegionalMaster = {
    ...
    fromJSON(object: any): RegionalMaster {
        ...
        message.externalV6Address =
            object.externalV6Address !== undefined && object.externalV6Address !== null
...
export const MasterEndpoints = {
    ...
    fromJSON(object: any): MasterEndpoints {
        ...
        message.internalV4Endpoint =
            object.internalV4Endpoint !== undefined && object.internalV4Endpoint !== null
                ? String(object.internalV4Endpoint)
                : '';
        message.externalV4Endpoint =
            object.externalV4Endpoint !== undefined && object.externalV4Endpoint !== null
                ? String(object.externalV4Endpoint)
                : '';
        message.externalV6Endpoint =
            object.externalV6Endpoint !== undefined && object.externalV6Endpoint !== null
...
export const IPAllocationPolicy = {
    ...
    fromJSON(object: any): IPAllocationPolicy {
        ...
        message.clusterIpv4CidrBlock =
            object.clusterIpv4CidrBlock !== undefined && object.clusterIpv4CidrBlock !== null
                ? String(object.clusterIpv4CidrBlock)
                : '';
        message.nodeIpv4CidrMaskSize =
            object.nodeIpv4CidrMaskSize !== undefined && object.nodeIpv4CidrMaskSize !== null
                ? Number(object.nodeIpv4CidrMaskSize)
                : 0;
        message.serviceIpv4CidrBlock =
            object.serviceIpv4CidrBlock !== undefined && object.serviceIpv4CidrBlock !== null
                ? String(object.serviceIpv4CidrBlock)
                : '';
        message.clusterIpv6CidrBlock =
            object.clusterIpv6CidrBlock !== undefined && object.clusterIpv6CidrBlock !== null
                ? String(object.clusterIpv6CidrBlock)
                : '';
        message.serviceIpv6CidrBlock =
            object.serviceIpv6CidrBlock !== undefined && object.serviceIpv6CidrBlock !== null
...
export const MasterMaintenancePolicy = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): MasterMaintenancePolicy {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMasterMaintenancePolicy } as MasterMaintenancePolicy;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const MasterLogging = {
    ...
    fromJSON(object: any): MasterLogging {
        ...
        message.kubeApiserverEnabled =
            object.kubeApiserverEnabled !== undefined && object.kubeApiserverEnabled !== null
    ...
    toJSON(message: MasterLogging): unknown {
        ...
        message.logGroupId !== undefined && (obj.logGroupId = message.logGroupId);
        message.folderId !== undefined && (obj.folderId = message.folderId);
        message.auditEnabled !== undefined && (obj.auditEnabled = message.auditEnabled);
        ...
        message.eventsEnabled !== undefined && (obj.eventsEnabled = message.eventsEnabled);
        return obj;
    },
