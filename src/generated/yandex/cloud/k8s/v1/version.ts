...
export const VersionInfo = {
    ...
    fromJSON(object: any): VersionInfo {
        ...
        message.newRevisionAvailable =
            object.newRevisionAvailable !== undefined && object.newRevisionAvailable !== null
                ? Boolean(object.newRevisionAvailable)
                : false;
        message.newRevisionSummary =
            object.newRevisionSummary !== undefined && object.newRevisionSummary !== null
                ? String(object.newRevisionSummary)
                : '';
        message.versionDeprecated =
            object.versionDeprecated !== undefined && object.versionDeprecated !== null
...
export const UpdateVersionSpec = {
    ...
    toJSON(message: UpdateVersionSpec): unknown {
        ...
        message.latestRevision !== undefined && (obj.latestRevision = message.latestRevision);
        return obj;
    },
