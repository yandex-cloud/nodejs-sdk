...
export interface HelmRelease {
  $type: "yandex.cloud.k8s.marketplace.v1.HelmRelease";
...
export const HelmRelease = {
  $type: "yandex.cloud.k8s.marketplace.v1.HelmRelease" as const,
...
messageTypeRegistry.set(HelmRelease.$type, HelmRelease);
