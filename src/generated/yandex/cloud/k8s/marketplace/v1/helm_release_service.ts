...
export const ListHelmReleasesResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListHelmReleasesResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListHelmReleasesResponse } as ListHelmReleasesResponse;
        message.helmReleases = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.helmReleases.push(HelmRelease.decode(reader, reader.uint32()));
                    break;
                case 2:
    ...
    fromJSON(object: any): ListHelmReleasesResponse {
        const message = { ...baseListHelmReleasesResponse } as ListHelmReleasesResponse;
        message.helmReleases = (object.helmReleases ?? []).map((e: any) => HelmRelease.fromJSON(e));
    ...
    fromPartial<I extends Exact<DeepPartial<ListHelmReleasesResponse>, I>>(
        ...
        const message = { ...baseListHelmReleasesResponse } as ListHelmReleasesResponse;
        message.helmReleases = object.helmReleases?.map((e) => HelmRelease.fromPartial(e)) || [];
...
export const InstallHelmReleaseRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): InstallHelmReleaseRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseInstallHelmReleaseRequest } as InstallHelmReleaseRequest;
        message.userValues = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object: any): InstallHelmReleaseRequest {
        ...
        message.productVersionId =
            object.productVersionId !== undefined && object.productVersionId !== null
                ...
                : '';
        message.userValues = (object.userValues ?? []).map((e: any) => ValueWithKey.fromJSON(e));
        return message;
    },
    ...
    fromPartial<I extends Exact<DeepPartial<InstallHelmReleaseRequest>, I>>(
        ...
        message.userValues = object.userValues?.map((e) => ValueWithKey.fromPartial(e)) || [];
        return message;
    },
};
...
export const InstallHelmReleaseMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): InstallHelmReleaseMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseInstallHelmReleaseMetadata } as InstallHelmReleaseMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    toJSON(message: InstallHelmReleaseMetadata): unknown {
        const obj: any = {};
        message.clusterId !== undefined && (obj.clusterId = message.clusterId);
        message.helmReleaseId !== undefined && (obj.helmReleaseId = message.helmReleaseId);
        message.productVersionId !== undefined && (obj.productVersionId = message.productVersionId);
        return obj;
    },
...
export const UpdateHelmReleaseRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): UpdateHelmReleaseRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseUpdateHelmReleaseRequest } as UpdateHelmReleaseRequest;
        message.userValues = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
export const UpdateHelmReleaseMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): UpdateHelmReleaseMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseUpdateHelmReleaseMetadata } as UpdateHelmReleaseMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const UninstallHelmReleaseRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): UninstallHelmReleaseRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseUninstallHelmReleaseRequest } as UninstallHelmReleaseRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const UninstallHelmReleaseMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): UninstallHelmReleaseMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseUninstallHelmReleaseMetadata } as UninstallHelmReleaseMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const HelmReleaseServiceService = {
    ...
    list: {
        ...
        requestDeserialize: (value: Buffer) => ListHelmReleasesRequest.decode(value),
        responseSerialize: (value: ListHelmReleasesResponse) =>
            Buffer.from(ListHelmReleasesResponse.encode(value).finish()),
        responseDeserialize: (value: Buffer) => ListHelmReleasesResponse.decode(value),
    },
    ...
    get: {
        ...
        responseSerialize: (value: HelmRelease) => Buffer.from(HelmRelease.encode(value).finish()),
    ...
    install: {
        ...
        requestDeserialize: (value: Buffer) => InstallHelmReleaseRequest.decode(value),
    ...
    update: {
        ...
        requestDeserialize: (value: Buffer) => UpdateHelmReleaseRequest.decode(value),
        responseSerialize: (value: Operation) => Buffer.from(Operation.encode(value).finish()),
        responseDeserialize: (value: Buffer) => Operation.decode(value),
    },
    ...
    uninstall: {
        ...
        requestDeserialize: (value: Buffer) => UninstallHelmReleaseRequest.decode(value),
        responseSerialize: (value: Operation) => Buffer.from(Operation.encode(value).finish()),
        responseDeserialize: (value: Buffer) => Operation.decode(value),
    },
} as const;
...
export interface HelmReleaseServiceClient extends Client {
    ...
    list(
        ...
        callback: (error: ServiceError | null, response: ListHelmReleasesResponse) => void,
    ): ClientUnaryCall;
    list(
        request: ListHelmReleasesRequest,
        metadata: Metadata,
