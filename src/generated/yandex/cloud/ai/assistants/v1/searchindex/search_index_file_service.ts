...
export const GetSearchIndexFileRequest = {
  $type:
    "yandex.cloud.ai.assistants.v1.searchindex.GetSearchIndexFileRequest" as const,
  ...
  decode(
    ...
    const message = {
      ...baseGetSearchIndexFileRequest,
    } as GetSearchIndexFileRequest;
  ...
  fromJSON(object: any): GetSearchIndexFileRequest {
    ...
    message.fileId =
      object.fileId !== undefined && object.fileId !== null
...
messageTypeRegistry.set(
  GetSearchIndexFileRequest.$type,
  GetSearchIndexFileRequest
);

const baseListSearchIndexFilesRequest: object = {
  $type:
    "yandex.cloud.ai.assistants.v1.searchindex.ListSearchIndexFilesRequest",
  searchIndexId: "",
  pageSize: 0,
  pageToken: "",
};
...
export const ListSearchIndexFilesRequest = {
  $type:
    "yandex.cloud.ai.assistants.v1.searchindex.ListSearchIndexFilesRequest" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListSearchIndexFilesRequest,
    } as ListSearchIndexFilesRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  ListSearchIndexFilesRequest.$type,
  ListSearchIndexFilesRequest
);

const baseListSearchIndexFilesResponse: object = {
  $type:
    "yandex.cloud.ai.assistants.v1.searchindex.ListSearchIndexFilesResponse",
  nextPageToken: "",
};

export const ListSearchIndexFilesResponse = {
  $type:
    "yandex.cloud.ai.assistants.v1.searchindex.ListSearchIndexFilesResponse" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListSearchIndexFilesResponse,
    } as ListSearchIndexFilesResponse;
    message.files = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  toJSON(message: ListSearchIndexFilesResponse): unknown {
    ...
    if (message.files) {
      obj.files = message.files.map((e) =>
        e ? SearchIndexFile.toJSON(e) : undefined
      );
    } else {
      obj.files = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<ListSearchIndexFilesResponse>, I>>(
    ...
    message.files =
      object.files?.map((e) => SearchIndexFile.fromPartial(e)) || [];
...
messageTypeRegistry.set(
  ListSearchIndexFilesResponse.$type,
  ListSearchIndexFilesResponse
);
...
export const SearchIndexFileServiceService = {
  get: {
    ...
    requestDeserialize: (value: Buffer) =>
      GetSearchIndexFileRequest.decode(value),
  ...
  list: {
    ...
    requestDeserialize: (value: Buffer) =>
      ListSearchIndexFilesRequest.decode(value),
    responseSerialize: (value: ListSearchIndexFilesResponse) =>
      Buffer.from(ListSearchIndexFilesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) =>
      ListSearchIndexFilesResponse.decode(value),
  },
} as const;

export interface SearchIndexFileServiceServer
...
export interface SearchIndexFileServiceClient extends Client {
  ...
  list(
    ...
    callback: (
      ...
      response: ListSearchIndexFilesResponse
    ) => void
  ): ClientUnaryCall;
  list(
    request: ListSearchIndexFilesRequest,
