...
export const CreateSearchIndexRequest = {
  $type:
    "yandex.cloud.ai.assistants.v1.searchindex.CreateSearchIndexRequest" as const,
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      CreateSearchIndexRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.ai.assistants.v1.searchindex.CreateSearchIndexRequest.LabelsEntry",
          key: key as any,
          value,
        },
  ...
  decode(
    ...
    const message = {
      ...baseCreateSearchIndexRequest,
    } as CreateSearchIndexRequest;
    message.fileIds = [];
    message.labels = {};
...
export const CreateSearchIndexRequest_LabelsEntry = {
  $type:
    "yandex.cloud.ai.assistants.v1.searchindex.CreateSearchIndexRequest.LabelsEntry" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<CreateSearchIndexRequest_LabelsEntry>, I>
  >(object: I): CreateSearchIndexRequest_LabelsEntry {
    const message = {
      ...baseCreateSearchIndexRequest_LabelsEntry,
    } as CreateSearchIndexRequest_LabelsEntry;
...
export const GetSearchIndexRequest = {
  $type:
    "yandex.cloud.ai.assistants.v1.searchindex.GetSearchIndexRequest" as const,
...
export const UpdateSearchIndexRequest = {
  $type:
    "yandex.cloud.ai.assistants.v1.searchindex.UpdateSearchIndexRequest" as const,
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      UpdateSearchIndexRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.ai.assistants.v1.searchindex.UpdateSearchIndexRequest.LabelsEntry",
          key: key as any,
          value,
        },
        writer.uint32(50).fork()
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpdateSearchIndexRequest,
    } as UpdateSearchIndexRequest;
    message.labels = {};
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
export const UpdateSearchIndexRequest_LabelsEntry = {
  $type:
    "yandex.cloud.ai.assistants.v1.searchindex.UpdateSearchIndexRequest.LabelsEntry" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<UpdateSearchIndexRequest_LabelsEntry>, I>
  >(object: I): UpdateSearchIndexRequest_LabelsEntry {
    const message = {
      ...baseUpdateSearchIndexRequest_LabelsEntry,
    } as UpdateSearchIndexRequest_LabelsEntry;
    message.key = object.key ?? "";
...
export const DeleteSearchIndexRequest = {
  $type:
    "yandex.cloud.ai.assistants.v1.searchindex.DeleteSearchIndexRequest" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseDeleteSearchIndexRequest,
    } as DeleteSearchIndexRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const DeleteSearchIndexResponse = {
  $type:
    "yandex.cloud.ai.assistants.v1.searchindex.DeleteSearchIndexResponse" as const,

  encode(
    _: DeleteSearchIndexResponse,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    return writer;
  },
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseDeleteSearchIndexResponse,
    } as DeleteSearchIndexResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
...
messageTypeRegistry.set(
  DeleteSearchIndexResponse.$type,
  DeleteSearchIndexResponse
);
...
export const ListSearchIndicesRequest = {
  $type:
    "yandex.cloud.ai.assistants.v1.searchindex.ListSearchIndicesRequest" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListSearchIndicesRequest,
    } as ListSearchIndicesRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const ListSearchIndicesResponse = {
  $type:
    "yandex.cloud.ai.assistants.v1.searchindex.ListSearchIndicesResponse" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListSearchIndicesResponse,
    } as ListSearchIndicesResponse;
    message.indices = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromJSON(object: any): ListSearchIndicesResponse {
    ...
    message.indices = (object.indices ?? []).map((e: any) =>
      SearchIndex.fromJSON(e)
    );
  ...
  toJSON(message: ListSearchIndicesResponse): unknown {
    ...
    if (message.indices) {
      obj.indices = message.indices.map((e) =>
        e ? SearchIndex.toJSON(e) : undefined
      );
    } else {
      obj.indices = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<ListSearchIndicesResponse>, I>>(
    ...
    message.indices =
      object.indices?.map((e) => SearchIndex.fromPartial(e)) || [];
...
messageTypeRegistry.set(
  ListSearchIndicesResponse.$type,
  ListSearchIndicesResponse
);
...
export const SearchIndexServiceService = {
  create: {
    ...
    requestDeserialize: (value: Buffer) =>
      CreateSearchIndexRequest.decode(value),
  ...
  get: {
    ...
    responseSerialize: (value: SearchIndex) =>
      Buffer.from(SearchIndex.encode(value).finish()),
  ...
  update: {
    ...
    requestDeserialize: (value: Buffer) =>
      UpdateSearchIndexRequest.decode(value),
    responseSerialize: (value: SearchIndex) =>
      Buffer.from(SearchIndex.encode(value).finish()),
    responseDeserialize: (value: Buffer) => SearchIndex.decode(value),
  },
...
export interface SearchIndexServiceClient extends Client {
  ...
  list(
    ...
    callback: (
      error: ServiceError | null,
      response: ListSearchIndicesResponse
    ) => void
  ): ClientUnaryCall;
  list(
    request: ListSearchIndicesRequest,
