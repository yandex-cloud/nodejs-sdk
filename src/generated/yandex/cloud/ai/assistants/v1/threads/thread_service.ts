...
export const CreateThreadRequest = {
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      CreateThreadRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.ai.assistants.v1.threads.CreateThreadRequest.LabelsEntry",
          key: key as any,
          value,
        },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          break;
        case 7:
          const entry7 = CreateThreadRequest_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
  ...
  fromJSON(object: any): CreateThreadRequest {
    ...
    message.defaultMessageAuthorId =
      object.defaultMessageAuthorId !== undefined &&
      object.defaultMessageAuthorId !== null
...
export const CreateThreadRequest_LabelsEntry = {
  $type:
    "yandex.cloud.ai.assistants.v1.threads.CreateThreadRequest.LabelsEntry" as const,
...
messageTypeRegistry.set(
  CreateThreadRequest_LabelsEntry.$type,
  CreateThreadRequest_LabelsEntry
);
...
export const GetThreadRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetThreadRequest>, I>>(
    object: I
  ): GetThreadRequest {
    const message = { ...baseGetThreadRequest } as GetThreadRequest;
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      UpdateThreadRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.ai.assistants.v1.threads.UpdateThreadRequest.LabelsEntry",
          key: key as any,
          value,
        },
        writer.uint32(50).fork()
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break;
        case 6:
          const entry6 = UpdateThreadRequest_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
...
export const UpdateThreadRequest_LabelsEntry = {
  $type:
    "yandex.cloud.ai.assistants.v1.threads.UpdateThreadRequest.LabelsEntry" as const,
...
messageTypeRegistry.set(
  UpdateThreadRequest_LabelsEntry.$type,
  UpdateThreadRequest_LabelsEntry
);
...
export const DeleteThreadResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<DeleteThreadResponse>, I>>(
    _: I
  ): DeleteThreadResponse {
    const message = { ...baseDeleteThreadResponse } as DeleteThreadResponse;
    return message;
...
export const ListThreadsResponse = {
  ...
  fromJSON(object: any): ListThreadsResponse {
    const message = { ...baseListThreadsResponse } as ListThreadsResponse;
    message.threads = (object.threads ?? []).map((e: any) =>
      Thread.fromJSON(e)
    );
  ...
  toJSON(message: ListThreadsResponse): unknown {
    const obj: any = {};
    if (message.threads) {
      obj.threads = message.threads.map((e) =>
...
export const ThreadServiceService = {
  create: {
    ...
    responseSerialize: (value: Thread) =>
      Buffer.from(Thread.encode(value).finish()),
