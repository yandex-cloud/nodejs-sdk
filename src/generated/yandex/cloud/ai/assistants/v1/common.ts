...
export const PromptTruncationOptions = {
  ...
  decode(
    ...
    const message = {
      ...basePromptTruncationOptions,
    } as PromptTruncationOptions;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.maxPromptTokens = Int64Value.decode(
            reader,
            reader.uint32()
          ).value;
          break;
  ...
  toJSON(message: PromptTruncationOptions): unknown {
    const obj: any = {};
    message.maxPromptTokens !== undefined &&
      (obj.maxPromptTokens = message.maxPromptTokens);
    return obj;
  },
...
export const SearchIndexTool = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.maxNumResults = Int64Value.decode(
            reader,
            reader.uint32()
          ).value;
          break;
  ...
  fromJSON(object: any): SearchIndexTool {
    const message = { ...baseSearchIndexTool } as SearchIndexTool;
    message.searchIndexIds = (object.searchIndexIds ?? []).map((e: any) =>
      String(e)
    );
  ...
  toJSON(message: SearchIndexTool): unknown {
    ...
    message.maxNumResults !== undefined &&
      (obj.maxNumResults = message.maxNumResults);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<SearchIndexTool>, I>>(
    object: I
  ): SearchIndexTool {
    const message = { ...baseSearchIndexTool } as SearchIndexTool;
