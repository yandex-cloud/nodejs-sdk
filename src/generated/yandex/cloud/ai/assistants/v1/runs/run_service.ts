...
export function streamEvent_EventTypeFromJSON(
  object: any
): StreamEvent_EventType {
  switch (object) {
    case 0:
...
export function streamEvent_EventTypeToJSON(
  object: StreamEvent_EventType
): string {
  switch (object) {
...
export const CreateRunRequest = {
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      CreateRunRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.ai.assistants.v1.runs.CreateRunRequest.LabelsEntry",
          key: key as any,
          value,
        },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          const entry3 = CreateRunRequest_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
          ...
          break;
        case 4:
          message.additionalMessages.push(
            MessageData.decode(reader, reader.uint32())
          );
          break;
        case 5:
          message.customPromptTruncationOptions =
            PromptTruncationOptions.decode(reader, reader.uint32());
          break;
        case 6:
  ...
  fromJSON(object: any): CreateRunRequest {
    ...
    message.additionalMessages = (object.additionalMessages ?? []).map(
      (e: any) => MessageData.fromJSON(e)
    );
    message.customPromptTruncationOptions =
      ...
      object.customPromptTruncationOptions !== null
        ...
        : undefined;
    message.customCompletionOptions =
      object.customCompletionOptions !== undefined &&
      object.customCompletionOptions !== null
  ...
  toJSON(message: CreateRunRequest): unknown {
    const obj: any = {};
    message.assistantId !== undefined &&
      (obj.assistantId = message.assistantId);
  ...
  fromPartial<I extends Exact<DeepPartial<CreateRunRequest>, I>>(
    object: I
  ): CreateRunRequest {
    const message = { ...baseCreateRunRequest } as CreateRunRequest;
    ...
    message.customPromptTruncationOptions =
      object.customPromptTruncationOptions !== undefined &&
      object.customPromptTruncationOptions !== null
        ? PromptTruncationOptions.fromPartial(
            object.customPromptTruncationOptions
          )
        : undefined;
    message.customCompletionOptions =
      object.customCompletionOptions !== undefined &&
...
export const CreateRunRequest_LabelsEntry = {
  $type:
    "yandex.cloud.ai.assistants.v1.runs.CreateRunRequest.LabelsEntry" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCreateRunRequest_LabelsEntry,
    } as CreateRunRequest_LabelsEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  CreateRunRequest_LabelsEntry.$type,
  CreateRunRequest_LabelsEntry
);
...
export const ListenRunRequest = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.eventsStartIdx = Int64Value.decode(
            reader,
            reader.uint32()
          ).value;
          break;
  ...
  fromJSON(object: any): ListenRunRequest {
    const message = { ...baseListenRunRequest } as ListenRunRequest;
    message.runId =
      object.runId !== undefined && object.runId !== null
        ? String(object.runId)
        : "";
  ...
  toJSON(message: ListenRunRequest): unknown {
    ...
    message.eventsStartIdx !== undefined &&
      (obj.eventsStartIdx = message.eventsStartIdx);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<ListenRunRequest>, I>>(
    object: I
  ): ListenRunRequest {
    const message = { ...baseListenRunRequest } as ListenRunRequest;
...
export const GetRunRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetRunRequest>, I>>(
    object: I
  ): GetRunRequest {
    const message = { ...baseGetRunRequest } as GetRunRequest;
    message.runId = object.runId ?? "";
...
export const GetLastRunByThreadRequest = {
  $type:
    "yandex.cloud.ai.assistants.v1.runs.GetLastRunByThreadRequest" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseGetLastRunByThreadRequest,
    } as GetLastRunByThreadRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  GetLastRunByThreadRequest.$type,
  GetLastRunByThreadRequest
);
...
export const ListRunsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListRunsRequest>, I>>(
    object: I
  ): ListRunsRequest {
    const message = { ...baseListRunsRequest } as ListRunsRequest;
...
export const ListRunsResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListRunsResponse>, I>>(
    object: I
  ): ListRunsResponse {
    const message = { ...baseListRunsResponse } as ListRunsResponse;
...
export const StreamCursor = {
  ...
  fromJSON(object: any): StreamCursor {
    ...
    message.numUserEventsReceived =
      object.numUserEventsReceived !== undefined &&
      object.numUserEventsReceived !== null
  ...
  fromPartial<I extends Exact<DeepPartial<StreamCursor>, I>>(
    object: I
  ): StreamCursor {
    const message = { ...baseStreamCursor } as StreamCursor;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.partialMessage = MessageContent.decode(
            reader,
            reader.uint32()
          );
          break;
...
export const RunServiceService = {
  ...
  listen: {
    ...
    responseSerialize: (value: StreamEvent) =>
      Buffer.from(StreamEvent.encode(value).finish()),
  ...
  getLastByThread: {
    ...
    requestDeserialize: (value: Buffer) =>
      GetLastRunByThreadRequest.decode(value),
    responseSerialize: (value: Run) => Buffer.from(Run.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Run.decode(value),
  },
  list: {
