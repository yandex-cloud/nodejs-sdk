  ...
  toJSON(message: Run): unknown {
    ...
    message.usage !== undefined &&
      (obj.usage = message.usage
        ? ContentUsage.toJSON(message.usage)
        : undefined);
...
export const Run_LabelsEntry = {
  ...
  fromPartial<I extends Exact<DeepPartial<Run_LabelsEntry>, I>>(
    object: I
  ): Run_LabelsEntry {
    const message = { ...baseRun_LabelsEntry } as Run_LabelsEntry;
...
export const RunState = {
  ...
  toJSON(message: RunState): unknown {
    ...
    message.status !== undefined &&
      (obj.status = runState_RunStatusToJSON(message.status));
