  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      CreateAssistantRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.ai.assistants.v1.CreateAssistantRequest.LabelsEntry",
          key: key as any,
          value,
        },
...
export const CreateAssistantRequest_LabelsEntry = {
  $type:
    "yandex.cloud.ai.assistants.v1.CreateAssistantRequest.LabelsEntry" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<CreateAssistantRequest_LabelsEntry>, I>
  >(object: I): CreateAssistantRequest_LabelsEntry {
    const message = {
      ...baseCreateAssistantRequest_LabelsEntry,
    } as CreateAssistantRequest_LabelsEntry;
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      UpdateAssistantRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.ai.assistants.v1.UpdateAssistantRequest.LabelsEntry",
          key: key as any,
          value,
        },
...
export const UpdateAssistantRequest_LabelsEntry = {
  $type:
    "yandex.cloud.ai.assistants.v1.UpdateAssistantRequest.LabelsEntry" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<UpdateAssistantRequest_LabelsEntry>, I>
  >(object: I): UpdateAssistantRequest_LabelsEntry {
    const message = {
      ...baseUpdateAssistantRequest_LabelsEntry,
    } as UpdateAssistantRequest_LabelsEntry;
    message.key = object.key ?? "";
...
export const ListAssistantsResponse = {
  ...
  fromJSON(object: any): ListAssistantsResponse {
    const message = { ...baseListAssistantsResponse } as ListAssistantsResponse;
    message.assistants = (object.assistants ?? []).map((e: any) =>
      Assistant.fromJSON(e)
    );
  ...
  toJSON(message: ListAssistantsResponse): unknown {
    ...
    if (message.assistants) {
      obj.assistants = message.assistants.map((e) =>
        e ? Assistant.toJSON(e) : undefined
      );
    } else {
      obj.assistants = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<ListAssistantsResponse>, I>>(
    ...
    const message = { ...baseListAssistantsResponse } as ListAssistantsResponse;
    message.assistants =
      object.assistants?.map((e) => Assistant.fromPartial(e)) || [];
...
export const ListAssistantVersionsRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListAssistantVersionsRequest,
    } as ListAssistantVersionsRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  ListAssistantVersionsRequest.$type,
  ListAssistantVersionsRequest
);
  ...
  toJSON(message: AssistantVersion): unknown {
    ...
    message.assistant !== undefined &&
      (obj.assistant = message.assistant
        ? Assistant.toJSON(message.assistant)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<AssistantVersion>, I>>(
    object: I
  ): AssistantVersion {
    const message = { ...baseAssistantVersion } as AssistantVersion;
...
export const ListAssistantVersionsResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListAssistantVersionsResponse,
    } as ListAssistantVersionsResponse;
    message.versions = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.versions.push(
            AssistantVersion.decode(reader, reader.uint32())
          );
          break;
        case 2:
          message.nextPageToken = reader.string();
  ...
  fromPartial<I extends Exact<DeepPartial<ListAssistantVersionsResponse>, I>>(
    ...
    message.versions =
      object.versions?.map((e) => AssistantVersion.fromPartial(e)) || [];
    message.nextPageToken = object.nextPageToken ?? "";
    return message;
  },
};
...
messageTypeRegistry.set(
  ListAssistantVersionsResponse.$type,
  ListAssistantVersionsResponse
);
...
export const AssistantServiceService = {
  create: {
    ...
    responseSerialize: (value: Assistant) =>
      Buffer.from(Assistant.encode(value).finish()),
  ...
  delete: {
    ...
    responseDeserialize: (value: Buffer) =>
      DeleteAssistantResponse.decode(value),
  },
  list: {
    ...
    responseDeserialize: (value: Buffer) =>
      ListAssistantsResponse.decode(value),
  },
  listVersions: {
...
export interface AssistantServiceClient extends Client {
  ...
  listVersions(
    ...
    callback: (
      error: ServiceError | null,
      response: ListAssistantVersionsResponse
    ) => void
  ): ClientUnaryCall;
  listVersions(
    request: ListAssistantVersionsRequest,
