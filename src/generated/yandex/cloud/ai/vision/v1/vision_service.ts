...
export const BatchAnalyzeRequest = {
    ...
    fromJSON(object: any): BatchAnalyzeRequest {
        const message = { ...baseBatchAnalyzeRequest } as BatchAnalyzeRequest;
        message.analyzeSpecs = (object.analyzeSpecs ?? []).map((e: any) => AnalyzeSpec.fromJSON(e));
        message.folderId =
    ...
    fromJSON(object: any): AnalyzeSpec {
        ...
        message.signature =
            object.signature !== undefined && object.signature !== null
                ...
                : undefined;
        message.features = (object.features ?? []).map((e: any) => Feature.fromJSON(e));
        message.mimeType =
    ...
    fromJSON(object: any): Feature {
        ...
        message.type =
            object.type !== undefined && object.type !== null
                ...
                : 0;
        message.classificationConfig =
            object.classificationConfig !== undefined && object.classificationConfig !== null
                ? FeatureClassificationConfig.fromJSON(object.classificationConfig)
                : undefined;
        message.textDetectionConfig =
            object.textDetectionConfig !== undefined && object.textDetectionConfig !== null
...
export const FeatureClassificationConfig = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): FeatureClassificationConfig {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseFeatureClassificationConfig } as FeatureClassificationConfig;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const FeatureTextDetectionConfig = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): FeatureTextDetectionConfig {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseFeatureTextDetectionConfig } as FeatureTextDetectionConfig;
    ...
    fromJSON(object: any): FeatureTextDetectionConfig {
        const message = { ...baseFeatureTextDetectionConfig } as FeatureTextDetectionConfig;
        message.languageCodes = (object.languageCodes ?? []).map((e: any) => String(e));
        message.model =
            object.model !== undefined && object.model !== null ? String(object.model) : '';
        return message;
    },
...
export const BatchAnalyzeResponse = {
    ...
    fromJSON(object: any): BatchAnalyzeResponse {
        const message = { ...baseBatchAnalyzeResponse } as BatchAnalyzeResponse;
        message.results = (object.results ?? []).map((e: any) => AnalyzeResult.fromJSON(e));
        return message;
    },
...
export const AnalyzeResult = {
    ...
    fromJSON(object: any): AnalyzeResult {
        const message = { ...baseAnalyzeResult } as AnalyzeResult;
        message.results = (object.results ?? []).map((e: any) => FeatureResult.fromJSON(e));
        message.error =
