...
export const CreateFileRequest = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break;
        case 6:
          const entry6 = CreateFileRequest_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
  ...
  fromPartial<I extends Exact<DeepPartial<CreateFileRequest>, I>>(
    object: I
  ): CreateFileRequest {
    const message = { ...baseCreateFileRequest } as CreateFileRequest;
...
export const CreateFileRequest_LabelsEntry = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCreateFileRequest_LabelsEntry,
    } as CreateFileRequest_LabelsEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  CreateFileRequest_LabelsEntry.$type,
  CreateFileRequest_LabelsEntry
);

const baseGetFileRequest: object = {
  $type: "yandex.cloud.ai.files.v1.GetFileRequest",
  fileId: "",
};
...
export const GetFileRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetFileRequest>, I>>(
    object: I
  ): GetFileRequest {
    const message = { ...baseGetFileRequest } as GetFileRequest;
...
export const GetFileUrlRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetFileUrlRequest>, I>>(
    object: I
  ): GetFileUrlRequest {
    const message = { ...baseGetFileUrlRequest } as GetFileUrlRequest;
    message.fileId = object.fileId ?? "";
...
export const UpdateFileRequest = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break;
        case 6:
          const entry6 = UpdateFileRequest_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
          if (entry6.value !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<UpdateFileRequest>, I>>(
    object: I
  ): UpdateFileRequest {
    const message = { ...baseUpdateFileRequest } as UpdateFileRequest;
    message.fileId = object.fileId ?? "";
...
export const UpdateFileRequest_LabelsEntry = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpdateFileRequest_LabelsEntry,
    } as UpdateFileRequest_LabelsEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  UpdateFileRequest_LabelsEntry.$type,
  UpdateFileRequest_LabelsEntry
);
