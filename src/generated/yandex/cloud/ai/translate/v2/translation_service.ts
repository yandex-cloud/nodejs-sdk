...
export const TranslateRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<TranslateRequest>, I>>(
    object: I
  ): TranslateRequest {
    const message = { ...baseTranslateRequest } as TranslateRequest;
...
export const GlossaryData = {
  ...
  fromPartial<I extends Exact<DeepPartial<GlossaryData>, I>>(
    object: I
  ): GlossaryData {
    const message = { ...baseGlossaryData } as GlossaryData;
    message.glossaryPairs =
      object.glossaryPairs?.map((e) => GlossaryPair.fromPartial(e)) || [];
    return message;
  },
};
...
export const GlossaryPair = {
  ...
  fromPartial<I extends Exact<DeepPartial<GlossaryPair>, I>>(
    object: I
  ): GlossaryPair {
    const message = { ...baseGlossaryPair } as GlossaryPair;
...
export const TranslateResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<TranslateResponse>, I>>(
    object: I
  ): TranslateResponse {
    const message = { ...baseTranslateResponse } as TranslateResponse;
    message.translations =
      object.translations?.map((e) => TranslatedText.fromPartial(e)) || [];
    return message;
  },
};
  ...
  fromJSON(object: any): DetectLanguageRequest {
    ...
    message.text =
      object.text !== undefined && object.text !== null
        ? String(object.text)
        : "";
    message.languageCodeHints = (object.languageCodeHints ?? []).map((e: any) =>
      String(e)
    );
    message.folderId =
      object.folderId !== undefined && object.folderId !== null
...
export const ListLanguagesResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListLanguagesResponse>, I>>(
    ...
    const message = { ...baseListLanguagesResponse } as ListLanguagesResponse;
    message.languages =
      object.languages?.map((e) => Language.fromPartial(e)) || [];
    return message;
  },
};
