...
const baseClassificationLabel: object = {
  $type:
    "yandex.cloud.ai.foundation_models.v1.text_classification.ClassificationLabel",
  label: "",
  confidence: 0,
};
...
export const ClassificationLabel = {
  $type:
    "yandex.cloud.ai.foundation_models.v1.text_classification.ClassificationLabel" as const,
...
const baseClassificationSample: object = {
  $type:
    "yandex.cloud.ai.foundation_models.v1.text_classification.ClassificationSample",
  text: "",
  label: "",
};
...
export const ClassificationSample = {
  $type:
    "yandex.cloud.ai.foundation_models.v1.text_classification.ClassificationSample" as const,
