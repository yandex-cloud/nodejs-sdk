...
const baseImageGenerationRequest: object = {
  $type:
    "yandex.cloud.ai.foundation_models.v1.image_generation.ImageGenerationRequest",
  modelUri: "",
};

export const ImageGenerationRequest = {
  $type:
    "yandex.cloud.ai.foundation_models.v1.image_generation.ImageGenerationRequest" as const,
...
const baseImageGenerationResponse: object = {
  $type:
    "yandex.cloud.ai.foundation_models.v1.image_generation.ImageGenerationResponse",
  modelVersion: "",
};

export const ImageGenerationResponse = {
  $type:
    "yandex.cloud.ai.foundation_models.v1.image_generation.ImageGenerationResponse" as const,
...
export interface ImageGenerationAsyncServiceServer
