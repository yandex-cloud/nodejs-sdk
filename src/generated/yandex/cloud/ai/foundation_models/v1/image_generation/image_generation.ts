...
export const protobufPackage =
  "yandex.cloud.ai.foundation_models.v1.image_generation";
...
export const Message = {
  $type:
    "yandex.cloud.ai.foundation_models.v1.image_generation.Message" as const,
...
export const AspectRatio = {
  $type:
    "yandex.cloud.ai.foundation_models.v1.image_generation.AspectRatio" as const,
  ...
  toJSON(message: AspectRatio): unknown {
    const obj: any = {};
    message.widthRatio !== undefined &&
      (obj.widthRatio = Math.round(message.widthRatio));
    message.heightRatio !== undefined &&
      (obj.heightRatio = Math.round(message.heightRatio));
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<AspectRatio>, I>>(
    object: I
  ): AspectRatio {
    const message = { ...baseAspectRatio } as AspectRatio;
...
const baseImageGenerationOptions: object = {
  $type:
    "yandex.cloud.ai.foundation_models.v1.image_generation.ImageGenerationOptions",
  mimeType: "",
  seed: 0,
};
...
export const ImageGenerationOptions = {
  $type:
    "yandex.cloud.ai.foundation_models.v1.image_generation.ImageGenerationOptions" as const,
