    ...
    toJSON(message: InstructRequest): unknown {
        ...
        message.generationOptions !== undefined &&
            (obj.generationOptions = message.generationOptions
                ...
                : undefined);
        message.instructionText !== undefined && (obj.instructionText = message.instructionText);
        message.instructionUri !== undefined && (obj.instructionUri = message.instructionUri);
        message.requestText !== undefined && (obj.requestText = message.requestText);
        return obj;
    },
