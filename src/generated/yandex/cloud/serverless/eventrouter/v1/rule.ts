...
export const Rule = {
  ...
  toJSON(message: Rule): unknown {
    ...
    message.status !== undefined &&
      (obj.status = rule_StatusToJSON(message.status));
    return obj;
  },
...
export const Rule_LabelsEntry = {
  ...
  fromPartial<I extends Exact<DeepPartial<Rule_LabelsEntry>, I>>(
    object: I
  ): Rule_LabelsEntry {
    const message = { ...baseRule_LabelsEntry } as Rule_LabelsEntry;
...
export const Transformer = {
  ...
  toJSON(message: Transformer): unknown {
    const obj: any = {};
    message.jqTransformer !== undefined &&
      (obj.jqTransformer = message.jqTransformer);
    return obj;
  },
...
export const Target = {
  ...
  encode(
    ...
    if (message.function !== undefined) {
      FunctionTarget.encode(
        message.function,
        writer.uint32(26).fork()
      ).ldelim();
    }
    if (message.container !== undefined) {
      ContainerTarget.encode(
        message.container,
  ...
  fromJSON(object: any): Target {
    ...
    message.container =
      object.container !== undefined && object.container !== null
        ...
        : undefined;
    message.gatewayWsBroadcast =
      object.gatewayWsBroadcast !== undefined &&
      object.gatewayWsBroadcast !== null
  ...
  toJSON(message: Target): unknown {
    ...
    message.function !== undefined &&
      (obj.function = message.function
        ? FunctionTarget.toJSON(message.function)
        : undefined);
    ...
    message.logging !== undefined &&
      (obj.logging = message.logging
        ? LoggingTarget.toJSON(message.logging)
        : undefined);
    message.workflow !== undefined &&
      (obj.workflow = message.workflow
        ? WorkflowTarget.toJSON(message.workflow)
        : undefined);
    ...
    message.deadLetterQueue !== undefined &&
      (obj.deadLetterQueue = message.deadLetterQueue
        ...
        : undefined);
    message.status !== undefined &&
      (obj.status = target_StatusToJSON(message.status));
    return obj;
  },
...
export const YdsTarget = {
  ...
  fromPartial<I extends Exact<DeepPartial<YdsTarget>, I>>(
    object: I
  ): YdsTarget {
    const message = { ...baseYdsTarget } as YdsTarget;
...
export const FunctionTarget = {
  ...
  fromPartial<I extends Exact<DeepPartial<FunctionTarget>, I>>(
    object: I
  ): FunctionTarget {
    const message = { ...baseFunctionTarget } as FunctionTarget;
...
export const ContainerTarget = {
  ...
  fromPartial<I extends Exact<DeepPartial<ContainerTarget>, I>>(
    object: I
  ): ContainerTarget {
    const message = { ...baseContainerTarget } as ContainerTarget;
...
const baseGatewayWebsocketBroadcastTarget: object = {
  $type:
    "yandex.cloud.serverless.eventrouter.v1.GatewayWebsocketBroadcastTarget",
  gatewayId: "",
  path: "",
  serviceAccountId: "",
};
...
export const GatewayWebsocketBroadcastTarget = {
  $type:
    "yandex.cloud.serverless.eventrouter.v1.GatewayWebsocketBroadcastTarget" as const,
...
messageTypeRegistry.set(
  GatewayWebsocketBroadcastTarget.$type,
  GatewayWebsocketBroadcastTarget
);
...
export const LoggingTarget = {
  ...
  fromPartial<I extends Exact<DeepPartial<LoggingTarget>, I>>(
    object: I
  ): LoggingTarget {
    const message = { ...baseLoggingTarget } as LoggingTarget;
...
export const WorkflowTarget = {
  ...
  fromPartial<I extends Exact<DeepPartial<WorkflowTarget>, I>>(
    object: I
  ): WorkflowTarget {
    const message = { ...baseWorkflowTarget } as WorkflowTarget;
...
export const RetrySettings = {
  ...
  toJSON(message: RetrySettings): unknown {
    ...
    message.maximumAge !== undefined &&
      (obj.maximumAge = message.maximumAge
        ? Duration.toJSON(message.maximumAge)
        : undefined);
    return obj;
  },
