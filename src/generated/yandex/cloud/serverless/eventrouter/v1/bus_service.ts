...
export const GetBusRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetBusRequest>, I>>(
    object: I
  ): GetBusRequest {
    const message = { ...baseGetBusRequest } as GetBusRequest;
...
export const ListBusesRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListBusesRequest>, I>>(
    object: I
  ): ListBusesRequest {
    const message = { ...baseListBusesRequest } as ListBusesRequest;
...
export const ListBusesResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListBusesResponse>, I>>(
    object: I
  ): ListBusesResponse {
    const message = { ...baseListBusesResponse } as ListBusesResponse;
...
export const CreateBusRequest = {
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      CreateBusRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.serverless.eventrouter.v1.CreateBusRequest.LabelsEntry",
          key: key as any,
          value,
        },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          const entry4 = CreateBusRequest_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
  ...
  fromPartial<I extends Exact<DeepPartial<CreateBusRequest>, I>>(
    object: I
  ): CreateBusRequest {
    const message = { ...baseCreateBusRequest } as CreateBusRequest;
    message.folderId = object.folderId ?? "";
...
export const CreateBusRequest_LabelsEntry = {
  $type:
    "yandex.cloud.serverless.eventrouter.v1.CreateBusRequest.LabelsEntry" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCreateBusRequest_LabelsEntry,
    } as CreateBusRequest_LabelsEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  CreateBusRequest_LabelsEntry.$type,
  CreateBusRequest_LabelsEntry
);
...
export const CreateBusMetadata = {
  ...
  fromPartial<I extends Exact<DeepPartial<CreateBusMetadata>, I>>(
    object: I
  ): CreateBusMetadata {
    const message = { ...baseCreateBusMetadata } as CreateBusMetadata;
    message.busId = object.busId ?? "";
...
export const UpdateBusRequest = {
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      UpdateBusRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.serverless.eventrouter.v1.UpdateBusRequest.LabelsEntry",
          key: key as any,
          value,
        },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          const entry5 = UpdateBusRequest_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
  ...
  fromPartial<I extends Exact<DeepPartial<UpdateBusRequest>, I>>(
    object: I
  ): UpdateBusRequest {
    const message = { ...baseUpdateBusRequest } as UpdateBusRequest;
    message.busId = object.busId ?? "";
...
export const UpdateBusRequest_LabelsEntry = {
  $type:
    "yandex.cloud.serverless.eventrouter.v1.UpdateBusRequest.LabelsEntry" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpdateBusRequest_LabelsEntry,
    } as UpdateBusRequest_LabelsEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  UpdateBusRequest_LabelsEntry.$type,
  UpdateBusRequest_LabelsEntry
);
...
export const UpdateBusMetadata = {
  ...
  fromPartial<I extends Exact<DeepPartial<UpdateBusMetadata>, I>>(
    object: I
  ): UpdateBusMetadata {
    const message = { ...baseUpdateBusMetadata } as UpdateBusMetadata;
    message.busId = object.busId ?? "";
...
export const DeleteBusRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<DeleteBusRequest>, I>>(
    object: I
  ): DeleteBusRequest {
    const message = { ...baseDeleteBusRequest } as DeleteBusRequest;
    message.busId = object.busId ?? "";
...
export const DeleteBusMetadata = {
  ...
  fromPartial<I extends Exact<DeepPartial<DeleteBusMetadata>, I>>(
    object: I
  ): DeleteBusMetadata {
    const message = { ...baseDeleteBusMetadata } as DeleteBusMetadata;
    message.busId = object.busId ?? "";
...
export const ListBusOperationsRequest = {
  $type:
    "yandex.cloud.serverless.eventrouter.v1.ListBusOperationsRequest" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListBusOperationsRequest,
    } as ListBusOperationsRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const ListBusOperationsResponse = {
  $type:
    "yandex.cloud.serverless.eventrouter.v1.ListBusOperationsResponse" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListBusOperationsResponse,
    } as ListBusOperationsResponse;
    message.operations = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
messageTypeRegistry.set(
  ListBusOperationsResponse.$type,
  ListBusOperationsResponse
);
...
export interface BusServiceClient extends Client {
  ...
  listOperations(
    ...
    callback: (
      ...
      response: ListBusOperationsResponse
    ) => void
  ): ClientUnaryCall;
  listOperations(
    request: ListBusOperationsRequest,
