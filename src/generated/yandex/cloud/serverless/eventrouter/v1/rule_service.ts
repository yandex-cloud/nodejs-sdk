...
import {
  ...
  Rule,
  Target,
} from "../../../../../yandex/cloud/serverless/eventrouter/v1/rule";
...
export const GetRuleRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetRuleRequest>, I>>(
    object: I
  ): GetRuleRequest {
    const message = { ...baseGetRuleRequest } as GetRuleRequest;
...
export const ListRulesRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListRulesRequest>, I>>(
    object: I
  ): ListRulesRequest {
    const message = { ...baseListRulesRequest } as ListRulesRequest;
...
export const ListRulesResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListRulesResponse>, I>>(
    object: I
  ): ListRulesResponse {
    const message = { ...baseListRulesResponse } as ListRulesResponse;
...
export const CreateRuleRequest = {
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      CreateRuleRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.serverless.eventrouter.v1.CreateRuleRequest.LabelsEntry",
          key: key as any,
          value,
        },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          const entry4 = CreateRuleRequest_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
  ...
  fromPartial<I extends Exact<DeepPartial<CreateRuleRequest>, I>>(
    object: I
  ): CreateRuleRequest {
    const message = { ...baseCreateRuleRequest } as CreateRuleRequest;
...
export const CreateRuleRequest_LabelsEntry = {
  $type:
    "yandex.cloud.serverless.eventrouter.v1.CreateRuleRequest.LabelsEntry" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCreateRuleRequest_LabelsEntry,
    } as CreateRuleRequest_LabelsEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  CreateRuleRequest_LabelsEntry.$type,
  CreateRuleRequest_LabelsEntry
);
...
export const UpdateRuleRequest = {
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      UpdateRuleRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.serverless.eventrouter.v1.UpdateRuleRequest.LabelsEntry",
          key: key as any,
          value,
        },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          const entry5 = UpdateRuleRequest_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
  ...
  fromPartial<I extends Exact<DeepPartial<UpdateRuleRequest>, I>>(
    object: I
  ): UpdateRuleRequest {
    const message = { ...baseUpdateRuleRequest } as UpdateRuleRequest;
    message.ruleId = object.ruleId ?? "";
...
export const UpdateRuleRequest_LabelsEntry = {
  $type:
    "yandex.cloud.serverless.eventrouter.v1.UpdateRuleRequest.LabelsEntry" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpdateRuleRequest_LabelsEntry,
    } as UpdateRuleRequest_LabelsEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  UpdateRuleRequest_LabelsEntry.$type,
  UpdateRuleRequest_LabelsEntry
);
...
export const DeleteRuleRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<DeleteRuleRequest>, I>>(
    object: I
  ): DeleteRuleRequest {
    const message = { ...baseDeleteRuleRequest } as DeleteRuleRequest;
    message.ruleId = object.ruleId ?? "";
...
export const ListRuleOperationsRequest = {
  $type:
    "yandex.cloud.serverless.eventrouter.v1.ListRuleOperationsRequest" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListRuleOperationsRequest,
    } as ListRuleOperationsRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  ListRuleOperationsRequest.$type,
  ListRuleOperationsRequest
);
...
export const ListRuleOperationsResponse = {
  $type:
    "yandex.cloud.serverless.eventrouter.v1.ListRuleOperationsResponse" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListRuleOperationsResponse,
    } as ListRuleOperationsResponse;
    message.operations = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
messageTypeRegistry.set(
  ListRuleOperationsResponse.$type,
  ListRuleOperationsResponse
);
...
export const EnableRuleRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<EnableRuleRequest>, I>>(
    object: I
  ): EnableRuleRequest {
    const message = { ...baseEnableRuleRequest } as EnableRuleRequest;
    message.ruleId = object.ruleId ?? "";
...
export const RuleServiceService = {
  ...
  get: {
    ...
    responseSerialize: (value: Rule) =>
      Buffer.from(Rule.encode(value).finish()),
...
export interface RuleServiceClient extends Client {
  ...
  listOperations(
    ...
    callback: (
      error: ServiceError | null,
      response: ListRuleOperationsResponse
    ) => void
  ): ClientUnaryCall;
  listOperations(
    request: ListRuleOperationsRequest,
