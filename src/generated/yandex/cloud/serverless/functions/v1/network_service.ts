...
export const UsedNetwork = {
    ...
    fromJSON(object: any): UsedNetwork {
        ...
        message.willBeCleanedUpAt =
            object.willBeCleanedUpAt !== undefined && object.willBeCleanedUpAt !== null
    ...
    toJSON(message: UsedNetwork): unknown {
        ...
        message.status !== undefined && (obj.status = usedNetwork_StatusToJSON(message.status));
...
export const ListUsedNetworksRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListUsedNetworksRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListUsedNetworksRequest } as ListUsedNetworksRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListUsedNetworksResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListUsedNetworksResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListUsedNetworksResponse } as ListUsedNetworksResponse;
        message.networks = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object: any): ListUsedNetworksResponse {
        const message = { ...baseListUsedNetworksResponse } as ListUsedNetworksResponse;
        message.networks = (object.networks ?? []).map((e: any) => UsedNetwork.fromJSON(e));
    ...
    toJSON(message: ListUsedNetworksResponse): unknown {
        const obj: any = {};
        if (message.networks) {
            obj.networks = message.networks.map((e) => (e ? UsedNetwork.toJSON(e) : undefined));
        } else {
            obj.networks = [];
        }
...
export const ListConnectedResourcesRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListConnectedResourcesRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListConnectedResourcesRequest } as ListConnectedResourcesRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListConnectedResourcesResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListConnectedResourcesResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListConnectedResourcesResponse } as ListConnectedResourcesResponse;
        message.resources = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    toJSON(message: ListConnectedResourcesResponse): unknown {
        ...
        if (message.resources) {
            obj.resources = message.resources.map((e) =>
                e ? ListConnectedResourcesResponse_ConnectedResource.toJSON(e) : undefined,
            );
        } else {
            obj.resources = [];
        }
...
export const ListConnectedResourcesResponse_ConnectedResource = {
    ...
    toJSON(message: ListConnectedResourcesResponse_ConnectedResource): unknown {
        ...
        message.subresourceType !== undefined && (obj.subresourceType = message.subresourceType);
        message.subresourceId !== undefined && (obj.subresourceId = message.subresourceId);
        message.resourceCloudId !== undefined && (obj.resourceCloudId = message.resourceCloudId);
        message.resourceFolderId !== undefined && (obj.resourceFolderId = message.resourceFolderId);
        return obj;
    },
...
export const TriggerUsedNetworkCleanupResponse = {
    ...
    fromJSON(object: any): TriggerUsedNetworkCleanupResponse {
        ...
        message.networkCleanupTime =
            object.networkCleanupTime !== undefined && object.networkCleanupTime !== null
