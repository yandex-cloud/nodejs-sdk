...
export const Function = {
    ...
    toJSON(message: Function): unknown {
        ...
        message.httpInvokeUrl !== undefined && (obj.httpInvokeUrl = message.httpInvokeUrl);
        message.status !== undefined && (obj.status = function_StatusToJSON(message.status));
        return obj;
    },
...
export const Version = {
    ...
    toJSON(message: Version): unknown {
        ...
        message.imageSize !== undefined && (obj.imageSize = Math.round(message.imageSize));
...
export const Version_EnvironmentEntry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Version_EnvironmentEntry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseVersion_EnvironmentEntry } as Version_EnvironmentEntry;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const StorageMount = {
    ...
    toJSON(message: StorageMount): unknown {
        ...
        message.mountPointName !== undefined && (obj.mountPointName = message.mountPointName);
...
export const AsyncInvocationConfig = {
    ...
    toJSON(message: AsyncInvocationConfig): unknown {
        const obj: any = {};
        message.retriesCount !== undefined && (obj.retriesCount = Math.round(message.retriesCount));
...
export const AsyncInvocationConfig_ResponseTarget = {
    ...
    toJSON(message: AsyncInvocationConfig_ResponseTarget): unknown {
        ...
        message.ymqTarget !== undefined &&
            (obj.ymqTarget = message.ymqTarget ? YMQTarget.toJSON(message.ymqTarget) : undefined);
        return obj;
    },
