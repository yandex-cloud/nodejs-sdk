...
export const GetProxyRequest = {
    ...
    fromJSON(object: any): GetProxyRequest {
        const message = { ...baseGetProxyRequest } as GetProxyRequest;
        message.proxyId =
            object.proxyId !== undefined && object.proxyId !== null ? String(object.proxyId) : '';
        return message;
    },
...
export const CreateProxyRequest_LabelsEntry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): CreateProxyRequest_LabelsEntry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseCreateProxyRequest_LabelsEntry } as CreateProxyRequest_LabelsEntry;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const UpdateProxyRequest_LabelsEntry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): UpdateProxyRequest_LabelsEntry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseUpdateProxyRequest_LabelsEntry } as UpdateProxyRequest_LabelsEntry;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListProxyOperationsRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListProxyOperationsRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListProxyOperationsRequest } as ListProxyOperationsRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListProxyOperationsResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListProxyOperationsResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListProxyOperationsResponse } as ListProxyOperationsResponse;
        message.operations = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
