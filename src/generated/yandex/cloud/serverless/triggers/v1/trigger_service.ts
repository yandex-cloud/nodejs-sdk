...
export const ListTriggersResponse = {
    ...
    fromJSON(object: any): ListTriggersResponse {
        const message = { ...baseListTriggersResponse } as ListTriggersResponse;
        message.triggers = (object.triggers ?? []).map((e: any) => Trigger.fromJSON(e));
...
export const ListTriggerOperationsRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListTriggerOperationsRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListTriggerOperationsRequest } as ListTriggerOperationsRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListTriggerOperationsResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListTriggerOperationsResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListTriggerOperationsResponse } as ListTriggerOperationsResponse;
        message.operations = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
