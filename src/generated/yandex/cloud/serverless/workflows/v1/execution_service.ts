  ...
  toJSON(message: StartExecutionRequest): unknown {
    ...
    message.input !== undefined &&
      (obj.input = message.input
        ? ExecutionInput.toJSON(message.input)
        : undefined);
    return obj;
  },
...
export const GetExecutionHistoryRequest = {
  $type:
    "yandex.cloud.serverless.workflows.v1.GetExecutionHistoryRequest" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseGetExecutionHistoryRequest,
    } as GetExecutionHistoryRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  GetExecutionHistoryRequest.$type,
  GetExecutionHistoryRequest
);
...
export const GetExecutionHistoryResponse = {
  $type:
    "yandex.cloud.serverless.workflows.v1.GetExecutionHistoryResponse" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseGetExecutionHistoryResponse,
  ...
  toJSON(message: GetExecutionHistoryResponse): unknown {
    ...
    if (message.entries) {
      obj.entries = message.entries.map((e) =>
        e ? HistoryEntry.toJSON(e) : undefined
      );
    } else {
      obj.entries = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<GetExecutionHistoryResponse>, I>>(
    ...
    message.execution =
      object.execution !== undefined && object.execution !== null
        ...
        : undefined;
    message.entries =
      object.entries?.map((e) => HistoryEntry.fromPartial(e)) || [];
    return message;
  },
};

messageTypeRegistry.set(
  GetExecutionHistoryResponse.$type,
  GetExecutionHistoryResponse
);
...
export const ListExecutionsResponse = {
      ...
      switch (tag >>> 3) {
        case 1:
          message.executions.push(
            ExecutionPreview.decode(reader, reader.uint32())
          );
          break;
        case 2:
  ...
  fromPartial<I extends Exact<DeepPartial<ListExecutionsResponse>, I>>(
    ...
    const message = { ...baseListExecutionsResponse } as ListExecutionsResponse;
    message.executions =
      object.executions?.map((e) => ExecutionPreview.fromPartial(e)) || [];
...
export const ExecutionServiceService = {
  ...
  start: {
    ...
    responseDeserialize: (value: Buffer) =>
      StartExecutionResponse.decode(value),
  },
