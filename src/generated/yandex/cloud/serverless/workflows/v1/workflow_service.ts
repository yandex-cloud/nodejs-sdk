  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      CreateWorkflowRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.serverless.workflows.v1.CreateWorkflowRequest.LabelsEntry",
          key: key as any,
          value,
        },
...
export const CreateWorkflowRequest_LabelsEntry = {
  $type:
    "yandex.cloud.serverless.workflows.v1.CreateWorkflowRequest.LabelsEntry" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<CreateWorkflowRequest_LabelsEntry>, I>
  >(object: I): CreateWorkflowRequest_LabelsEntry {
    const message = {
      ...baseCreateWorkflowRequest_LabelsEntry,
    } as CreateWorkflowRequest_LabelsEntry;
...
messageTypeRegistry.set(
  CreateWorkflowRequest_LabelsEntry.$type,
  CreateWorkflowRequest_LabelsEntry
);
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      UpdateWorkflowRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.serverless.workflows.v1.UpdateWorkflowRequest.LabelsEntry",
          key: key as any,
          value,
        },
        writer.uint32(34).fork()
...
export const UpdateWorkflowRequest_LabelsEntry = {
  $type:
    "yandex.cloud.serverless.workflows.v1.UpdateWorkflowRequest.LabelsEntry" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<UpdateWorkflowRequest_LabelsEntry>, I>
  >(object: I): UpdateWorkflowRequest_LabelsEntry {
    const message = {
      ...baseUpdateWorkflowRequest_LabelsEntry,
    } as UpdateWorkflowRequest_LabelsEntry;
    message.key = object.key ?? "";
...
messageTypeRegistry.set(
  UpdateWorkflowRequest_LabelsEntry.$type,
  UpdateWorkflowRequest_LabelsEntry
);
...
export const ListWorkflowsResponse = {
      ...
      switch (tag >>> 3) {
        case 1:
          message.workflows.push(
            WorkflowPreview.decode(reader, reader.uint32())
          );
          break;
        case 2:
  ...
  fromJSON(object: any): ListWorkflowsResponse {
    const message = { ...baseListWorkflowsResponse } as ListWorkflowsResponse;
    message.workflows = (object.workflows ?? []).map((e: any) =>
      WorkflowPreview.fromJSON(e)
    );
  ...
  fromPartial<I extends Exact<DeepPartial<ListWorkflowsResponse>, I>>(
    ...
    const message = { ...baseListWorkflowsResponse } as ListWorkflowsResponse;
    message.workflows =
      object.workflows?.map((e) => WorkflowPreview.fromPartial(e)) || [];
