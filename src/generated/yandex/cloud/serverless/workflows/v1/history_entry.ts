...
export const HistoryEntry = {
  ...
  encode(
    ...
    if (message.input !== undefined) {
      HistoryEntryInput.encode(
        message.input,
        writer.uint32(50).fork()
      ).ldelim();
    }
    if (message.output !== undefined) {
      HistoryEntryOutput.encode(
        message.output,
        writer.uint32(58).fork()
      ).ldelim();
    }
    if (message.error !== undefined) {
      HistoryEntryError.encode(
        message.error,
  ...
  fromJSON(object: any): HistoryEntry {
    ...
    message.type =
      object.type !== undefined && object.type !== null
        ...
        : "";
    message.attempts =
      object.attempts !== undefined && object.attempts !== null
        ? Number(object.attempts)
        : 0;
    message.lastError =
  ...
  toJSON(message: HistoryEntry): unknown {
    ...
    message.input !== undefined &&
      (obj.input = message.input
        ? HistoryEntryInput.toJSON(message.input)
        : undefined);
    message.output !== undefined &&
      (obj.output = message.output
        ? HistoryEntryOutput.toJSON(message.output)
        : undefined);
    message.error !== undefined &&
      (obj.error = message.error
        ? HistoryEntryError.toJSON(message.error)
        : undefined);
    message.status !== undefined &&
      (obj.status = historyEntry_StatusToJSON(message.status));
  ...
  fromPartial<I extends Exact<DeepPartial<HistoryEntry>, I>>(
    object: I
  ): HistoryEntry {
    const message = { ...baseHistoryEntry } as HistoryEntry;
...
export const HistoryEntry_FailedAttempt = {
  $type:
    "yandex.cloud.serverless.workflows.v1.HistoryEntry.FailedAttempt" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseHistoryEntry_FailedAttempt,
    } as HistoryEntry_FailedAttempt;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  HistoryEntry_FailedAttempt.$type,
  HistoryEntry_FailedAttempt
);
...
export const HistoryEntryInput = {
  ...
  fromPartial<I extends Exact<DeepPartial<HistoryEntryInput>, I>>(
    object: I
  ): HistoryEntryInput {
    const message = { ...baseHistoryEntryInput } as HistoryEntryInput;
...
export const HistoryEntryError = {
  ...
  fromPartial<I extends Exact<DeepPartial<HistoryEntryError>, I>>(
    object: I
  ): HistoryEntryError {
    const message = { ...baseHistoryEntryError } as HistoryEntryError;
