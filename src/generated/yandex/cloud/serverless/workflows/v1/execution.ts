  ...
  toJSON(message: Execution): unknown {
    ...
    message.result !== undefined &&
      (obj.result = message.result
        ? ExecutionResult.toJSON(message.result)
        : undefined);
    message.error !== undefined &&
      (obj.error = message.error
        ? ExecutionError.toJSON(message.error)
        : undefined);
    message.status !== undefined &&
      (obj.status = execution_StatusToJSON(message.status));
...
export const ExecutionPreview = {
  ...
  fromPartial<I extends Exact<DeepPartial<ExecutionPreview>, I>>(
    object: I
  ): ExecutionPreview {
    const message = { ...baseExecutionPreview } as ExecutionPreview;
    message.id = object.id ?? "";
...
export const ExecutionInput = {
  ...
  fromPartial<I extends Exact<DeepPartial<ExecutionInput>, I>>(
    object: I
  ): ExecutionInput {
    const message = { ...baseExecutionInput } as ExecutionInput;
...
export const ExecutionResult = {
  ...
  fromPartial<I extends Exact<DeepPartial<ExecutionResult>, I>>(
    object: I
  ): ExecutionResult {
    const message = { ...baseExecutionResult } as ExecutionResult;
...
export const ExecutionError = {
  ...
  fromPartial<I extends Exact<DeepPartial<ExecutionError>, I>>(
    object: I
  ): ExecutionError {
    const message = { ...baseExecutionError } as ExecutionError;
