...
export const GetConnectionRequest = {
  $type:
    "yandex.cloud.serverless.apigateway.websocket.v1.GetConnectionRequest" as const,
...
const baseSendToConnectionRequest: object = {
  $type:
    "yandex.cloud.serverless.apigateway.websocket.v1.SendToConnectionRequest",
  connectionId: "",
  type: 0,
};
...
export const SendToConnectionRequest = {
  $type:
    "yandex.cloud.serverless.apigateway.websocket.v1.SendToConnectionRequest" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseSendToConnectionRequest,
    } as SendToConnectionRequest;
...
const baseSendToConnectionResponse: object = {
  $type:
    "yandex.cloud.serverless.apigateway.websocket.v1.SendToConnectionResponse",
};

export const SendToConnectionResponse = {
  $type:
    "yandex.cloud.serverless.apigateway.websocket.v1.SendToConnectionResponse" as const,

  encode(
    _: SendToConnectionResponse,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    return writer;
  },
...
export const DisconnectRequest = {
  $type:
    "yandex.cloud.serverless.apigateway.websocket.v1.DisconnectRequest" as const,
  ...
  fromPartial<I extends Exact<DeepPartial<DisconnectRequest>, I>>(
    object: I
  ): DisconnectRequest {
    const message = { ...baseDisconnectRequest } as DisconnectRequest;
    message.connectionId = object.connectionId ?? "";
...
export const DisconnectResponse = {
  $type:
    "yandex.cloud.serverless.apigateway.websocket.v1.DisconnectResponse" as const,

  encode(
    _: DisconnectResponse,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<DisconnectResponse>, I>>(
    _: I
  ): DisconnectResponse {
    const message = { ...baseDisconnectResponse } as DisconnectResponse;
    return message;
...
export const ConnectionServiceService = {
  ...
  get: {
    ...
    responseSerialize: (value: Connection) =>
      Buffer.from(Connection.encode(value).finish()),
...
export interface ConnectionServiceClient extends Client {
  ...
  send(
    ...
    callback: (
      ...
      response: SendToConnectionResponse
    ) => void
  ): ClientUnaryCall;
  send(
    request: SendToConnectionRequest,
