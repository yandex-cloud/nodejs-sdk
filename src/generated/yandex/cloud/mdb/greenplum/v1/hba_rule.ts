...
export function hBARule_ConnectionTypeFromJSON(
  object: any
): HBARule_ConnectionType {
  switch (object) {
    case 0:
...
export function hBARule_ConnectionTypeToJSON(
  object: HBARule_ConnectionType
): string {
  switch (object) {
...
export const HBARule = {
  ...
  toJSON(message: HBARule): unknown {
    ...
    message.connectionType !== undefined &&
      (obj.connectionType = hBARule_ConnectionTypeToJSON(
        message.connectionType
      ));
