...
export const CreatePXFDatasourceMetadata = {
  ...
  decode(
    ...
    const message = {
      ...baseCreatePXFDatasourceMetadata,
    } as CreatePXFDatasourceMetadata;
  ...
  toJSON(message: CreatePXFDatasourceMetadata): unknown {
    ...
    message.datasourceName !== undefined &&
...
messageTypeRegistry.set(
  CreatePXFDatasourceMetadata.$type,
  CreatePXFDatasourceMetadata
);
...
export const UpdatePXFDatasourceMetadata = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpdatePXFDatasourceMetadata,
    } as UpdatePXFDatasourceMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  UpdatePXFDatasourceMetadata.$type,
  UpdatePXFDatasourceMetadata
);
...
export const DeletePXFDatasourceMetadata = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseDeletePXFDatasourceMetadata,
    } as DeletePXFDatasourceMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  DeletePXFDatasourceMetadata.$type,
  DeletePXFDatasourceMetadata
);
...
export const ListPXFDatasourcesRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListPXFDatasourcesRequest,
    } as ListPXFDatasourcesRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  ListPXFDatasourcesRequest.$type,
  ListPXFDatasourcesRequest
);
...
export const ListPXFDatasourcesResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListPXFDatasourcesResponse,
    } as ListPXFDatasourcesResponse;
    message.datasources = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.datasources.push(
            PXFDatasource.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  fromPartial<I extends Exact<DeepPartial<ListPXFDatasourcesResponse>, I>>(
    ...
    message.datasources =
      object.datasources?.map((e) => PXFDatasource.fromPartial(e)) || [];
    return message;
  },
};

messageTypeRegistry.set(
  ListPXFDatasourcesResponse.$type,
  ListPXFDatasourcesResponse
);
...
export const CreatePXFDatasourceRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCreatePXFDatasourceRequest,
    } as CreatePXFDatasourceRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  CreatePXFDatasourceRequest.$type,
  CreatePXFDatasourceRequest
);
...
export const UpdatePXFDatasourceRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpdatePXFDatasourceRequest,
    } as UpdatePXFDatasourceRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  UpdatePXFDatasourceRequest.$type,
  UpdatePXFDatasourceRequest
);
...
export const DeletePXFDatasourceRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseDeletePXFDatasourceRequest,
    } as DeletePXFDatasourceRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  DeletePXFDatasourceRequest.$type,
  DeletePXFDatasourceRequest
);
...
export const PXFDatasourceServiceService = {
  ...
  create: {
    ...
    requestDeserialize: (value: Buffer) =>
      CreatePXFDatasourceRequest.decode(value),
  ...
  update: {
    ...
    requestDeserialize: (value: Buffer) =>
      UpdatePXFDatasourceRequest.decode(value),
    responseSerialize: (value: Operation) =>
      Buffer.from(Operation.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Operation.decode(value),
  },
  ...
  delete: {
    ...
    requestDeserialize: (value: Buffer) =>
      DeletePXFDatasourceRequest.decode(value),
    responseSerialize: (value: Operation) =>
      Buffer.from(Operation.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Operation.decode(value),
  },
...
export interface PXFDatasourceServiceServer
...
export interface PXFDatasourceServiceClient extends Client {
  ...
  list(
    ...
    callback: (
      ...
      response: ListPXFDatasourcesResponse
    ) => void
  ): ClientUnaryCall;
  list(
    request: ListPXFDatasourcesRequest,
