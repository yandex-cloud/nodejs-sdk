...
export const ResourceGroup = {
    encode(message: ResourceGroup, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.isUserDefined !== undefined) {
            BoolValue.encode({ value: message.isUserDefined! }, writer.uint32(18).fork()).ldelim();
        }
        if (message.concurrency !== undefined) {
            Int64Value.encode({ value: message.concurrency! }, writer.uint32(26).fork()).ldelim();
        }
        if (message.cpuRateLimit !== undefined) {
            Int64Value.encode({ value: message.cpuRateLimit! }, writer.uint32(34).fork()).ldelim();
        }
        if (message.memoryLimit !== undefined) {
            Int64Value.encode({ value: message.memoryLimit! }, writer.uint32(42).fork()).ldelim();
        }
        ...
        if (message.memorySpillRatio !== undefined) {
            Int64Value.encode(
                { value: message.memorySpillRatio! },
