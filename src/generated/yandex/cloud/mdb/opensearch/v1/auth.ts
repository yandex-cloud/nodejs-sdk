...
export const SAMLSettings = {
    ...
    toJSON(message: SAMLSettings): unknown {
        ...
        message.dashboardsUrl !== undefined && (obj.dashboardsUrl = message.dashboardsUrl);
    ...
    fromPartial<I extends Exact<DeepPartial<SAMLSettings>, I>>(object: I): SAMLSettings {
        ...
        message.jwtDefaultExpirationTimeout = object.jwtDefaultExpirationTimeout ?? undefined;
        return message;
    },
};
