  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      CreateClusterRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.mdb.sqlserver.v1.CreateClusterRequest.LabelsEntry",
          key: key as any,
          value,
        },
...
export const CreateClusterRequest_LabelsEntry = {
  $type:
    "yandex.cloud.mdb.sqlserver.v1.CreateClusterRequest.LabelsEntry" as const,
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      UpdateClusterRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.mdb.sqlserver.v1.UpdateClusterRequest.LabelsEntry",
          key: key as any,
          value,
        },
        writer.uint32(34).fork()
...
export const UpdateClusterRequest_LabelsEntry = {
  $type:
    "yandex.cloud.mdb.sqlserver.v1.UpdateClusterRequest.LabelsEntry" as const,
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      RestoreClusterRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.mdb.sqlserver.v1.RestoreClusterRequest.LabelsEntry",
          key: key as any,
          value,
        },
...
export const RestoreClusterRequest_LabelsEntry = {
  $type:
    "yandex.cloud.mdb.sqlserver.v1.RestoreClusterRequest.LabelsEntry" as const,
