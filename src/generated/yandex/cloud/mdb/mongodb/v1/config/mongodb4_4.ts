...
export const Mongodconfig44_Storage_WiredTiger = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          message.indexConfig =
            Mongodconfig44_Storage_WiredTiger_IndexConfig.decode(
              reader,
              reader.uint32()
            );
          break;
  ...
  fromJSON(object: any): Mongodconfig44_Storage_WiredTiger {
    ...
    message.indexConfig =
      object.indexConfig !== undefined && object.indexConfig !== null
        ? Mongodconfig44_Storage_WiredTiger_IndexConfig.fromJSON(
            object.indexConfig
          )
        : undefined;
    return message;
  ...
  toJSON(message: Mongodconfig44_Storage_WiredTiger): unknown {
    ...
    message.indexConfig !== undefined &&
      (obj.indexConfig = message.indexConfig
        ? Mongodconfig44_Storage_WiredTiger_IndexConfig.toJSON(
            message.indexConfig
          )
        : undefined);
    return obj;
  ...
  >(object: I): Mongodconfig44_Storage_WiredTiger {
    ...
    message.indexConfig =
      object.indexConfig !== undefined && object.indexConfig !== null
        ? Mongodconfig44_Storage_WiredTiger_IndexConfig.fromPartial(
            object.indexConfig
          )
        : undefined;
    return message;
...
const baseMongodconfig44_Storage_WiredTiger_IndexConfig: object = {
  $type:
    "yandex.cloud.mdb.mongodb.v1.config.MongodConfig4_4.Storage.WiredTiger.IndexConfig",
};

export const Mongodconfig44_Storage_WiredTiger_IndexConfig = {
  $type:
    "yandex.cloud.mdb.mongodb.v1.config.MongodConfig4_4.Storage.WiredTiger.IndexConfig" as const,
  ...
  fromPartial<
    I extends Exact<
      DeepPartial<Mongodconfig44_Storage_WiredTiger_IndexConfig>,
      I
    >
  >(object: I): Mongodconfig44_Storage_WiredTiger_IndexConfig {
    const message = {
      ...baseMongodconfig44_Storage_WiredTiger_IndexConfig,
    } as Mongodconfig44_Storage_WiredTiger_IndexConfig;
...
const baseMongodconfig44_Network_Compression: object = {
  $type:
    "yandex.cloud.mdb.mongodb.v1.config.MongodConfig4_4.Network.Compression",
  compressors: 0,
};

export const Mongodconfig44_Network_Compression = {
  $type:
    "yandex.cloud.mdb.mongodb.v1.config.MongodConfig4_4.Network.Compression" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<Mongodconfig44_Network_Compression>, I>
  >(object: I): Mongodconfig44_Network_Compression {
    const message = {
      ...baseMongodconfig44_Network_Compression,
    } as Mongodconfig44_Network_Compression;
...
export const Mongodconfig44_SetParameter = {
  $type:
    "yandex.cloud.mdb.mongodb.v1.config.MongodConfig4_4.SetParameter" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMongodconfig44_SetParameter,
    } as Mongodconfig44_SetParameter;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  Mongodconfig44_SetParameter.$type,
  Mongodconfig44_SetParameter
);
...
const baseMongosconfig44_Network_Compression: object = {
  $type:
    "yandex.cloud.mdb.mongodb.v1.config.MongosConfig4_4.Network.Compression",
  compressors: 0,
};

export const Mongosconfig44_Network_Compression = {
  $type:
    "yandex.cloud.mdb.mongodb.v1.config.MongosConfig4_4.Network.Compression" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<Mongosconfig44_Network_Compression>, I>
  >(object: I): Mongosconfig44_Network_Compression {
    const message = {
      ...baseMongosconfig44_Network_Compression,
    } as Mongosconfig44_Network_Compression;
    message.compressors = object.compressors?.map((e) => e) || [];
