...
export interface Mongodconfig44 {
    ...
    setParameter?: Mongodconfig44_SetParameter;
}
...
export interface Mongodconfig44_Storage_WiredTiger {
    ...
    indexConfig?: Mongodconfig44_Storage_WiredTiger_IndexConfig;
}
...
export interface Mongodconfig44_Network {
    ...
    compression?: Mongodconfig44_Network_Compression;
}
...
export function mongodconfig44_Network_Compression_CompressorFromJSON(
    ...
    switch (object) {
        ...
        case 4:
        case 'DISABLED':
            return Mongodconfig44_Network_Compression_Compressor.DISABLED;
        case -1:
        case 'UNRECOGNIZED':
        default:
...
export function mongodconfig44_Network_Compression_CompressorToJSON(
    ...
    switch (object) {
        ...
        case Mongodconfig44_Network_Compression_Compressor.ZSTD:
            return 'ZSTD';
        case Mongodconfig44_Network_Compression_Compressor.DISABLED:
            return 'DISABLED';
        default:
            return 'UNKNOWN';
    }
...
export interface Mongosconfig44_Network {
    ...
    maxIncomingConnections?: number;
    /** Compression settings */
    compression?: Mongosconfig44_Network_Compression;
}
...
export function mongosconfig44_Network_Compression_CompressorFromJSON(
    ...
    switch (object) {
        ...
        case 4:
        case 'DISABLED':
            return Mongosconfig44_Network_Compression_Compressor.DISABLED;
        case -1:
        case 'UNRECOGNIZED':
        default:
...
export function mongosconfig44_Network_Compression_CompressorToJSON(
    ...
    switch (object) {
        ...
        case Mongosconfig44_Network_Compression_Compressor.ZSTD:
            return 'ZSTD';
        case Mongosconfig44_Network_Compression_Compressor.DISABLED:
            return 'DISABLED';
        default:
            return 'UNKNOWN';
    }
...
export const Mongodconfig44: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig44>, I>>(object: I): Mongodconfig44;
} = {
    encode(message: Mongodconfig44, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.setParameter !== undefined) {
            Mongodconfig44_SetParameter.encode(
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.setParameter = Mongodconfig44_SetParameter.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    fromJSON(object: any): Mongodconfig44 {
        ...
        message.setParameter =
            object.setParameter !== undefined && object.setParameter !== null
                ? Mongodconfig44_SetParameter.fromJSON(object.setParameter)
                : undefined;
        return message;
    },
    ...
    toJSON(message: Mongodconfig44): unknown {
        ...
        message.net !== undefined &&
            (obj.net = message.net ? Mongodconfig44_Network.toJSON(message.net) : undefined);
...
export const Mongodconfig44_Storage: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig44_Storage>, I>>(object: I): Mongodconfig44_Storage;
} = {
...
export const Mongodconfig44_Storage_WiredTiger: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig44_Storage_WiredTiger>, I>>(object: I): Mongodconfig44_Storage_WiredTiger;
} = {
    encode(
        ...
        if (message.indexConfig !== undefined) {
            Mongodconfig44_Storage_WiredTiger_IndexConfig.encode(
                message.indexConfig,
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongodconfig44_Storage_WiredTiger {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.engineConfig = Mongodconfig44_Storage_WiredTiger_EngineConfig.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
                case 2:
                    ...
                    break;
                case 3:
                    message.indexConfig = Mongodconfig44_Storage_WiredTiger_IndexConfig.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    toJSON(message: Mongodconfig44_Storage_WiredTiger): unknown {
        ...
        message.indexConfig !== undefined &&
            (obj.indexConfig = message.indexConfig
                ? Mongodconfig44_Storage_WiredTiger_IndexConfig.toJSON(message.indexConfig)
                : undefined);
        return obj;
    },

    fromPartial<I extends Exact<DeepPartial<Mongodconfig44_Storage_WiredTiger>, I>>(
        object: I,
...
export const Mongodconfig44_Storage_WiredTiger_EngineConfig: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig44_Storage_WiredTiger_EngineConfig>, I>>(object: I): Mongodconfig44_Storage_WiredTiger_EngineConfig;
} = {
    encode(
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig44_Storage_WiredTiger_EngineConfig>, I>>(
        object: I,
    ): Mongodconfig44_Storage_WiredTiger_EngineConfig {
        const message = {
            ...baseMongodconfig44_Storage_WiredTiger_EngineConfig,
...
const baseMongodconfig44_Storage_WiredTiger_CollectionConfig: object = { blockCompressor: 0 };
...
export const Mongodconfig44_Storage_WiredTiger_CollectionConfig: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig44_Storage_WiredTiger_CollectionConfig>, I>>(object: I): Mongodconfig44_Storage_WiredTiger_CollectionConfig;
} = {
    encode(
    ...
    fromPartial<
        I extends Exact<DeepPartial<Mongodconfig44_Storage_WiredTiger_CollectionConfig>, I>,
...
const baseMongodconfig44_Storage_WiredTiger_IndexConfig: object = {};

export const Mongodconfig44_Storage_WiredTiger_IndexConfig: {
    encode(message: Mongodconfig44_Storage_WiredTiger_IndexConfig, writer?: _m0.Writer): _m0.Writer;
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig44_Storage_WiredTiger_IndexConfig>, I>>(object: I): Mongodconfig44_Storage_WiredTiger_IndexConfig;
} = {
    encode(
        message: Mongodconfig44_Storage_WiredTiger_IndexConfig,
        writer: _m0.Writer = _m0.Writer.create(),
    ): _m0.Writer {
    ...
    decode(
        ...
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = {
            ...baseMongodconfig44_Storage_WiredTiger_IndexConfig,
        } as Mongodconfig44_Storage_WiredTiger_IndexConfig;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig44_Storage_WiredTiger_IndexConfig>, I>>(
        object: I,
    ): Mongodconfig44_Storage_WiredTiger_IndexConfig {
        const message = {
            ...baseMongodconfig44_Storage_WiredTiger_IndexConfig,
...
export const Mongodconfig44_Storage_Journal: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig44_Storage_Journal>, I>>(object: I): Mongodconfig44_Storage_Journal;
} = {
    encode(
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongodconfig44_Storage_Journal {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMongodconfig44_Storage_Journal } as Mongodconfig44_Storage_Journal;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const Mongodconfig44_OperationProfiling: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig44_OperationProfiling>, I>>(object: I): Mongodconfig44_OperationProfiling;
} = {
    encode(
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig44_OperationProfiling>, I>>(
        object: I,
...
export const Mongodconfig44_Network: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig44_Network>, I>>(object: I): Mongodconfig44_Network;
} = {
    encode(message: Mongodconfig44_Network, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.compression !== undefined) {
            Mongodconfig44_Network_Compression.encode(
                message.compression,
                writer.uint32(18).fork(),
            ).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.compression = Mongodconfig44_Network_Compression.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    toJSON(message: Mongodconfig44_Network): unknown {
        ...
        message.compression !== undefined &&
            (obj.compression = message.compression
                ? Mongodconfig44_Network_Compression.toJSON(message.compression)
                : undefined);
        return obj;
    },
...
const baseMongodconfig44_Network_Compression: object = { compressors: 0 };

export const Mongodconfig44_Network_Compression: {
    encode(message: Mongodconfig44_Network_Compression, writer?: _m0.Writer): _m0.Writer;
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig44_Network_Compression>, I>>(object: I): Mongodconfig44_Network_Compression;
} = {
    encode(
        message: Mongodconfig44_Network_Compression,
        writer: _m0.Writer = _m0.Writer.create(),
    ): _m0.Writer {
        writer.uint32(10).fork();
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongodconfig44_Network_Compression {
        ...
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = {
            ...baseMongodconfig44_Network_Compression,
        } as Mongodconfig44_Network_Compression;
        message.compressors = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object: any): Mongodconfig44_Network_Compression {
        ...
        message.compressors = (object.compressors ?? []).map((e: any) =>
            mongodconfig44_Network_Compression_CompressorFromJSON(e),
        );
        return message;
    },
    ...
    toJSON(message: Mongodconfig44_Network_Compression): unknown {
        ...
        if (message.compressors) {
            obj.compressors = message.compressors.map((e) =>
                mongodconfig44_Network_Compression_CompressorToJSON(e),
            );
        } else {
            obj.compressors = [];
        }
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig44_Network_Compression>, I>>(
        object: I,
    ): Mongodconfig44_Network_Compression {
        const message = {
            ...baseMongodconfig44_Network_Compression,
        } as Mongodconfig44_Network_Compression;
...
const baseMongodconfig44_SetParameter: object = {};

export const Mongodconfig44_SetParameter: {
    encode(message: Mongodconfig44_SetParameter, writer?: _m0.Writer): _m0.Writer;
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig44_SetParameter>, I>>(object: I): Mongodconfig44_SetParameter;
} = {
    encode(
        message: Mongodconfig44_SetParameter,
        writer: _m0.Writer = _m0.Writer.create(),
    ): _m0.Writer {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongodconfig44_SetParameter {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMongodconfig44_SetParameter } as Mongodconfig44_SetParameter;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig44_SetParameter>, I>>(
        object: I,
...
export const Mongocfgconfig44: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig44>, I>>(object: I): Mongocfgconfig44;
} = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.operationProfiling = Mongocfgconfig44_OperationProfiling.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    toJSON(message: Mongocfgconfig44): unknown {
        ...
        message.operationProfiling !== undefined &&
            (obj.operationProfiling = message.operationProfiling
                ...
                : undefined);
        message.net !== undefined &&
            (obj.net = message.net ? Mongocfgconfig44_Network.toJSON(message.net) : undefined);
        return obj;
    },
...
export const Mongocfgconfig44_Storage: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig44_Storage>, I>>(object: I): Mongocfgconfig44_Storage;
} = {
    encode(
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongocfgconfig44_Storage {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMongocfgconfig44_Storage } as Mongocfgconfig44_Storage;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const Mongocfgconfig44_Storage_WiredTiger: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig44_Storage_WiredTiger>, I>>(object: I): Mongocfgconfig44_Storage_WiredTiger;
} = {
    encode(
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongocfgconfig44_Storage_WiredTiger {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.engineConfig = Mongocfgconfig44_Storage_WiredTiger_EngineConfig.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig44_Storage_WiredTiger>, I>>(
        object: I,
...
export const Mongocfgconfig44_Storage_WiredTiger_EngineConfig: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig44_Storage_WiredTiger_EngineConfig>, I>>(object: I): Mongocfgconfig44_Storage_WiredTiger_EngineConfig;
} = {
    encode(
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig44_Storage_WiredTiger_EngineConfig>, I>>(
        object: I,
    ): Mongocfgconfig44_Storage_WiredTiger_EngineConfig {
        const message = {
            ...baseMongocfgconfig44_Storage_WiredTiger_EngineConfig,
...
export const Mongocfgconfig44_OperationProfiling: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig44_OperationProfiling>, I>>(object: I): Mongocfgconfig44_OperationProfiling;
} = {
    encode(
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig44_OperationProfiling>, I>>(
        object: I,
...
export const Mongocfgconfig44_Network: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig44_Network>, I>>(object: I): Mongocfgconfig44_Network;
} = {
    encode(
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongocfgconfig44_Network {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMongocfgconfig44_Network } as Mongocfgconfig44_Network;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const Mongosconfig44: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongosconfig44>, I>>(object: I): Mongosconfig44;
} = {
    ...
    toJSON(message: Mongosconfig44): unknown {
        const obj: any = {};
        message.net !== undefined &&
            (obj.net = message.net ? Mongosconfig44_Network.toJSON(message.net) : undefined);
        return obj;
    },
...
export const Mongosconfig44_Network: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongosconfig44_Network>, I>>(object: I): Mongosconfig44_Network;
} = {
    encode(message: Mongosconfig44_Network, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.compression !== undefined) {
            Mongosconfig44_Network_Compression.encode(
                message.compression,
                writer.uint32(18).fork(),
            ).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.compression = Mongosconfig44_Network_Compression.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    toJSON(message: Mongosconfig44_Network): unknown {
        ...
        message.compression !== undefined &&
            (obj.compression = message.compression
                ? Mongosconfig44_Network_Compression.toJSON(message.compression)
                : undefined);
        return obj;
    },
...
const baseMongosconfig44_Network_Compression: object = { compressors: 0 };

export const Mongosconfig44_Network_Compression: {
    encode(message: Mongosconfig44_Network_Compression, writer?: _m0.Writer): _m0.Writer;
    ...
    fromPartial<I extends Exact<DeepPartial<Mongosconfig44_Network_Compression>, I>>(object: I): Mongosconfig44_Network_Compression;
} = {
    encode(
        message: Mongosconfig44_Network_Compression,
        writer: _m0.Writer = _m0.Writer.create(),
    ): _m0.Writer {
        writer.uint32(10).fork();
        for (const v of message.compressors) {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongosconfig44_Network_Compression {
        ...
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = {
            ...baseMongosconfig44_Network_Compression,
        } as Mongosconfig44_Network_Compression;
        message.compressors = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object: any): Mongosconfig44_Network_Compression {
        ...
        message.compressors = (object.compressors ?? []).map((e: any) =>
            mongosconfig44_Network_Compression_CompressorFromJSON(e),
        );
        return message;
    },
    ...
    toJSON(message: Mongosconfig44_Network_Compression): unknown {
        ...
        if (message.compressors) {
            obj.compressors = message.compressors.map((e) =>
                mongosconfig44_Network_Compression_CompressorToJSON(e),
            );
        } else {
            obj.compressors = [];
        }
    ...
    fromPartial<I extends Exact<DeepPartial<Mongosconfig44_Network_Compression>, I>>(
        object: I,
...
export const Mongodconfigset44: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfigset44>, I>>(object: I): Mongodconfigset44;
} = {
...
export const Mongocfgconfigset44: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfigset44>, I>>(object: I): Mongocfgconfigset44;
} = {
...
export const Mongosconfigset44: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongosconfigset44>, I>>(object: I): Mongosconfigset44;
} = {
