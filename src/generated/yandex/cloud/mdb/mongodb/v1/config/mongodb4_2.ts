...
export interface Mongodconfig42 {
    ...
    setParameter?: Mongodconfig42_SetParameter;
}
...
export interface Mongodconfig42_Storage_WiredTiger {
    ...
    indexConfig?: Mongodconfig42_Storage_WiredTiger_IndexConfig;
}
...
export interface Mongodconfig42_Network {
    ...
    compression?: Mongodconfig42_Network_Compression;
}
...
export function mongodconfig42_Network_Compression_CompressorFromJSON(
    ...
    switch (object) {
        ...
        case 4:
        case 'DISABLED':
            return Mongodconfig42_Network_Compression_Compressor.DISABLED;
        case -1:
        case 'UNRECOGNIZED':
        default:
...
export function mongodconfig42_Network_Compression_CompressorToJSON(
    ...
    switch (object) {
        ...
        case Mongodconfig42_Network_Compression_Compressor.ZSTD:
            return 'ZSTD';
        case Mongodconfig42_Network_Compression_Compressor.DISABLED:
            return 'DISABLED';
        default:
            return 'UNKNOWN';
    }
...
export interface Mongosconfig42_Network {
    ...
    maxIncomingConnections?: number;
    /** Compression settings */
    compression?: Mongosconfig42_Network_Compression;
}
...
export function mongosconfig42_Network_Compression_CompressorFromJSON(
    ...
    switch (object) {
        ...
        case 4:
        case 'DISABLED':
            return Mongosconfig42_Network_Compression_Compressor.DISABLED;
        case -1:
        case 'UNRECOGNIZED':
        default:
...
export function mongosconfig42_Network_Compression_CompressorToJSON(
    ...
    switch (object) {
        ...
        case Mongosconfig42_Network_Compression_Compressor.ZSTD:
            return 'ZSTD';
        case Mongosconfig42_Network_Compression_Compressor.DISABLED:
            return 'DISABLED';
        default:
            return 'UNKNOWN';
    }
...
export const Mongodconfig42: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig42>, I>>(object: I): Mongodconfig42;
} = {
    encode(message: Mongodconfig42, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.setParameter !== undefined) {
            Mongodconfig42_SetParameter.encode(
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.setParameter = Mongodconfig42_SetParameter.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    fromJSON(object: any): Mongodconfig42 {
        ...
        message.setParameter =
            object.setParameter !== undefined && object.setParameter !== null
                ? Mongodconfig42_SetParameter.fromJSON(object.setParameter)
                : undefined;
        return message;
    },
    ...
    toJSON(message: Mongodconfig42): unknown {
        ...
        message.net !== undefined &&
            (obj.net = message.net ? Mongodconfig42_Network.toJSON(message.net) : undefined);
...
export const Mongodconfig42_Storage: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig42_Storage>, I>>(object: I): Mongodconfig42_Storage;
} = {
...
export const Mongodconfig42_Storage_WiredTiger: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig42_Storage_WiredTiger>, I>>(object: I): Mongodconfig42_Storage_WiredTiger;
} = {
    encode(
        ...
        if (message.indexConfig !== undefined) {
            Mongodconfig42_Storage_WiredTiger_IndexConfig.encode(
                message.indexConfig,
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongodconfig42_Storage_WiredTiger {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.engineConfig = Mongodconfig42_Storage_WiredTiger_EngineConfig.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
                case 2:
                    ...
                    break;
                case 3:
                    message.indexConfig = Mongodconfig42_Storage_WiredTiger_IndexConfig.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    toJSON(message: Mongodconfig42_Storage_WiredTiger): unknown {
        ...
        message.indexConfig !== undefined &&
            (obj.indexConfig = message.indexConfig
                ? Mongodconfig42_Storage_WiredTiger_IndexConfig.toJSON(message.indexConfig)
                : undefined);
        return obj;
    },

    fromPartial<I extends Exact<DeepPartial<Mongodconfig42_Storage_WiredTiger>, I>>(
        object: I,
...
export const Mongodconfig42_Storage_WiredTiger_EngineConfig: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig42_Storage_WiredTiger_EngineConfig>, I>>(object: I): Mongodconfig42_Storage_WiredTiger_EngineConfig;
} = {
    encode(
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig42_Storage_WiredTiger_EngineConfig>, I>>(
        object: I,
    ): Mongodconfig42_Storage_WiredTiger_EngineConfig {
        const message = {
            ...baseMongodconfig42_Storage_WiredTiger_EngineConfig,
...
const baseMongodconfig42_Storage_WiredTiger_CollectionConfig: object = { blockCompressor: 0 };
...
export const Mongodconfig42_Storage_WiredTiger_CollectionConfig: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig42_Storage_WiredTiger_CollectionConfig>, I>>(object: I): Mongodconfig42_Storage_WiredTiger_CollectionConfig;
} = {
    encode(
    ...
    fromPartial<
        I extends Exact<DeepPartial<Mongodconfig42_Storage_WiredTiger_CollectionConfig>, I>,
...
const baseMongodconfig42_Storage_WiredTiger_IndexConfig: object = {};

export const Mongodconfig42_Storage_WiredTiger_IndexConfig: {
    encode(message: Mongodconfig42_Storage_WiredTiger_IndexConfig, writer?: _m0.Writer): _m0.Writer;
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig42_Storage_WiredTiger_IndexConfig>, I>>(object: I): Mongodconfig42_Storage_WiredTiger_IndexConfig;
} = {
    encode(
        message: Mongodconfig42_Storage_WiredTiger_IndexConfig,
        writer: _m0.Writer = _m0.Writer.create(),
    ): _m0.Writer {
    ...
    decode(
        ...
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = {
            ...baseMongodconfig42_Storage_WiredTiger_IndexConfig,
        } as Mongodconfig42_Storage_WiredTiger_IndexConfig;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig42_Storage_WiredTiger_IndexConfig>, I>>(
        object: I,
    ): Mongodconfig42_Storage_WiredTiger_IndexConfig {
        const message = {
            ...baseMongodconfig42_Storage_WiredTiger_IndexConfig,
...
export const Mongodconfig42_Storage_Journal: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig42_Storage_Journal>, I>>(object: I): Mongodconfig42_Storage_Journal;
} = {
    encode(
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongodconfig42_Storage_Journal {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMongodconfig42_Storage_Journal } as Mongodconfig42_Storage_Journal;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const Mongodconfig42_OperationProfiling: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig42_OperationProfiling>, I>>(object: I): Mongodconfig42_OperationProfiling;
} = {
    encode(
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig42_OperationProfiling>, I>>(
        object: I,
...
export const Mongodconfig42_Network: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig42_Network>, I>>(object: I): Mongodconfig42_Network;
} = {
    encode(message: Mongodconfig42_Network, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.compression !== undefined) {
            Mongodconfig42_Network_Compression.encode(
                message.compression,
                writer.uint32(18).fork(),
            ).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.compression = Mongodconfig42_Network_Compression.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    toJSON(message: Mongodconfig42_Network): unknown {
        ...
        message.compression !== undefined &&
            (obj.compression = message.compression
                ? Mongodconfig42_Network_Compression.toJSON(message.compression)
                : undefined);
        return obj;
    },
...
const baseMongodconfig42_Network_Compression: object = { compressors: 0 };

export const Mongodconfig42_Network_Compression: {
    encode(message: Mongodconfig42_Network_Compression, writer?: _m0.Writer): _m0.Writer;
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig42_Network_Compression>, I>>(object: I): Mongodconfig42_Network_Compression;
} = {
    encode(
        message: Mongodconfig42_Network_Compression,
        writer: _m0.Writer = _m0.Writer.create(),
    ): _m0.Writer {
        writer.uint32(10).fork();
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongodconfig42_Network_Compression {
        ...
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = {
            ...baseMongodconfig42_Network_Compression,
        } as Mongodconfig42_Network_Compression;
        message.compressors = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object: any): Mongodconfig42_Network_Compression {
        ...
        message.compressors = (object.compressors ?? []).map((e: any) =>
            mongodconfig42_Network_Compression_CompressorFromJSON(e),
        );
        return message;
    },
    ...
    toJSON(message: Mongodconfig42_Network_Compression): unknown {
        ...
        if (message.compressors) {
            obj.compressors = message.compressors.map((e) =>
                mongodconfig42_Network_Compression_CompressorToJSON(e),
            );
        } else {
            obj.compressors = [];
        }
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig42_Network_Compression>, I>>(
        object: I,
...
const baseMongodconfig42_SetParameter: object = {};

export const Mongodconfig42_SetParameter: {
    encode(message: Mongodconfig42_SetParameter, writer?: _m0.Writer): _m0.Writer;
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig42_SetParameter>, I>>(object: I): Mongodconfig42_SetParameter;
} = {
    encode(
        message: Mongodconfig42_SetParameter,
        writer: _m0.Writer = _m0.Writer.create(),
    ): _m0.Writer {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongodconfig42_SetParameter {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMongodconfig42_SetParameter } as Mongodconfig42_SetParameter;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig42_SetParameter>, I>>(
        object: I,
...
export const Mongocfgconfig42: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig42>, I>>(object: I): Mongocfgconfig42;
} = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.operationProfiling = Mongocfgconfig42_OperationProfiling.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    toJSON(message: Mongocfgconfig42): unknown {
        ...
        message.operationProfiling !== undefined &&
            (obj.operationProfiling = message.operationProfiling
                ...
                : undefined);
        message.net !== undefined &&
            (obj.net = message.net ? Mongocfgconfig42_Network.toJSON(message.net) : undefined);
        return obj;
    },
...
export const Mongocfgconfig42_Storage: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig42_Storage>, I>>(object: I): Mongocfgconfig42_Storage;
} = {
    encode(
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongocfgconfig42_Storage {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMongocfgconfig42_Storage } as Mongocfgconfig42_Storage;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const Mongocfgconfig42_Storage_WiredTiger: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig42_Storage_WiredTiger>, I>>(object: I): Mongocfgconfig42_Storage_WiredTiger;
} = {
    encode(
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongocfgconfig42_Storage_WiredTiger {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.engineConfig = Mongocfgconfig42_Storage_WiredTiger_EngineConfig.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig42_Storage_WiredTiger>, I>>(
        object: I,
...
export const Mongocfgconfig42_Storage_WiredTiger_EngineConfig: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig42_Storage_WiredTiger_EngineConfig>, I>>(object: I): Mongocfgconfig42_Storage_WiredTiger_EngineConfig;
} = {
    encode(
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig42_Storage_WiredTiger_EngineConfig>, I>>(
        object: I,
    ): Mongocfgconfig42_Storage_WiredTiger_EngineConfig {
        const message = {
            ...baseMongocfgconfig42_Storage_WiredTiger_EngineConfig,
...
export const Mongocfgconfig42_OperationProfiling: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig42_OperationProfiling>, I>>(object: I): Mongocfgconfig42_OperationProfiling;
} = {
    encode(
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig42_OperationProfiling>, I>>(
        object: I,
...
export const Mongocfgconfig42_Network: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig42_Network>, I>>(object: I): Mongocfgconfig42_Network;
} = {
    encode(
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongocfgconfig42_Network {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMongocfgconfig42_Network } as Mongocfgconfig42_Network;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const Mongosconfig42: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongosconfig42>, I>>(object: I): Mongosconfig42;
} = {
    ...
    toJSON(message: Mongosconfig42): unknown {
        const obj: any = {};
        message.net !== undefined &&
            (obj.net = message.net ? Mongosconfig42_Network.toJSON(message.net) : undefined);
        return obj;
    },
...
export const Mongosconfig42_Network: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongosconfig42_Network>, I>>(object: I): Mongosconfig42_Network;
} = {
    encode(message: Mongosconfig42_Network, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.compression !== undefined) {
            Mongosconfig42_Network_Compression.encode(
                message.compression,
                writer.uint32(18).fork(),
            ).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.compression = Mongosconfig42_Network_Compression.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    toJSON(message: Mongosconfig42_Network): unknown {
        ...
        message.compression !== undefined &&
            (obj.compression = message.compression
                ? Mongosconfig42_Network_Compression.toJSON(message.compression)
                : undefined);
        return obj;
    },
...
const baseMongosconfig42_Network_Compression: object = { compressors: 0 };

export const Mongosconfig42_Network_Compression: {
    encode(message: Mongosconfig42_Network_Compression, writer?: _m0.Writer): _m0.Writer;
    ...
    fromPartial<I extends Exact<DeepPartial<Mongosconfig42_Network_Compression>, I>>(object: I): Mongosconfig42_Network_Compression;
} = {
    encode(
        message: Mongosconfig42_Network_Compression,
        writer: _m0.Writer = _m0.Writer.create(),
    ): _m0.Writer {
        writer.uint32(10).fork();
        for (const v of message.compressors) {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongosconfig42_Network_Compression {
        ...
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = {
            ...baseMongosconfig42_Network_Compression,
        } as Mongosconfig42_Network_Compression;
        message.compressors = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object: any): Mongosconfig42_Network_Compression {
        ...
        message.compressors = (object.compressors ?? []).map((e: any) =>
            mongosconfig42_Network_Compression_CompressorFromJSON(e),
        );
        return message;
    },
    ...
    toJSON(message: Mongosconfig42_Network_Compression): unknown {
        ...
        if (message.compressors) {
            obj.compressors = message.compressors.map((e) =>
                mongosconfig42_Network_Compression_CompressorToJSON(e),
            );
        } else {
            obj.compressors = [];
        }
    ...
    fromPartial<I extends Exact<DeepPartial<Mongosconfig42_Network_Compression>, I>>(
        object: I,
    ): Mongosconfig42_Network_Compression {
        const message = {
            ...baseMongosconfig42_Network_Compression,
        } as Mongosconfig42_Network_Compression;
        message.compressors = object.compressors?.map((e) => e) || [];
...
export const Mongodconfigset42: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfigset42>, I>>(object: I): Mongodconfigset42;
} = {
...
export const Mongocfgconfigset42: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfigset42>, I>>(object: I): Mongocfgconfigset42;
} = {
...
export const Mongosconfigset42: {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongosconfigset42>, I>>(object: I): Mongosconfigset42;
} = {
