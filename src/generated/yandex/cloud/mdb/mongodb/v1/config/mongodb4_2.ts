...
export const Mongodconfig42_Storage_WiredTiger = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          message.indexConfig =
            Mongodconfig42_Storage_WiredTiger_IndexConfig.decode(
              reader,
              reader.uint32()
            );
          break;
  ...
  fromJSON(object: any): Mongodconfig42_Storage_WiredTiger {
    ...
    message.indexConfig =
      object.indexConfig !== undefined && object.indexConfig !== null
        ? Mongodconfig42_Storage_WiredTiger_IndexConfig.fromJSON(
            object.indexConfig
          )
        : undefined;
    return message;
  ...
  toJSON(message: Mongodconfig42_Storage_WiredTiger): unknown {
    ...
    message.indexConfig !== undefined &&
      (obj.indexConfig = message.indexConfig
        ? Mongodconfig42_Storage_WiredTiger_IndexConfig.toJSON(
            message.indexConfig
          )
        : undefined);
    return obj;
  ...
  >(object: I): Mongodconfig42_Storage_WiredTiger {
    ...
    message.indexConfig =
      object.indexConfig !== undefined && object.indexConfig !== null
        ? Mongodconfig42_Storage_WiredTiger_IndexConfig.fromPartial(
            object.indexConfig
          )
        : undefined;
    return message;
...
const baseMongodconfig42_Storage_WiredTiger_IndexConfig: object = {
  $type:
    "yandex.cloud.mdb.mongodb.v1.config.MongodConfig4_2.Storage.WiredTiger.IndexConfig",
};

export const Mongodconfig42_Storage_WiredTiger_IndexConfig = {
  $type:
    "yandex.cloud.mdb.mongodb.v1.config.MongodConfig4_2.Storage.WiredTiger.IndexConfig" as const,
  ...
  fromPartial<
    I extends Exact<
      DeepPartial<Mongodconfig42_Storage_WiredTiger_IndexConfig>,
      I
    >
  >(object: I): Mongodconfig42_Storage_WiredTiger_IndexConfig {
    const message = {
      ...baseMongodconfig42_Storage_WiredTiger_IndexConfig,
    } as Mongodconfig42_Storage_WiredTiger_IndexConfig;
...
const baseMongodconfig42_Network_Compression: object = {
  $type:
    "yandex.cloud.mdb.mongodb.v1.config.MongodConfig4_2.Network.Compression",
  compressors: 0,
};

export const Mongodconfig42_Network_Compression = {
  $type:
    "yandex.cloud.mdb.mongodb.v1.config.MongodConfig4_2.Network.Compression" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<Mongodconfig42_Network_Compression>, I>
  >(object: I): Mongodconfig42_Network_Compression {
    const message = {
      ...baseMongodconfig42_Network_Compression,
    } as Mongodconfig42_Network_Compression;
...
export const Mongodconfig42_SetParameter = {
  $type:
    "yandex.cloud.mdb.mongodb.v1.config.MongodConfig4_2.SetParameter" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMongodconfig42_SetParameter,
    } as Mongodconfig42_SetParameter;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  Mongodconfig42_SetParameter.$type,
  Mongodconfig42_SetParameter
);
...
const baseMongosconfig42_Network_Compression: object = {
  $type:
    "yandex.cloud.mdb.mongodb.v1.config.MongosConfig4_2.Network.Compression",
  compressors: 0,
};

export const Mongosconfig42_Network_Compression = {
  $type:
    "yandex.cloud.mdb.mongodb.v1.config.MongosConfig4_2.Network.Compression" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<Mongosconfig42_Network_Compression>, I>
  >(object: I): Mongosconfig42_Network_Compression {
    const message = {
      ...baseMongosconfig42_Network_Compression,
    } as Mongosconfig42_Network_Compression;
    message.compressors = object.compressors?.map((e) => e) || [];
