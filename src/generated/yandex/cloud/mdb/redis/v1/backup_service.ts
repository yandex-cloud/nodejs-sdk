...
export interface DeleteBackupRequest {
  $type: "yandex.cloud.mdb.redis.v1.DeleteBackupRequest";
  /** Required. ID of the backup to delete. */
  backupId: string;
}

export interface DeleteBackupMetadata {
  $type: "yandex.cloud.mdb.redis.v1.DeleteBackupMetadata";
...
export const DeleteBackupRequest = {
  $type: "yandex.cloud.mdb.redis.v1.DeleteBackupRequest" as const,
...
export const DeleteBackupMetadata = {
  $type: "yandex.cloud.mdb.redis.v1.DeleteBackupMetadata" as const,
