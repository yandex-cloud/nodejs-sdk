...
import { BoolValue, StringValue, Int64Value } from '../../../../../google/protobuf/wrappers';
...
const baseEnableShardingClusterMetadata: object = { clusterId: '' };

export const EnableShardingClusterMetadata: {
    encode(message: EnableShardingClusterMetadata, writer?: _m0.Writer): _m0.Writer;
    ...
    fromPartial<I extends Exact<DeepPartial<EnableShardingClusterMetadata>, I>>(object: I): EnableShardingClusterMetadata;
} = {
    encode(
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): EnableShardingClusterMetadata {
        ...
        const message = { ...baseEnableShardingClusterMetadata } as EnableShardingClusterMetadata;
...
const baseEnableShardingClusterRequest: object = { clusterId: '' };

export const EnableShardingClusterRequest: {
    encode(message: EnableShardingClusterRequest, writer?: _m0.Writer): _m0.Writer;
    ...
    fromPartial<I extends Exact<DeepPartial<EnableShardingClusterRequest>, I>>(object: I): EnableShardingClusterRequest;
} = {
    encode(
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): EnableShardingClusterRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseEnableShardingClusterRequest } as EnableShardingClusterRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const RestoreClusterRequest: {
    ...
    encode(message: RestoreClusterRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.sharded === true) {
            writer.uint32(136).bool(message.sharded);
        }
        if (message.diskEncryptionKeyId !== undefined) {
            StringValue.encode(
                { value: message.diskEncryptionKeyId! },
        ...
        for (const v of message.userSpecs) {
            UserSpec.encode(v!, writer.uint32(154).fork()).ldelim();
        }
        return writer;
    },
...
const baseStartClusterFailoverRequest: object = { clusterId: '', hostNames: '' };
...
const baseStartClusterFailoverMetadata: object = { clusterId: '', hostNames: '' };
...
export const RebalanceClusterRequest: {
    ...
    fromPartial<I extends Exact<DeepPartial<RebalanceClusterRequest>, I>>(object: I): RebalanceClusterRequest;
} = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): RebalanceClusterRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseRebalanceClusterRequest } as RebalanceClusterRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const RebalanceClusterMetadata: {
    ...
    fromPartial<I extends Exact<DeepPartial<RebalanceClusterMetadata>, I>>(object: I): RebalanceClusterMetadata;
} = {
    encode(
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): RebalanceClusterMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseRebalanceClusterMetadata } as RebalanceClusterMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const UpdateHostSpec: {
    ...
    toJSON(message: UpdateHostSpec): unknown {
        ...
        message.replicaPriority !== undefined && (obj.replicaPriority = message.replicaPriority);
...
const baseHostSpec: object = { zoneId: '', subnetId: '', shardName: '', assignPublicIp: false };
...
export const ConfigSpec: {
    ...
    toJSON(message: ConfigSpec): unknown {
        ...
        message.redis !== undefined &&
            (obj.redis = message.redis ? RedisConfig.toJSON(message.redis) : undefined);
...
export const ClusterServiceService = {
    ...
    listAccessBindings: {
        path: '/yandex.cloud.mdb.redis.v1.ClusterService/ListAccessBindings',
        requestStream: false,
        responseStream: false,
    ...
    setAccessBindings: {
        path: '/yandex.cloud.mdb.redis.v1.ClusterService/SetAccessBindings',
        requestStream: false,
        responseStream: false,
    ...
    updateAccessBindings: {
        path: '/yandex.cloud.mdb.redis.v1.ClusterService/UpdateAccessBindings',
        requestStream: false,
        responseStream: false,
