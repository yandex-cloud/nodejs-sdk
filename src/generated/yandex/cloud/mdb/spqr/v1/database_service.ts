...
export const DatabaseServiceService = {
     ...
     */
    get: {
        path: '/yandex.cloud.mdb.spqr.v1.DatabaseService/Get',
        requestStream: false,
    ...
    list: {
        path: '/yandex.cloud.mdb.spqr.v1.DatabaseService/List',
        requestStream: false,
        responseStream: false,
    ...
    delete: {
        path: '/yandex.cloud.mdb.spqr.v1.DatabaseService/Delete',
        requestStream: false,
        responseStream: false,
...
export const DatabaseServiceClient = makeGenericClientConstructor(
    ...
    'yandex.cloud.mdb.spqr.v1.DatabaseService',
) as unknown as {
    new (
        address: string,
