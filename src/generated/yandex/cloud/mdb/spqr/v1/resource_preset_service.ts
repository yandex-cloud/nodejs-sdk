...
import { ResourcePreset } from '../../../../../yandex/cloud/mdb/spqr/v1/resource_preset';
...
export const GetResourcePresetRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): GetResourcePresetRequest {
        ...
        const message = { ...baseGetResourcePresetRequest } as GetResourcePresetRequest;
...
export const ListResourcePresetsRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListResourcePresetsRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListResourcePresetsRequest } as ListResourcePresetsRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 2:
...
export const ListResourcePresetsResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListResourcePresetsResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListResourcePresetsResponse } as ListResourcePresetsResponse;
...
export const ResourcePresetServiceService = {
     ...
     */
    get: {
        path: '/yandex.cloud.mdb.spqr.v1.ResourcePresetService/Get',
        requestStream: false,
    ...
    list: {
        path: '/yandex.cloud.mdb.spqr.v1.ResourcePresetService/List',
        requestStream: false,
        responseStream: false,
...
export const ResourcePresetServiceClient = makeGenericClientConstructor(
    ...
    'yandex.cloud.mdb.spqr.v1.ResourcePresetService',
) as unknown as {
    new (
        address: string,
