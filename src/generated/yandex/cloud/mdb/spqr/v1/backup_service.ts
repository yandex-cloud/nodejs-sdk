...
export const BackupServiceService = {
     ...
     */
    get: {
        path: '/yandex.cloud.mdb.spqr.v1.BackupService/Get',
        requestStream: false,
    ...
    list: {
        path: '/yandex.cloud.mdb.spqr.v1.BackupService/List',
        requestStream: false,
        responseStream: false,
    ...
    /** Returns the list of available backups for the specified SPQR cluster. */
    delete: {
        path: '/yandex.cloud.mdb.spqr.v1.BackupService/Delete',
        requestStream: false,
        responseStream: false,
...
export const BackupServiceClient = makeGenericClientConstructor(
    ...
    'yandex.cloud.mdb.spqr.v1.BackupService',
) as unknown as {
    new (
        address: string,
