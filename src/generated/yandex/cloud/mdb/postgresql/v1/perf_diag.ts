...
export const SessionState = {
    ...
    fromJSON(object: any): SessionState {
        ...
        message.pid = object.pid !== undefined && object.pid !== null ? Number(object.pid) : 0;
        message.database =
        ...
        message.blockingPids =
            object.blockingPids !== undefined && object.blockingPids !== null
                ...
                : '';
        message.queryId =
            object.queryId !== undefined && object.queryId !== null ? String(object.queryId) : '';
        return message;
    },
    ...
    toJSON(message: SessionState): unknown {
        ...
        message.xactStart !== undefined && (obj.xactStart = message.xactStart.toISOString());
        message.queryStart !== undefined && (obj.queryStart = message.queryStart.toISOString());
        message.stateChange !== undefined && (obj.stateChange = message.stateChange.toISOString());
        message.waitEventType !== undefined && (obj.waitEventType = message.waitEventType);
        message.waitEvent !== undefined && (obj.waitEvent = message.waitEvent);
        message.state !== undefined && (obj.state = message.state);
        message.query !== undefined && (obj.query = message.query);
        message.backendType !== undefined && (obj.backendType = message.backendType);
        message.clientAddr !== undefined && (obj.clientAddr = message.clientAddr);
        message.clientHostname !== undefined && (obj.clientHostname = message.clientHostname);
        message.clientPort !== undefined && (obj.clientPort = Math.round(message.clientPort));
        message.backendXid !== undefined && (obj.backendXid = Math.round(message.backendXid));
        message.backendXmin !== undefined && (obj.backendXmin = Math.round(message.backendXmin));
        message.blockingPids !== undefined && (obj.blockingPids = message.blockingPids);
...
export const PrimaryKey = {
    ...
    fromJSON(object: any): PrimaryKey {
        ...
        message.queryId =
            object.queryId !== undefined && object.queryId !== null ? String(object.queryId) : '';
        message.planId =
            object.planId !== undefined && object.planId !== null ? String(object.planId) : '';
        return message;
    },
...
export const QueryStats = {
    ...
    fromJSON(object: any): QueryStats {
        ...
        message.examplePlan =
            object.examplePlan !== undefined && object.examplePlan !== null
                ...
                : '';
        message.plans =
            object.plans !== undefined && object.plans !== null ? Number(object.plans) : 0;
        ...
        message.stddevPlanTime =
            object.stddevPlanTime !== undefined && object.stddevPlanTime !== null
                ...
                : 0;
        message.calls =
            object.calls !== undefined && object.calls !== null ? Number(object.calls) : 0;
        message.totalTime =
            object.totalTime !== undefined && object.totalTime !== null
                ? Number(object.totalTime)
                : 0;
        message.minTime =
            object.minTime !== undefined && object.minTime !== null ? Number(object.minTime) : 0;
        message.maxTime =
            object.maxTime !== undefined && object.maxTime !== null ? Number(object.maxTime) : 0;
        message.meanTime =
            object.meanTime !== undefined && object.meanTime !== null ? Number(object.meanTime) : 0;
        message.stddevTime =
        ...
        message.sharedBlksDirtied =
            object.sharedBlksDirtied !== undefined && object.sharedBlksDirtied !== null
                ? Number(object.sharedBlksDirtied)
                : 0;
        message.sharedBlksWritten =
            object.sharedBlksWritten !== undefined && object.sharedBlksWritten !== null
        ...
        message.walRecords =
            object.walRecords !== undefined && object.walRecords !== null
                ...
                : 0;
        message.walFpi =
            object.walFpi !== undefined && object.walFpi !== null ? Number(object.walFpi) : 0;
        message.walBytes =
            object.walBytes !== undefined && object.walBytes !== null ? Number(object.walBytes) : 0;
        ...
        message.jitGenerationTime =
            object.jitGenerationTime !== undefined && object.jitGenerationTime !== null
        ...
        message.jitOptimizationCount =
            object.jitOptimizationCount !== undefined && object.jitOptimizationCount !== null
                ? Number(object.jitOptimizationCount)
                : 0;
        message.jitOptimizationTime =
            object.jitOptimizationTime !== undefined && object.jitOptimizationTime !== null
        ...
        message.totalCost =
            object.totalCost !== undefined && object.totalCost !== null
                ...
                : 0;
        message.planRows =
            object.planRows !== undefined && object.planRows !== null ? Number(object.planRows) : 0;
        message.planWidth =
            object.planWidth !== undefined && object.planWidth !== null
                ? Number(object.planWidth)
                : 0;
        message.reads =
            object.reads !== undefined && object.reads !== null ? Number(object.reads) : 0;
        message.writes =
            object.writes !== undefined && object.writes !== null ? Number(object.writes) : 0;
        message.userTime =
            object.userTime !== undefined && object.userTime !== null ? Number(object.userTime) : 0;
        message.systemTime =
    ...
    toJSON(message: QueryStats): unknown {
        ...
        message.time !== undefined && (obj.time = message.time.toISOString());
        message.query !== undefined && (obj.query = message.query);
        message.normalizedPlan !== undefined && (obj.normalizedPlan = message.normalizedPlan);
        message.examplePlan !== undefined && (obj.examplePlan = message.examplePlan);
        message.plans !== undefined && (obj.plans = Math.round(message.plans));
        message.totalPlanTime !== undefined && (obj.totalPlanTime = message.totalPlanTime);
        message.minPlanTime !== undefined && (obj.minPlanTime = message.minPlanTime);
        message.maxPlanTime !== undefined && (obj.maxPlanTime = message.maxPlanTime);
        message.meanPlanTime !== undefined && (obj.meanPlanTime = message.meanPlanTime);
        message.stddevPlanTime !== undefined && (obj.stddevPlanTime = message.stddevPlanTime);
        ...
        message.localBlksHit !== undefined && (obj.localBlksHit = Math.round(message.localBlksHit));
        ...
        message.tempBlksRead !== undefined && (obj.tempBlksRead = Math.round(message.tempBlksRead));
        message.tempBlksWritten !== undefined &&
            (obj.tempBlksWritten = Math.round(message.tempBlksWritten));
        message.blkReadTime !== undefined && (obj.blkReadTime = message.blkReadTime);
        message.blkWriteTime !== undefined && (obj.blkWriteTime = message.blkWriteTime);
        message.tempBlkReadTime !== undefined && (obj.tempBlkReadTime = message.tempBlkReadTime);
        message.tempBlkWriteTime !== undefined && (obj.tempBlkWriteTime = message.tempBlkWriteTime);
        message.walRecords !== undefined && (obj.walRecords = Math.round(message.walRecords));
        message.walFpi !== undefined && (obj.walFpi = Math.round(message.walFpi));
        message.walBytes !== undefined && (obj.walBytes = Math.round(message.walBytes));
        message.jitFunctions !== undefined && (obj.jitFunctions = Math.round(message.jitFunctions));
        ...
        message.jitInliningTime !== undefined && (obj.jitInliningTime = message.jitInliningTime);
        ...
        message.jitEmissionTime !== undefined && (obj.jitEmissionTime = message.jitEmissionTime);
        message.startupCost !== undefined && (obj.startupCost = Math.round(message.startupCost));
        message.totalCost !== undefined && (obj.totalCost = Math.round(message.totalCost));
        message.planRows !== undefined && (obj.planRows = Math.round(message.planRows));
        message.planWidth !== undefined && (obj.planWidth = Math.round(message.planWidth));
...
export const QueryStatement = {
    ...
    toJSON(message: QueryStatement): unknown {
        ...
        message.stats !== undefined &&
            (obj.stats = message.stats ? QueryStats.toJSON(message.stats) : undefined);
        return obj;
    },
