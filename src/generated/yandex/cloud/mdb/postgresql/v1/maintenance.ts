...
const baseMaintenanceWindow: object = { $type: 'yandex.cloud.mdb.postgresql.v1.MaintenanceWindow' };
...
export const WeeklyMaintenanceWindow = {
    ...
    toJSON(message: WeeklyMaintenanceWindow): unknown {
        const obj: any = {};
        message.day !== undefined && (obj.day = weeklyMaintenanceWindow_WeekDayToJSON(message.day));
