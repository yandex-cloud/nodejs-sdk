...
export function postgresqlconfig151c_LogLevelFromJSON(
  object: any
): Postgresqlconfig151c_LogLevel {
  switch (object) {
    case 0:
...
export function postgresqlconfig151c_LogLevelToJSON(
  object: Postgresqlconfig151c_LogLevel
): string {
  switch (object) {
...
export function postgresqlconfig151c_WalLevelFromJSON(
  object: any
): Postgresqlconfig151c_WalLevel {
  switch (object) {
    case 0:
...
export function postgresqlconfig151c_WalLevelToJSON(
  object: Postgresqlconfig151c_WalLevel
): string {
  switch (object) {
...
export const Postgresqlconfig151c = {
  ...
  fromJSON(object: any): Postgresqlconfig151c {
    ...
    message.synchronousCommit =
      ...
      object.synchronousCommit !== null
        ? postgresqlconfig151c_SynchronousCommitFromJSON(
    ...
    message.constraintExclusion =
      ...
      object.constraintExclusion !== null
        ? postgresqlconfig151c_ConstraintExclusionFromJSON(
    ...
    message.forceParallelMode =
      ...
      object.forceParallelMode !== null
        ? postgresqlconfig151c_ForceParallelModeFromJSON(
    ...
    message.logErrorVerbosity =
      ...
      object.logErrorVerbosity !== null
        ? postgresqlconfig151c_LogErrorVerbosityFromJSON(
    ...
    message.sharedPreloadLibraries = (object.sharedPreloadLibraries ?? []).map(
      (e: any) => postgresqlconfig151c_SharedPreloadLibrariesFromJSON(e)
    );
    ...
    message.pgHintPlanDebugPrint =
      ...
      object.pgHintPlanDebugPrint !== null
        ? postgresqlconfig151c_PgHintPlanDebugPrintFromJSON(
    ...
    message.passwordEncryption =
      ...
      object.passwordEncryption !== null
        ? postgresqlconfig151c_PasswordEncryptionFromJSON(
  ...
  toJSON(message: Postgresqlconfig151c): unknown {
    ...
    message.logMinMessages !== undefined &&
      (obj.logMinMessages = postgresqlconfig151c_LogLevelToJSON(
        message.logMinMessages
      ));
    ...
    message.logStatement !== undefined &&
      (obj.logStatement = postgresqlconfig151c_LogStatementToJSON(
        message.logStatement
      ));
    ...
    message.defaultTransactionIsolation !== undefined &&
      (obj.defaultTransactionIsolation =
        postgresqlconfig151c_TransactionIsolationToJSON(
          message.defaultTransactionIsolation
        ));
    ...
    message.byteaOutput !== undefined &&
      (obj.byteaOutput = postgresqlconfig151c_ByteaOutputToJSON(
        message.byteaOutput
      ));
    ...
    message.planCacheMode !== undefined &&
      (obj.planCacheMode = postgresqlconfig151c_PlanCacheModeToJSON(
        message.planCacheMode
      ));
    ...
    message.pgHintPlanDebugPrint !== undefined &&
      (obj.pgHintPlanDebugPrint =
        postgresqlconfig151c_PgHintPlanDebugPrintToJSON(
          message.pgHintPlanDebugPrint
        ));
...
export const Postgresqlconfigset151c = {
  $type:
    "yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet15_1C" as const,

  encode(
    message: Postgresqlconfigset151c,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...basePostgresqlconfigset151c,
    } as Postgresqlconfigset151c;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.effectiveConfig = Postgresqlconfig151c.decode(
            reader,
            reader.uint32()
          );
          break;
        case 2:
          message.userConfig = Postgresqlconfig151c.decode(
            reader,
            reader.uint32()
          );
          break;
        case 3:
          message.defaultConfig = Postgresqlconfig151c.decode(
            reader,
            reader.uint32()
          );
          break;
