...
export function postgresqlConfig16_LogLevelFromJSON(
  object: any
): PostgresqlConfig16_LogLevel {
  switch (object) {
    case 0:
...
export function postgresqlConfig16_LogLevelToJSON(
  object: PostgresqlConfig16_LogLevel
): string {
  switch (object) {
...
export function postgresqlConfig16_WalLevelFromJSON(
  object: any
): PostgresqlConfig16_WalLevel {
  switch (object) {
    case 0:
...
export function postgresqlConfig16_WalLevelToJSON(
  object: PostgresqlConfig16_WalLevel
): string {
  switch (object) {
...
export function postgresqlConfig16_XmlBinaryFromJSON(
  object: any
): PostgresqlConfig16_XmlBinary {
  switch (object) {
    case 0:
...
export function postgresqlConfig16_XmlBinaryToJSON(
  object: PostgresqlConfig16_XmlBinary
): string {
  switch (object) {
...
export function postgresqlConfig16_XmlOptionFromJSON(
  object: any
): PostgresqlConfig16_XmlOption {
  switch (object) {
    case 0:
...
export function postgresqlConfig16_XmlOptionToJSON(
  object: PostgresqlConfig16_XmlOption
): string {
  switch (object) {
...
export const PostgresqlConfig16 = {
  ...
  fromJSON(object: any): PostgresqlConfig16 {
    ...
    message.debugParallelQuery =
      ...
      object.debugParallelQuery !== null
        ? postgresqlConfig16_DebugParallelQueryFromJSON(
    ...
    message.sharedPreloadLibraries = (object.sharedPreloadLibraries ?? []).map(
      (e: any) => postgresqlConfig16_SharedPreloadLibrariesFromJSON(e)
    );
    ...
    message.pgHintPlanDebugPrint =
      ...
      object.pgHintPlanDebugPrint !== null
        ? postgresqlConfig16_PgHintPlanDebugPrintFromJSON(
  ...
  toJSON(message: PostgresqlConfig16): unknown {
    ...
    message.clientMinMessages !== undefined &&
      (obj.clientMinMessages = postgresqlConfig16_LogLevelToJSON(
        message.clientMinMessages
      ));
    message.logMinMessages !== undefined &&
      (obj.logMinMessages = postgresqlConfig16_LogLevelToJSON(
        message.logMinMessages
      ));
    ...
    message.logStatement !== undefined &&
      (obj.logStatement = postgresqlConfig16_LogStatementToJSON(
        message.logStatement
      ));
    ...
    message.byteaOutput !== undefined &&
      (obj.byteaOutput = postgresqlConfig16_ByteaOutputToJSON(
        message.byteaOutput
      ));
    ...
    message.backslashQuote !== undefined &&
      (obj.backslashQuote = postgresqlConfig16_BackslashQuoteToJSON(
        message.backslashQuote
      ));
    ...
    message.planCacheMode !== undefined &&
      (obj.planCacheMode = postgresqlConfig16_PlanCacheModeToJSON(
        message.planCacheMode
      ));
...
export const PostgresqlConfigSet16 = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.effectiveConfig = PostgresqlConfig16.decode(
            reader,
            reader.uint32()
          );
          break;
        case 2:
          message.userConfig = PostgresqlConfig16.decode(
            reader,
            reader.uint32()
          );
          break;
        case 3:
          message.defaultConfig = PostgresqlConfig16.decode(
            reader,
            reader.uint32()
          );
          break;
