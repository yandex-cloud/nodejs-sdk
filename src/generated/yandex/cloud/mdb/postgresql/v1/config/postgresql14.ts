...
export function postgresqlConfig14_LogLevelFromJSON(
  object: any
...
export function postgresqlConfig14_LogLevelToJSON(
  object: PostgresqlConfig14_LogLevel
): string {
  switch (object) {
...
export function postgresqlConfig14_WalLevelFromJSON(
  object: any
...
export function postgresqlConfig14_WalLevelToJSON(
  object: PostgresqlConfig14_WalLevel
): string {
  switch (object) {
...
export function postgresqlConfig14_XmlBinaryToJSON(
  object: PostgresqlConfig14_XmlBinary
): string {
  switch (object) {
...
export function postgresqlConfig14_XmlOptionFromJSON(
  object: any
...
export function postgresqlConfig14_XmlOptionToJSON(
  object: PostgresqlConfig14_XmlOption
): string {
  switch (object) {
...
export const PostgresqlConfig14 = {
  ...
  fromJSON(object: any): PostgresqlConfig14 {
    ...
    message.constraintExclusion =
      ...
      object.constraintExclusion !== null
        ? postgresqlConfig14_ConstraintExclusionFromJSON(
    ...
    message.sharedPreloadLibraries = (object.sharedPreloadLibraries ?? []).map(
      (e: any) => postgresqlConfig14_SharedPreloadLibrariesFromJSON(e)
    );
    ...
    message.pgHintPlanDebugPrint =
      ...
      object.pgHintPlanDebugPrint !== null
        ? postgresqlConfig14_PgHintPlanDebugPrintFromJSON(
    ...
    message.passwordEncryption =
      ...
      object.passwordEncryption !== null
        ? postgresqlConfig14_PasswordEncryptionFromJSON(
  ...
  toJSON(message: PostgresqlConfig14): unknown {
    ...
    message.clientMinMessages !== undefined &&
      (obj.clientMinMessages = postgresqlConfig14_LogLevelToJSON(
        message.clientMinMessages
      ));
    message.logMinMessages !== undefined &&
      (obj.logMinMessages = postgresqlConfig14_LogLevelToJSON(
        message.logMinMessages
      ));
    ...
    message.logStatement !== undefined &&
      (obj.logStatement = postgresqlConfig14_LogStatementToJSON(
        message.logStatement
      ));
    ...
    message.defaultTransactionIsolation !== undefined &&
      (obj.defaultTransactionIsolation =
        postgresqlConfig14_TransactionIsolationToJSON(
          message.defaultTransactionIsolation
        ));
    ...
    message.byteaOutput !== undefined &&
      (obj.byteaOutput = postgresqlConfig14_ByteaOutputToJSON(
        message.byteaOutput
      ));
    ...
    message.backslashQuote !== undefined &&
      (obj.backslashQuote = postgresqlConfig14_BackslashQuoteToJSON(
        message.backslashQuote
      ));
    ...
    message.planCacheMode !== undefined &&
      (obj.planCacheMode = postgresqlConfig14_PlanCacheModeToJSON(
        message.planCacheMode
      ));
...
export const PostgresqlConfigSet14 = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.effectiveConfig = PostgresqlConfig14.decode(
            reader,
            reader.uint32()
          );
          break;
        case 2:
          message.userConfig = PostgresqlConfig14.decode(
            reader,
            reader.uint32()
          );
          break;
        case 3:
          message.defaultConfig = PostgresqlConfig14.decode(
            reader,
            reader.uint32()
          );
          break;
