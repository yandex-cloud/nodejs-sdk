...
export function postgresqlConfig11_PasswordEncryptionFromJSON(
    object: any,
): PostgresqlConfig11_PasswordEncryption {
    switch (object) {
        case 0:
...
export function postgresqlConfig11_PasswordEncryptionToJSON(
    object: PostgresqlConfig11_PasswordEncryption,
): string {
    switch (object) {
...
export const PostgresqlConfig11: {
    ...
    fromPartial<I extends Exact<DeepPartial<PostgresqlConfig11>, I>>(object: I): PostgresqlConfig11;
} = {
    ...
    toJSON(message: PostgresqlConfig11): unknown {
        ...
        message.constraintExclusion !== undefined &&
            (obj.constraintExclusion = postgresqlConfig11_ConstraintExclusionToJSON(
                message.constraintExclusion,
            ));
        ...
        message.pgHintPlanDebugPrint !== undefined &&
            (obj.pgHintPlanDebugPrint = postgresqlConfig11_PgHintPlanDebugPrintToJSON(
                message.pgHintPlanDebugPrint,
            ));
        ...
        message.passwordEncryption !== undefined &&
            (obj.passwordEncryption = postgresqlConfig11_PasswordEncryptionToJSON(
                message.passwordEncryption,
            ));
        return obj;
    },

    fromPartial<I extends Exact<DeepPartial<PostgresqlConfig11>, I>>(
        object: I,
    ): PostgresqlConfig11 {
        const message = { ...basePostgresqlConfig11 } as PostgresqlConfig11;
...
export const PostgresqlConfigSet11: {
    ...
    fromPartial<I extends Exact<DeepPartial<PostgresqlConfigSet11>, I>>(object: I): PostgresqlConfigSet11;
} = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): PostgresqlConfigSet11 {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...basePostgresqlConfigSet11 } as PostgresqlConfigSet11;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object: any): PostgresqlConfigSet11 {
        ...
        message.effectiveConfig =
            object.effectiveConfig !== undefined && object.effectiveConfig !== null
                ? PostgresqlConfig11.fromJSON(object.effectiveConfig)
                : undefined;
        message.userConfig =
            object.userConfig !== undefined && object.userConfig !== null
                ? PostgresqlConfig11.fromJSON(object.userConfig)
                : undefined;
        message.defaultConfig =
            object.defaultConfig !== undefined && object.defaultConfig !== null
                ? PostgresqlConfig11.fromJSON(object.defaultConfig)
                : undefined;
        return message;
    },
    ...
    fromPartial<I extends Exact<DeepPartial<PostgresqlConfigSet11>, I>>(
        object: I,
