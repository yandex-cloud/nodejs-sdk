...
export const PostgresqlHostConfig13: {
    ...
    fromPartial<I extends Exact<DeepPartial<PostgresqlHostConfig13>, I>>(object: I): PostgresqlHostConfig13;
} = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): PostgresqlHostConfig13 {
        ...
        const message = { ...basePostgresqlHostConfig13 } as PostgresqlHostConfig13;
    ...
    toJSON(message: PostgresqlHostConfig13): unknown {
        ...
        message.constraintExclusion !== undefined &&
            (obj.constraintExclusion = postgresqlHostConfig13_ConstraintExclusionToJSON(
                message.constraintExclusion,
            ));
        ...
        message.forceParallelMode !== undefined &&
            (obj.forceParallelMode = postgresqlHostConfig13_ForceParallelModeToJSON(
                message.forceParallelMode,
            ));
        ...
        message.logErrorVerbosity !== undefined &&
            (obj.logErrorVerbosity = postgresqlHostConfig13_LogErrorVerbosityToJSON(
                message.logErrorVerbosity,
            ));
    ...
    fromPartial<I extends Exact<DeepPartial<PostgresqlHostConfig13>, I>>(
        object: I,
