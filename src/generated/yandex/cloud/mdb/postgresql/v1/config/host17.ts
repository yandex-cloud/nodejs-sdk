 ...
 */
export interface PostgresqlHostConfig17 {
    $type: 'yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig17';
    /** in milliseconds. */
    ...
    constraintExclusion: PostgresqlHostConfig17_ConstraintExclusion;
    cursorTupleFraction?: number;
    fromCollapseLimit?: number;
    joinCollapseLimit?: number;
    debugParallelQuery: PostgresqlHostConfig17_DebugParallelQuery;
    clientMinMessages: PostgresqlHostConfig17_LogLevel;
    logMinMessages: PostgresqlHostConfig17_LogLevel;
    logMinErrorStatement: PostgresqlHostConfig17_LogLevel;
    /** in milliseconds. */
    ...
    logDuration?: boolean;
    logErrorVerbosity: PostgresqlHostConfig17_LogErrorVerbosity;
    logLockWaits?: boolean;
    logStatement: PostgresqlHostConfig17_LogStatement;
    logTempFiles?: number;
    searchPath: string;
    rowSecurity?: boolean;
    defaultTransactionIsolation: PostgresqlHostConfig17_TransactionIsolation;
    /** in milliseconds. */
    ...
    byteaOutput: PostgresqlHostConfig17_ByteaOutput;
    xmlbinary: PostgresqlHostConfig17_XmlBinary;
    xmloption: PostgresqlHostConfig17_XmlOption;
    /** in bytes. */
    ...
    arrayNulls?: boolean;
    backslashQuote: PostgresqlHostConfig17_BackslashQuote;
...
export enum PostgresqlHostConfig17_BackslashQuote {
...
export function postgresqlHostConfig17_BackslashQuoteFromJSON(
    object: any,
): PostgresqlHostConfig17_BackslashQuote {
    switch (object) {
        case 0:
        case 'BACKSLASH_QUOTE_UNSPECIFIED':
            return PostgresqlHostConfig17_BackslashQuote.BACKSLASH_QUOTE_UNSPECIFIED;
        case 1:
        case 'BACKSLASH_QUOTE':
            return PostgresqlHostConfig17_BackslashQuote.BACKSLASH_QUOTE;
        case 2:
        case 'BACKSLASH_QUOTE_ON':
            return PostgresqlHostConfig17_BackslashQuote.BACKSLASH_QUOTE_ON;
        case 3:
        case 'BACKSLASH_QUOTE_OFF':
            return PostgresqlHostConfig17_BackslashQuote.BACKSLASH_QUOTE_OFF;
        case 4:
        case 'BACKSLASH_QUOTE_SAFE_ENCODING':
            return PostgresqlHostConfig17_BackslashQuote.BACKSLASH_QUOTE_SAFE_ENCODING;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return PostgresqlHostConfig17_BackslashQuote.UNRECOGNIZED;
    }
}

export function postgresqlHostConfig17_BackslashQuoteToJSON(
    object: PostgresqlHostConfig17_BackslashQuote,
): string {
    switch (object) {
        case PostgresqlHostConfig17_BackslashQuote.BACKSLASH_QUOTE_UNSPECIFIED:
            return 'BACKSLASH_QUOTE_UNSPECIFIED';
        case PostgresqlHostConfig17_BackslashQuote.BACKSLASH_QUOTE:
            return 'BACKSLASH_QUOTE';
        case PostgresqlHostConfig17_BackslashQuote.BACKSLASH_QUOTE_ON:
            return 'BACKSLASH_QUOTE_ON';
        case PostgresqlHostConfig17_BackslashQuote.BACKSLASH_QUOTE_OFF:
            return 'BACKSLASH_QUOTE_OFF';
        case PostgresqlHostConfig17_BackslashQuote.BACKSLASH_QUOTE_SAFE_ENCODING:
...
export enum PostgresqlHostConfig17_ByteaOutput {
...
export function postgresqlHostConfig17_ByteaOutputFromJSON(
    object: any,
): PostgresqlHostConfig17_ByteaOutput {
    switch (object) {
        case 0:
        case 'BYTEA_OUTPUT_UNSPECIFIED':
            return PostgresqlHostConfig17_ByteaOutput.BYTEA_OUTPUT_UNSPECIFIED;
        case 1:
        case 'BYTEA_OUTPUT_HEX':
            return PostgresqlHostConfig17_ByteaOutput.BYTEA_OUTPUT_HEX;
        case 2:
        case 'BYTEA_OUTPUT_ESCAPED':
            return PostgresqlHostConfig17_ByteaOutput.BYTEA_OUTPUT_ESCAPED;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return PostgresqlHostConfig17_ByteaOutput.UNRECOGNIZED;
    }
}

export function postgresqlHostConfig17_ByteaOutputToJSON(
    object: PostgresqlHostConfig17_ByteaOutput,
): string {
    switch (object) {
        case PostgresqlHostConfig17_ByteaOutput.BYTEA_OUTPUT_UNSPECIFIED:
            return 'BYTEA_OUTPUT_UNSPECIFIED';
        case PostgresqlHostConfig17_ByteaOutput.BYTEA_OUTPUT_HEX:
            return 'BYTEA_OUTPUT_HEX';
        case PostgresqlHostConfig17_ByteaOutput.BYTEA_OUTPUT_ESCAPED:
...
export enum PostgresqlHostConfig17_ConstraintExclusion {
...
export function postgresqlHostConfig17_ConstraintExclusionFromJSON(
    object: any,
): PostgresqlHostConfig17_ConstraintExclusion {
    switch (object) {
        case 0:
        case 'CONSTRAINT_EXCLUSION_UNSPECIFIED':
            return PostgresqlHostConfig17_ConstraintExclusion.CONSTRAINT_EXCLUSION_UNSPECIFIED;
        case 1:
        case 'CONSTRAINT_EXCLUSION_ON':
            return PostgresqlHostConfig17_ConstraintExclusion.CONSTRAINT_EXCLUSION_ON;
        case 2:
        case 'CONSTRAINT_EXCLUSION_OFF':
            return PostgresqlHostConfig17_ConstraintExclusion.CONSTRAINT_EXCLUSION_OFF;
        case 3:
        case 'CONSTRAINT_EXCLUSION_PARTITION':
            return PostgresqlHostConfig17_ConstraintExclusion.CONSTRAINT_EXCLUSION_PARTITION;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return PostgresqlHostConfig17_ConstraintExclusion.UNRECOGNIZED;
    }
}

export function postgresqlHostConfig17_ConstraintExclusionToJSON(
    object: PostgresqlHostConfig17_ConstraintExclusion,
): string {
    switch (object) {
        case PostgresqlHostConfig17_ConstraintExclusion.CONSTRAINT_EXCLUSION_UNSPECIFIED:
            return 'CONSTRAINT_EXCLUSION_UNSPECIFIED';
        case PostgresqlHostConfig17_ConstraintExclusion.CONSTRAINT_EXCLUSION_ON:
            return 'CONSTRAINT_EXCLUSION_ON';
        case PostgresqlHostConfig17_ConstraintExclusion.CONSTRAINT_EXCLUSION_OFF:
            return 'CONSTRAINT_EXCLUSION_OFF';
        case PostgresqlHostConfig17_ConstraintExclusion.CONSTRAINT_EXCLUSION_PARTITION:
...
export enum PostgresqlHostConfig17_DebugParallelQuery {
...
export function postgresqlHostConfig17_DebugParallelQueryFromJSON(
    object: any,
): PostgresqlHostConfig17_DebugParallelQuery {
    switch (object) {
        case 0:
        case 'DEBUG_PARALLEL_QUERY_UNSPECIFIED':
            return PostgresqlHostConfig17_DebugParallelQuery.DEBUG_PARALLEL_QUERY_UNSPECIFIED;
        case 1:
        case 'DEBUG_PARALLEL_QUERY_ON':
            return PostgresqlHostConfig17_DebugParallelQuery.DEBUG_PARALLEL_QUERY_ON;
        case 2:
        case 'DEBUG_PARALLEL_QUERY_OFF':
            return PostgresqlHostConfig17_DebugParallelQuery.DEBUG_PARALLEL_QUERY_OFF;
        case 3:
        case 'DEBUG_PARALLEL_QUERY_REGRESS':
            return PostgresqlHostConfig17_DebugParallelQuery.DEBUG_PARALLEL_QUERY_REGRESS;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return PostgresqlHostConfig17_DebugParallelQuery.UNRECOGNIZED;
    }
}

export function postgresqlHostConfig17_DebugParallelQueryToJSON(
    object: PostgresqlHostConfig17_DebugParallelQuery,
): string {
    switch (object) {
        case PostgresqlHostConfig17_DebugParallelQuery.DEBUG_PARALLEL_QUERY_UNSPECIFIED:
            return 'DEBUG_PARALLEL_QUERY_UNSPECIFIED';
        case PostgresqlHostConfig17_DebugParallelQuery.DEBUG_PARALLEL_QUERY_ON:
            return 'DEBUG_PARALLEL_QUERY_ON';
        case PostgresqlHostConfig17_DebugParallelQuery.DEBUG_PARALLEL_QUERY_OFF:
            return 'DEBUG_PARALLEL_QUERY_OFF';
        case PostgresqlHostConfig17_DebugParallelQuery.DEBUG_PARALLEL_QUERY_REGRESS:
...
export enum PostgresqlHostConfig17_ForceParallelMode {
...
export function postgresqlHostConfig17_ForceParallelModeFromJSON(
    object: any,
): PostgresqlHostConfig17_ForceParallelMode {
    switch (object) {
        case 0:
        case 'FORCE_PARALLEL_MODE_UNSPECIFIED':
            return PostgresqlHostConfig17_ForceParallelMode.FORCE_PARALLEL_MODE_UNSPECIFIED;
        case 1:
        case 'FORCE_PARALLEL_MODE_ON':
            return PostgresqlHostConfig17_ForceParallelMode.FORCE_PARALLEL_MODE_ON;
        case 2:
        case 'FORCE_PARALLEL_MODE_OFF':
            return PostgresqlHostConfig17_ForceParallelMode.FORCE_PARALLEL_MODE_OFF;
        case 3:
        case 'FORCE_PARALLEL_MODE_REGRESS':
            return PostgresqlHostConfig17_ForceParallelMode.FORCE_PARALLEL_MODE_REGRESS;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return PostgresqlHostConfig17_ForceParallelMode.UNRECOGNIZED;
    }
}

export function postgresqlHostConfig17_ForceParallelModeToJSON(
    object: PostgresqlHostConfig17_ForceParallelMode,
): string {
    switch (object) {
        case PostgresqlHostConfig17_ForceParallelMode.FORCE_PARALLEL_MODE_UNSPECIFIED:
            return 'FORCE_PARALLEL_MODE_UNSPECIFIED';
        case PostgresqlHostConfig17_ForceParallelMode.FORCE_PARALLEL_MODE_ON:
            return 'FORCE_PARALLEL_MODE_ON';
        case PostgresqlHostConfig17_ForceParallelMode.FORCE_PARALLEL_MODE_OFF:
            return 'FORCE_PARALLEL_MODE_OFF';
        case PostgresqlHostConfig17_ForceParallelMode.FORCE_PARALLEL_MODE_REGRESS:
...
export enum PostgresqlHostConfig17_LogErrorVerbosity {
...
export function postgresqlHostConfig17_LogErrorVerbosityFromJSON(
    object: any,
): PostgresqlHostConfig17_LogErrorVerbosity {
    switch (object) {
        case 0:
        case 'LOG_ERROR_VERBOSITY_UNSPECIFIED':
            return PostgresqlHostConfig17_LogErrorVerbosity.LOG_ERROR_VERBOSITY_UNSPECIFIED;
        case 1:
        case 'LOG_ERROR_VERBOSITY_TERSE':
            return PostgresqlHostConfig17_LogErrorVerbosity.LOG_ERROR_VERBOSITY_TERSE;
        case 2:
        case 'LOG_ERROR_VERBOSITY_DEFAULT':
            return PostgresqlHostConfig17_LogErrorVerbosity.LOG_ERROR_VERBOSITY_DEFAULT;
        case 3:
        case 'LOG_ERROR_VERBOSITY_VERBOSE':
            return PostgresqlHostConfig17_LogErrorVerbosity.LOG_ERROR_VERBOSITY_VERBOSE;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return PostgresqlHostConfig17_LogErrorVerbosity.UNRECOGNIZED;
    }
}

export function postgresqlHostConfig17_LogErrorVerbosityToJSON(
    object: PostgresqlHostConfig17_LogErrorVerbosity,
): string {
    switch (object) {
        case PostgresqlHostConfig17_LogErrorVerbosity.LOG_ERROR_VERBOSITY_UNSPECIFIED:
            return 'LOG_ERROR_VERBOSITY_UNSPECIFIED';
        case PostgresqlHostConfig17_LogErrorVerbosity.LOG_ERROR_VERBOSITY_TERSE:
            return 'LOG_ERROR_VERBOSITY_TERSE';
        case PostgresqlHostConfig17_LogErrorVerbosity.LOG_ERROR_VERBOSITY_DEFAULT:
            return 'LOG_ERROR_VERBOSITY_DEFAULT';
        case PostgresqlHostConfig17_LogErrorVerbosity.LOG_ERROR_VERBOSITY_VERBOSE:
...
export enum PostgresqlHostConfig17_LogLevel {
...
export function postgresqlHostConfig17_LogLevelFromJSON(
    object: any,
): PostgresqlHostConfig17_LogLevel {
    switch (object) {
        case 0:
        case 'LOG_LEVEL_UNSPECIFIED':
            return PostgresqlHostConfig17_LogLevel.LOG_LEVEL_UNSPECIFIED;
        case 1:
        case 'LOG_LEVEL_DEBUG5':
            return PostgresqlHostConfig17_LogLevel.LOG_LEVEL_DEBUG5;
        case 2:
        case 'LOG_LEVEL_DEBUG4':
            return PostgresqlHostConfig17_LogLevel.LOG_LEVEL_DEBUG4;
        case 3:
        case 'LOG_LEVEL_DEBUG3':
            return PostgresqlHostConfig17_LogLevel.LOG_LEVEL_DEBUG3;
        case 4:
        case 'LOG_LEVEL_DEBUG2':
            return PostgresqlHostConfig17_LogLevel.LOG_LEVEL_DEBUG2;
        case 5:
        case 'LOG_LEVEL_DEBUG1':
            return PostgresqlHostConfig17_LogLevel.LOG_LEVEL_DEBUG1;
        case 12:
        case 'LOG_LEVEL_INFO':
            return PostgresqlHostConfig17_LogLevel.LOG_LEVEL_INFO;
        case 6:
        case 'LOG_LEVEL_LOG':
            return PostgresqlHostConfig17_LogLevel.LOG_LEVEL_LOG;
        case 7:
        case 'LOG_LEVEL_NOTICE':
            return PostgresqlHostConfig17_LogLevel.LOG_LEVEL_NOTICE;
        case 8:
        case 'LOG_LEVEL_WARNING':
            return PostgresqlHostConfig17_LogLevel.LOG_LEVEL_WARNING;
        case 9:
        case 'LOG_LEVEL_ERROR':
            return PostgresqlHostConfig17_LogLevel.LOG_LEVEL_ERROR;
        case 10:
        case 'LOG_LEVEL_FATAL':
            return PostgresqlHostConfig17_LogLevel.LOG_LEVEL_FATAL;
        case 11:
        case 'LOG_LEVEL_PANIC':
            return PostgresqlHostConfig17_LogLevel.LOG_LEVEL_PANIC;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return PostgresqlHostConfig17_LogLevel.UNRECOGNIZED;
    }
}

export function postgresqlHostConfig17_LogLevelToJSON(
    object: PostgresqlHostConfig17_LogLevel,
): string {
    switch (object) {
        case PostgresqlHostConfig17_LogLevel.LOG_LEVEL_UNSPECIFIED:
            return 'LOG_LEVEL_UNSPECIFIED';
        case PostgresqlHostConfig17_LogLevel.LOG_LEVEL_DEBUG5:
            return 'LOG_LEVEL_DEBUG5';
        case PostgresqlHostConfig17_LogLevel.LOG_LEVEL_DEBUG4:
            return 'LOG_LEVEL_DEBUG4';
        case PostgresqlHostConfig17_LogLevel.LOG_LEVEL_DEBUG3:
            return 'LOG_LEVEL_DEBUG3';
        case PostgresqlHostConfig17_LogLevel.LOG_LEVEL_DEBUG2:
            return 'LOG_LEVEL_DEBUG2';
        case PostgresqlHostConfig17_LogLevel.LOG_LEVEL_DEBUG1:
            return 'LOG_LEVEL_DEBUG1';
        case PostgresqlHostConfig17_LogLevel.LOG_LEVEL_INFO:
            return 'LOG_LEVEL_INFO';
        case PostgresqlHostConfig17_LogLevel.LOG_LEVEL_LOG:
            return 'LOG_LEVEL_LOG';
        case PostgresqlHostConfig17_LogLevel.LOG_LEVEL_NOTICE:
            return 'LOG_LEVEL_NOTICE';
        case PostgresqlHostConfig17_LogLevel.LOG_LEVEL_WARNING:
            return 'LOG_LEVEL_WARNING';
        case PostgresqlHostConfig17_LogLevel.LOG_LEVEL_ERROR:
            return 'LOG_LEVEL_ERROR';
        case PostgresqlHostConfig17_LogLevel.LOG_LEVEL_FATAL:
            return 'LOG_LEVEL_FATAL';
        case PostgresqlHostConfig17_LogLevel.LOG_LEVEL_PANIC:
...
export enum PostgresqlHostConfig17_LogStatement {
...
export function postgresqlHostConfig17_LogStatementFromJSON(
    object: any,
): PostgresqlHostConfig17_LogStatement {
    switch (object) {
        case 0:
        case 'LOG_STATEMENT_UNSPECIFIED':
            return PostgresqlHostConfig17_LogStatement.LOG_STATEMENT_UNSPECIFIED;
        case 1:
        case 'LOG_STATEMENT_NONE':
            return PostgresqlHostConfig17_LogStatement.LOG_STATEMENT_NONE;
        case 2:
        case 'LOG_STATEMENT_DDL':
            return PostgresqlHostConfig17_LogStatement.LOG_STATEMENT_DDL;
        case 3:
        case 'LOG_STATEMENT_MOD':
            return PostgresqlHostConfig17_LogStatement.LOG_STATEMENT_MOD;
        case 4:
        case 'LOG_STATEMENT_ALL':
            return PostgresqlHostConfig17_LogStatement.LOG_STATEMENT_ALL;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return PostgresqlHostConfig17_LogStatement.UNRECOGNIZED;
    }
}

export function postgresqlHostConfig17_LogStatementToJSON(
    object: PostgresqlHostConfig17_LogStatement,
): string {
    switch (object) {
        case PostgresqlHostConfig17_LogStatement.LOG_STATEMENT_UNSPECIFIED:
            return 'LOG_STATEMENT_UNSPECIFIED';
        case PostgresqlHostConfig17_LogStatement.LOG_STATEMENT_NONE:
            return 'LOG_STATEMENT_NONE';
        case PostgresqlHostConfig17_LogStatement.LOG_STATEMENT_DDL:
            return 'LOG_STATEMENT_DDL';
        case PostgresqlHostConfig17_LogStatement.LOG_STATEMENT_MOD:
            return 'LOG_STATEMENT_MOD';
        case PostgresqlHostConfig17_LogStatement.LOG_STATEMENT_ALL:
...
export enum PostgresqlHostConfig17_TransactionIsolation {
...
export function postgresqlHostConfig17_TransactionIsolationFromJSON(
    object: any,
): PostgresqlHostConfig17_TransactionIsolation {
    switch (object) {
        case 0:
        case 'TRANSACTION_ISOLATION_UNSPECIFIED':
            return PostgresqlHostConfig17_TransactionIsolation.TRANSACTION_ISOLATION_UNSPECIFIED;
        case 1:
        case 'TRANSACTION_ISOLATION_READ_UNCOMMITTED':
            return PostgresqlHostConfig17_TransactionIsolation.TRANSACTION_ISOLATION_READ_UNCOMMITTED;
        case 2:
        case 'TRANSACTION_ISOLATION_READ_COMMITTED':
            return PostgresqlHostConfig17_TransactionIsolation.TRANSACTION_ISOLATION_READ_COMMITTED;
        case 3:
        case 'TRANSACTION_ISOLATION_REPEATABLE_READ':
            return PostgresqlHostConfig17_TransactionIsolation.TRANSACTION_ISOLATION_REPEATABLE_READ;
        case 4:
        case 'TRANSACTION_ISOLATION_SERIALIZABLE':
            return PostgresqlHostConfig17_TransactionIsolation.TRANSACTION_ISOLATION_SERIALIZABLE;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return PostgresqlHostConfig17_TransactionIsolation.UNRECOGNIZED;
    }
}

export function postgresqlHostConfig17_TransactionIsolationToJSON(
    object: PostgresqlHostConfig17_TransactionIsolation,
): string {
    switch (object) {
        case PostgresqlHostConfig17_TransactionIsolation.TRANSACTION_ISOLATION_UNSPECIFIED:
            return 'TRANSACTION_ISOLATION_UNSPECIFIED';
        case PostgresqlHostConfig17_TransactionIsolation.TRANSACTION_ISOLATION_READ_UNCOMMITTED:
            return 'TRANSACTION_ISOLATION_READ_UNCOMMITTED';
        case PostgresqlHostConfig17_TransactionIsolation.TRANSACTION_ISOLATION_READ_COMMITTED:
            return 'TRANSACTION_ISOLATION_READ_COMMITTED';
        case PostgresqlHostConfig17_TransactionIsolation.TRANSACTION_ISOLATION_REPEATABLE_READ:
            return 'TRANSACTION_ISOLATION_REPEATABLE_READ';
        case PostgresqlHostConfig17_TransactionIsolation.TRANSACTION_ISOLATION_SERIALIZABLE:
...
export enum PostgresqlHostConfig17_XmlBinary {
...
export function postgresqlHostConfig17_XmlBinaryFromJSON(
    object: any,
): PostgresqlHostConfig17_XmlBinary {
    switch (object) {
        case 0:
        case 'XML_BINARY_UNSPECIFIED':
            return PostgresqlHostConfig17_XmlBinary.XML_BINARY_UNSPECIFIED;
        case 1:
        case 'XML_BINARY_BASE64':
            return PostgresqlHostConfig17_XmlBinary.XML_BINARY_BASE64;
        case 2:
        case 'XML_BINARY_HEX':
            return PostgresqlHostConfig17_XmlBinary.XML_BINARY_HEX;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return PostgresqlHostConfig17_XmlBinary.UNRECOGNIZED;
    }
}

export function postgresqlHostConfig17_XmlBinaryToJSON(
    object: PostgresqlHostConfig17_XmlBinary,
): string {
    switch (object) {
        case PostgresqlHostConfig17_XmlBinary.XML_BINARY_UNSPECIFIED:
            return 'XML_BINARY_UNSPECIFIED';
        case PostgresqlHostConfig17_XmlBinary.XML_BINARY_BASE64:
            return 'XML_BINARY_BASE64';
        case PostgresqlHostConfig17_XmlBinary.XML_BINARY_HEX:
...
export enum PostgresqlHostConfig17_XmlOption {
...
export function postgresqlHostConfig17_XmlOptionFromJSON(
    object: any,
): PostgresqlHostConfig17_XmlOption {
    switch (object) {
        case 0:
        case 'XML_OPTION_UNSPECIFIED':
            return PostgresqlHostConfig17_XmlOption.XML_OPTION_UNSPECIFIED;
        case 1:
        case 'XML_OPTION_DOCUMENT':
            return PostgresqlHostConfig17_XmlOption.XML_OPTION_DOCUMENT;
        case 2:
        case 'XML_OPTION_CONTENT':
            return PostgresqlHostConfig17_XmlOption.XML_OPTION_CONTENT;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return PostgresqlHostConfig17_XmlOption.UNRECOGNIZED;
    }
}

export function postgresqlHostConfig17_XmlOptionToJSON(
    object: PostgresqlHostConfig17_XmlOption,
): string {
    switch (object) {
        case PostgresqlHostConfig17_XmlOption.XML_OPTION_UNSPECIFIED:
            return 'XML_OPTION_UNSPECIFIED';
        case PostgresqlHostConfig17_XmlOption.XML_OPTION_DOCUMENT:
            return 'XML_OPTION_DOCUMENT';
        case PostgresqlHostConfig17_XmlOption.XML_OPTION_CONTENT:
...
const basePostgresqlHostConfig17: object = {
    $type: 'yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig17',
...
export const PostgresqlHostConfig17 = {
    $type: 'yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig17' as const,

    encode(message: PostgresqlHostConfig17, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): PostgresqlHostConfig17 {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...basePostgresqlHostConfig17 } as PostgresqlHostConfig17;
    ...
    fromJSON(object: any): PostgresqlHostConfig17 {
        const message = { ...basePostgresqlHostConfig17 } as PostgresqlHostConfig17;
        ...
        message.constraintExclusion =
            object.constraintExclusion !== undefined && object.constraintExclusion !== null
                ? postgresqlHostConfig17_ConstraintExclusionFromJSON(object.constraintExclusion)
                : 0;
        ...
        message.debugParallelQuery =
            object.debugParallelQuery !== undefined && object.debugParallelQuery !== null
                ? postgresqlHostConfig17_DebugParallelQueryFromJSON(object.debugParallelQuery)
                : 0;
        message.clientMinMessages =
            object.clientMinMessages !== undefined && object.clientMinMessages !== null
                ? postgresqlHostConfig17_LogLevelFromJSON(object.clientMinMessages)
                : 0;
        message.logMinMessages =
            object.logMinMessages !== undefined && object.logMinMessages !== null
                ? postgresqlHostConfig17_LogLevelFromJSON(object.logMinMessages)
                : 0;
        message.logMinErrorStatement =
            object.logMinErrorStatement !== undefined && object.logMinErrorStatement !== null
                ? postgresqlHostConfig17_LogLevelFromJSON(object.logMinErrorStatement)
                : 0;
        ...
        message.logErrorVerbosity =
            object.logErrorVerbosity !== undefined && object.logErrorVerbosity !== null
                ? postgresqlHostConfig17_LogErrorVerbosityFromJSON(object.logErrorVerbosity)
                : 0;
        ...
        message.logStatement =
            object.logStatement !== undefined && object.logStatement !== null
                ? postgresqlHostConfig17_LogStatementFromJSON(object.logStatement)
                : 0;
        ...
        message.defaultTransactionIsolation =
            ...
            object.defaultTransactionIsolation !== null
                ? postgresqlHostConfig17_TransactionIsolationFromJSON(
        ...
        message.byteaOutput =
            object.byteaOutput !== undefined && object.byteaOutput !== null
                ? postgresqlHostConfig17_ByteaOutputFromJSON(object.byteaOutput)
                : 0;
        message.xmlbinary =
            object.xmlbinary !== undefined && object.xmlbinary !== null
                ? postgresqlHostConfig17_XmlBinaryFromJSON(object.xmlbinary)
                : 0;
        message.xmloption =
            object.xmloption !== undefined && object.xmloption !== null
                ? postgresqlHostConfig17_XmlOptionFromJSON(object.xmloption)
                : 0;
        ...
        message.backslashQuote =
            object.backslashQuote !== undefined && object.backslashQuote !== null
                ? postgresqlHostConfig17_BackslashQuoteFromJSON(object.backslashQuote)
                : 0;
    ...
    toJSON(message: PostgresqlHostConfig17): unknown {
        const obj: any = {};
        ...
        message.constraintExclusion !== undefined &&
            (obj.constraintExclusion = postgresqlHostConfig17_ConstraintExclusionToJSON(
                message.constraintExclusion,
            ));
        ...
        message.debugParallelQuery !== undefined &&
            (obj.debugParallelQuery = postgresqlHostConfig17_DebugParallelQueryToJSON(
                message.debugParallelQuery,
            ));
        message.clientMinMessages !== undefined &&
            (obj.clientMinMessages = postgresqlHostConfig17_LogLevelToJSON(
                message.clientMinMessages,
            ));
        message.logMinMessages !== undefined &&
            (obj.logMinMessages = postgresqlHostConfig17_LogLevelToJSON(message.logMinMessages));
        message.logMinErrorStatement !== undefined &&
            (obj.logMinErrorStatement = postgresqlHostConfig17_LogLevelToJSON(
                message.logMinErrorStatement,
            ));
        ...
        message.logErrorVerbosity !== undefined &&
            (obj.logErrorVerbosity = postgresqlHostConfig17_LogErrorVerbosityToJSON(
                message.logErrorVerbosity,
            ));
        message.logLockWaits !== undefined && (obj.logLockWaits = message.logLockWaits);
        message.logStatement !== undefined &&
            (obj.logStatement = postgresqlHostConfig17_LogStatementToJSON(message.logStatement));
        ...
        message.defaultTransactionIsolation !== undefined &&
            (obj.defaultTransactionIsolation = postgresqlHostConfig17_TransactionIsolationToJSON(
                message.defaultTransactionIsolation,
            ));
        ...
        message.byteaOutput !== undefined &&
            (obj.byteaOutput = postgresqlHostConfig17_ByteaOutputToJSON(message.byteaOutput));
        message.xmlbinary !== undefined &&
            (obj.xmlbinary = postgresqlHostConfig17_XmlBinaryToJSON(message.xmlbinary));
        message.xmloption !== undefined &&
            (obj.xmloption = postgresqlHostConfig17_XmlOptionToJSON(message.xmloption));
        ...
        message.backslashQuote !== undefined &&
            (obj.backslashQuote = postgresqlHostConfig17_BackslashQuoteToJSON(
                message.backslashQuote,
            ));
    ...
    fromPartial<I extends Exact<DeepPartial<PostgresqlHostConfig17>, I>>(
        object: I,
...
messageTypeRegistry.set(PostgresqlHostConfig17.$type, PostgresqlHostConfig17);
