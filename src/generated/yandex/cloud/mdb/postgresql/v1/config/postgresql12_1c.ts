...
export const Postgresqlconfig121c = {
  ...
  fromJSON(object: any): Postgresqlconfig121c {
    ...
    message.sharedPreloadLibraries = (object.sharedPreloadLibraries ?? []).map(
      (e: any) => postgresqlconfig121c_SharedPreloadLibrariesFromJSON(e)
    );
    ...
    message.passwordEncryption =
      ...
      object.passwordEncryption !== null
        ? postgresqlconfig121c_PasswordEncryptionFromJSON(
...
export const Postgresqlconfigset121c = {
  $type:
    "yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet12_1C" as const,
