...
export function postgresqlconfig121c_PasswordEncryptionFromJSON(
    object: any,
...
export function postgresqlconfig121c_PasswordEncryptionToJSON(
    object: Postgresqlconfig121c_PasswordEncryption,
): string {
    switch (object) {
...
export const Postgresqlconfig121c: {
    ...
    fromPartial<I extends Exact<DeepPartial<Postgresqlconfig121c>, I>>(object: I): Postgresqlconfig121c;
} = {
    ...
    toJSON(message: Postgresqlconfig121c): unknown {
        ...
        message.synchronousCommit !== undefined &&
            (obj.synchronousCommit = postgresqlconfig121c_SynchronousCommitToJSON(
                message.synchronousCommit,
            ));
        ...
        message.constraintExclusion !== undefined &&
            (obj.constraintExclusion = postgresqlconfig121c_ConstraintExclusionToJSON(
                message.constraintExclusion,
            ));
        ...
        message.forceParallelMode !== undefined &&
            (obj.forceParallelMode = postgresqlconfig121c_ForceParallelModeToJSON(
                message.forceParallelMode,
            ));
        ...
        message.logErrorVerbosity !== undefined &&
            (obj.logErrorVerbosity = postgresqlconfig121c_LogErrorVerbosityToJSON(
                message.logErrorVerbosity,
            ));
        ...
        message.pgHintPlanDebugPrint !== undefined &&
            (obj.pgHintPlanDebugPrint = postgresqlconfig121c_PgHintPlanDebugPrintToJSON(
                message.pgHintPlanDebugPrint,
            ));
    ...
    fromPartial<I extends Exact<DeepPartial<Postgresqlconfig121c>, I>>(
        object: I,
...
export const Postgresqlconfigset121c: {
    ...
    fromPartial<I extends Exact<DeepPartial<Postgresqlconfigset121c>, I>>(object: I): Postgresqlconfigset121c;
} = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Postgresqlconfigset121c {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...basePostgresqlconfigset121c } as Postgresqlconfigset121c;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object: any): Postgresqlconfigset121c {
        ...
        message.userConfig =
            object.userConfig !== undefined && object.userConfig !== null
                ? Postgresqlconfig121c.fromJSON(object.userConfig)
                : undefined;
        message.defaultConfig =
            object.defaultConfig !== undefined && object.defaultConfig !== null
                ? Postgresqlconfig121c.fromJSON(object.defaultConfig)
                : undefined;
        return message;
    },
    ...
    fromPartial<I extends Exact<DeepPartial<Postgresqlconfigset121c>, I>>(
        object: I,
