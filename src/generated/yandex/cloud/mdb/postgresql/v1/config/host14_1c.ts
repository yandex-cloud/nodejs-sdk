...
export const Postgresqlhostconfig141c: {
    ...
    fromPartial<I extends Exact<DeepPartial<Postgresqlhostconfig141c>, I>>(object: I): Postgresqlhostconfig141c;
} = {
    encode(
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Postgresqlhostconfig141c {
        ...
        const message = { ...basePostgresqlhostconfig141c } as Postgresqlhostconfig141c;
    ...
    toJSON(message: Postgresqlhostconfig141c): unknown {
        ...
        message.constraintExclusion !== undefined &&
            (obj.constraintExclusion = postgresqlhostconfig141c_ConstraintExclusionToJSON(
                message.constraintExclusion,
            ));
