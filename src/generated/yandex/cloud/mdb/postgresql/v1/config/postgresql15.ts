...
export function postgresqlConfig15_LogLevelFromJSON(
  object: any
): PostgresqlConfig15_LogLevel {
  switch (object) {
    case 0:
...
export function postgresqlConfig15_LogLevelToJSON(
  object: PostgresqlConfig15_LogLevel
): string {
  switch (object) {
...
export function postgresqlConfig15_WalLevelFromJSON(
  object: any
): PostgresqlConfig15_WalLevel {
  switch (object) {
    case 0:
...
export function postgresqlConfig15_WalLevelToJSON(
  object: PostgresqlConfig15_WalLevel
): string {
  switch (object) {
...
export function postgresqlConfig15_XmlBinaryFromJSON(
  object: any
): PostgresqlConfig15_XmlBinary {
  switch (object) {
    case 0:
...
export function postgresqlConfig15_XmlBinaryToJSON(
  object: PostgresqlConfig15_XmlBinary
): string {
  switch (object) {
...
export function postgresqlConfig15_XmlOptionFromJSON(
  object: any
): PostgresqlConfig15_XmlOption {
  switch (object) {
    case 0:
...
export function postgresqlConfig15_XmlOptionToJSON(
  object: PostgresqlConfig15_XmlOption
): string {
  switch (object) {
...
export const PostgresqlConfig15 = {
  ...
  fromJSON(object: any): PostgresqlConfig15 {
    ...
    message.constraintExclusion =
      ...
      object.constraintExclusion !== null
        ? postgresqlConfig15_ConstraintExclusionFromJSON(
    ...
    message.sharedPreloadLibraries = (object.sharedPreloadLibraries ?? []).map(
      (e: any) => postgresqlConfig15_SharedPreloadLibrariesFromJSON(e)
    );
    ...
    message.pgHintPlanDebugPrint =
      ...
      object.pgHintPlanDebugPrint !== null
        ? postgresqlConfig15_PgHintPlanDebugPrintFromJSON(
    ...
    message.passwordEncryption =
      ...
      object.passwordEncryption !== null
        ? postgresqlConfig15_PasswordEncryptionFromJSON(
  ...
  toJSON(message: PostgresqlConfig15): unknown {
    ...
    message.clientMinMessages !== undefined &&
      (obj.clientMinMessages = postgresqlConfig15_LogLevelToJSON(
        message.clientMinMessages
      ));
    message.logMinMessages !== undefined &&
      (obj.logMinMessages = postgresqlConfig15_LogLevelToJSON(
        message.logMinMessages
      ));
    ...
    message.logStatement !== undefined &&
      (obj.logStatement = postgresqlConfig15_LogStatementToJSON(
        message.logStatement
      ));
    ...
    message.defaultTransactionIsolation !== undefined &&
      (obj.defaultTransactionIsolation =
        postgresqlConfig15_TransactionIsolationToJSON(
          message.defaultTransactionIsolation
        ));
    ...
    message.byteaOutput !== undefined &&
      (obj.byteaOutput = postgresqlConfig15_ByteaOutputToJSON(
        message.byteaOutput
      ));
    ...
    message.backslashQuote !== undefined &&
      (obj.backslashQuote = postgresqlConfig15_BackslashQuoteToJSON(
        message.backslashQuote
      ));
    ...
    message.planCacheMode !== undefined &&
      (obj.planCacheMode = postgresqlConfig15_PlanCacheModeToJSON(
        message.planCacheMode
      ));
...
export const PostgresqlConfigSet15 = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.effectiveConfig = PostgresqlConfig15.decode(
            reader,
            reader.uint32()
          );
          break;
        case 2:
          message.userConfig = PostgresqlConfig15.decode(
            reader,
            reader.uint32()
          );
          break;
        case 3:
          message.defaultConfig = PostgresqlConfig15.decode(
            reader,
            reader.uint32()
          );
          break;
