...
export interface Postgresqlconfig141c {
    ...
    autoExplainLogFormat: Postgresqlconfig141c_AutoExplainLogFormat;
    /** in milliseconds. */
    idleSessionTimeout?: number;
}

export enum Postgresqlconfig141c_AutoExplainLogFormat {
...
export function postgresqlconfig141c_AutoExplainLogFormatFromJSON(
    object: any,
): Postgresqlconfig141c_AutoExplainLogFormat {
    switch (object) {
        case 0:
        case 'AUTO_EXPLAIN_LOG_FORMAT_UNSPECIFIED':
            return Postgresqlconfig141c_AutoExplainLogFormat.AUTO_EXPLAIN_LOG_FORMAT_UNSPECIFIED;
        case 1:
        case 'AUTO_EXPLAIN_LOG_FORMAT_TEXT':
            return Postgresqlconfig141c_AutoExplainLogFormat.AUTO_EXPLAIN_LOG_FORMAT_TEXT;
        case 2:
        case 'AUTO_EXPLAIN_LOG_FORMAT_XML':
            return Postgresqlconfig141c_AutoExplainLogFormat.AUTO_EXPLAIN_LOG_FORMAT_XML;
        case 3:
        case 'AUTO_EXPLAIN_LOG_FORMAT_JSON':
            return Postgresqlconfig141c_AutoExplainLogFormat.AUTO_EXPLAIN_LOG_FORMAT_JSON;
        case 4:
        case 'AUTO_EXPLAIN_LOG_FORMAT_YAML':
            return Postgresqlconfig141c_AutoExplainLogFormat.AUTO_EXPLAIN_LOG_FORMAT_YAML;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return Postgresqlconfig141c_AutoExplainLogFormat.UNRECOGNIZED;
    }
}

export function postgresqlconfig141c_AutoExplainLogFormatToJSON(
    object: Postgresqlconfig141c_AutoExplainLogFormat,
): string {
    switch (object) {
        case Postgresqlconfig141c_AutoExplainLogFormat.AUTO_EXPLAIN_LOG_FORMAT_UNSPECIFIED:
            return 'AUTO_EXPLAIN_LOG_FORMAT_UNSPECIFIED';
        case Postgresqlconfig141c_AutoExplainLogFormat.AUTO_EXPLAIN_LOG_FORMAT_TEXT:
            return 'AUTO_EXPLAIN_LOG_FORMAT_TEXT';
        case Postgresqlconfig141c_AutoExplainLogFormat.AUTO_EXPLAIN_LOG_FORMAT_XML:
            return 'AUTO_EXPLAIN_LOG_FORMAT_XML';
        case Postgresqlconfig141c_AutoExplainLogFormat.AUTO_EXPLAIN_LOG_FORMAT_JSON:
            return 'AUTO_EXPLAIN_LOG_FORMAT_JSON';
        case Postgresqlconfig141c_AutoExplainLogFormat.AUTO_EXPLAIN_LOG_FORMAT_YAML:
...
export const Postgresqlconfig141c: {
    ...
    fromPartial<I extends Exact<DeepPartial<Postgresqlconfig141c>, I>>(object: I): Postgresqlconfig141c;
} = {
    ...
    fromJSON(object: any): Postgresqlconfig141c {
        ...
        message.sharedPreloadLibraries = (object.sharedPreloadLibraries ?? []).map((e: any) =>
            postgresqlconfig141c_SharedPreloadLibrariesFromJSON(e),
        );
        ...
        message.autoExplainLogFormat =
            object.autoExplainLogFormat !== undefined && object.autoExplainLogFormat !== null
                ? postgresqlconfig141c_AutoExplainLogFormatFromJSON(object.autoExplainLogFormat)
                : 0;
    ...
    toJSON(message: Postgresqlconfig141c): unknown {
        ...
        message.pgHintPlanDebugPrint !== undefined &&
            (obj.pgHintPlanDebugPrint = postgresqlconfig141c_PgHintPlanDebugPrintToJSON(
                message.pgHintPlanDebugPrint,
            ));
        ...
        message.autoExplainLogFormat !== undefined &&
            (obj.autoExplainLogFormat = postgresqlconfig141c_AutoExplainLogFormatToJSON(
                message.autoExplainLogFormat,
            ));
...
export const Postgresqlconfigset141c: {
    ...
    fromPartial<I extends Exact<DeepPartial<Postgresqlconfigset141c>, I>>(object: I): Postgresqlconfigset141c;
} = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Postgresqlconfigset141c {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...basePostgresqlconfigset141c } as Postgresqlconfigset141c;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
