...
export function postgresqlconfig101c_PasswordEncryptionFromJSON(
    object: any,
): Postgresqlconfig101c_PasswordEncryption {
    switch (object) {
        case 0:
...
export function postgresqlconfig101c_PasswordEncryptionToJSON(
    object: Postgresqlconfig101c_PasswordEncryption,
): string {
    switch (object) {
...
export const Postgresqlconfig101c: {
    ...
    fromPartial<I extends Exact<DeepPartial<Postgresqlconfig101c>, I>>(object: I): Postgresqlconfig101c;
} = {
    ...
    toJSON(message: Postgresqlconfig101c): unknown {
        ...
        message.pgHintPlanDebugPrint !== undefined &&
            (obj.pgHintPlanDebugPrint = postgresqlconfig101c_PgHintPlanDebugPrintToJSON(
                message.pgHintPlanDebugPrint,
            ));
        ...
        message.passwordEncryption !== undefined &&
            (obj.passwordEncryption = postgresqlconfig101c_PasswordEncryptionToJSON(
                message.passwordEncryption,
            ));
        return obj;
    },
...
export const Postgresqlconfigset101c: {
    ...
    fromPartial<I extends Exact<DeepPartial<Postgresqlconfigset101c>, I>>(object: I): Postgresqlconfigset101c;
} = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Postgresqlconfigset101c {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...basePostgresqlconfigset101c } as Postgresqlconfigset101c;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
