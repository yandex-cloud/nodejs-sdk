...
export const Postgresqlhostconfig96: {
    ...
    fromPartial<I extends Exact<DeepPartial<Postgresqlhostconfig96>, I>>(object: I): Postgresqlhostconfig96;
} = {
    ...
    toJSON(message: Postgresqlhostconfig96): unknown {
        ...
        message.constraintExclusion !== undefined &&
            (obj.constraintExclusion = postgresqlhostconfig96_ConstraintExclusionToJSON(
                message.constraintExclusion,
            ));
