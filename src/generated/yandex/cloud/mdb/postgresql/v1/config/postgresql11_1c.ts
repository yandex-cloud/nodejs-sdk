...
export const Postgresqlconfig111c = {
  ...
  fromJSON(object: any): Postgresqlconfig111c {
    ...
    message.sharedPreloadLibraries = (object.sharedPreloadLibraries ?? []).map(
      (e: any) => postgresqlconfig111c_SharedPreloadLibrariesFromJSON(e)
    );
    ...
    message.passwordEncryption =
      ...
      object.passwordEncryption !== null
        ? postgresqlconfig111c_PasswordEncryptionFromJSON(
...
export const Postgresqlconfigset111c = {
  $type:
    "yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet11_1C" as const,
