...
export function postgresqlconfig111c_PasswordEncryptionFromJSON(
    object: any,
): Postgresqlconfig111c_PasswordEncryption {
    switch (object) {
        case 0:
...
export const Postgresqlconfig111c: {
    ...
    fromPartial<I extends Exact<DeepPartial<Postgresqlconfig111c>, I>>(object: I): Postgresqlconfig111c;
} = {
    ...
    toJSON(message: Postgresqlconfig111c): unknown {
        ...
        message.synchronousCommit !== undefined &&
            (obj.synchronousCommit = postgresqlconfig111c_SynchronousCommitToJSON(
                message.synchronousCommit,
            ));
        ...
        message.constraintExclusion !== undefined &&
            (obj.constraintExclusion = postgresqlconfig111c_ConstraintExclusionToJSON(
                message.constraintExclusion,
            ));
        ...
        message.forceParallelMode !== undefined &&
            (obj.forceParallelMode = postgresqlconfig111c_ForceParallelModeToJSON(
                message.forceParallelMode,
            ));
        ...
        message.logErrorVerbosity !== undefined &&
            (obj.logErrorVerbosity = postgresqlconfig111c_LogErrorVerbosityToJSON(
                message.logErrorVerbosity,
            ));
        ...
        message.pgHintPlanDebugPrint !== undefined &&
            (obj.pgHintPlanDebugPrint = postgresqlconfig111c_PgHintPlanDebugPrintToJSON(
                message.pgHintPlanDebugPrint,
            ));
        ...
        message.passwordEncryption !== undefined &&
            (obj.passwordEncryption = postgresqlconfig111c_PasswordEncryptionToJSON(
                message.passwordEncryption,
            ));
        return obj;
    },

    fromPartial<I extends Exact<DeepPartial<Postgresqlconfig111c>, I>>(
        object: I,
...
export const Postgresqlconfigset111c: {
    ...
    fromPartial<I extends Exact<DeepPartial<Postgresqlconfigset111c>, I>>(object: I): Postgresqlconfigset111c;
} = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Postgresqlconfigset111c {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...basePostgresqlconfigset111c } as Postgresqlconfigset111c;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object: any): Postgresqlconfigset111c {
        ...
        message.userConfig =
            object.userConfig !== undefined && object.userConfig !== null
                ? Postgresqlconfig111c.fromJSON(object.userConfig)
                : undefined;
        message.defaultConfig =
            object.defaultConfig !== undefined && object.defaultConfig !== null
                ? Postgresqlconfig111c.fromJSON(object.defaultConfig)
                : undefined;
        return message;
    },
    ...
    fromPartial<I extends Exact<DeepPartial<Postgresqlconfigset111c>, I>>(
        object: I,
