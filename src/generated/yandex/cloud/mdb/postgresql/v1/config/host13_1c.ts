...
export function postgresqlhostconfig131c_BackslashQuoteFromJSON(
  object: any
...
export function postgresqlhostconfig131c_BackslashQuoteToJSON(
  object: Postgresqlhostconfig131c_BackslashQuote
): string {
  switch (object) {
...
export function postgresqlhostconfig131c_ByteaOutputFromJSON(
  object: any
): Postgresqlhostconfig131c_ByteaOutput {
  switch (object) {
    case 0:
...
export function postgresqlhostconfig131c_ByteaOutputToJSON(
  object: Postgresqlhostconfig131c_ByteaOutput
): string {
  switch (object) {
...
export function postgresqlhostconfig131c_LogLevelFromJSON(
  object: any
): Postgresqlhostconfig131c_LogLevel {
  switch (object) {
    case 0:
...
export function postgresqlhostconfig131c_LogLevelToJSON(
  object: Postgresqlhostconfig131c_LogLevel
): string {
  switch (object) {
...
export function postgresqlhostconfig131c_LogStatementFromJSON(
  object: any
): Postgresqlhostconfig131c_LogStatement {
  switch (object) {
    case 0:
...
export function postgresqlhostconfig131c_LogStatementToJSON(
  object: Postgresqlhostconfig131c_LogStatement
): string {
  switch (object) {
...
export function postgresqlhostconfig131c_XmlBinaryFromJSON(
  object: any
): Postgresqlhostconfig131c_XmlBinary {
  switch (object) {
    case 0:
...
export function postgresqlhostconfig131c_XmlBinaryToJSON(
  object: Postgresqlhostconfig131c_XmlBinary
): string {
  switch (object) {
...
export function postgresqlhostconfig131c_XmlOptionFromJSON(
  object: any
): Postgresqlhostconfig131c_XmlOption {
  switch (object) {
    case 0:
...
export function postgresqlhostconfig131c_XmlOptionToJSON(
  object: Postgresqlhostconfig131c_XmlOption
): string {
  switch (object) {
...
const basePostgresqlhostconfig131c: object = {
  $type: "yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig13_1C",
...
export const Postgresqlhostconfig131c = {
  $type:
    "yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig13_1C" as const,

  encode(
    message: Postgresqlhostconfig131c,
  ...
  decode(
    ...
    const message = {
      ...basePostgresqlhostconfig131c,
    } as Postgresqlhostconfig131c;
  ...
  fromJSON(object: any): Postgresqlhostconfig131c {
    ...
    message.constraintExclusion =
      ...
      object.constraintExclusion !== null
        ? postgresqlhostconfig131c_ConstraintExclusionFromJSON(
    ...
    message.forceParallelMode =
      ...
      object.forceParallelMode !== null
        ? postgresqlhostconfig131c_ForceParallelModeFromJSON(
    ...
    message.logErrorVerbosity =
      ...
      object.logErrorVerbosity !== null
        ? postgresqlhostconfig131c_LogErrorVerbosityFromJSON(
    ...
    message.defaultTransactionIsolation =
      ...
      object.defaultTransactionIsolation !== null
        ? postgresqlhostconfig131c_TransactionIsolationFromJSON(
  ...
  toJSON(message: Postgresqlhostconfig131c): unknown {
    ...
    message.constraintExclusion !== undefined &&
      (obj.constraintExclusion =
        postgresqlhostconfig131c_ConstraintExclusionToJSON(
          message.constraintExclusion
        ));
    ...
    message.forceParallelMode !== undefined &&
      (obj.forceParallelMode = postgresqlhostconfig131c_ForceParallelModeToJSON(
        message.forceParallelMode
      ));
    message.clientMinMessages !== undefined &&
      (obj.clientMinMessages = postgresqlhostconfig131c_LogLevelToJSON(
        message.clientMinMessages
      ));
    message.logMinMessages !== undefined &&
      (obj.logMinMessages = postgresqlhostconfig131c_LogLevelToJSON(
        message.logMinMessages
      ));
    message.logMinErrorStatement !== undefined &&
      (obj.logMinErrorStatement = postgresqlhostconfig131c_LogLevelToJSON(
        message.logMinErrorStatement
      ));
    ...
    message.logErrorVerbosity !== undefined &&
      (obj.logErrorVerbosity = postgresqlhostconfig131c_LogErrorVerbosityToJSON(
        message.logErrorVerbosity
      ));
    message.logLockWaits !== undefined &&
      (obj.logLockWaits = message.logLockWaits);
    message.logStatement !== undefined &&
      (obj.logStatement = postgresqlhostconfig131c_LogStatementToJSON(
        message.logStatement
      ));
    ...
    message.defaultTransactionIsolation !== undefined &&
      (obj.defaultTransactionIsolation =
        postgresqlhostconfig131c_TransactionIsolationToJSON(
          message.defaultTransactionIsolation
        ));
    ...
    message.byteaOutput !== undefined &&
      (obj.byteaOutput = postgresqlhostconfig131c_ByteaOutputToJSON(
        message.byteaOutput
      ));
    message.xmlbinary !== undefined &&
      (obj.xmlbinary = postgresqlhostconfig131c_XmlBinaryToJSON(
        message.xmlbinary
      ));
    message.xmloption !== undefined &&
      (obj.xmloption = postgresqlhostconfig131c_XmlOptionToJSON(
        message.xmloption
      ));
    ...
    message.backslashQuote !== undefined &&
      (obj.backslashQuote = postgresqlhostconfig131c_BackslashQuoteToJSON(
        message.backslashQuote
      ));
  ...
  fromPartial<I extends Exact<DeepPartial<Postgresqlhostconfig131c>, I>>(
    object: I
  ): Postgresqlhostconfig131c {
    const message = {
      ...basePostgresqlhostconfig131c,
