...
export const Postgresqlhostconfig131c: {
    ...
    fromPartial<I extends Exact<DeepPartial<Postgresqlhostconfig131c>, I>>(object: I): Postgresqlhostconfig131c;
} = {
    encode(
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Postgresqlhostconfig131c {
        ...
        const message = { ...basePostgresqlhostconfig131c } as Postgresqlhostconfig131c;
    ...
    toJSON(message: Postgresqlhostconfig131c): unknown {
        ...
        message.constraintExclusion !== undefined &&
            (obj.constraintExclusion = postgresqlhostconfig131c_ConstraintExclusionToJSON(
                message.constraintExclusion,
            ));
