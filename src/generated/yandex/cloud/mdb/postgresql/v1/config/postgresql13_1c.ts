...
export const Postgresqlconfig131c: {
    ...
    fromPartial<I extends Exact<DeepPartial<Postgresqlconfig131c>, I>>(object: I): Postgresqlconfig131c;
} = {
    ...
    fromJSON(object: any): Postgresqlconfig131c {
        ...
        message.sharedPreloadLibraries = (object.sharedPreloadLibraries ?? []).map((e: any) =>
            postgresqlconfig131c_SharedPreloadLibrariesFromJSON(e),
        );
    ...
    toJSON(message: Postgresqlconfig131c): unknown {
        ...
        message.pgHintPlanDebugPrint !== undefined &&
            (obj.pgHintPlanDebugPrint = postgresqlconfig131c_PgHintPlanDebugPrintToJSON(
                message.pgHintPlanDebugPrint,
            ));
...
export const Postgresqlconfigset131c: {
    ...
    fromPartial<I extends Exact<DeepPartial<Postgresqlconfigset131c>, I>>(object: I): Postgresqlconfigset131c;
} = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Postgresqlconfigset131c {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...basePostgresqlconfigset131c } as Postgresqlconfigset131c;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
