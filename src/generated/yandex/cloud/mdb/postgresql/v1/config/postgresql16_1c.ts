...
export function postgresqlconfig161c_LogLevelFromJSON(
  object: any
): Postgresqlconfig161c_LogLevel {
  switch (object) {
    case 0:
...
export function postgresqlconfig161c_LogLevelToJSON(
  object: Postgresqlconfig161c_LogLevel
): string {
  switch (object) {
...
export function postgresqlconfig161c_WalLevelFromJSON(
  object: any
...
export function postgresqlconfig161c_WalLevelToJSON(
  object: Postgresqlconfig161c_WalLevel
): string {
  switch (object) {
...
export const Postgresqlconfig161c = {
  ...
  fromJSON(object: any): Postgresqlconfig161c {
    ...
    message.synchronousCommit =
      ...
      object.synchronousCommit !== null
        ? postgresqlconfig161c_SynchronousCommitFromJSON(
    ...
    message.constraintExclusion =
      ...
      object.constraintExclusion !== null
        ? postgresqlconfig161c_ConstraintExclusionFromJSON(
    ...
    message.debugParallelQuery =
      ...
      object.debugParallelQuery !== null
        ? postgresqlconfig161c_DebugParallelQueryFromJSON(
            object.debugParallelQuery
          )
        : 0;
    ...
    message.logErrorVerbosity =
      ...
      object.logErrorVerbosity !== null
        ? postgresqlconfig161c_LogErrorVerbosityFromJSON(
    ...
    message.sharedPreloadLibraries = (object.sharedPreloadLibraries ?? []).map(
      (e: any) => postgresqlconfig161c_SharedPreloadLibrariesFromJSON(e)
    );
    ...
    message.pgHintPlanDebugPrint =
      ...
      object.pgHintPlanDebugPrint !== null
        ? postgresqlconfig161c_PgHintPlanDebugPrintFromJSON(
    ...
    message.passwordEncryption =
      ...
      object.passwordEncryption !== null
        ? postgresqlconfig161c_PasswordEncryptionFromJSON(
  ...
  toJSON(message: Postgresqlconfig161c): unknown {
    ...
    message.logMinMessages !== undefined &&
      (obj.logMinMessages = postgresqlconfig161c_LogLevelToJSON(
        message.logMinMessages
      ));
    ...
    message.logStatement !== undefined &&
      (obj.logStatement = postgresqlconfig161c_LogStatementToJSON(
        message.logStatement
      ));
    ...
    message.defaultTransactionIsolation !== undefined &&
      (obj.defaultTransactionIsolation =
        postgresqlconfig161c_TransactionIsolationToJSON(
          message.defaultTransactionIsolation
        ));
    ...
    message.byteaOutput !== undefined &&
      (obj.byteaOutput = postgresqlconfig161c_ByteaOutputToJSON(
        message.byteaOutput
      ));
    ...
    message.planCacheMode !== undefined &&
      (obj.planCacheMode = postgresqlconfig161c_PlanCacheModeToJSON(
        message.planCacheMode
      ));
    ...
    message.pgHintPlanDebugPrint !== undefined &&
      (obj.pgHintPlanDebugPrint =
        postgresqlconfig161c_PgHintPlanDebugPrintToJSON(
          message.pgHintPlanDebugPrint
        ));
...
export const Postgresqlconfigset161c = {
  $type:
    "yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet16_1C" as const,

  encode(
    message: Postgresqlconfigset161c,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
  ...
  decode(
    ...
    } as Postgresqlconfigset161c;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.effectiveConfig = Postgresqlconfig161c.decode(
            reader,
            reader.uint32()
          );
          break;
        case 2:
          message.userConfig = Postgresqlconfig161c.decode(
            reader,
            reader.uint32()
          );
          break;
        case 3:
          message.defaultConfig = Postgresqlconfig161c.decode(
            reader,
            reader.uint32()
          );
          break;
