...
import { PostgresqlConfigSet17 } from './config/postgresql17';
import { Postgresqlconfigset171c } from './config/postgresql17_1c';
import { PostgresqlConfigSet18 } from './config/postgresql18';
import { Postgresqlconfigset181c } from './config/postgresql18_1c';
...
export interface ClusterConfig {
    ...
    postgresqlConfig18?: PostgresqlConfigSet18 | undefined;
    /** Configuration of a PostgreSQL 18 1C server. */
    postgresqlConfig181c?: Postgresqlconfigset181c | undefined;
...
export const ClusterConfig: {
    ...
    encode(message: ClusterConfig, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.fullVersion !== '') {
            writer.uint32(250).string(message.fullVersion);
        }
        return writer;
    },
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 28:
                    ...
                    break;
                case 29:
                    message.postgresqlConfig18 = PostgresqlConfigSet18.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
                case 30:
                    message.postgresqlConfig181c = Postgresqlconfigset181c.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    fromJSON(object: any): ClusterConfig {
        ...
        message.postgresqlConfig13 =
            object.postgresqlConfig_13 !== undefined && object.postgresqlConfig_13 !== null
                ...
                : undefined;
        message.postgresqlConfig131c =
            object.postgresqlConfig_13_1c !== undefined && object.postgresqlConfig_13_1c !== null
                ? Postgresqlconfigset131c.fromJSON(object.postgresqlConfig_13_1c)
                : undefined;
        message.postgresqlConfig14 =
            object.postgresqlConfig_14 !== undefined && object.postgresqlConfig_14 !== null
                ? PostgresqlConfigSet14.fromJSON(object.postgresqlConfig_14)
                : undefined;
        message.postgresqlConfig141c =
            object.postgresqlConfig_14_1c !== undefined && object.postgresqlConfig_14_1c !== null
                ? Postgresqlconfigset141c.fromJSON(object.postgresqlConfig_14_1c)
                : undefined;
        message.postgresqlConfig15 =
            object.postgresqlConfig_15 !== undefined && object.postgresqlConfig_15 !== null
                ? PostgresqlConfigSet15.fromJSON(object.postgresqlConfig_15)
                : undefined;
        message.postgresqlConfig151c =
            object.postgresqlConfig_15_1c !== undefined && object.postgresqlConfig_15_1c !== null
                ? Postgresqlconfigset151c.fromJSON(object.postgresqlConfig_15_1c)
                : undefined;
        message.postgresqlConfig16 =
            object.postgresqlConfig_16 !== undefined && object.postgresqlConfig_16 !== null
        ...
        message.postgresqlConfig18 =
            object.postgresqlConfig_18 !== undefined && object.postgresqlConfig_18 !== null
                ? PostgresqlConfigSet18.fromJSON(object.postgresqlConfig_18)
                : undefined;
        message.postgresqlConfig181c =
            object.postgresqlConfig_18_1c !== undefined && object.postgresqlConfig_18_1c !== null
                ? Postgresqlconfigset181c.fromJSON(object.postgresqlConfig_18_1c)
                : undefined;
    ...
    toJSON(message: ClusterConfig): unknown {
        ...
        message.postgresqlConfig18 !== undefined &&
            (obj.postgresqlConfig_18 = message.postgresqlConfig18
                ? PostgresqlConfigSet18.toJSON(message.postgresqlConfig18)
                : undefined);
        message.postgresqlConfig181c !== undefined &&
            (obj.postgresqlConfig_18_1c = message.postgresqlConfig181c
                ? Postgresqlconfigset181c.toJSON(message.postgresqlConfig181c)
                : undefined);
        ...
        message.autofailover !== undefined && (obj.autofailover = message.autofailover);
    ...
    fromPartial<I extends Exact<DeepPartial<ClusterConfig>, I>>(object: I): ClusterConfig {
        ...
        message.postgresqlConfig13 =
            object.postgresqlConfig13 !== undefined && object.postgresqlConfig13 !== null
                ...
                : undefined;
        message.postgresqlConfig131c =
            object.postgresqlConfig131c !== undefined && object.postgresqlConfig131c !== null
                ? Postgresqlconfigset131c.fromPartial(object.postgresqlConfig131c)
                : undefined;
        message.postgresqlConfig14 =
            object.postgresqlConfig14 !== undefined && object.postgresqlConfig14 !== null
                ? PostgresqlConfigSet14.fromPartial(object.postgresqlConfig14)
                : undefined;
        message.postgresqlConfig141c =
            object.postgresqlConfig141c !== undefined && object.postgresqlConfig141c !== null
                ? Postgresqlconfigset141c.fromPartial(object.postgresqlConfig141c)
                : undefined;
        message.postgresqlConfig15 =
            object.postgresqlConfig15 !== undefined && object.postgresqlConfig15 !== null
                ? PostgresqlConfigSet15.fromPartial(object.postgresqlConfig15)
                : undefined;
        message.postgresqlConfig151c =
            object.postgresqlConfig151c !== undefined && object.postgresqlConfig151c !== null
                ? Postgresqlconfigset151c.fromPartial(object.postgresqlConfig151c)
                : undefined;
        message.postgresqlConfig16 =
            object.postgresqlConfig16 !== undefined && object.postgresqlConfig16 !== null
        ...
        message.postgresqlConfig18 =
            object.postgresqlConfig18 !== undefined && object.postgresqlConfig18 !== null
                ? PostgresqlConfigSet18.fromPartial(object.postgresqlConfig18)
                : undefined;
        message.postgresqlConfig181c =
            object.postgresqlConfig181c !== undefined && object.postgresqlConfig181c !== null
                ? Postgresqlconfigset181c.fromPartial(object.postgresqlConfig181c)
                : undefined;
        message.poolerConfig =
            object.poolerConfig !== undefined && object.poolerConfig !== null
...
export const ConnectionPoolerConfig: {
    ...
    toJSON(message: ConnectionPoolerConfig): unknown {
        ...
        message.poolDiscard !== undefined && (obj.poolDiscard = message.poolDiscard);
        return obj;
    },
...
export const Host: {
    ...
    fromJSON(object: any): Host {
        ...
        message.replicationSource =
            object.replicationSource !== undefined && object.replicationSource !== null
    ...
    toJSON(message: Host): unknown {
        ...
        message.config !== undefined &&
            (obj.config = message.config ? HostConfig.toJSON(message.config) : undefined);
...
export const HostConfig: {
    ...
    fromPartial<I extends Exact<DeepPartial<HostConfig>, I>>(object: I): HostConfig;
} = {
    ...
    fromJSON(object: any): HostConfig {
        ...
        message.postgresqlConfig131c =
            ...
            object.postgresqlHostConfig_13_1c !== null
                ...
                : undefined;
        message.postgresqlConfig14 =
            object.postgresqlHostConfig_14 !== undefined && object.postgresqlHostConfig_14 !== null
        ...
        message.postgresqlConfig141c =
            ...
            object.postgresqlHostConfig_14_1c !== null
                ...
                : undefined;
        message.postgresqlConfig15 =
            object.postgresqlHostConfig_15 !== undefined && object.postgresqlHostConfig_15 !== null
        ...
        message.postgresqlConfig151c =
            ...
            object.postgresqlHostConfig_15_1c !== null
                ...
                : undefined;
        message.postgresqlConfig16 =
            object.postgresqlHostConfig_16 !== undefined && object.postgresqlHostConfig_16 !== null
