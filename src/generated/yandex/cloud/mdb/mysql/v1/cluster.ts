...
const baseClusterConfig: object = { $type: 'yandex.cloud.mdb.mysql.v1.ClusterConfig', version: '' };
...
const baseService: object = { $type: 'yandex.cloud.mdb.mysql.v1.Service', type: 0, health: 0 };
