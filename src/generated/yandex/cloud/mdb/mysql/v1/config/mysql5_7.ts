...
export const Mysqlconfig57 = {
    encode(message: Mysqlconfig57, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.slowQueryLog !== undefined) {
            BoolValue.encode({ value: message.slowQueryLog! }, writer.uint32(450).fork()).ldelim();
        }
        ...
        if (message.autocommit !== undefined) {
            BoolValue.encode({ value: message.autocommit! }, writer.uint32(578).fork()).ldelim();
        }
        ...
        if (message.userstat !== undefined) {
            BoolValue.encode({ value: message.userstat! }, writer.uint32(690).fork()).ldelim();
        }
    ...
    fromJSON(object: any): Mysqlconfig57 {
        ...
        message.auditLog =
            object.auditLog !== undefined && object.auditLog !== null
                ...
                : undefined;
        message.sqlMode = (object.sqlMode ?? []).map((e: any) => mysqlconfig57_SQLModeFromJSON(e));
        ...
        message.showCompatibility56 =
            object.showCompatibility_56 !== undefined && object.showCompatibility_56 !== null
        ...
        message.queryResponseTimeStats =
            object.queryResponseTimeStats !== undefined && object.queryResponseTimeStats !== null
    ...
    toJSON(message: Mysqlconfig57): unknown {
        ...
        message.queryCacheLimit !== undefined && (obj.queryCacheLimit = message.queryCacheLimit);
        message.queryCacheSize !== undefined && (obj.queryCacheSize = message.queryCacheSize);
        message.queryCacheType !== undefined && (obj.queryCacheType = message.queryCacheType);
