...
export function mysqlconfig80_AuthPluginFromJSON(object: any): Mysqlconfig80_AuthPlugin {
    switch (object) {
        ...
        case 4:
        case 'MYSQL_NO_LOGIN':
            return Mysqlconfig80_AuthPlugin.MYSQL_NO_LOGIN;
        case 5:
        case 'MDB_IAMPROXY_AUTH':
            return Mysqlconfig80_AuthPlugin.MDB_IAMPROXY_AUTH;
        case -1:
        case 'UNRECOGNIZED':
        default:
...
export function mysqlconfig80_AuthPluginToJSON(object: Mysqlconfig80_AuthPlugin): string {
    switch (object) {
        ...
        case Mysqlconfig80_AuthPlugin.MYSQL_NO_LOGIN:
            return 'MYSQL_NO_LOGIN';
        case Mysqlconfig80_AuthPlugin.MDB_IAMPROXY_AUTH:
...
export const Mysqlconfig80 = {
    encode(message: Mysqlconfig80, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.slowQueryLog !== undefined) {
            BoolValue.encode({ value: message.slowQueryLog! }, writer.uint32(458).fork()).ldelim();
        }
        ...
        if (message.userstat !== undefined) {
            BoolValue.encode({ value: message.userstat! }, writer.uint32(658).fork()).ldelim();
        }
    ...
    fromJSON(object: any): Mysqlconfig80 {
        ...
        message.auditLog =
            object.auditLog !== undefined && object.auditLog !== null
                ...
                : undefined;
        message.sqlMode = (object.sqlMode ?? []).map((e: any) => mysqlconfig80_SQLModeFromJSON(e));
