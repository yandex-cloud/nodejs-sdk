...
const baseLogRecord: object = { $type: 'yandex.cloud.mdb.mysql.v1alpha.LogRecord' };
...
const baseConfigSpec: object = { $type: 'yandex.cloud.mdb.mysql.v1alpha.ConfigSpec', version: '' };
