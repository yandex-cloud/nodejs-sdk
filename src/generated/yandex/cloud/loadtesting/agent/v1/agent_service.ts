...
export const ClaimAgentStatusRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ClaimAgentStatusRequest {
        ...
        const message = { ...baseClaimAgentStatusRequest } as ClaimAgentStatusRequest;
...
export const ClaimAgentStatusResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ClaimAgentStatusResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseClaimAgentStatusResponse } as ClaimAgentStatusResponse;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ReportEventLogsRequest = {
    ...
    fromJSON(object: any): ReportEventLogsRequest {
        ...
        message.idempotencyKey =
            object.idempotencyKey !== undefined && object.idempotencyKey !== null
                ...
                : '';
        message.events = (object.events ?? []).map((e: any) => EventLog.fromJSON(e));
        return message;
    },
    ...
    toJSON(message: ReportEventLogsRequest): unknown {
        ...
        if (message.events) {
            obj.events = message.events.map((e) => (e ? EventLog.toJSON(e) : undefined));
        } else {
            obj.events = [];
        }
        return obj;
...
export const ReportEventLogsResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ReportEventLogsResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseReportEventLogsResponse } as ReportEventLogsResponse;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
export const AgentServiceService = {
    ...
    reportEventLogs: {
        ...
        responseDeserialize: (value: Buffer) => ReportEventLogsResponse.decode(value),
    },
} as const;
...
export interface AgentServiceServer extends UntypedServiceImplementation {
    ...
    reportEventLogs: handleUnaryCall<ReportEventLogsRequest, ReportEventLogsResponse>;
}
...
export interface AgentServiceClient extends Client {
    ...
    reportEventLogs(
        ...
        callback: (error: ServiceError | null, response: ReportEventLogsResponse) => void,
    ): ClientUnaryCall;
    reportEventLogs(
        request: ReportEventLogsRequest,
        metadata: Metadata,
