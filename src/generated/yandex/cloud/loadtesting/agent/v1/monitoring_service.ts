...
export const AddMetricRequest = {
    ...
    fromJSON(object: any): AddMetricRequest {
        ...
        message.chunks = (object.chunks ?? []).map((e: any) => MetricChunk.fromJSON(e));
    ...
    toJSON(message: AddMetricRequest): unknown {
        ...
        if (message.chunks) {
            obj.chunks = message.chunks.map((e) => (e ? MetricChunk.toJSON(e) : undefined));
        } else {
            obj.chunks = [];
        }
...
export const MetricChunk = {
    ...
    toJSON(message: MetricChunk): unknown {
        ...
        message.instanceHost !== undefined && (obj.instanceHost = message.instanceHost);
        return obj;
    },
...
export const AddMetricResponse = {
    ...
    toJSON(message: AddMetricResponse): unknown {
        const obj: any = {};
        message.metricTrailId !== undefined && (obj.metricTrailId = message.metricTrailId);
