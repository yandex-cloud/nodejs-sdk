...
export const Job = {
    ...
    fromJSON(object: any): Job {
        ...
        message.loggingLogGroupId =
            object.loggingLogGroupId !== undefined && object.loggingLogGroupId !== null
        ...
        message.testData =
            object.testData !== undefined && object.testData !== null
                ...
                : undefined;
        message.dataPayload = (object.dataPayload ?? []).map((e: any) => TestDataEntry.fromJSON(e));
        message.artifactUploadSettings =
    ...
    toJSON(message: Job): unknown {
        ...
        message.testData !== undefined &&
            (obj.testData = message.testData ? StorageObject.toJSON(message.testData) : undefined);
...
export const StorageObject = {
    ...
    fromJSON(object: any): StorageObject {
        ...
        message.objectStorageFilename =
            object.objectStorageFilename !== undefined && object.objectStorageFilename !== null
...
export const TestArtifactUploadSettings = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): TestArtifactUploadSettings {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseTestArtifactUploadSettings } as TestArtifactUploadSettings;
    ...
    toJSON(message: TestArtifactUploadSettings): unknown {
        const obj: any = {};
        message.outputBucket !== undefined && (obj.outputBucket = message.outputBucket);
...
export const JobSignalResponse = {
    ...
    fromJSON(object: any): JobSignalResponse {
        ...
        message.waitDuration =
            object.waitDuration !== undefined && object.waitDuration !== null
                ...
                : 0;
        message.runIn =
            object.runIn !== undefined && object.runIn !== null ? Number(object.runIn) : 0;
        return message;
    },
    ...
    toJSON(message: JobSignalResponse): unknown {
        ...
        message.waitDuration !== undefined && (obj.waitDuration = message.waitDuration);
