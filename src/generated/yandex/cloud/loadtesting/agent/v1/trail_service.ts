...
export const Trail = {
    ...
    fromJSON(object: any): Trail {
        const message = { ...baseTrail } as Trail;
        message.overall =
            object.overall !== undefined && object.overall !== null ? Number(object.overall) : 0;
        message.caseId =
            object.caseId !== undefined && object.caseId !== null ? String(object.caseId) : '';
        message.time = object.time !== undefined && object.time !== null ? String(object.time) : '';
        message.reqps =
            object.reqps !== undefined && object.reqps !== null ? Number(object.reqps) : 0;
        message.resps =
            object.resps !== undefined && object.resps !== null ? Number(object.resps) : 0;
        message.expect =
            object.expect !== undefined && object.expect !== null ? Number(object.expect) : 0;
        message.input =
            object.input !== undefined && object.input !== null ? Number(object.input) : 0;
        message.output =
            object.output !== undefined && object.output !== null ? Number(object.output) : 0;
        message.connectTime =
            object.connectTime !== undefined && object.connectTime !== null
                ? Number(object.connectTime)
                : 0;
        message.sendTime =
            object.sendTime !== undefined && object.sendTime !== null ? Number(object.sendTime) : 0;
        message.latency =
            object.latency !== undefined && object.latency !== null ? Number(object.latency) : 0;
        message.receiveTime =
            object.receiveTime !== undefined && object.receiveTime !== null
                ? Number(object.receiveTime)
                : 0;
        message.threads =
            object.threads !== undefined && object.threads !== null ? Number(object.threads) : 0;
        message.q50 = object.q50 !== undefined && object.q50 !== null ? Number(object.q50) : 0;
        message.q75 = object.q75 !== undefined && object.q75 !== null ? Number(object.q75) : 0;
        message.q80 = object.q80 !== undefined && object.q80 !== null ? Number(object.q80) : 0;
        message.q85 = object.q85 !== undefined && object.q85 !== null ? Number(object.q85) : 0;
        message.q90 = object.q90 !== undefined && object.q90 !== null ? Number(object.q90) : 0;
        message.q95 = object.q95 !== undefined && object.q95 !== null ? Number(object.q95) : 0;
        message.q98 = object.q98 !== undefined && object.q98 !== null ? Number(object.q98) : 0;
        message.q99 = object.q99 !== undefined && object.q99 !== null ? Number(object.q99) : 0;
        message.q100 = object.q100 !== undefined && object.q100 !== null ? Number(object.q100) : 0;
        message.httpCodes = (object.httpCodes ?? []).map((e: any) => Trail_Codes.fromJSON(e));
        message.netCodes = (object.netCodes ?? []).map((e: any) => Trail_Codes.fromJSON(e));
    ...
    toJSON(message: Trail): unknown {
        const obj: any = {};
        message.overall !== undefined && (obj.overall = Math.round(message.overall));
        ...
        message.connectTime !== undefined && (obj.connectTime = message.connectTime);
        message.sendTime !== undefined && (obj.sendTime = message.sendTime);
        message.latency !== undefined && (obj.latency = message.latency);
        message.receiveTime !== undefined && (obj.receiveTime = message.receiveTime);
        ...
        if (message.httpCodes) {
            obj.httpCodes = message.httpCodes.map((e) => (e ? Trail_Codes.toJSON(e) : undefined));
        } else {
            obj.httpCodes = [];
        }
        if (message.netCodes) {
            obj.netCodes = message.netCodes.map((e) => (e ? Trail_Codes.toJSON(e) : undefined));
        } else {
            obj.netCodes = [];
        }
...
export const CreateTrailResponse = {
    ...
    fromJSON(object: any): CreateTrailResponse {
        const message = { ...baseCreateTrailResponse } as CreateTrailResponse;
        message.trailId =
            object.trailId !== undefined && object.trailId !== null ? String(object.trailId) : '';
        message.code = object.code !== undefined && object.code !== null ? Number(object.code) : 0;
        return message;
    },
