  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      CreateAgentRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.loadtesting.api.v1.CreateAgentRequest.LabelsEntry",
          key: key as any,
          value,
        },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break;
        case 6:
          const entry6 = CreateAgentRequest_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
...
export const CreateAgentRequest_LabelsEntry = {
  $type:
    "yandex.cloud.loadtesting.api.v1.CreateAgentRequest.LabelsEntry" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCreateAgentRequest_LabelsEntry,
    } as CreateAgentRequest_LabelsEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  CreateAgentRequest_LabelsEntry.$type,
  CreateAgentRequest_LabelsEntry
);
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      UpdateAgentRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.loadtesting.api.v1.UpdateAgentRequest.LabelsEntry",
          key: key as any,
          value,
        },
        writer.uint32(50).fork()
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break;
        case 6:
          const entry6 = UpdateAgentRequest_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
          if (entry6.value !== undefined) {
...
export const UpdateAgentRequest_LabelsEntry = {
  $type:
    "yandex.cloud.loadtesting.api.v1.UpdateAgentRequest.LabelsEntry" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpdateAgentRequest_LabelsEntry,
    } as UpdateAgentRequest_LabelsEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  UpdateAgentRequest_LabelsEntry.$type,
  UpdateAgentRequest_LabelsEntry
);
