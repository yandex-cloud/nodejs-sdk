...
export const Dashboard = {
  ...
  fromPartial<I extends Exact<DeepPartial<Dashboard>, I>>(
    object: I
  ): Dashboard {
    const message = { ...baseDashboard } as Dashboard;
...
export const Dashboard_Content = {
  $type:
    "yandex.cloud.loadtesting.api.v1.regression.Dashboard.Content" as const,

  encode(
    message: Dashboard_Content,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
  ...
  fromPartial<I extends Exact<DeepPartial<Dashboard_Content>, I>>(
    object: I
  ): Dashboard_Content {
    const message = { ...baseDashboard_Content } as Dashboard_Content;
