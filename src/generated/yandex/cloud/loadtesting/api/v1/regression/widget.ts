...
export function titleWidget_TitleSizeFromJSON(
  object: any
): TitleWidget_TitleSize {
  switch (object) {
    case 0:
...
export function titleWidget_TitleSizeToJSON(
  object: TitleWidget_TitleSize
): string {
  switch (object) {
...
export const Widget = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Widget {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.position = Widget_LayoutPosition.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  toJSON(message: Widget): unknown {
    ...
    message.title !== undefined &&
      (obj.title = message.title
        ? TitleWidget.toJSON(message.title)
        : undefined);
    return obj;
  },
...
export const Widget_LayoutPosition = {
  $type:
    "yandex.cloud.loadtesting.api.v1.regression.Widget.LayoutPosition" as const,

  encode(
    message: Widget_LayoutPosition,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.x !== 0) {
...
export const TextWidget = {
  ...
  fromPartial<I extends Exact<DeepPartial<TextWidget>, I>>(
    object: I
  ): TextWidget {
    const message = { ...baseTextWidget } as TextWidget;
...
export const TitleWidget = {
  ...
  fromPartial<I extends Exact<DeepPartial<TitleWidget>, I>>(
    object: I
  ): TitleWidget {
    const message = { ...baseTitleWidget } as TitleWidget;
    message.text = object.text ?? "";
