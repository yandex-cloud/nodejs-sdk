...
export const CreateTestRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<CreateTestRequest>, I>>(
    ...
    message.configurations =
      object.configurations?.map((e) =>
        SingleAgentConfiguration.fromPartial(e)
      ) || [];
    message.testDetails =
      object.testDetails !== undefined && object.testDetails !== null
...
export const StopTestRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<StopTestRequest>, I>>(
    object: I
  ): StopTestRequest {
    const message = { ...baseStopTestRequest } as StopTestRequest;
    message.testId = object.testId ?? "";
...
export const StopTestMetadata = {
  ...
  fromPartial<I extends Exact<DeepPartial<StopTestMetadata>, I>>(
    object: I
  ): StopTestMetadata {
    const message = { ...baseStopTestMetadata } as StopTestMetadata;
    message.testId = object.testId ?? "";
...
export const DeleteTestRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<DeleteTestRequest>, I>>(
    object: I
  ): DeleteTestRequest {
    const message = { ...baseDeleteTestRequest } as DeleteTestRequest;
    message.testId = object.testId ?? "";
...
export const ListTestsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListTestsRequest>, I>>(
    object: I
  ): ListTestsRequest {
    const message = { ...baseListTestsRequest } as ListTestsRequest;
    message.folderId = object.folderId ?? "";
...
export const ListTestsResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListTestsResponse>, I>>(
    object: I
  ): ListTestsResponse {
    const message = { ...baseListTestsResponse } as ListTestsResponse;
