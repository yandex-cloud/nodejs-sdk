...
export const Report = {
  ...
  encode(
    ...
    Object.entries(message.httpCodes).forEach(([key, value]) => {
      Report_HttpCodesEntry.encode(
        {
          $type:
            "yandex.cloud.loadtesting.api.v1.report.table.Report.HttpCodesEntry",
          key: key as any,
          value,
        },
    ...
    Object.entries(message.netCodes).forEach(([key, value]) => {
      Report_NetCodesEntry.encode(
        {
          $type:
            "yandex.cloud.loadtesting.api.v1.report.table.Report.NetCodesEntry",
          key: key as any,
          value,
        },
  ...
  fromJSON(object: any): Report {
    ...
    message.netCodes = Object.entries(object.netCodes ?? {}).reduce<{
      [key: number]: number;
    }>((acc, [key, value]) => {
      acc[Number(key)] = Number(value);
      return acc;
...
export const Report_HttpCodesEntry = {
  $type:
    "yandex.cloud.loadtesting.api.v1.report.table.Report.HttpCodesEntry" as const,

  encode(
    message: Report_HttpCodesEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== 0) {
...
export const Report_NetCodesEntry = {
  $type:
    "yandex.cloud.loadtesting.api.v1.report.table.Report.NetCodesEntry" as const,

  encode(
    message: Report_NetCodesEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== 0) {
      writer.uint32(8).int64(message.key);
