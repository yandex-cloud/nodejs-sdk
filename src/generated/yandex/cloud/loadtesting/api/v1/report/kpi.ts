  ...
  toJSON(message: Kpi): unknown {
    ...
    message.selector !== undefined &&
      (obj.selector = message.selector
        ? KpiSelector.toJSON(message.selector)
        : undefined);
...
export const KpiThreshold = {
  ...
  toJSON(message: KpiThreshold): unknown {
    ...
    message.comparison !== undefined &&
      (obj.comparison = comparisonToJSON(message.comparison));
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<KpiThreshold>, I>>(
    object: I
  ): KpiThreshold {
    const message = { ...baseKpiThreshold } as KpiThreshold;
...
export const KpiSelector = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): KpiSelector {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.responseTime = KpiSelector_ResponseTime.decode(
            reader,
            reader.uint32()
          );
          break;
        case 2:
          message.instances = KpiSelector_Instances.decode(
            reader,
            reader.uint32()
          );
          break;
        case 3:
          message.imbalanceRps = KpiSelector_ImbalanceRps.decode(
            reader,
            reader.uint32()
          );
          break;
        case 4:
          message.protocolCodesAbsolute =
            KpiSelector_ProtocolCodesAbsolute.decode(reader, reader.uint32());
          break;
        case 5:
          message.protocolCodesRelative =
            KpiSelector_ProtocolCodesRelative.decode(reader, reader.uint32());
          break;
        case 6:
          message.networkCodesAbsolute =
            KpiSelector_NetworkCodesAbsolute.decode(reader, reader.uint32());
          break;
        case 7:
          message.networkCodesRelative =
            KpiSelector_NetworkCodesRelative.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): KpiSelector {
    ...
    message.imbalanceRps =
      object.imbalanceRps !== undefined && object.imbalanceRps !== null
        ...
        : undefined;
    message.protocolCodesAbsolute =
      object.protocolCodesAbsolute !== undefined &&
      object.protocolCodesAbsolute !== null
        ? KpiSelector_ProtocolCodesAbsolute.fromJSON(
            object.protocolCodesAbsolute
          )
        : undefined;
    message.protocolCodesRelative =
      object.protocolCodesRelative !== undefined &&
      object.protocolCodesRelative !== null
        ? KpiSelector_ProtocolCodesRelative.fromJSON(
            object.protocolCodesRelative
          )
        : undefined;
    message.networkCodesAbsolute =
      object.networkCodesAbsolute !== undefined &&
      object.networkCodesAbsolute !== null
        ? KpiSelector_NetworkCodesAbsolute.fromJSON(object.networkCodesAbsolute)
        : undefined;
    message.networkCodesRelative =
      object.networkCodesRelative !== undefined &&
      object.networkCodesRelative !== null
  ...
  fromPartial<I extends Exact<DeepPartial<KpiSelector>, I>>(
    object: I
  ): KpiSelector {
    const message = { ...baseKpiSelector } as KpiSelector;
    message.responseTime =
    ...
    message.protocolCodesAbsolute =
      object.protocolCodesAbsolute !== undefined &&
      object.protocolCodesAbsolute !== null
        ? KpiSelector_ProtocolCodesAbsolute.fromPartial(
            object.protocolCodesAbsolute
          )
        : undefined;
    message.protocolCodesRelative =
      object.protocolCodesRelative !== undefined &&
      object.protocolCodesRelative !== null
        ? KpiSelector_ProtocolCodesRelative.fromPartial(
            object.protocolCodesRelative
          )
        : undefined;
    message.networkCodesAbsolute =
      object.networkCodesAbsolute !== undefined &&
      object.networkCodesAbsolute !== null
        ? KpiSelector_NetworkCodesAbsolute.fromPartial(
            object.networkCodesAbsolute
          )
        : undefined;
    message.networkCodesRelative =
      object.networkCodesRelative !== undefined &&
      object.networkCodesRelative !== null
        ? KpiSelector_NetworkCodesRelative.fromPartial(
            object.networkCodesRelative
          )
        : undefined;
    return message;
  },
...
export const KpiSelector_ResponseTime = {
  $type:
    "yandex.cloud.loadtesting.api.v1.report.KpiSelector.ResponseTime" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseKpiSelector_ResponseTime,
    } as KpiSelector_ResponseTime;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: KpiSelector_ResponseTime): unknown {
    const obj: any = {};
    message.quantile !== undefined &&
      (obj.quantile = quantileTypeToJSON(message.quantile));
    return obj;
  },
...
export const KpiSelector_Instances = {
  $type:
    "yandex.cloud.loadtesting.api.v1.report.KpiSelector.Instances" as const,

  encode(
    message: KpiSelector_Instances,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.agg !== 0) {
  ...
  fromJSON(object: any): KpiSelector_Instances {
    const message = { ...baseKpiSelector_Instances } as KpiSelector_Instances;
    message.agg =
      object.agg !== undefined && object.agg !== null
        ? aggregationFromJSON(object.agg)
        : 0;
    return message;
  },
...
export const KpiSelector_ImbalanceRps = {
  $type:
    "yandex.cloud.loadtesting.api.v1.report.KpiSelector.ImbalanceRps" as const,

  encode(
    _: KpiSelector_ImbalanceRps,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    return writer;
  },
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseKpiSelector_ImbalanceRps,
    } as KpiSelector_ImbalanceRps;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
...
messageTypeRegistry.set(
  KpiSelector_ImbalanceRps.$type,
  KpiSelector_ImbalanceRps
);

const baseKpiSelector_ProtocolCodesAbsolute: object = {
  $type:
    "yandex.cloud.loadtesting.api.v1.report.KpiSelector.ProtocolCodesAbsolute",
  codesPatterns: "",
};

export const KpiSelector_ProtocolCodesAbsolute = {
  $type:
    "yandex.cloud.loadtesting.api.v1.report.KpiSelector.ProtocolCodesAbsolute" as const,
  ...
  fromJSON(object: any): KpiSelector_ProtocolCodesAbsolute {
    ...
    message.codesPatterns = (object.codesPatterns ?? []).map((e: any) =>
      String(e)
    );
    return message;
  },
  ...
  fromPartial<
    I extends Exact<DeepPartial<KpiSelector_ProtocolCodesAbsolute>, I>
  >(object: I): KpiSelector_ProtocolCodesAbsolute {
    const message = {
      ...baseKpiSelector_ProtocolCodesAbsolute,
    } as KpiSelector_ProtocolCodesAbsolute;
...
messageTypeRegistry.set(
  KpiSelector_ProtocolCodesAbsolute.$type,
  KpiSelector_ProtocolCodesAbsolute
);

const baseKpiSelector_ProtocolCodesRelative: object = {
  $type:
    "yandex.cloud.loadtesting.api.v1.report.KpiSelector.ProtocolCodesRelative",
  codesPatterns: "",
};

export const KpiSelector_ProtocolCodesRelative = {
  $type:
    "yandex.cloud.loadtesting.api.v1.report.KpiSelector.ProtocolCodesRelative" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<KpiSelector_ProtocolCodesRelative>, I>
  >(object: I): KpiSelector_ProtocolCodesRelative {
    const message = {
      ...baseKpiSelector_ProtocolCodesRelative,
    } as KpiSelector_ProtocolCodesRelative;
    message.codesPatterns = object.codesPatterns?.map((e) => e) || [];
...
messageTypeRegistry.set(
  KpiSelector_ProtocolCodesRelative.$type,
  KpiSelector_ProtocolCodesRelative
);

const baseKpiSelector_NetworkCodesAbsolute: object = {
  $type:
    "yandex.cloud.loadtesting.api.v1.report.KpiSelector.NetworkCodesAbsolute",
  codesPatterns: "",
};

export const KpiSelector_NetworkCodesAbsolute = {
  $type:
    "yandex.cloud.loadtesting.api.v1.report.KpiSelector.NetworkCodesAbsolute" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<KpiSelector_NetworkCodesAbsolute>, I>
  >(object: I): KpiSelector_NetworkCodesAbsolute {
    const message = {
      ...baseKpiSelector_NetworkCodesAbsolute,
    } as KpiSelector_NetworkCodesAbsolute;
    message.codesPatterns = object.codesPatterns?.map((e) => e) || [];
...
messageTypeRegistry.set(
  KpiSelector_NetworkCodesAbsolute.$type,
  KpiSelector_NetworkCodesAbsolute
);

const baseKpiSelector_NetworkCodesRelative: object = {
  $type:
    "yandex.cloud.loadtesting.api.v1.report.KpiSelector.NetworkCodesRelative",
  codesPatterns: "",
};

export const KpiSelector_NetworkCodesRelative = {
  $type:
    "yandex.cloud.loadtesting.api.v1.report.KpiSelector.NetworkCodesRelative" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<KpiSelector_NetworkCodesRelative>, I>
  >(object: I): KpiSelector_NetworkCodesRelative {
    const message = {
      ...baseKpiSelector_NetworkCodesRelative,
    } as KpiSelector_NetworkCodesRelative;
    message.codesPatterns = object.codesPatterns?.map((e) => e) || [];
...
messageTypeRegistry.set(
  KpiSelector_NetworkCodesRelative.$type,
  KpiSelector_NetworkCodesRelative
);
