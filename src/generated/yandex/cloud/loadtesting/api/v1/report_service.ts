  ...
  encode(
    ...
    Object.entries(message.cases).forEach(([key, value]) => {
      GetTableReportResponse_CasesEntry.encode(
        {
          $type:
            "yandex.cloud.loadtesting.api.v1.GetTableReportResponse.CasesEntry",
          key: key as any,
          value,
        },
  ...
  fromJSON(object: any): GetTableReportResponse {
    ...
    message.overall =
      object.overall !== undefined && object.overall !== null
        ...
        : undefined;
    message.cases = Object.entries(object.cases ?? {}).reduce<{
      [key: string]: Report;
    }>((acc, [key, value]) => {
...
export const GetTableReportResponse_CasesEntry = {
  $type:
    "yandex.cloud.loadtesting.api.v1.GetTableReportResponse.CasesEntry" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<GetTableReportResponse_CasesEntry>, I>
  >(object: I): GetTableReportResponse_CasesEntry {
    const message = {
      ...baseGetTableReportResponse_CasesEntry,
    } as GetTableReportResponse_CasesEntry;
...
messageTypeRegistry.set(
  GetTableReportResponse_CasesEntry.$type,
  GetTableReportResponse_CasesEntry
);
...
export const CalculateReportKpiValuesRequest = {
  $type:
    "yandex.cloud.loadtesting.api.v1.CalculateReportKpiValuesRequest" as const,
...
messageTypeRegistry.set(
  CalculateReportKpiValuesRequest.$type,
  CalculateReportKpiValuesRequest
);
...
export const CalculateReportKpiValuesResponse = {
  $type:
    "yandex.cloud.loadtesting.api.v1.CalculateReportKpiValuesResponse" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<CalculateReportKpiValuesResponse>, I>
  >(object: I): CalculateReportKpiValuesResponse {
    const message = {
      ...baseCalculateReportKpiValuesResponse,
    } as CalculateReportKpiValuesResponse;
    message.folderId = object.folderId ?? "";
...
messageTypeRegistry.set(
  CalculateReportKpiValuesResponse.$type,
  CalculateReportKpiValuesResponse
);
...
export const ReportServiceService = {
  ...
  getTable: {
    ...
    responseDeserialize: (value: Buffer) =>
      GetTableReportResponse.decode(value),
  },
...
export interface ReportServiceClient extends Client {
  ...
  getTable(
    ...
    callback: (
      ...
      response: GetTableReportResponse
    ) => void
  ): ClientUnaryCall;
  getTable(
    request: GetTableReportRequest,
  ...
  calculateKpiValues(
    ...
    callback: (
      error: ServiceError | null,
      response: CalculateReportKpiValuesResponse
    ) => void
  ): ClientUnaryCall;
  calculateKpiValues(
    request: CalculateReportKpiValuesRequest,
