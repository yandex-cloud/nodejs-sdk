...
export const SingleAgentConfiguration = {
  $type:
    "yandex.cloud.loadtesting.api.v1.test.SingleAgentConfiguration" as const,
  ...
  encode(
    ...
    Object.entries(message.files).forEach(([key, value]) => {
      SingleAgentConfiguration_FilesEntry.encode(
        {
          $type:
            "yandex.cloud.loadtesting.api.v1.test.SingleAgentConfiguration.FilesEntry",
          key: key as any,
          value,
        },
  ...
  decode(
    ...
    const message = {
      ...baseSingleAgentConfiguration,
    } as SingleAgentConfiguration;
    message.files = {};
...
export const SingleAgentConfiguration_FilesEntry = {
  $type:
    "yandex.cloud.loadtesting.api.v1.test.SingleAgentConfiguration.FilesEntry" as const,
  ...
  toJSON(message: SingleAgentConfiguration_FilesEntry): unknown {
    ...
    message.value !== undefined &&
      (obj.value = message.value
        ? FilePointer.toJSON(message.value)
        : undefined);
    return obj;
  },

  fromPartial<
    I extends Exact<DeepPartial<SingleAgentConfiguration_FilesEntry>, I>
  >(object: I): SingleAgentConfiguration_FilesEntry {
    const message = {
      ...baseSingleAgentConfiguration_FilesEntry,
    } as SingleAgentConfiguration_FilesEntry;
