...
export const AgentSelector = {
  ...
  toJSON(message: AgentSelector): unknown {
    ...
    message.matchByFilter !== undefined &&
      (obj.matchByFilter = message.matchByFilter);
    message.anonymousAgent !== undefined &&
      (obj.anonymousAgent = message.anonymousAgent);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<AgentSelector>, I>>(
    object: I
  ): AgentSelector {
    const message = { ...baseAgentSelector } as AgentSelector;
