...
export function securityProfile_DefaultActionFromJSON(
  object: any
...
export function securityProfile_DefaultActionToJSON(
  object: SecurityProfile_DefaultAction
): string {
  switch (object) {
...
export function securityRule_Waf_ModeFromJSON(
  object: any
): SecurityRule_Waf_Mode {
  switch (object) {
    case 0:
    case "MODE_UNSPECIFIED":
...
export function securityRule_Waf_ModeToJSON(
  object: SecurityRule_Waf_Mode
): string {
  switch (object) {
...
export const SecurityProfile = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          const entry3 = SecurityProfile_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
        ...
        case 6:
          ...
          break;
        case 7:
          message.securityRules.push(
            SecurityRule.decode(reader, reader.uint32())
          );
          break;
        case 8:
  ...
  toJSON(message: SecurityProfile): unknown {
    ...
    message.defaultAction !== undefined &&
      (obj.defaultAction = securityProfile_DefaultActionToJSON(
        message.defaultAction
      ));
  ...
  fromPartial<I extends Exact<DeepPartial<SecurityProfile>, I>>(
    object: I
  ): SecurityProfile {
    const message = { ...baseSecurityProfile } as SecurityProfile;
    ...
    message.securityRules =
      object.securityRules?.map((e) => SecurityRule.fromPartial(e)) || [];
...
export const SecurityProfile_LabelsEntry = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.SecurityProfile.LabelsEntry" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseSecurityProfile_LabelsEntry,
    } as SecurityProfile_LabelsEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  SecurityProfile_LabelsEntry.$type,
  SecurityProfile_LabelsEntry
);
...
export const SecurityRule = {
  ...
  fromJSON(object: any): SecurityRule {
    ...
    message.priority =
      object.priority !== undefined && object.priority !== null
        ...
        : 0;
    message.dryRun =
      object.dryRun !== undefined && object.dryRun !== null
        ? Boolean(object.dryRun)
        : false;
    message.ruleCondition =
  ...
  toJSON(message: SecurityRule): unknown {
    ...
    message.waf !== undefined &&
      (obj.waf = message.waf
        ? SecurityRule_Waf.toJSON(message.waf)
        : undefined);
    message.description !== undefined &&
      (obj.description = message.description);
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<SecurityRule>, I>>(
    object: I
  ): SecurityRule {
    const message = { ...baseSecurityRule } as SecurityRule;
    message.name = object.name ?? "";
...
export const SecurityRule_RuleCondition = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseSecurityRule_RuleCondition,
    } as SecurityRule_RuleCondition;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  SecurityRule_RuleCondition.$type,
  SecurityRule_RuleCondition
);
...
export const SecurityRule_SmartProtection = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.SecurityRule.SmartProtection" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseSecurityRule_SmartProtection,
    } as SecurityRule_SmartProtection;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  SecurityRule_SmartProtection.$type,
  SecurityRule_SmartProtection
);
...
export const SecurityRule_Waf = {
  ...
  toJSON(message: SecurityRule_Waf): unknown {
    const obj: any = {};
    message.mode !== undefined &&
      (obj.mode = securityRule_Waf_ModeToJSON(message.mode));
    message.condition !== undefined &&
      (obj.condition = message.condition
        ? Condition.toJSON(message.condition)
        : undefined);
    message.wafProfileId !== undefined &&
      (obj.wafProfileId = message.wafProfileId);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<SecurityRule_Waf>, I>>(
    object: I
  ): SecurityRule_Waf {
    const message = { ...baseSecurityRule_Waf } as SecurityRule_Waf;
    message.mode = object.mode ?? 0;
...
export const Condition = {
  ...
  encode(
    ...
    if (message.authority !== undefined) {
      Condition_AuthorityMatcher.encode(
        message.authority,
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Condition {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.authority = Condition_AuthorityMatcher.decode(
            reader,
            reader.uint32()
          );
          break;
        ...
        case 4:
          message.headers.push(
            Condition_HeaderMatcher.decode(reader, reader.uint32())
          );
          break;
        case 5:
          message.sourceIp = Condition_IpMatcher.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromPartial<I extends Exact<DeepPartial<Condition>, I>>(
    ...
    message.requestUri =
      object.requestUri !== undefined && object.requestUri !== null
        ...
        : undefined;
    message.headers =
      object.headers?.map((e) => Condition_HeaderMatcher.fromPartial(e)) || [];
    message.sourceIp =
      object.sourceIp !== undefined && object.sourceIp !== null
...
export const Condition_StringMatcher = {
  ...
  encode(
    message: Condition_StringMatcher,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCondition_StringMatcher,
    } as Condition_StringMatcher;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): Condition_StringMatcher {
    ...
    message.pireRegexNotMatch =
      object.pireRegexNotMatch !== undefined &&
      object.pireRegexNotMatch !== null
  ...
  toJSON(message: Condition_StringMatcher): unknown {
    ...
    message.exactNotMatch !== undefined &&
      (obj.exactNotMatch = message.exactNotMatch);
    message.prefixMatch !== undefined &&
      (obj.prefixMatch = message.prefixMatch);
    message.prefixNotMatch !== undefined &&
      (obj.prefixNotMatch = message.prefixNotMatch);
    message.pireRegexMatch !== undefined &&
      (obj.pireRegexMatch = message.pireRegexMatch);
...
export const Condition_HttpMethodMatcher = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.Condition.HttpMethodMatcher" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCondition_HttpMethodMatcher,
    } as Condition_HttpMethodMatcher;
    message.httpMethods = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
messageTypeRegistry.set(
  Condition_HttpMethodMatcher.$type,
  Condition_HttpMethodMatcher
);
...
export const Condition_AuthorityMatcher = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCondition_AuthorityMatcher,
    } as Condition_AuthorityMatcher;
    message.authorities = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
messageTypeRegistry.set(
  Condition_AuthorityMatcher.$type,
  Condition_AuthorityMatcher
);
...
export const Condition_RequestUriMatcher = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.Condition.RequestUriMatcher" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCondition_RequestUriMatcher,
    } as Condition_RequestUriMatcher;
    message.queries = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.path = Condition_StringMatcher.decode(
            reader,
            reader.uint32()
          );
          break;
        case 2:
          message.queries.push(
            Condition_QueryMatcher.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  toJSON(message: Condition_RequestUriMatcher): unknown {
    ...
    message.path !== undefined &&
      (obj.path = message.path
        ? Condition_StringMatcher.toJSON(message.path)
        : undefined);
    if (message.queries) {
  ...
  fromPartial<I extends Exact<DeepPartial<Condition_RequestUriMatcher>, I>>(
    ...
    message.path =
      object.path !== undefined && object.path !== null
        ...
        : undefined;
    message.queries =
      object.queries?.map((e) => Condition_QueryMatcher.fromPartial(e)) || [];
    return message;
  },
};

messageTypeRegistry.set(
  Condition_RequestUriMatcher.$type,
  Condition_RequestUriMatcher
);
...
export const Condition_QueryMatcher = {
  ...
  encode(
    message: Condition_QueryMatcher,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.value = Condition_StringMatcher.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  toJSON(message: Condition_QueryMatcher): unknown {
    ...
    message.value !== undefined &&
      (obj.value = message.value
        ? Condition_StringMatcher.toJSON(message.value)
        : undefined);
    return obj;
  },
...
export const Condition_HeaderMatcher = {
  ...
  encode(
    message: Condition_HeaderMatcher,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCondition_HeaderMatcher,
    } as Condition_HeaderMatcher;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.geoIpMatch = Condition_GeoIpMatcher.decode(
            reader,
            reader.uint32()
          );
          break;
        case 4:
          message.geoIpNotMatch = Condition_GeoIpMatcher.decode(
            reader,
            reader.uint32()
          );
          break;
...
export const Condition_IpRangesMatcher = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCondition_IpRangesMatcher,
    } as Condition_IpRangesMatcher;
    message.ipRanges = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
messageTypeRegistry.set(
  Condition_IpRangesMatcher.$type,
  Condition_IpRangesMatcher
);
...
export const Condition_GeoIpMatcher = {
  ...
  encode(
    message: Condition_GeoIpMatcher,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
