...
export const GetRuleSetDescriptorRequest = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.waf.GetRuleSetDescriptorRequest" as const,
  ...
  decode(
    ...
    const message = {
      ...baseGetRuleSetDescriptorRequest,
    } as GetRuleSetDescriptorRequest;
...
messageTypeRegistry.set(
  GetRuleSetDescriptorRequest.$type,
  GetRuleSetDescriptorRequest
);
...
export const RuleSetDescriptorServiceService = {
  ...
  get: {
    ...
    requestDeserialize: (value: Buffer) =>
      GetRuleSetDescriptorRequest.decode(value),
...
export interface RuleSetDescriptorServiceServer
