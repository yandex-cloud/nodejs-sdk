...
export const WafProfile = {
  ...
  fromPartial<I extends Exact<DeepPartial<WafProfile>, I>>(
    object: I
  ): WafProfile {
    const message = { ...baseWafProfile } as WafProfile;
...
export const WafProfile_LabelsEntry = {
  ...
  encode(
    message: WafProfile_LabelsEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== "") {
...
export const WafProfile_CoreRuleSet = {
  ...
  encode(
    message: WafProfile_CoreRuleSet,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
  ...
  fromJSON(object: any): WafProfile_CoreRuleSet {
    ...
    message.inboundAnomalyScore =
      object.inboundAnomalyScore !== undefined &&
      object.inboundAnomalyScore !== null
  ...
  toJSON(message: WafProfile_CoreRuleSet): unknown {
    ...
    message.ruleSet !== undefined &&
      (obj.ruleSet = message.ruleSet
        ? RuleSet.toJSON(message.ruleSet)
        : undefined);
    return obj;
  },
...
export const WafProfile_AnalyzeRequestBody = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.waf.WafProfile.AnalyzeRequestBody" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseWafProfile_AnalyzeRequestBody,
    } as WafProfile_AnalyzeRequestBody;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  WafProfile_AnalyzeRequestBody.$type,
  WafProfile_AnalyzeRequestBody
);
...
export const WafProfileRule = {
  ...
  fromPartial<I extends Exact<DeepPartial<WafProfileRule>, I>>(
    object: I
  ): WafProfileRule {
    const message = { ...baseWafProfileRule } as WafProfileRule;
...
export const WafProfileExclusionRule = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.waf.WafProfileExclusionRule" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseWafProfileExclusionRule,
    } as WafProfileExclusionRule;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: WafProfileExclusionRule): unknown {
    ...
    message.excludeRules !== undefined &&
      (obj.excludeRules = message.excludeRules
        ...
        : undefined);
    message.logExcluded !== undefined &&
      (obj.logExcluded = message.logExcluded);
    return obj;
  },
...
const baseWafProfileExclusionRule_ExcludeRules: object = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.waf.WafProfileExclusionRule.ExcludeRules",
  excludeAll: false,
  ruleIds: "",
};
...
export const WafProfileExclusionRule_ExcludeRules = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.waf.WafProfileExclusionRule.ExcludeRules" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<WafProfileExclusionRule_ExcludeRules>, I>
  >(object: I): WafProfileExclusionRule_ExcludeRules {
    const message = {
      ...baseWafProfileExclusionRule_ExcludeRules,
    } as WafProfileExclusionRule_ExcludeRules;
