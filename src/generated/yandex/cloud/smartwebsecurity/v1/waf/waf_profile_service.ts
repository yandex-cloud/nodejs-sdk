...
export const ListWafProfilesResponse = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.waf.ListWafProfilesResponse" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListWafProfilesResponse,
    } as ListWafProfilesResponse;
    message.wafProfiles = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromJSON(object: any): ListWafProfilesResponse {
    ...
    message.wafProfiles = (object.wafProfiles ?? []).map((e: any) =>
      WafProfile.fromJSON(e)
    );
    return message;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ListWafProfilesResponse>, I>>(
    ...
    message.wafProfiles =
      object.wafProfiles?.map((e) => WafProfile.fromPartial(e)) || [];
    return message;
  },
};
...
export const CreateWafProfileRequest = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.waf.CreateWafProfileRequest" as const,
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      CreateWafProfileRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.smartwebsecurity.v1.waf.CreateWafProfileRequest.LabelsEntry",
          key: key as any,
          value,
        },
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCreateWafProfileRequest,
    } as CreateWafProfileRequest;
    message.labels = {};
    message.rules = [];
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          break;
        case 7:
          message.coreRuleSet = WafProfile_CoreRuleSet.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): CreateWafProfileRequest {
    ...
    message.coreRuleSet =
      object.coreRuleSet !== undefined && object.coreRuleSet !== null
        ...
        : undefined;
    message.analyzeRequestBody =
      object.analyzeRequestBody !== undefined &&
      object.analyzeRequestBody !== null
  ...
  toJSON(message: CreateWafProfileRequest): unknown {
    ...
    if (message.rules) {
      obj.rules = message.rules.map((e) =>
        e ? WafProfileRule.toJSON(e) : undefined
      );
    } else {
      obj.rules = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<CreateWafProfileRequest>, I>>(
    ...
    message.rules =
      object.rules?.map((e) => WafProfileRule.fromPartial(e)) || [];
    message.exclusionRules =
      object.exclusionRules?.map((e) =>
        WafProfileExclusionRule.fromPartial(e)
      ) || [];
    message.coreRuleSet =
      object.coreRuleSet !== undefined && object.coreRuleSet !== null
...
export const CreateWafProfileRequest_LabelsEntry = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.waf.CreateWafProfileRequest.LabelsEntry" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<CreateWafProfileRequest_LabelsEntry>, I>
  >(object: I): CreateWafProfileRequest_LabelsEntry {
    const message = {
      ...baseCreateWafProfileRequest_LabelsEntry,
    } as CreateWafProfileRequest_LabelsEntry;
...
export const CreateWafProfileMetadata = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.waf.CreateWafProfileMetadata" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCreateWafProfileMetadata,
    } as CreateWafProfileMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const UpdateWafProfileRequest = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.waf.UpdateWafProfileRequest" as const,
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      UpdateWafProfileRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.smartwebsecurity.v1.waf.UpdateWafProfileRequest.LabelsEntry",
          key: key as any,
          value,
        },
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpdateWafProfileRequest,
    } as UpdateWafProfileRequest;
    message.labels = {};
    message.rules = [];
    message.exclusionRules = [];
    while (reader.pos < end) {
...
export const UpdateWafProfileRequest_LabelsEntry = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.waf.UpdateWafProfileRequest.LabelsEntry" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<UpdateWafProfileRequest_LabelsEntry>, I>
  >(object: I): UpdateWafProfileRequest_LabelsEntry {
    const message = {
      ...baseUpdateWafProfileRequest_LabelsEntry,
    } as UpdateWafProfileRequest_LabelsEntry;
    message.key = object.key ?? "";
...
export const UpdateWafProfileMetadata = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.waf.UpdateWafProfileMetadata" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpdateWafProfileMetadata,
    } as UpdateWafProfileMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const DeleteWafProfileRequest = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.waf.DeleteWafProfileRequest" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseDeleteWafProfileRequest,
    } as DeleteWafProfileRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const DeleteWafProfileMetadata = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.waf.DeleteWafProfileMetadata" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseDeleteWafProfileMetadata,
    } as DeleteWafProfileMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const WafProfileServiceService = {
  ...
  get: {
    ...
    responseSerialize: (value: WafProfile) =>
      Buffer.from(WafProfile.encode(value).finish()),
  ...
  list: {
    ...
    responseDeserialize: (value: Buffer) =>
      ListWafProfilesResponse.decode(value),
  },
  ...
  create: {
    ...
    requestDeserialize: (value: Buffer) =>
      CreateWafProfileRequest.decode(value),
  ...
  update: {
    ...
    requestDeserialize: (value: Buffer) =>
      UpdateWafProfileRequest.decode(value),
    responseSerialize: (value: Operation) =>
      Buffer.from(Operation.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Operation.decode(value),
  },
  ...
  delete: {
    ...
    requestDeserialize: (value: Buffer) =>
      DeleteWafProfileRequest.decode(value),
    responseSerialize: (value: Operation) =>
      Buffer.from(Operation.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Operation.decode(value),
  },
...
export interface WafProfileServiceClient extends Client {
  ...
  list(
    ...
    callback: (
      ...
      response: ListWafProfilesResponse
    ) => void
  ): ClientUnaryCall;
  list(
    request: ListWafProfilesRequest,
