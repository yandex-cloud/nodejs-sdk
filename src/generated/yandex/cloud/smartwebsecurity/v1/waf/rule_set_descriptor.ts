...
export const RuleSetDescriptor = {
    encode(message: RuleSetDescriptor, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        for (const v of message.rules) {
            RuleSetDescriptor_RuleDescription.encode(v!, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    ...
    fromPartial<I extends Exact<DeepPartial<RuleSetDescriptor>, I>>(object: I): RuleSetDescriptor {
        ...
        message.rules =
            object.rules?.map((e) => RuleSetDescriptor_RuleDescription.fromPartial(e)) || [];
        return message;
    },
};
...
export const RuleSetDescriptor_RuleDescription = {
    ...
    toJSON(message: RuleSetDescriptor_RuleDescription): unknown {
        const obj: any = {};
        message.id !== undefined && (obj.id = message.id);
        message.anomalyScore !== undefined && (obj.anomalyScore = Math.round(message.anomalyScore));
        message.paranoiaLevel !== undefined &&
            (obj.paranoiaLevel = Math.round(message.paranoiaLevel));
        return obj;
    },

    fromPartial<I extends Exact<DeepPartial<RuleSetDescriptor_RuleDescription>, I>>(
        object: I,
