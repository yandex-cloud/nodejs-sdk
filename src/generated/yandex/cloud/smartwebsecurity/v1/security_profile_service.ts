...
export const GetSecurityProfileRequest = {
  ...
  decode(
    ...
    const message = {
      ...baseGetSecurityProfileRequest,
    } as GetSecurityProfileRequest;
...
messageTypeRegistry.set(
  GetSecurityProfileRequest.$type,
  GetSecurityProfileRequest
);
...
export const ListSecurityProfilesRequest = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.ListSecurityProfilesRequest" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListSecurityProfilesRequest,
    } as ListSecurityProfilesRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  ListSecurityProfilesRequest.$type,
  ListSecurityProfilesRequest
);
...
export const ListSecurityProfilesResponse = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.ListSecurityProfilesResponse" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListSecurityProfilesResponse,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.securityProfiles.push(
            SecurityProfile.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
...
export const CreateSecurityProfileRequest = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.CreateSecurityProfileRequest" as const,
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      CreateSecurityProfileRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.smartwebsecurity.v1.CreateSecurityProfileRequest.LabelsEntry",
          key: key as any,
          value,
        },
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCreateSecurityProfileRequest,
    } as CreateSecurityProfileRequest;
    message.labels = {};
...
messageTypeRegistry.set(
  CreateSecurityProfileRequest.$type,
  CreateSecurityProfileRequest
);
...
export const CreateSecurityProfileRequest_LabelsEntry = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.CreateSecurityProfileRequest.LabelsEntry" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<CreateSecurityProfileRequest_LabelsEntry>, I>
  >(object: I): CreateSecurityProfileRequest_LabelsEntry {
    const message = {
      ...baseCreateSecurityProfileRequest_LabelsEntry,
    } as CreateSecurityProfileRequest_LabelsEntry;
...
export const CreateSecurityProfileMetadata = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.CreateSecurityProfileMetadata" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCreateSecurityProfileMetadata,
    } as CreateSecurityProfileMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  CreateSecurityProfileMetadata.$type,
  CreateSecurityProfileMetadata
);
...
export const UpdateSecurityProfileRequest = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.UpdateSecurityProfileRequest" as const,
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      UpdateSecurityProfileRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.smartwebsecurity.v1.UpdateSecurityProfileRequest.LabelsEntry",
          key: key as any,
          value,
        },
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpdateSecurityProfileRequest,
...
messageTypeRegistry.set(
  UpdateSecurityProfileRequest.$type,
  UpdateSecurityProfileRequest
);
...
export const UpdateSecurityProfileRequest_LabelsEntry = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.UpdateSecurityProfileRequest.LabelsEntry" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<UpdateSecurityProfileRequest_LabelsEntry>, I>
  >(object: I): UpdateSecurityProfileRequest_LabelsEntry {
    const message = {
      ...baseUpdateSecurityProfileRequest_LabelsEntry,
    } as UpdateSecurityProfileRequest_LabelsEntry;
    message.key = object.key ?? "";
...
export const UpdateSecurityProfileMetadata = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.UpdateSecurityProfileMetadata" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpdateSecurityProfileMetadata,
    } as UpdateSecurityProfileMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  UpdateSecurityProfileMetadata.$type,
  UpdateSecurityProfileMetadata
);
...
export const DeleteSecurityProfileRequest = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.DeleteSecurityProfileRequest" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseDeleteSecurityProfileRequest,
    } as DeleteSecurityProfileRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  DeleteSecurityProfileRequest.$type,
  DeleteSecurityProfileRequest
);
...
export const DeleteSecurityProfileMetadata = {
  $type:
    "yandex.cloud.smartwebsecurity.v1.DeleteSecurityProfileMetadata" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseDeleteSecurityProfileMetadata,
    } as DeleteSecurityProfileMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  DeleteSecurityProfileMetadata.$type,
  DeleteSecurityProfileMetadata
);
...
export const SecurityProfileServiceService = {
  ...
  get: {
    ...
    requestDeserialize: (value: Buffer) =>
      GetSecurityProfileRequest.decode(value),
  ...
  create: {
    ...
    requestDeserialize: (value: Buffer) =>
      CreateSecurityProfileRequest.decode(value),
  ...
  update: {
    ...
    requestDeserialize: (value: Buffer) =>
      UpdateSecurityProfileRequest.decode(value),
    responseSerialize: (value: Operation) =>
      Buffer.from(Operation.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Operation.decode(value),
  },
  ...
  delete: {
    ...
    requestDeserialize: (value: Buffer) =>
      DeleteSecurityProfileRequest.decode(value),
    responseSerialize: (value: Operation) =>
      Buffer.from(Operation.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Operation.decode(value),
  },
...
export interface SecurityProfileServiceServer
