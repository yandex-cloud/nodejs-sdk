...
export const PricingVersion = {
  ...
  fromJSON(object: any): PricingVersion {
    ...
    message.effectiveTime =
      object.effectiveTime !== undefined && object.effectiveTime !== null
        ...
        : undefined;
    message.pricingExpressions = (object.pricingExpressions ?? []).map(
      (e: any) => PricingExpression.fromJSON(e)
    );
    return message;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<PricingVersion>, I>>(
    object: I
  ): PricingVersion {
    const message = { ...basePricingVersion } as PricingVersion;
...
export const PricingExpression = {
  ...
  fromPartial<I extends Exact<DeepPartial<PricingExpression>, I>>(
    object: I
  ): PricingExpression {
    const message = { ...basePricingExpression } as PricingExpression;
