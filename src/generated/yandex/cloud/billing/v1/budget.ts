...
export const CostBudgetSpec = {
  ...
  fromJSON(object: any): CostBudgetSpec {
    ...
    message.amount =
      object.amount !== undefined && object.amount !== null
        ...
        : "";
    message.notificationUserAccountIds = (
      object.notificationUserAccountIds ?? []
    ).map((e: any) => String(e));
  ...
  toJSON(message: CostBudgetSpec): unknown {
    ...
    if (message.notificationUserAccountIds) {
      obj.notificationUserAccountIds = message.notificationUserAccountIds.map(
        (e) => e
      );
    } else {
  ...
  fromPartial<I extends Exact<DeepPartial<CostBudgetSpec>, I>>(
    object: I
  ): CostBudgetSpec {
    const message = { ...baseCostBudgetSpec } as CostBudgetSpec;
    message.amount = object.amount ?? "";
    message.notificationUserAccountIds =
      object.notificationUserAccountIds?.map((e) => e) || [];
    message.thresholdRules =
...
export const ExpenseBudgetSpec = {
  ...
  fromPartial<I extends Exact<DeepPartial<ExpenseBudgetSpec>, I>>(
    object: I
  ): ExpenseBudgetSpec {
    const message = { ...baseExpenseBudgetSpec } as ExpenseBudgetSpec;
    message.amount = object.amount ?? "";
...
export const BalanceBudgetSpec = {
  ...
  fromPartial<I extends Exact<DeepPartial<BalanceBudgetSpec>, I>>(
    object: I
  ): BalanceBudgetSpec {
    const message = { ...baseBalanceBudgetSpec } as BalanceBudgetSpec;
    message.amount = object.amount ?? "";
...
export const ConsumptionFilter = {
  ...
  fromJSON(object: any): ConsumptionFilter {
    ...
    message.cloudFoldersFilters = (object.cloudFoldersFilters ?? []).map(
      (e: any) => CloudFoldersConsumptionFilter.fromJSON(e)
    );
    return message;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ConsumptionFilter>, I>>(
    object: I
  ): ConsumptionFilter {
    const message = { ...baseConsumptionFilter } as ConsumptionFilter;
    message.serviceIds = object.serviceIds?.map((e) => e) || [];
    message.cloudFoldersFilters =
      object.cloudFoldersFilters?.map((e) =>
...
export const ThresholdRule = {
  ...
  fromPartial<I extends Exact<DeepPartial<ThresholdRule>, I>>(
    object: I
  ): ThresholdRule {
    const message = { ...baseThresholdRule } as ThresholdRule;
