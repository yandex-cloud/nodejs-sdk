...
export function trunkConnection_CapacityFromJSON(
  object: any
...
export function trunkConnection_CapacityToJSON(
  object: TrunkConnection_Capacity
): string {
  switch (object) {
...
export const TrunkConnection = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): TrunkConnection {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9:
          message.singlePortDirectJoint =
            TrunkConnection_SinglePortDirectJoint.decode(
              reader,
              reader.uint32()
            );
          break;
        ...
        case 11:
          ...
          break;
        case 12:
          message.pointOfPresenceId = StringValue.decode(
            reader,
            reader.uint32()
          ).value;
          break;
        case 22:
          ...
          break;
        case 23:
          const entry23 = TrunkConnection_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
  ...
  fromJSON(object: any): TrunkConnection {
    ...
    message.regionId =
      object.regionId !== undefined && object.regionId !== null
        ...
        : "";
    message.singlePortDirectJoint =
      object.singlePortDirectJoint !== undefined &&
      object.singlePortDirectJoint !== null
        ? TrunkConnection_SinglePortDirectJoint.fromJSON(
  ...
  toJSON(message: TrunkConnection): unknown {
    ...
    message.singlePortDirectJoint !== undefined &&
      (obj.singlePortDirectJoint = message.singlePortDirectJoint
        ? TrunkConnection_SinglePortDirectJoint.toJSON(
            message.singlePortDirectJoint
          )
        : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<TrunkConnection>, I>>(
    object: I
  ): TrunkConnection {
    const message = { ...baseTrunkConnection } as TrunkConnection;
    ...
    message.singlePortDirectJoint =
      object.singlePortDirectJoint !== undefined &&
      object.singlePortDirectJoint !== null
        ? TrunkConnection_SinglePortDirectJoint.fromPartial(
            object.singlePortDirectJoint
          )
        : undefined;
    message.lagDirectJoint =
...
export const TrunkConnection_LabelsEntry = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseTrunkConnection_LabelsEntry,
    } as TrunkConnection_LabelsEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  TrunkConnection_LabelsEntry.$type,
  TrunkConnection_LabelsEntry
);
...
export const TrunkConnection_PartnerJointInfo = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<TrunkConnection_PartnerJointInfo>, I>
  >(object: I): TrunkConnection_PartnerJointInfo {
    const message = {
      ...baseTrunkConnection_PartnerJointInfo,
    } as TrunkConnection_PartnerJointInfo;
...
messageTypeRegistry.set(
  TrunkConnection_PartnerJointInfo.$type,
  TrunkConnection_PartnerJointInfo
);
...
export const TrunkConnection_SinglePortDirectJoint = {
  ...
  toJSON(message: TrunkConnection_SinglePortDirectJoint): unknown {
    ...
    message.accessDeviceName !== undefined &&
      (obj.accessDeviceName = message.accessDeviceName);
    return obj;
  },

  fromPartial<
    I extends Exact<DeepPartial<TrunkConnection_SinglePortDirectJoint>, I>
  >(object: I): TrunkConnection_SinglePortDirectJoint {
    const message = {
      ...baseTrunkConnection_SinglePortDirectJoint,
    } as TrunkConnection_SinglePortDirectJoint;
...
export const TrunkConnection_LagDirectJoint = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseTrunkConnection_LagDirectJoint,
    } as TrunkConnection_LagDirectJoint;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): TrunkConnection_LagDirectJoint {
    ...
    message.transceiverType =
      object.transceiverType !== undefined && object.transceiverType !== null
        ...
        : 0;
    message.lagAllocationSettings =
      object.lagAllocationSettings !== undefined &&
      object.lagAllocationSettings !== null
...
messageTypeRegistry.set(
  TrunkConnection_LagDirectJoint.$type,
  TrunkConnection_LagDirectJoint
);
