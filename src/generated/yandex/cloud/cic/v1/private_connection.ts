...
export const PrivateConnection = {
  ...
  encode(
    ...
    for (const v of message.ipv4StaticRoutes) {
      PrivateConnection_StaticRoute.encode(
        v!,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 18:
          ...
          break;
        case 24:
          const entry24 = PrivateConnection_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
  ...
  fromPartial<I extends Exact<DeepPartial<PrivateConnection>, I>>(
    object: I
  ): PrivateConnection {
    const message = { ...basePrivateConnection } as PrivateConnection;
    ...
    message.ipv4Peering =
      object.ipv4Peering !== undefined && object.ipv4Peering !== null
        ...
        : undefined;
    message.ipv4StaticRoutes =
      object.ipv4StaticRoutes?.map((e) =>
        PrivateConnection_StaticRoute.fromPartial(e)
      ) || [];
    message.labels = Object.entries(object.labels ?? {}).reduce<{
      [key: string]: string;
    }>((acc, [key, value]) => {
...
export const PrivateConnection_LabelsEntry = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...basePrivateConnection_LabelsEntry,
    } as PrivateConnection_LabelsEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  PrivateConnection_LabelsEntry.$type,
  PrivateConnection_LabelsEntry
);
...
export const PrivateConnection_StaticRoute = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...basePrivateConnection_StaticRoute,
    } as PrivateConnection_StaticRoute;
    message.nextHop = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
messageTypeRegistry.set(
  PrivateConnection_StaticRoute.$type,
  PrivateConnection_StaticRoute
);
