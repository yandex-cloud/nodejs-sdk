...
export const Peering = {
    ...
    fromJSON(object: any): Peering {
        ...
        message.peeringSubnet =
            object.peeringSubnet !== undefined && object.peeringSubnet !== null
                ...
                : '';
        message.peerIp =
            object.peerIp !== undefined && object.peerIp !== null ? String(object.peerIp) : '';
        message.cloudIp =
            object.cloudIp !== undefined && object.cloudIp !== null ? String(object.cloudIp) : '';
        message.peerBgpAsn =
    ...
    toJSON(message: Peering): unknown {
        const obj: any = {};
        message.peeringSubnet !== undefined && (obj.peeringSubnet = message.peeringSubnet);
        message.peerIp !== undefined && (obj.peerIp = message.peerIp);
        message.cloudIp !== undefined && (obj.cloudIp = message.cloudIp);
        message.peerBgpAsn !== undefined && (obj.peerBgpAsn = Math.round(message.peerBgpAsn));
        message.cloudBgpAsn !== undefined && (obj.cloudBgpAsn = Math.round(message.cloudBgpAsn));
        message.peerBgpMd5Key !== undefined && (obj.peerBgpMd5Key = message.peerBgpMd5Key);
        return obj;
    },
