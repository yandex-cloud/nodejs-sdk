...
export const GetPrivateConnectionRequest = {
  ...
  decode(
    ...
    const message = {
      ...baseGetPrivateConnectionRequest,
    } as GetPrivateConnectionRequest;
  ...
  fromJSON(object: any): GetPrivateConnectionRequest {
    ...
    message.privateConnectionId =
      object.privateConnectionId !== undefined &&
      object.privateConnectionId !== null
...
messageTypeRegistry.set(
  GetPrivateConnectionRequest.$type,
  GetPrivateConnectionRequest
);
...
export const ListPrivateConnectionsRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListPrivateConnectionsRequest,
    } as ListPrivateConnectionsRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  ListPrivateConnectionsRequest.$type,
  ListPrivateConnectionsRequest
);
...
export const ListPrivateConnectionsResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListPrivateConnectionsResponse,
    } as ListPrivateConnectionsResponse;
  ...
  fromJSON(object: any): ListPrivateConnectionsResponse {
    ...
    message.privateConnections = (object.privateConnections ?? []).map(
      (e: any) => PrivateConnection.fromJSON(e)
    );
...
export const PrivateConnectionServiceService = {
  ...
  get: {
    ...
    requestDeserialize: (value: Buffer) =>
      GetPrivateConnectionRequest.decode(value),
  ...
  list: {
    ...
    requestDeserialize: (value: Buffer) =>
      ListPrivateConnectionsRequest.decode(value),
    ...
    responseDeserialize: (value: Buffer) =>
      ListPrivateConnectionsResponse.decode(value),
  },
} as const;

export interface PrivateConnectionServiceServer
