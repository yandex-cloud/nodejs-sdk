...
export interface Partner {
  $type: "yandex.cloud.cic.v1.Partner";
...
export const Partner = {
  $type: "yandex.cloud.cic.v1.Partner" as const,
  ...
  toJSON(message: Partner): unknown {
    ...
    message.status !== undefined &&
      (obj.status = partner_StatusToJSON(message.status));
    return obj;
  },
...
messageTypeRegistry.set(Partner.$type, Partner);
