...
export const GetPublicConnectionRequest = {
  ...
  decode(
    ...
    const message = {
      ...baseGetPublicConnectionRequest,
    } as GetPublicConnectionRequest;
  ...
  fromJSON(object: any): GetPublicConnectionRequest {
    ...
    message.publicConnectionId =
      ...
      object.publicConnectionId !== null
...
messageTypeRegistry.set(
  GetPublicConnectionRequest.$type,
  GetPublicConnectionRequest
);
...
export const ListPublicConnectionsRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListPublicConnectionsRequest,
    } as ListPublicConnectionsRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  ListPublicConnectionsRequest.$type,
  ListPublicConnectionsRequest
);
...
export const ListPublicConnectionsResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListPublicConnectionsResponse,
    } as ListPublicConnectionsResponse;
...
messageTypeRegistry.set(
  ListPublicConnectionsResponse.$type,
  ListPublicConnectionsResponse
);
...
export const PublicConnectionServiceService = {
  ...
  get: {
    ...
    requestDeserialize: (value: Buffer) =>
      GetPublicConnectionRequest.decode(value),
  ...
  list: {
    ...
    requestDeserialize: (value: Buffer) =>
      ListPublicConnectionsRequest.decode(value),
    responseSerialize: (value: ListPublicConnectionsResponse) =>
      Buffer.from(ListPublicConnectionsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) =>
      ListPublicConnectionsResponse.decode(value),
  },
} as const;

export interface PublicConnectionServiceServer
...
export interface PublicConnectionServiceClient extends Client {
  ...
  list(
    ...
    callback: (
      ...
      response: ListPublicConnectionsResponse
    ) => void
  ): ClientUnaryCall;
  list(
    request: ListPublicConnectionsRequest,
