...
export const PublicConnection = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 13:
          ...
          break;
        case 18:
          const entry18 = PublicConnection_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
  ...
  fromJSON(object: any): PublicConnection {
    ...
    message.ipv4Peering =
      object.ipv4Peering !== undefined && object.ipv4Peering !== null
        ...
        : undefined;
    message.ipv4AllowedServiceTypes = (
      object.ipv4AllowedServiceTypes ?? []
    ).map((e: any) => publicConnection_CloudServiceTypeFromJSON(e));
    message.ipv4PeerAnnouncedPrefixes = (
      object.ipv4PeerAnnouncedPrefixes ?? []
    ).map((e: any) => String(e));
  ...
  toJSON(message: PublicConnection): unknown {
    ...
    if (message.ipv4PeerAnnouncedPrefixes) {
      obj.ipv4PeerAnnouncedPrefixes = message.ipv4PeerAnnouncedPrefixes.map(
        (e) => e
      );
    } else {
  ...
  fromPartial<I extends Exact<DeepPartial<PublicConnection>, I>>(
    object: I
  ): PublicConnection {
    const message = { ...basePublicConnection } as PublicConnection;
    ...
    message.ipv4Peering =
      object.ipv4Peering !== undefined && object.ipv4Peering !== null
        ...
        : undefined;
    message.ipv4AllowedServiceTypes =
      object.ipv4AllowedServiceTypes?.map((e) => e) || [];
    message.ipv4PeerAnnouncedPrefixes =
      object.ipv4PeerAnnouncedPrefixes?.map((e) => e) || [];
    message.labels = Object.entries(object.labels ?? {}).reduce<{
      [key: string]: string;
    }>((acc, [key, value]) => {
      if (value !== undefined) {
...
export const PublicConnection_LabelsEntry = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...basePublicConnection_LabelsEntry,
    } as PublicConnection_LabelsEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  PublicConnection_LabelsEntry.$type,
  PublicConnection_LabelsEntry
);
