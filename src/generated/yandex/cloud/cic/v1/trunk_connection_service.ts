...
export const GetTrunkConnectionRequest = {
  ...
  decode(
    ...
    const message = {
      ...baseGetTrunkConnectionRequest,
    } as GetTrunkConnectionRequest;
  ...
  fromJSON(object: any): GetTrunkConnectionRequest {
    ...
    message.trunkConnectionId =
      object.trunkConnectionId !== undefined &&
      object.trunkConnectionId !== null
...
messageTypeRegistry.set(
  GetTrunkConnectionRequest.$type,
  GetTrunkConnectionRequest
);
...
export const ListTrunkConnectionsRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListTrunkConnectionsRequest,
    } as ListTrunkConnectionsRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  ListTrunkConnectionsRequest.$type,
  ListTrunkConnectionsRequest
);
...
export const ListTrunkConnectionsResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListTrunkConnectionsResponse,
    } as ListTrunkConnectionsResponse;
    message.trunkConnections = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.trunkConnections.push(
            TrunkConnection.decode(reader, reader.uint32())
          );
          break;
        case 2:
...
messageTypeRegistry.set(
  ListTrunkConnectionsResponse.$type,
  ListTrunkConnectionsResponse
);
...
export const TrunkConnectionServiceService = {
  ...
  get: {
    ...
    requestDeserialize: (value: Buffer) =>
      GetTrunkConnectionRequest.decode(value),
  ...
  list: {
    ...
    requestDeserialize: (value: Buffer) =>
      ListTrunkConnectionsRequest.decode(value),
    responseSerialize: (value: ListTrunkConnectionsResponse) =>
      Buffer.from(ListTrunkConnectionsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) =>
      ListTrunkConnectionsResponse.decode(value),
  },
} as const;

export interface TrunkConnectionServiceServer
...
export interface TrunkConnectionServiceClient extends Client {
  ...
  list(
    ...
    callback: (
      ...
      response: ListTrunkConnectionsResponse
    ) => void
  ): ClientUnaryCall;
  list(
    request: ListTrunkConnectionsRequest,
