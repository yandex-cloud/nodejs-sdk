...
export const BackupSchedule = {
  ...
  fromPartial<I extends Exact<DeepPartial<BackupSchedule>, I>>(
    object: I
  ): BackupSchedule {
    const message = { ...baseBackupSchedule } as BackupSchedule;
    message.dailyBackupSchedule =
...
export const BackupSettings = {
  ...
  fromJSON(object: any): BackupSettings {
    ...
    message.sourcePathsToExclude = (object.sourcePathsToExclude ?? []).map(
      (e: any) => String(e)
    );
    message.type =
  ...
  fromPartial<I extends Exact<DeepPartial<BackupSettings>, I>>(
    object: I
  ): BackupSettings {
    const message = { ...baseBackupSettings } as BackupSettings;
    ...
    message.sourcePathsToExclude =
      object.sourcePathsToExclude?.map((e) => e) || [];
...
export const BackupConfig = {
  ...
  fromPartial<I extends Exact<DeepPartial<BackupConfig>, I>>(
    object: I
  ): BackupConfig {
    const message = { ...baseBackupConfig } as BackupConfig;
    message.backupSettings =
