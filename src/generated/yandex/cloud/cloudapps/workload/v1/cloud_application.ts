...
export function cloudApplication_StatusFromJSON(
  object: any
): CloudApplication_Status {
  switch (object) {
    case 0:
...
export function cloudApplication_StatusToJSON(
  object: CloudApplication_Status
): string {
  switch (object) {
...
export const CloudApplication = {
  ...
  encode(
    ...
    if (message.billing !== undefined) {
      CloudApplication_Billing.encode(
        message.billing,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.billing = CloudApplication_Billing.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromPartial<I extends Exact<DeepPartial<CloudApplication>, I>>(
    object: I
  ): CloudApplication {
    const message = { ...baseCloudApplication } as CloudApplication;
...
export const CloudApplication_Billing = {
  ...
  encode(
    ...
    for (const v of message.subscriptions) {
      CloudApplication_Billing_Subscription.encode(
        v!,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCloudApplication_Billing,
    } as CloudApplication_Billing;
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.subscriptions.push(
            CloudApplication_Billing_Subscription.decode(
              reader,
              reader.uint32()
            )
          );
...
messageTypeRegistry.set(
  CloudApplication_Billing.$type,
  CloudApplication_Billing
);

const baseCloudApplication_Billing_Subscription: object = {
  $type:
    "yandex.cloud.cloudapps.workload.v1.CloudApplication.Billing.Subscription",
  instanceId: "",
  templateId: "",
};
...
export const CloudApplication_Billing_Subscription = {
  $type:
    "yandex.cloud.cloudapps.workload.v1.CloudApplication.Billing.Subscription" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<CloudApplication_Billing_Subscription>, I>
  >(object: I): CloudApplication_Billing_Subscription {
    const message = {
      ...baseCloudApplication_Billing_Subscription,
    } as CloudApplication_Billing_Subscription;
