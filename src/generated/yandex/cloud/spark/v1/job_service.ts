...
export const CreateJobRequest = {
    encode(message: CreateJobRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.sparkJob !== undefined) {
            SparkJob.encode(message.sparkJob, writer.uint32(26).fork()).ldelim();
        }
...
export const JobServiceService = {
    ...
    list: {
        path: '/yandex.cloud.spark.v1.JobService/List',
        requestStream: false,
    ...
    create: {
        path: '/yandex.cloud.spark.v1.JobService/Create',
        requestStream: false,
        responseStream: false,
    ...
    get: {
        path: '/yandex.cloud.spark.v1.JobService/Get',
        requestStream: false,
        responseStream: false,
    ...
    listLog: {
        path: '/yandex.cloud.spark.v1.JobService/ListLog',
        requestStream: false,
        responseStream: false,
    ...
    cancel: {
        path: '/yandex.cloud.spark.v1.JobService/Cancel',
        requestStream: false,
        responseStream: false,
...
export const JobServiceClient = makeGenericClientConstructor(
    JobServiceService,
    'yandex.cloud.spark.v1.JobService',
) as unknown as {
    new (
        address: string,
