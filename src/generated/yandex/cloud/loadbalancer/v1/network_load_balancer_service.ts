...
export const GetNetworkLoadBalancerRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): GetNetworkLoadBalancerRequest {
        ...
        const message = { ...baseGetNetworkLoadBalancerRequest } as GetNetworkLoadBalancerRequest;
...
export const ListNetworkLoadBalancersResponse = {
    ...
    fromJSON(object: any): ListNetworkLoadBalancersResponse {
        ...
        message.networkLoadBalancers = (object.networkLoadBalancers ?? []).map((e: any) =>
    ...
    fromPartial<I extends Exact<DeepPartial<ListNetworkLoadBalancersResponse>, I>>(
        ...
        message.networkLoadBalancers =
            object.networkLoadBalancers?.map((e) => NetworkLoadBalancer.fromPartial(e)) || [];
...
export const CreateNetworkLoadBalancerRequest = {
    encode(
        ...
        if (message.allowZonalShift === true) {
            writer.uint32(80).bool(message.allowZonalShift);
        }
        return writer;
    },
    ...
    fromJSON(object: any): CreateNetworkLoadBalancerRequest {
        ...
        message.attachedTargetGroups = (object.attachedTargetGroups ?? []).map((e: any) =>
    ...
    toJSON(message: CreateNetworkLoadBalancerRequest): unknown {
        ...
        message.type !== undefined && (obj.type = networkLoadBalancer_TypeToJSON(message.type));
...
export const UpdateNetworkLoadBalancerRequest = {
    encode(
        ...
        if (message.allowZonalShift === true) {
            writer.uint32(72).bool(message.allowZonalShift);
        }
        return writer;
    },
...
export const StopNetworkLoadBalancerRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): StopNetworkLoadBalancerRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseStopNetworkLoadBalancerRequest } as StopNetworkLoadBalancerRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object: any): AttachNetworkLoadBalancerTargetGroupRequest {
        ...
        message.networkLoadBalancerId =
            object.networkLoadBalancerId !== undefined && object.networkLoadBalancerId !== null
                ...
                : '';
        message.attachedTargetGroup =
            object.attachedTargetGroup !== undefined && object.attachedTargetGroup !== null
    ...
    fromJSON(object: any): ListenerSpec {
        ...
        message.protocol =
            object.protocol !== undefined && object.protocol !== null
                ...
                : 0;
        message.externalAddressSpec =
            object.externalAddressSpec !== undefined && object.externalAddressSpec !== null
                ? ExternalAddressSpec.fromJSON(object.externalAddressSpec)
                : undefined;
        message.internalAddressSpec =
            object.internalAddressSpec !== undefined && object.internalAddressSpec !== null
