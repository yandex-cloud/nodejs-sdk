...
export function downsampling_GridAggregationFromJSON(
  object: any
): Downsampling_GridAggregation {
  switch (object) {
    case 0:
...
export function downsampling_GridAggregationToJSON(
  object: Downsampling_GridAggregation
): string {
  switch (object) {
...
export function downsampling_GapFillingFromJSON(
  object: any
): Downsampling_GapFilling {
  switch (object) {
    case 0:
...
export function downsampling_GapFillingToJSON(
  object: Downsampling_GapFilling
): string {
  switch (object) {
...
export const Downsampling = {
  ...
  toJSON(message: Downsampling): unknown {
    ...
    message.gridAggregation !== undefined &&
      (obj.gridAggregation = downsampling_GridAggregationToJSON(
        message.gridAggregation
      ));
  ...
  fromPartial<I extends Exact<DeepPartial<Downsampling>, I>>(
    object: I
  ): Downsampling {
    const message = { ...baseDownsampling } as Downsampling;
