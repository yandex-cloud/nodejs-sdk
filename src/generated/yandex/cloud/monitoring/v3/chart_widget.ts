        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.visualizationSettings = ChartWidget_VisualizationSettings.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    toJSON(message: ChartWidget): unknown {
        ...
        message.visualizationSettings !== undefined &&
            (obj.visualizationSettings = message.visualizationSettings
                ? ChartWidget_VisualizationSettings.toJSON(message.visualizationSettings)
                : undefined);
    ...
    fromPartial<I extends Exact<DeepPartial<ChartWidget>, I>>(object: I): ChartWidget {
        ...
        message.visualizationSettings =
            object.visualizationSettings !== undefined && object.visualizationSettings !== null
                ...
                : undefined;
        message.seriesOverrides =
            object.seriesOverrides?.map((e) => ChartWidget_SeriesOverrides.fromPartial(e)) || [];
        message.nameHidingSettings =
            object.nameHidingSettings !== undefined && object.nameHidingSettings !== null
...
export const ChartWidget_Queries_Target = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ChartWidget_Queries_Target {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseChartWidget_Queries_Target } as ChartWidget_Queries_Target;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ChartWidget_VisualizationSettings = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    message.yaxisSettings = ChartWidget_VisualizationSettings_YaxisSettings.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    toJSON(message: ChartWidget_VisualizationSettings): unknown {
        ...
        message.aggregation !== undefined &&
            (obj.aggregation = chartWidget_VisualizationSettings_SeriesAggregationToJSON(
                message.aggregation,
            ));
        ...
        message.heatmapSettings !== undefined &&
            (obj.heatmapSettings = message.heatmapSettings
                ? ChartWidget_VisualizationSettings_HeatmapSettings.toJSON(message.heatmapSettings)
                : undefined);
        message.yaxisSettings !== undefined &&
            (obj.yaxisSettings = message.yaxisSettings
                ? ChartWidget_VisualizationSettings_YaxisSettings.toJSON(message.yaxisSettings)
                : undefined);
        message.title !== undefined && (obj.title = message.title);
...
export const ChartWidget_VisualizationSettings_ColorSchemeSettings = {
    ...
    fromPartial<
        I extends Exact<DeepPartial<ChartWidget_VisualizationSettings_ColorSchemeSettings>, I>,
...
export const ChartWidget_VisualizationSettings_ColorSchemeSettings_HashColorScheme = {
    ...
    fromJSON(_: any): ChartWidget_VisualizationSettings_ColorSchemeSettings_HashColorScheme {
        const message = {
            ...baseChartWidget_VisualizationSettings_ColorSchemeSettings_HashColorScheme,
        } as ChartWidget_VisualizationSettings_ColorSchemeSettings_HashColorScheme;
        return message;
    ...
    toJSON(_: ChartWidget_VisualizationSettings_ColorSchemeSettings_HashColorScheme): unknown {
        const obj: any = {};
        return obj;
    },
    ...
    fromPartial<
        I extends Exact<
            ...
            I
        >,
    >(_: I): ChartWidget_VisualizationSettings_ColorSchemeSettings_HashColorScheme {
        const message = {
            ...baseChartWidget_VisualizationSettings_ColorSchemeSettings_HashColorScheme,
        } as ChartWidget_VisualizationSettings_ColorSchemeSettings_HashColorScheme;
        return message;
...
export const ChartWidget_SeriesOverrides = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ChartWidget_SeriesOverrides {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseChartWidget_SeriesOverrides } as ChartWidget_SeriesOverrides;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.settings = ChartWidget_SeriesOverrides_SeriesOverrideSettings.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
...
export const ChartWidget_SeriesOverrides_SeriesOverrideSettings = {
    ...
    fromPartial<
        I extends Exact<DeepPartial<ChartWidget_SeriesOverrides_SeriesOverrideSettings>, I>,
...
export const ChartWidget_NameHidingSettings = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ChartWidget_NameHidingSettings {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseChartWidget_NameHidingSettings } as ChartWidget_NameHidingSettings;
        message.names = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
export const ChartWidget_RepeatSettings = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ChartWidget_RepeatSettings {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseChartWidget_RepeatSettings } as ChartWidget_RepeatSettings;
        message.repeatBy = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
