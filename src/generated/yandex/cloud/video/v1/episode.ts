...
export function episode_VisibilityStatusFromJSON(
  object: any
): Episode_VisibilityStatus {
  switch (object) {
    case 0:
...
export function episode_VisibilityStatusToJSON(
  object: Episode_VisibilityStatus
): string {
  switch (object) {
...
export const Episode = {
  ...
  toJSON(message: Episode): unknown {
    ...
    message.visibilityStatus !== undefined &&
      (obj.visibilityStatus = episode_VisibilityStatusToJSON(
        message.visibilityStatus
      ));
...
export const EpisodePublicAccessRights = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseEpisodePublicAccessRights,
    } as EpisodePublicAccessRights;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
...
messageTypeRegistry.set(
  EpisodePublicAccessRights.$type,
  EpisodePublicAccessRights
);
...
export const EpisodeAuthSystemAccessRights = {
  ...
  encode(
    _: EpisodeAuthSystemAccessRights,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    return writer;
  },
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseEpisodeAuthSystemAccessRights,
    } as EpisodeAuthSystemAccessRights;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
...
messageTypeRegistry.set(
  EpisodeAuthSystemAccessRights.$type,
  EpisodeAuthSystemAccessRights
);
