...
export function autoLine_AutoLineStatusFromJSON(
  object: any
): AutoLine_AutoLineStatus {
  switch (object) {
    case 0:
...
export function autoLine_AutoLineStatusToJSON(
...
export const StreamLine = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 101:
          ...
          break;
        case 200:
          const entry200 = StreamLine_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
  ...
  toJSON(message: StreamLine): unknown {
    ...
    message.rtmpPush !== undefined &&
      (obj.rtmpPush = message.rtmpPush
        ? RTMPPushInput.toJSON(message.rtmpPush)
        : undefined);
    message.srtPush !== undefined &&
      (obj.srtPush = message.srtPush
        ? SRTPushInput.toJSON(message.srtPush)
        : undefined);
    ...
    message.srtPull !== undefined &&
      (obj.srtPull = message.srtPull
        ? SRTPullInput.toJSON(message.srtPull)
        : undefined);
    message.tcpPull !== undefined &&
      (obj.tcpPull = message.tcpPull
        ? TCPPullInput.toJSON(message.tcpPull)
        : undefined);
    message.rtspPull !== undefined &&
      (obj.rtspPull = message.rtspPull
        ? RTSPPullInput.toJSON(message.rtspPull)
        : undefined);
    ...
    message.autoLine !== undefined &&
      (obj.autoLine = message.autoLine
        ? AutoLine.toJSON(message.autoLine)
        : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<StreamLine>, I>>(
    object: I
  ): StreamLine {
    const message = { ...baseStreamLine } as StreamLine;
...
export const StreamLine_LabelsEntry = {
  ...
  encode(
    message: StreamLine_LabelsEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== "") {
...
const basePushStreamKey: object = {
  $type: "yandex.cloud.video.v1.PushStreamKey",
  key: "",
};
...
export const PushStreamKey = {
  ...
  fromPartial<I extends Exact<DeepPartial<PushStreamKey>, I>>(
    object: I
  ): PushStreamKey {
    const message = { ...basePushStreamKey } as PushStreamKey;
    message.key = object.key ?? "";
...
const baseRTMPPushInput: object = {
  $type: "yandex.cloud.video.v1.RTMPPushInput",
  url: "",
};
...
export const RTMPPushInput = {
  ...
  fromPartial<I extends Exact<DeepPartial<RTMPPushInput>, I>>(
    object: I
  ): RTMPPushInput {
    const message = { ...baseRTMPPushInput } as RTMPPushInput;
...
export const SRTPushInput = {
  ...
  fromPartial<I extends Exact<DeepPartial<SRTPushInput>, I>>(
    object: I
  ): SRTPushInput {
    const message = { ...baseSRTPushInput } as SRTPushInput;
    message.url = object.url ?? "";
...
const baseRTMPPullInput: object = {
  $type: "yandex.cloud.video.v1.RTMPPullInput",
  url: "",
};
...
export const RTMPPullInput = {
  ...
  fromPartial<I extends Exact<DeepPartial<RTMPPullInput>, I>>(
    object: I
  ): RTMPPullInput {
    const message = { ...baseRTMPPullInput } as RTMPPullInput;
    message.url = object.url ?? "";
...
export const SRTPullInput = {
  ...
  fromPartial<I extends Exact<DeepPartial<SRTPullInput>, I>>(
    object: I
  ): SRTPullInput {
    const message = { ...baseSRTPullInput } as SRTPullInput;
    message.url = object.url ?? "";
...
export const TCPPullInput = {
  ...
  fromPartial<I extends Exact<DeepPartial<TCPPullInput>, I>>(
    object: I
  ): TCPPullInput {
    const message = { ...baseTCPPullInput } as TCPPullInput;
    message.url = object.url ?? "";
...
const baseRTSPPullInput: object = {
  $type: "yandex.cloud.video.v1.RTSPPullInput",
  url: "",
};
...
export const RTSPPullInput = {
  ...
  fromPartial<I extends Exact<DeepPartial<RTSPPullInput>, I>>(
    object: I
  ): RTSPPullInput {
    const message = { ...baseRTSPPullInput } as RTSPPullInput;
    message.url = object.url ?? "";
