...
export const ListThumbnailResponse = {
  ...
  fromJSON(object: any): ListThumbnailResponse {
    const message = { ...baseListThumbnailResponse } as ListThumbnailResponse;
    message.thumbnails = (object.thumbnails ?? []).map((e: any) =>
      Thumbnail.fromJSON(e)
    );
  ...
  fromPartial<I extends Exact<DeepPartial<ListThumbnailResponse>, I>>(
    ...
    const message = { ...baseListThumbnailResponse } as ListThumbnailResponse;
    message.thumbnails =
      object.thumbnails?.map((e) => Thumbnail.fromPartial(e)) || [];
...
export const CreateThumbnailMetadata = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCreateThumbnailMetadata,
    } as CreateThumbnailMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const BatchGenerateDownloadURLsRequest = {
  ...
  fromJSON(object: any): BatchGenerateDownloadURLsRequest {
    ...
    message.channelId =
      object.channelId !== undefined && object.channelId !== null
        ? String(object.channelId)
        : "";
    message.thumbnailIds = (object.thumbnailIds ?? []).map((e: any) =>
      String(e)
    );
    return message;
  },
  ...
  fromPartial<
    I extends Exact<DeepPartial<BatchGenerateDownloadURLsRequest>, I>
  >(object: I): BatchGenerateDownloadURLsRequest {
    const message = {
      ...baseBatchGenerateDownloadURLsRequest,
    } as BatchGenerateDownloadURLsRequest;
    message.channelId = object.channelId ?? "";
...
messageTypeRegistry.set(
  BatchGenerateDownloadURLsRequest.$type,
  BatchGenerateDownloadURLsRequest
);
...
export const BatchGenerateDownloadURLsResponse = {
      ...
      switch (tag >>> 3) {
        case 1:
          message.downloadUrls.push(
            ThumbnailDownloadURL.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  fromPartial<
    I extends Exact<DeepPartial<BatchGenerateDownloadURLsResponse>, I>
  >(object: I): BatchGenerateDownloadURLsResponse {
    const message = {
      ...baseBatchGenerateDownloadURLsResponse,
    } as BatchGenerateDownloadURLsResponse;
    message.downloadUrls =
...
messageTypeRegistry.set(
  BatchGenerateDownloadURLsResponse.$type,
  BatchGenerateDownloadURLsResponse
);
...
export const GenerateThumbnailUploadURLRequest = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<GenerateThumbnailUploadURLRequest>, I>
  >(object: I): GenerateThumbnailUploadURLRequest {
    const message = {
      ...baseGenerateThumbnailUploadURLRequest,
    } as GenerateThumbnailUploadURLRequest;
    message.thumbnailId = object.thumbnailId ?? "";
...
messageTypeRegistry.set(
  GenerateThumbnailUploadURLRequest.$type,
  GenerateThumbnailUploadURLRequest
);
...
export const GenerateThumbnailUploadURLResponse = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<GenerateThumbnailUploadURLResponse>, I>
  >(object: I): GenerateThumbnailUploadURLResponse {
    const message = {
      ...baseGenerateThumbnailUploadURLResponse,
    } as GenerateThumbnailUploadURLResponse;
...
export const ThumbnailServiceService = {
  ...
  batchGenerateDownloadURLs: {
    ...
    requestDeserialize: (value: Buffer) =>
      BatchGenerateDownloadURLsRequest.decode(value),
    ...
    responseDeserialize: (value: Buffer) =>
      BatchGenerateDownloadURLsResponse.decode(value),
  },
  ...
  generateUploadURL: {
    ...
    requestDeserialize: (value: Buffer) =>
      GenerateThumbnailUploadURLRequest.decode(value),
    ...
    responseDeserialize: (value: Buffer) =>
      GenerateThumbnailUploadURLResponse.decode(value),
  },
} as const;
...
export interface ThumbnailServiceClient extends Client {
  ...
  list(
    ...
    callback: (
      ...
      response: ListThumbnailResponse
    ) => void
  ): ClientUnaryCall;
  list(
    request: ListThumbnailRequest,
  ...
  batchGenerateDownloadURLs(
    ...
    callback: (
      error: ServiceError | null,
      response: BatchGenerateDownloadURLsResponse
    ) => void
  ): ClientUnaryCall;
  batchGenerateDownloadURLs(
    request: BatchGenerateDownloadURLsRequest,
