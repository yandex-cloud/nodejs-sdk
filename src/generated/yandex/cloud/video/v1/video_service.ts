...
const baseGetVideoRequest: object = {
  $type: "yandex.cloud.video.v1.GetVideoRequest",
  videoId: "",
};
...
export const ListVideoRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListVideoRequest>, I>>(
    object: I
  ): ListVideoRequest {
    const message = { ...baseListVideoRequest } as ListVideoRequest;
...
export const ListVideoResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListVideoResponse>, I>>(
    object: I
  ): ListVideoResponse {
    const message = { ...baseListVideoResponse } as ListVideoResponse;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 200:
          const entry200 = CreateVideoRequest_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
        ...
        case 1000:
          ...
          break;
        case 2000:
          message.publicAccess = VideoPublicAccessParams.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  toJSON(message: CreateVideoRequest): unknown {
    ...
    message.tusd !== undefined &&
      (obj.tusd = message.tusd
        ? VideoTUSDParams.toJSON(message.tusd)
        : undefined);
...
export const CreateVideoRequest_LabelsEntry = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCreateVideoRequest_LabelsEntry,
...
messageTypeRegistry.set(
  CreateVideoRequest_LabelsEntry.$type,
  CreateVideoRequest_LabelsEntry
);
...
export const VideoTUSDParams = {
  ...
  fromPartial<I extends Exact<DeepPartial<VideoTUSDParams>, I>>(
    object: I
  ): VideoTUSDParams {
    const message = { ...baseVideoTUSDParams } as VideoTUSDParams;
...
export const VideoPublicAccessParams = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseVideoPublicAccessParams,
    } as VideoPublicAccessParams;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
...
export const VideoAuthSystemAccessParams = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseVideoAuthSystemAccessParams,
...
messageTypeRegistry.set(
  VideoAuthSystemAccessParams.$type,
  VideoAuthSystemAccessParams
);
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break;
        case 200:
          const entry200 = UpdateVideoRequest_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
          if (entry200.value !== undefined) {
...
export const UpdateVideoRequest_LabelsEntry = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpdateVideoRequest_LabelsEntry,
    } as UpdateVideoRequest_LabelsEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  UpdateVideoRequest_LabelsEntry.$type,
  UpdateVideoRequest_LabelsEntry
);
...
export const PerformVideoActionRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...basePerformVideoActionRequest,
    } as PerformVideoActionRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 1000:
          ...
          break;
        case 1001:
          message.unpublish = UnpublishVideoAction.decode(
            reader,
            reader.uint32()
          );
          break;
...
messageTypeRegistry.set(
  PerformVideoActionRequest.$type,
  PerformVideoActionRequest
);
...
export const PublishVideoAction = {
  ...
  fromPartial<I extends Exact<DeepPartial<PublishVideoAction>, I>>(
    _: I
  ): PublishVideoAction {
    const message = { ...basePublishVideoAction } as PublishVideoAction;
    return message;
...
export const UnpublishVideoAction = {
  ...
  fromPartial<I extends Exact<DeepPartial<UnpublishVideoAction>, I>>(
    _: I
  ): UnpublishVideoAction {
    const message = { ...baseUnpublishVideoAction } as UnpublishVideoAction;
    return message;
...
export const PerformVideoActionMetadata = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...basePerformVideoActionMetadata,
    } as PerformVideoActionMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  PerformVideoActionMetadata.$type,
  PerformVideoActionMetadata
);
  ...
  toJSON(message: GetVideoPlayerURLRequest): unknown {
    ...
    message.params !== undefined &&
      (obj.params = message.params
        ? VideoPlayerParams.toJSON(message.params)
        : undefined);
    return obj;
  },
...
export const VideoPlayerParams = {
  ...
  fromPartial<I extends Exact<DeepPartial<VideoPlayerParams>, I>>(
    object: I
  ): VideoPlayerParams {
    const message = { ...baseVideoPlayerParams } as VideoPlayerParams;
...
export const GetVideoPlayerURLResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseGetVideoPlayerURLResponse,
    } as GetVideoPlayerURLResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  GetVideoPlayerURLResponse.$type,
  GetVideoPlayerURLResponse
);
...
export const GetVideoManifestsRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseGetVideoManifestsRequest,
    } as GetVideoManifestsRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const GetVideoManifestsResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseGetVideoManifestsResponse,
    } as GetVideoManifestsResponse;
    message.manifests = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
messageTypeRegistry.set(
  GetVideoManifestsResponse.$type,
  GetVideoManifestsResponse
);
...
export const VideoServiceService = {
  ...
  get: {
    ...
    responseSerialize: (value: Video) =>
      Buffer.from(Video.encode(value).finish()),
  ...
  performAction: {
    ...
    requestDeserialize: (value: Buffer) =>
      PerformVideoActionRequest.decode(value),
    responseSerialize: (value: Operation) =>
      Buffer.from(Operation.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Operation.decode(value),
  },
...
export interface VideoServiceClient extends Client {
  ...
  getPlayerURL(
    ...
    callback: (
      ...
      response: GetVideoPlayerURLResponse
    ) => void
  ): ClientUnaryCall;
  getPlayerURL(
    request: GetVideoPlayerURLRequest,
  ...
  getManifests(
    ...
    callback: (
      error: ServiceError | null,
      response: GetVideoManifestsResponse
    ) => void
  ): ClientUnaryCall;
  getManifests(
    request: GetVideoManifestsRequest,
