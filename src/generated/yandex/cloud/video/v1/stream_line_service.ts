...
import {
  StreamLine,
  PushStreamKey,
} from "../../../../yandex/cloud/video/v1/stream_line";
...
export const GetStreamLineRequest = {
  ...
  toJSON(message: GetStreamLineRequest): unknown {
    const obj: any = {};
    message.streamLineId !== undefined &&
      (obj.streamLineId = message.streamLineId);
    return obj;
  },
...
export const ListStreamLinesResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListStreamLinesResponse,
    } as ListStreamLinesResponse;
    message.streamLines = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromJSON(object: any): ListStreamLinesResponse {
    ...
    message.streamLines = (object.streamLines ?? []).map((e: any) =>
      StreamLine.fromJSON(e)
    );
  ...
  fromPartial<I extends Exact<DeepPartial<ListStreamLinesResponse>, I>>(
    ...
    message.streamLines =
      object.streamLines?.map((e) => StreamLine.fromPartial(e)) || [];
...
export const CreateStreamLineRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCreateStreamLineRequest,
    } as CreateStreamLineRequest;
    message.labels = {};
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  toJSON(message: CreateStreamLineRequest): unknown {
    ...
    message.rtmpPush !== undefined &&
      (obj.rtmpPush = message.rtmpPush
        ? RTMPPushParams.toJSON(message.rtmpPush)
        : undefined);
    message.srtPush !== undefined &&
      (obj.srtPush = message.srtPush
        ? SRTPushParams.toJSON(message.srtPush)
        : undefined);
    ...
    message.srtPull !== undefined &&
      (obj.srtPull = message.srtPull
        ? SRTPullParams.toJSON(message.srtPull)
        : undefined);
    message.tcpPull !== undefined &&
      (obj.tcpPull = message.tcpPull
        ? TCPPullParams.toJSON(message.tcpPull)
        : undefined);
    message.rtspPull !== undefined &&
      (obj.rtspPull = message.rtspPull
        ? RTSPPullParams.toJSON(message.rtspPull)
        : undefined);
    ...
    message.autoLine !== undefined &&
      (obj.autoLine = message.autoLine
        ? AutoLineParams.toJSON(message.autoLine)
        : undefined);
    return obj;
  },
...
export const CreateStreamLineRequest_LabelsEntry = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<CreateStreamLineRequest_LabelsEntry>, I>
  >(object: I): CreateStreamLineRequest_LabelsEntry {
    const message = {
      ...baseCreateStreamLineRequest_LabelsEntry,
    } as CreateStreamLineRequest_LabelsEntry;
...
export const CreateStreamLineMetadata = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCreateStreamLineMetadata,
    } as CreateStreamLineMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const UpdateStreamLineRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpdateStreamLineRequest,
    } as UpdateStreamLineRequest;
    message.labels = {};
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
export const UpdateStreamLineRequest_LabelsEntry = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<UpdateStreamLineRequest_LabelsEntry>, I>
  >(object: I): UpdateStreamLineRequest_LabelsEntry {
    const message = {
      ...baseUpdateStreamLineRequest_LabelsEntry,
    } as UpdateStreamLineRequest_LabelsEntry;
    message.key = object.key ?? "";
...
export const UpdateStreamLineMetadata = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpdateStreamLineMetadata,
    } as UpdateStreamLineMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const DeleteStreamLineRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseDeleteStreamLineRequest,
    } as DeleteStreamLineRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const DeleteStreamLineMetadata = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseDeleteStreamLineMetadata,
    } as DeleteStreamLineMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const PerformLineActionRequest = {
  ...
  encode(
    ...
    if (message.activate !== undefined) {
      ActivateAction.encode(
        message.activate,
        writer.uint32(8002).fork()
      ).ldelim();
    }
    if (message.deactivate !== undefined) {
      DeactivateAction.encode(
        message.deactivate,
        writer.uint32(8010).fork()
      ).ldelim();
    }
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...basePerformLineActionRequest,
    } as PerformLineActionRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: PerformLineActionRequest): unknown {
    ...
    message.activate !== undefined &&
      (obj.activate = message.activate
        ? ActivateAction.toJSON(message.activate)
        : undefined);
...
export const PerformLineActionMetadata = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...basePerformLineActionMetadata,
    } as PerformLineActionMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  PerformLineActionMetadata.$type,
  PerformLineActionMetadata
);
...
export const RTMPPushParams = {
  ...
  fromPartial<I extends Exact<DeepPartial<RTMPPushParams>, I>>(
    _: I
  ): RTMPPushParams {
    const message = { ...baseRTMPPushParams } as RTMPPushParams;
    return message;
...
export const SRTPushParams = {
  ...
  fromPartial<I extends Exact<DeepPartial<SRTPushParams>, I>>(
    _: I
  ): SRTPushParams {
    const message = { ...baseSRTPushParams } as SRTPushParams;
    return message;
...
const baseRTMPPullParams: object = {
  $type: "yandex.cloud.video.v1.RTMPPullParams",
  url: "",
};
...
export const RTMPPullParams = {
  ...
  fromPartial<I extends Exact<DeepPartial<RTMPPullParams>, I>>(
    object: I
  ): RTMPPullParams {
    const message = { ...baseRTMPPullParams } as RTMPPullParams;
...
const baseSRTPullParams: object = {
  $type: "yandex.cloud.video.v1.SRTPullParams",
  url: "",
};
...
export const SRTPullParams = {
  ...
  fromPartial<I extends Exact<DeepPartial<SRTPullParams>, I>>(
    object: I
  ): SRTPullParams {
    const message = { ...baseSRTPullParams } as SRTPullParams;
    message.url = object.url ?? "";
...
const baseTCPPullParams: object = {
  $type: "yandex.cloud.video.v1.TCPPullParams",
  url: "",
};
...
export const TCPPullParams = {
  ...
  fromPartial<I extends Exact<DeepPartial<TCPPullParams>, I>>(
    object: I
  ): TCPPullParams {
    const message = { ...baseTCPPullParams } as TCPPullParams;
    message.url = object.url ?? "";
...
const baseRTSPPullParams: object = {
  $type: "yandex.cloud.video.v1.RTSPPullParams",
  url: "",
};
...
export const RTSPPullParams = {
  ...
  fromPartial<I extends Exact<DeepPartial<RTSPPullParams>, I>>(
    object: I
  ): RTSPPullParams {
    const message = { ...baseRTSPPullParams } as RTSPPullParams;
    message.url = object.url ?? "";
...
export const ManualLineParams = {
  ...
  fromPartial<I extends Exact<DeepPartial<ManualLineParams>, I>>(
    _: I
  ): ManualLineParams {
    const message = { ...baseManualLineParams } as ManualLineParams;
    return message;
...
export const AutoLineParams = {
  ...
  fromPartial<I extends Exact<DeepPartial<AutoLineParams>, I>>(
    _: I
  ): AutoLineParams {
    const message = { ...baseAutoLineParams } as AutoLineParams;
    return message;
...
export const ActivateAction = {
  ...
  fromPartial<I extends Exact<DeepPartial<ActivateAction>, I>>(
    _: I
  ): ActivateAction {
    const message = { ...baseActivateAction } as ActivateAction;
    return message;
...
export const DeactivateAction = {
  ...
  fromPartial<I extends Exact<DeepPartial<DeactivateAction>, I>>(
    _: I
  ): DeactivateAction {
    const message = { ...baseDeactivateAction } as DeactivateAction;
    return message;
...
export const UpdateStreamKeyMetadata = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpdateStreamKeyMetadata,
    } as UpdateStreamKeyMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const StreamLineServiceService = {
  ...
  get: {
    ...
    responseSerialize: (value: StreamLine) =>
      Buffer.from(StreamLine.encode(value).finish()),
  ...
  list: {
    ...
    responseDeserialize: (value: Buffer) =>
      ListStreamLinesResponse.decode(value),
  },
  /** Create stream line. */
  create: {
    ...
    requestDeserialize: (value: Buffer) =>
      CreateStreamLineRequest.decode(value),
  ...
  update: {
    ...
    requestDeserialize: (value: Buffer) =>
      UpdateStreamLineRequest.decode(value),
    responseSerialize: (value: Operation) =>
      Buffer.from(Operation.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Operation.decode(value),
  },
  ...
  delete: {
    ...
    requestDeserialize: (value: Buffer) =>
      DeleteStreamLineRequest.decode(value),
    responseSerialize: (value: Operation) =>
      Buffer.from(Operation.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Operation.decode(value),
  },
  ...
  performAction: {
    ...
    requestDeserialize: (value: Buffer) =>
      PerformLineActionRequest.decode(value),
    responseSerialize: (value: Operation) =>
      Buffer.from(Operation.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Operation.decode(value),
  },
...
export interface StreamLineServiceClient extends Client {
  ...
  list(
    ...
    callback: (
      ...
      response: ListStreamLinesResponse
    ) => void
  ): ClientUnaryCall;
  list(
    request: ListStreamLinesRequest,
