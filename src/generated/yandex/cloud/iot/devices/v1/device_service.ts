...
export const GetDeviceRequest = {
    ...
    toJSON(message: GetDeviceRequest): unknown {
        ...
        message.deviceView !== undefined && (obj.deviceView = deviceViewToJSON(message.deviceView));
        return obj;
    },
...
export const ListDevicesResponse = {
    ...
    fromJSON(object: any): ListDevicesResponse {
        const message = { ...baseListDevicesResponse } as ListDevicesResponse;
        message.devices = (object.devices ?? []).map((e: any) => Device.fromJSON(e));
...
export const CreateDeviceRequest = {
    ...
    fromPartial<I extends Exact<DeepPartial<CreateDeviceRequest>, I>>(
        ...
        message.certificates =
            object.certificates?.map((e) => CreateDeviceRequest_Certificate.fromPartial(e)) || [];
        message.topicAliases = Object.entries(object.topicAliases ?? {}).reduce<{
            [key: string]: string;
        }>((acc, [key, value]) => {
            if (value !== undefined) {
...
export const ListDeviceCertificatesRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListDeviceCertificatesRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListDeviceCertificatesRequest } as ListDeviceCertificatesRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListDeviceCertificatesResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListDeviceCertificatesResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListDeviceCertificatesResponse } as ListDeviceCertificatesResponse;
        message.certificates = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
export const AddDeviceCertificateRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): AddDeviceCertificateRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseAddDeviceCertificateRequest } as AddDeviceCertificateRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const AddDeviceCertificateMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): AddDeviceCertificateMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseAddDeviceCertificateMetadata } as AddDeviceCertificateMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const DeleteDeviceCertificateRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): DeleteDeviceCertificateRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseDeleteDeviceCertificateRequest } as DeleteDeviceCertificateRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListDevicePasswordsRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListDevicePasswordsRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListDevicePasswordsRequest } as ListDevicePasswordsRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListDevicePasswordsResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListDevicePasswordsResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListDevicePasswordsResponse } as ListDevicePasswordsResponse;
        message.passwords = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object: any): ListDevicePasswordsResponse {
        const message = { ...baseListDevicePasswordsResponse } as ListDevicePasswordsResponse;
        message.passwords = (object.passwords ?? []).map((e: any) => DevicePassword.fromJSON(e));
        return message;
    },
...
export const AddDevicePasswordRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): AddDevicePasswordRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseAddDevicePasswordRequest } as AddDevicePasswordRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const AddDevicePasswordMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): AddDevicePasswordMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseAddDevicePasswordMetadata } as AddDevicePasswordMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const DeleteDevicePasswordRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): DeleteDevicePasswordRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseDeleteDevicePasswordRequest } as DeleteDevicePasswordRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const DeleteDevicePasswordMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): DeleteDevicePasswordMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseDeleteDevicePasswordMetadata } as DeleteDevicePasswordMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListDeviceOperationsRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListDeviceOperationsRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListDeviceOperationsRequest } as ListDeviceOperationsRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListDeviceOperationsResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListDeviceOperationsResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListDeviceOperationsResponse } as ListDeviceOperationsResponse;
        message.operations = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
