...
export const GetPrivateEndpointRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): GetPrivateEndpointRequest {
        ...
        const message = { ...baseGetPrivateEndpointRequest } as GetPrivateEndpointRequest;
    ...
    fromJSON(object: any): GetPrivateEndpointRequest {
        ...
        message.privateEndpointId =
            object.privateEndpointId !== undefined && object.privateEndpointId !== null
...
export const CreatePrivateEndpointRequest = {
    encode(
        ...
        if (message.addressSpec !== undefined) {
            AddressSpec.encode(message.addressSpec, writer.uint32(50).fork()).ldelim();
        }
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): CreatePrivateEndpointRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseCreatePrivateEndpointRequest } as CreatePrivateEndpointRequest;
        message.labels = {};
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                ...
                case 6:
                    ...
                    break;
                case 8:
                    message.dnsOptions = PrivateEndpoint_DnsOptions.decode(reader, reader.uint32());
                    break;
                case 9:
...
export const CreatePrivateEndpointRequest_LabelsEntry = {
    ...
    fromPartial<I extends Exact<DeepPartial<CreatePrivateEndpointRequest_LabelsEntry>, I>>(
        object: I,
    ): CreatePrivateEndpointRequest_LabelsEntry {
        const message = {
            ...baseCreatePrivateEndpointRequest_LabelsEntry,
...
export const CreatePrivateEndpointMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): CreatePrivateEndpointMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseCreatePrivateEndpointMetadata } as CreatePrivateEndpointMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const UpdatePrivateEndpointRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): UpdatePrivateEndpointRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseUpdatePrivateEndpointRequest } as UpdatePrivateEndpointRequest;
        message.labels = {};
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
export const UpdatePrivateEndpointRequest_LabelsEntry = {
    ...
    fromPartial<I extends Exact<DeepPartial<UpdatePrivateEndpointRequest_LabelsEntry>, I>>(
        object: I,
    ): UpdatePrivateEndpointRequest_LabelsEntry {
        const message = {
            ...baseUpdatePrivateEndpointRequest_LabelsEntry,
...
export const UpdatePrivateEndpointMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): UpdatePrivateEndpointMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseUpdatePrivateEndpointMetadata } as UpdatePrivateEndpointMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const DeletePrivateEndpointRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): DeletePrivateEndpointRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseDeletePrivateEndpointRequest } as DeletePrivateEndpointRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const DeletePrivateEndpointMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): DeletePrivateEndpointMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseDeletePrivateEndpointMetadata } as DeletePrivateEndpointMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListPrivateEndpointsRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListPrivateEndpointsRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListPrivateEndpointsRequest } as ListPrivateEndpointsRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListPrivateEndpointsResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListPrivateEndpointsResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListPrivateEndpointsResponse } as ListPrivateEndpointsResponse;
        message.privateEndpoints = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.privateEndpoints.push(PrivateEndpoint.decode(reader, reader.uint32()));
                    break;
                case 2:
...
export const ListPrivateEndpointOperationsRequest = {
    ...
    fromPartial<I extends Exact<DeepPartial<ListPrivateEndpointOperationsRequest>, I>>(
        object: I,
...
export const ListPrivateEndpointOperationsResponse = {
    ...
    fromPartial<I extends Exact<DeepPartial<ListPrivateEndpointOperationsResponse>, I>>(
        object: I,
...
export const PrivateEndpointServiceService = {
    ...
    get: {
        ...
        requestDeserialize: (value: Buffer) => GetPrivateEndpointRequest.decode(value),
    ...
    list: {
        ...
        requestDeserialize: (value: Buffer) => ListPrivateEndpointsRequest.decode(value),
        responseSerialize: (value: ListPrivateEndpointsResponse) =>
            Buffer.from(ListPrivateEndpointsResponse.encode(value).finish()),
        responseDeserialize: (value: Buffer) => ListPrivateEndpointsResponse.decode(value),
    },
    ...
    create: {
        ...
        requestDeserialize: (value: Buffer) => CreatePrivateEndpointRequest.decode(value),
    ...
    update: {
        ...
        requestDeserialize: (value: Buffer) => UpdatePrivateEndpointRequest.decode(value),
        responseSerialize: (value: Operation) => Buffer.from(Operation.encode(value).finish()),
        responseDeserialize: (value: Buffer) => Operation.decode(value),
    },
    ...
    delete: {
        ...
        requestDeserialize: (value: Buffer) => DeletePrivateEndpointRequest.decode(value),
        responseSerialize: (value: Operation) => Buffer.from(Operation.encode(value).finish()),
        responseDeserialize: (value: Buffer) => Operation.decode(value),
    },
    ...
    listOperations: {
        ...
        requestDeserialize: (value: Buffer) => ListPrivateEndpointOperationsRequest.decode(value),
        ...
        responseDeserialize: (value: Buffer) => ListPrivateEndpointOperationsResponse.decode(value),
    },
} as const;

export interface PrivateEndpointServiceServer extends UntypedServiceImplementation {
    /**
     * Returns the specified Private Endpoint resource.
     *
     * To get the list of all available PrivateEndpoint resources, make a [List]
    ...
    /** Retrieves the list of PrivateEndpoint resources in the specified folder. */
    list: handleUnaryCall<ListPrivateEndpointsRequest, ListPrivateEndpointsResponse>;
    /** Creates an private endpoint in the specified folder and network. */
...
export interface PrivateEndpointServiceClient extends Client {
    ...
    list(
        ...
        callback: (error: ServiceError | null, response: ListPrivateEndpointsResponse) => void,
    ): ClientUnaryCall;
    list(
        request: ListPrivateEndpointsRequest,
        metadata: Metadata,
