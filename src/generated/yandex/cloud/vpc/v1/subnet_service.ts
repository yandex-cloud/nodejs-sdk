...
export const ListSubnetsResponse = {
    ...
    fromJSON(object: any): ListSubnetsResponse {
        const message = { ...baseListSubnetsResponse } as ListSubnetsResponse;
        message.subnets = (object.subnets ?? []).map((e: any) => Subnet.fromJSON(e));
...
export const CreateSubnetRequest = {
    ...
    toJSON(message: CreateSubnetRequest): unknown {
        ...
        message.routeTableId !== undefined && (obj.routeTableId = message.routeTableId);
...
export const AddSubnetCidrBlocksRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): AddSubnetCidrBlocksRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseAddSubnetCidrBlocksRequest } as AddSubnetCidrBlocksRequest;
        message.v4CidrBlocks = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
export const AddSubnetCidrBlocksMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): AddSubnetCidrBlocksMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseAddSubnetCidrBlocksMetadata } as AddSubnetCidrBlocksMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const RemoveSubnetCidrBlocksRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): RemoveSubnetCidrBlocksRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseRemoveSubnetCidrBlocksRequest } as RemoveSubnetCidrBlocksRequest;
        message.v4CidrBlocks = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
export const RemoveSubnetCidrBlocksMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): RemoveSubnetCidrBlocksMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseRemoveSubnetCidrBlocksMetadata } as RemoveSubnetCidrBlocksMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListSubnetOperationsRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListSubnetOperationsRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListSubnetOperationsRequest } as ListSubnetOperationsRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListSubnetOperationsResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListSubnetOperationsResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListSubnetOperationsResponse } as ListSubnetOperationsResponse;
        message.operations = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
export const ListUsedAddressesRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListUsedAddressesRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListUsedAddressesRequest } as ListUsedAddressesRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListUsedAddressesResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListUsedAddressesResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListUsedAddressesResponse } as ListUsedAddressesResponse;
        message.addresses = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object: any): ListUsedAddressesResponse {
        const message = { ...baseListUsedAddressesResponse } as ListUsedAddressesResponse;
        message.addresses = (object.addresses ?? []).map((e: any) => UsedAddress.fromJSON(e));
        message.nextPageToken =
            object.nextPageToken !== undefined && object.nextPageToken !== null
                ? String(object.nextPageToken)
                : '';
    ...
    fromJSON(object: any): UsedAddress {
        ...
        message.ipVersion =
            object.ipVersion !== undefined && object.ipVersion !== null
                ...
                : 0;
        message.references = (object.references ?? []).map((e: any) => Reference.fromJSON(e));
        return message;
    },
