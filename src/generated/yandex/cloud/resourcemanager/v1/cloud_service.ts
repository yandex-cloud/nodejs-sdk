...
export const GetCloudRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetCloudRequest>, I>>(
    object: I
  ): GetCloudRequest {
    const message = { ...baseGetCloudRequest } as GetCloudRequest;
...
export const ListCloudsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListCloudsRequest>, I>>(
    object: I
  ): ListCloudsRequest {
    const message = { ...baseListCloudsRequest } as ListCloudsRequest;
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      CreateCloudRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.resourcemanager.v1.CreateCloudRequest.LabelsEntry",
          key: key as any,
          value,
        },
...
export const CreateCloudRequest_LabelsEntry = {
  $type:
    "yandex.cloud.resourcemanager.v1.CreateCloudRequest.LabelsEntry" as const,
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      UpdateCloudRequest_LabelsEntry.encode(
        {
          $type:
            "yandex.cloud.resourcemanager.v1.UpdateCloudRequest.LabelsEntry",
          key: key as any,
          value,
        },
...
export const UpdateCloudRequest_LabelsEntry = {
  $type:
    "yandex.cloud.resourcemanager.v1.UpdateCloudRequest.LabelsEntry" as const,
