...
export const UpdateInstanceMetadataRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): UpdateInstanceMetadataRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseUpdateInstanceMetadataRequest } as UpdateInstanceMetadataRequest;
        message.delete = [];
        message.upsert = {};
        while (reader.pos < end) {
            const tag = reader.uint32();
    ...
    fromJSON(object: any): UpdateInstanceMetadataRequest {
        ...
        message.upsert = Object.entries(object.upsert ?? {}).reduce<{ [key: string]: string }>(
            (acc, [key, value]) => {
                acc[key] = String(value);
                return acc;
            },
...
export const UpdateInstanceMetadataMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): UpdateInstanceMetadataMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseUpdateInstanceMetadataMetadata } as UpdateInstanceMetadataMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const RestartInstanceMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): RestartInstanceMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseRestartInstanceMetadata } as RestartInstanceMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const AttachInstanceDiskRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): AttachInstanceDiskRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseAttachInstanceDiskRequest } as AttachInstanceDiskRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const AttachInstanceDiskMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): AttachInstanceDiskMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseAttachInstanceDiskMetadata } as AttachInstanceDiskMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const DetachInstanceDiskRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): DetachInstanceDiskRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseDetachInstanceDiskRequest } as DetachInstanceDiskRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const DetachInstanceDiskMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): DetachInstanceDiskMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseDetachInstanceDiskMetadata } as DetachInstanceDiskMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const AttachInstanceNetworkInterfaceRequest = {
    ...
    fromJSON(object: any): AttachInstanceNetworkInterfaceRequest {
        ...
        message.networkInterfaceIndex =
            object.networkInterfaceIndex !== undefined && object.networkInterfaceIndex !== null
    ...
    fromPartial<I extends Exact<DeepPartial<AttachInstanceNetworkInterfaceRequest>, I>>(
        object: I,
...
export const AttachInstanceNetworkInterfaceMetadata = {
    ...
    fromPartial<I extends Exact<DeepPartial<AttachInstanceNetworkInterfaceMetadata>, I>>(
        object: I,
    ): AttachInstanceNetworkInterfaceMetadata {
        const message = {
            ...baseAttachInstanceNetworkInterfaceMetadata,
...
export const DetachInstanceNetworkInterfaceRequest = {
    ...
    fromPartial<I extends Exact<DeepPartial<DetachInstanceNetworkInterfaceRequest>, I>>(
        object: I,
...
export const DetachInstanceNetworkInterfaceMetadata = {
    ...
    fromPartial<I extends Exact<DeepPartial<DetachInstanceNetworkInterfaceMetadata>, I>>(
        object: I,
    ): DetachInstanceNetworkInterfaceMetadata {
        const message = {
            ...baseDetachInstanceNetworkInterfaceMetadata,
...
export const AddInstanceOneToOneNatRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): AddInstanceOneToOneNatRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseAddInstanceOneToOneNatRequest } as AddInstanceOneToOneNatRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    toJSON(message: AddInstanceOneToOneNatRequest): unknown {
        ...
        message.networkInterfaceIndex !== undefined &&
            (obj.networkInterfaceIndex = message.networkInterfaceIndex);
        message.internalAddress !== undefined && (obj.internalAddress = message.internalAddress);
...
export const AddInstanceOneToOneNatMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): AddInstanceOneToOneNatMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseAddInstanceOneToOneNatMetadata } as AddInstanceOneToOneNatMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListInstanceOperationsRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListInstanceOperationsRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListInstanceOperationsRequest } as ListInstanceOperationsRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListInstanceOperationsResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListInstanceOperationsResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListInstanceOperationsResponse } as ListInstanceOperationsResponse;
        message.operations = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
export const RelocateInstanceRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): RelocateInstanceRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseRelocateInstanceRequest } as RelocateInstanceRequest;
        message.networkInterfaceSpecs = [];
    ...
    fromJSON(object: any): RelocateInstanceRequest {
        ...
        message.destinationZoneId =
            object.destinationZoneId !== undefined && object.destinationZoneId !== null
        ...
        message.bootDiskPlacement =
            object.bootDiskPlacement !== undefined && object.bootDiskPlacement !== null
                ? DiskPlacementPolicy.fromJSON(object.bootDiskPlacement)
                : undefined;
        message.secondaryDiskPlacements = (object.secondaryDiskPlacements ?? []).map((e: any) =>
            DiskPlacementPolicyChange.fromJSON(e),
        );
        return message;
    },
...
export const RelocateInstanceMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): RelocateInstanceMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseRelocateInstanceMetadata } as RelocateInstanceMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    toJSON(message: RelocateInstanceMetadata): unknown {
        const obj: any = {};
        message.instanceId !== undefined && (obj.instanceId = message.instanceId);
        message.sourceZoneId !== undefined && (obj.sourceZoneId = message.sourceZoneId);
        message.destinationZoneId !== undefined &&
            (obj.destinationZoneId = message.destinationZoneId);
        return obj;
    },
...
export const GuestStopInstanceMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): GuestStopInstanceMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseGuestStopInstanceMetadata } as GuestStopInstanceMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const PreemptInstanceMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): PreemptInstanceMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...basePreemptInstanceMetadata } as PreemptInstanceMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const InstanceServiceService = {
    ...
    attachNetworkInterface: {
        ...
        requestDeserialize: (value: Buffer) => AttachInstanceNetworkInterfaceRequest.decode(value),
        responseSerialize: (value: Operation) => Buffer.from(Operation.encode(value).finish()),
        responseDeserialize: (value: Buffer) => Operation.decode(value),
    },
    /**
    ...
    detachNetworkInterface: {
        ...
        requestDeserialize: (value: Buffer) => DetachInstanceNetworkInterfaceRequest.decode(value),
        responseSerialize: (value: Operation) => Buffer.from(Operation.encode(value).finish()),
        responseDeserialize: (value: Buffer) => Operation.decode(value),
    },
    /** Enables One-to-one NAT on the network interface. */
...
export interface InstanceServiceServer extends UntypedServiceImplementation {
     ...
     * To stop the running instance, make a [InstanceService.Stop] request.
     */
    attachNetworkInterface: handleUnaryCall<AttachInstanceNetworkInterfaceRequest, Operation>;
    /**
     * Detaches the network-interface to the instance.
     *
     * To Detach a network-interface, the instance must have a `STOPPED` status ([Instance.status]).
     ...
     * To stop the running instance, make a [InstanceService.Stop] request.
     */
    detachNetworkInterface: handleUnaryCall<DetachInstanceNetworkInterfaceRequest, Operation>;
    /** Enables One-to-one NAT on the network interface. */
