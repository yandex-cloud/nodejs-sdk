...
export const GetDiskPlacementGroupRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): GetDiskPlacementGroupRequest {
        ...
        const message = { ...baseGetDiskPlacementGroupRequest } as GetDiskPlacementGroupRequest;
    ...
    fromJSON(object: any): GetDiskPlacementGroupRequest {
        ...
        message.diskPlacementGroupId =
            object.diskPlacementGroupId !== undefined && object.diskPlacementGroupId !== null
...
export const ListDiskPlacementGroupsRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListDiskPlacementGroupsRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListDiskPlacementGroupsRequest } as ListDiskPlacementGroupsRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListDiskPlacementGroupsResponse = {
    ...
    fromJSON(object: any): ListDiskPlacementGroupsResponse {
        ...
        message.diskPlacementGroups = (object.diskPlacementGroups ?? []).map((e: any) =>
    ...
    fromPartial<I extends Exact<DeepPartial<ListDiskPlacementGroupsResponse>, I>>(
        ...
        message.diskPlacementGroups =
            object.diskPlacementGroups?.map((e) => DiskPlacementGroup.fromPartial(e)) || [];
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    message.partitionPlacementStrategy = DiskPartitionPlacementStrategy.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    toJSON(message: CreateDiskPlacementGroupRequest): unknown {
        ...
        message.partitionPlacementStrategy !== undefined &&
            (obj.partitionPlacementStrategy = message.partitionPlacementStrategy
                ? DiskPartitionPlacementStrategy.toJSON(message.partitionPlacementStrategy)
                : undefined);
        return obj;
    },
