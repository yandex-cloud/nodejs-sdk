...
export interface SerialPortSettings {
    $type: 'yandex.cloud.compute.v1.SerialPortSettings';
    /** Authentication and authorization in serial console when using SSH protocol */
    sshAuthorization: SerialPortSettings_SSHAuthorization;
}

export enum SerialPortSettings_SSHAuthorization {
...
export function serialPortSettings_SSHAuthorizationFromJSON(
    object: any,
): SerialPortSettings_SSHAuthorization {
    switch (object) {
        case 0:
        case 'SSH_AUTHORIZATION_UNSPECIFIED':
            return SerialPortSettings_SSHAuthorization.SSH_AUTHORIZATION_UNSPECIFIED;
        case 1:
        case 'INSTANCE_METADATA':
            return SerialPortSettings_SSHAuthorization.INSTANCE_METADATA;
        case 2:
        case 'OS_LOGIN':
            return SerialPortSettings_SSHAuthorization.OS_LOGIN;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return SerialPortSettings_SSHAuthorization.UNRECOGNIZED;
    }
}

export function serialPortSettings_SSHAuthorizationToJSON(
    object: SerialPortSettings_SSHAuthorization,
): string {
    switch (object) {
        case SerialPortSettings_SSHAuthorization.SSH_AUTHORIZATION_UNSPECIFIED:
            return 'SSH_AUTHORIZATION_UNSPECIFIED';
        case SerialPortSettings_SSHAuthorization.INSTANCE_METADATA:
            return 'INSTANCE_METADATA';
        case SerialPortSettings_SSHAuthorization.OS_LOGIN:
            return 'OS_LOGIN';
        default:
            return 'UNKNOWN';
    }
...
export const Instance = {
    ...
    toJSON(message: Instance): unknown {
        ...
        message.bootDisk !== undefined &&
            (obj.bootDisk = message.bootDisk ? AttachedDisk.toJSON(message.bootDisk) : undefined);
...
export const AttachedDisk = {
    ...
    toJSON(message: AttachedDisk): unknown {
        const obj: any = {};
        message.mode !== undefined && (obj.mode = attachedDisk_ModeToJSON(message.mode));
...
export const AttachedFilesystem = {
    ...
    toJSON(message: AttachedFilesystem): unknown {
        const obj: any = {};
        message.mode !== undefined && (obj.mode = attachedFilesystem_ModeToJSON(message.mode));
        message.deviceName !== undefined && (obj.deviceName = message.deviceName);
...
const basePrimaryAddress: object = { $type: 'yandex.cloud.compute.v1.PrimaryAddress', address: '' };
...
const baseNetworkSettings: object = { $type: 'yandex.cloud.compute.v1.NetworkSettings', type: 0 };
...
const baseGpuSettings: object = { $type: 'yandex.cloud.compute.v1.GpuSettings', gpuClusterId: '' };
...
export const GpuSettings = {
    ...
    toJSON(message: GpuSettings): unknown {
        const obj: any = {};
        message.gpuClusterId !== undefined && (obj.gpuClusterId = message.gpuClusterId);
        return obj;
    },
...
export const PlacementPolicy = {
    ...
    fromJSON(object: any): PlacementPolicy {
        ...
        message.placementGroupPartition =
            object.placementGroupPartition !== undefined && object.placementGroupPartition !== null
...
const baseSerialPortSettings: object = {
    $type: 'yandex.cloud.compute.v1.SerialPortSettings',
    sshAuthorization: 0,
};

export const SerialPortSettings = {
    $type: 'yandex.cloud.compute.v1.SerialPortSettings' as const,
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): SerialPortSettings {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseSerialPortSettings } as SerialPortSettings;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.sshAuthorization = reader.int32() as any;
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object: any): SerialPortSettings {
        const message = { ...baseSerialPortSettings } as SerialPortSettings;
        message.sshAuthorization =
            object.sshAuthorization !== undefined && object.sshAuthorization !== null
                ? serialPortSettings_SSHAuthorizationFromJSON(object.sshAuthorization)
                : 0;
        return message;
    },
    ...
    toJSON(message: SerialPortSettings): unknown {
        const obj: any = {};
        message.sshAuthorization !== undefined &&
            (obj.sshAuthorization = serialPortSettings_SSHAuthorizationToJSON(
                message.sshAuthorization,
            ));
        return obj;
    },

    fromPartial<I extends Exact<DeepPartial<SerialPortSettings>, I>>(
        object: I,
    ): SerialPortSettings {
        const message = { ...baseSerialPortSettings } as SerialPortSettings;
        message.sshAuthorization = object.sshAuthorization ?? 0;
        return message;
    },
};

messageTypeRegistry.set(SerialPortSettings.$type, SerialPortSettings);
