...
export function deployPolicy_MinimalActionFromJSON(
  object: any
...
export function deployPolicy_MinimalActionToJSON(
  object: DeployPolicy_MinimalAction
): string {
  switch (object) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 21:
          ...
          break;
        case 22:
          message.autoHealingPolicy = AutoHealingPolicy.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): InstanceGroup {
    ...
    message.applicationLoadBalancerState =
      ...
      object.applicationLoadBalancerState !== null
        ...
        : undefined;
    message.autoHealingPolicy =
      object.autoHealingPolicy !== undefined &&
      object.autoHealingPolicy !== null
...
export const DeployPolicy = {
  ...
  toJSON(message: DeployPolicy): unknown {
    ...
    message.minimalAction !== undefined &&
      (obj.minimalAction = deployPolicy_MinimalActionToJSON(
        message.minimalAction
      ));
    return obj;
  },
...
export const AutoHealingPolicy = {
  ...
  fromJSON(object: any): AutoHealingPolicy {
    ...
    message.autoHealingAction =
      object.autoHealingAction !== undefined &&
      object.autoHealingAction !== null
  ...
  fromPartial<I extends Exact<DeepPartial<AutoHealingPolicy>, I>>(
    object: I
  ): AutoHealingPolicy {
    const message = { ...baseAutoHealingPolicy } as AutoHealingPolicy;
