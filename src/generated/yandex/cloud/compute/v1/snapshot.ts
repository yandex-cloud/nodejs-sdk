...
export const Snapshot = {
    encode(message: Snapshot, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.kmsKey !== undefined) {
            KMSKey.encode(message.kmsKey, writer.uint32(106).fork()).ldelim();
        }
        return writer;
    },
    ...
    toJSON(message: Snapshot): unknown {
        ...
        message.status !== undefined && (obj.status = snapshot_StatusToJSON(message.status));
        message.sourceDiskId !== undefined && (obj.sourceDiskId = message.sourceDiskId);
