...
} from "../../../../yandex/cloud/speechsense/v1/audio";
import { TextContent } from "../../../../yandex/cloud/speechsense/v1/text";
import {
  Query,
  SortData,
  Filter,
} from "../../../../yandex/cloud/speechsense/v1/search";
  ...
  toJSON(message: StreamTalkRequest): unknown {
    ...
    message.metadata !== undefined &&
      (obj.metadata = message.metadata
        ? TalkMetadata.toJSON(message.metadata)
        : undefined);
    message.audio !== undefined &&
      (obj.audio = message.audio
        ? AudioStreamingRequest.toJSON(message.audio)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<StreamTalkRequest>, I>>(
    object: I
  ): StreamTalkRequest {
    const message = { ...baseStreamTalkRequest } as StreamTalkRequest;
    message.metadata =
...
export const UploadTalkRequest = {
  ...
  toJSON(message: UploadTalkRequest): unknown {
    ...
    message.audio !== undefined &&
      (obj.audio = message.audio
        ? AudioRequest.toJSON(message.audio)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<UploadTalkRequest>, I>>(
    object: I
  ): UploadTalkRequest {
    const message = { ...baseUploadTalkRequest } as UploadTalkRequest;
    message.metadata =
...
export const UploadTalkResponse = {
  ...
  fromJSON(object: any): UploadTalkResponse {
    const message = { ...baseUploadTalkResponse } as UploadTalkResponse;
    message.talkId =
      object.talkId !== undefined && object.talkId !== null
        ? String(object.talkId)
        : "";
    return message;
  },
...
export const UploadTextRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<UploadTextRequest>, I>>(
    object: I
  ): UploadTextRequest {
    const message = { ...baseUploadTextRequest } as UploadTextRequest;
    message.metadata =
...
export const TalkMetadata = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          const entry2 = TalkMetadata_FieldsEntry.decode(
            reader,
            reader.uint32()
          );
  ...
  toJSON(message: TalkMetadata): unknown {
    ...
    if (message.users) {
      obj.users = message.users.map((e) =>
        e ? UserMetadata.toJSON(e) : undefined
      );
    } else {
      obj.users = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<TalkMetadata>, I>>(
    object: I
  ): TalkMetadata {
    const message = { ...baseTalkMetadata } as TalkMetadata;
...
export const TalkMetadata_FieldsEntry = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseTalkMetadata_FieldsEntry,
    } as TalkMetadata_FieldsEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          const entry3 = UserMetadata_FieldsEntry.decode(
            reader,
            reader.uint32()
          );
...
export const UserMetadata_FieldsEntry = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUserMetadata_FieldsEntry,
    } as UserMetadata_FieldsEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const SearchTalkRequest = {
  ...
  toJSON(message: SearchTalkRequest): unknown {
    ...
    message.sortData !== undefined &&
      (obj.sortData = message.sortData
        ? SortData.toJSON(message.sortData)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<SearchTalkRequest>, I>>(
    object: I
  ): SearchTalkRequest {
    const message = { ...baseSearchTalkRequest } as SearchTalkRequest;
...
export const SearchTalkResponse = {
  ...
  toJSON(message: SearchTalkResponse): unknown {
    ...
    message.talksCount !== undefined &&
      (obj.talksCount = Math.round(message.talksCount));
...
export const GetTalkRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetTalkRequest>, I>>(
    object: I
  ): GetTalkRequest {
    const message = { ...baseGetTalkRequest } as GetTalkRequest;
    message.organizationId = object.organizationId ?? "";
...
export const GetTalkResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetTalkResponse>, I>>(
    object: I
  ): GetTalkResponse {
    const message = { ...baseGetTalkResponse } as GetTalkResponse;
...
export interface TalkServiceServer extends UntypedServiceImplementation {
   ...
   * second - audio metadata, others should contain audio bytes in chunks
   */
  uploadAsStream: handleClientStreamingCall<
    StreamTalkRequest,
    UploadTalkResponse
  >;
  /** rpc for uploading talk document as single message */
