...
export function summarizationFieldTypeFromJSON(object: any): SummarizationFieldType {
    switch (object) {
        case 0:
...
export function summarizationFieldTypeToJSON(object: SummarizationFieldType): string {
    switch (object) {
...
export const Summarization = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Summarization {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.statements.push(SummarizationStatement.decode(reader, reader.uint32()));
                    break;
                default:
...
export const SummarizationStatement = {
    ...
    toJSON(message: SummarizationStatement): unknown {
        ...
        message.field !== undefined &&
            (obj.field = message.field ? SummarizationField.toJSON(message.field) : undefined);
        if (message.response) {
...
export const SummarizationField = {
    ...
    toJSON(message: SummarizationField): unknown {
        ...
        message.type !== undefined && (obj.type = summarizationFieldTypeToJSON(message.type));
        return obj;
    },
