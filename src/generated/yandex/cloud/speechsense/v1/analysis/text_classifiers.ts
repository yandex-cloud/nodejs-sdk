...
export const TextClassifiers = {
  ...
  fromJSON(object: any): TextClassifiers {
    const message = { ...baseTextClassifiers } as TextClassifiers;
    message.classificationResult = (object.classificationResult ?? []).map(
      (e: any) => ClassificationResult.fromJSON(e)
    );
    return message;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<TextClassifiers>, I>>(
    object: I
  ): TextClassifiers {
    const message = { ...baseTextClassifiers } as TextClassifiers;
    message.classificationResult =
      object.classificationResult?.map((e) =>
        ClassificationResult.fromPartial(e)
      ) || [];
    return message;
  },
};
...
export const ClassificationResult = {
  ...
  fromJSON(object: any): ClassificationResult {
    ...
    message.classifier =
      object.classifier !== undefined && object.classifier !== null
        ...
        : "";
    message.classifierStatistics = (object.classifierStatistics ?? []).map(
      (e: any) => ClassifierStatistics.fromJSON(e)
    );
    return message;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ClassificationResult>, I>>(
    ...
    message.classifierStatistics =
      object.classifierStatistics?.map((e) =>
        ClassifierStatistics.fromPartial(e)
      ) || [];
    return message;
  },
};
...
export const ClassifierStatistics = {
  ...
  fromJSON(object: any): ClassifierStatistics {
    ...
    message.totalCount =
      object.totalCount !== undefined && object.totalCount !== null
        ...
        : 0;
    message.histograms = (object.histograms ?? []).map((e: any) =>
      Histogram.fromJSON(e)
    );
    return message;
  },
  ...
  toJSON(message: ClassifierStatistics): unknown {
    ...
    if (message.histograms) {
      obj.histograms = message.histograms.map((e) =>
        e ? Histogram.toJSON(e) : undefined
      );
    } else {
      obj.histograms = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<ClassifierStatistics>, I>>(
    ...
    message.histograms =
      object.histograms?.map((e) => Histogram.fromPartial(e)) || [];
    return message;
  },
};
