...
export const Filter = {
    encode(message: Filter, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.intRange !== undefined) {
            IntRangeFilter.encode(message.intRange, writer.uint32(26).fork()).ldelim();
        }
        if (message.doubleRange !== undefined) {
            DoubleRangeFilter.encode(message.doubleRange, writer.uint32(34).fork()).ldelim();
        }
        if (message.dateRange !== undefined) {
            DateRangeFilter.encode(message.dateRange, writer.uint32(42).fork()).ldelim();
        }
        if (message.durationRange !== undefined) {
            DurationRangeFilter.encode(message.durationRange, writer.uint32(50).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.doubleRange = DoubleRangeFilter.decode(reader, reader.uint32());
                    break;
                case 5:
                    message.dateRange = DateRangeFilter.decode(reader, reader.uint32());
                    break;
                case 6:
                    message.durationRange = DurationRangeFilter.decode(reader, reader.uint32());
                    break;
                case 9:
    ...
    toJSON(message: Filter): unknown {
        ...
        message.intRange !== undefined &&
            (obj.intRange = message.intRange ? IntRangeFilter.toJSON(message.intRange) : undefined);
...
export const BoundsInclusive = {
    ...
    toJSON(message: BoundsInclusive): unknown {
        const obj: any = {};
        message.fromInclusive !== undefined && (obj.fromInclusive = message.fromInclusive);
        message.toInclusive !== undefined && (obj.toInclusive = message.toInclusive);
        return obj;
    },
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.boundsInclusive = BoundsInclusive.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
...
export const DateRangeFilter = {
    encode(message: DateRangeFilter, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.toValue !== undefined) {
            Timestamp.encode(toTimestamp(message.toValue), writer.uint32(18).fork()).ldelim();
        }
        if (message.boundsInclusive !== undefined) {
            BoundsInclusive.encode(message.boundsInclusive, writer.uint32(26).fork()).ldelim();
        }
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): DateRangeFilter {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.fromValue = fromTimestamp(Timestamp.decode(reader, reader.uint32()));
                    break;
                case 2:
                    message.toValue = fromTimestamp(Timestamp.decode(reader, reader.uint32()));
                    break;
                case 3:
                    message.boundsInclusive = BoundsInclusive.decode(reader, reader.uint32());
                    break;
    ...
    toJSON(message: DateRangeFilter): unknown {
        const obj: any = {};
        message.fromValue !== undefined && (obj.fromValue = message.fromValue.toISOString());
        message.toValue !== undefined && (obj.toValue = message.toValue.toISOString());
        message.boundsInclusive !== undefined &&
            (obj.boundsInclusive = message.boundsInclusive
                ? BoundsInclusive.toJSON(message.boundsInclusive)
                : undefined);
...
export const DurationRangeFilter = {
    ...
    toJSON(message: DurationRangeFilter): unknown {
        ...
        message.fromValue !== undefined &&
            (obj.fromValue = message.fromValue ? Duration.toJSON(message.fromValue) : undefined);
        message.toValue !== undefined &&
            (obj.toValue = message.toValue ? Duration.toJSON(message.toValue) : undefined);
        message.boundsInclusive !== undefined &&
            (obj.boundsInclusive = message.boundsInclusive
                ? BoundsInclusive.toJSON(message.boundsInclusive)
                : undefined);
...
export const SortData = {
    ...
    fromJSON(object: any): SortData {
        const message = { ...baseSortData } as SortData;
        message.fields = (object.fields ?? []).map((e: any) => SortField.fromJSON(e));
        return message;
    },
    ...
    toJSON(message: SortData): unknown {
        const obj: any = {};
        if (message.fields) {
            obj.fields = message.fields.map((e) => (e ? SortField.toJSON(e) : undefined));
        } else {
            obj.fields = [];
        }
        return obj;
...
export const SortField = {
    ...
    fromJSON(object: any): SortField {
        const message = { ...baseSortField } as SortField;
        message.field =
            object.field !== undefined && object.field !== null ? String(object.field) : '';
        message.order =
