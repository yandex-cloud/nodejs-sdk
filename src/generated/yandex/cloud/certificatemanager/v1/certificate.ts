...
export const Certificate = {
    ...
    fromJSON(object: any): Certificate {
        ...
        message.subject =
            object.subject !== undefined && object.subject !== null ? String(object.subject) : '';
        message.serial =
            object.serial !== undefined && object.serial !== null ? String(object.serial) : '';
        message.updatedAt =
        ...
        message.notBefore =
            object.notBefore !== undefined && object.notBefore !== null
                ...
                : undefined;
        message.challenges = (object.challenges ?? []).map((e: any) => Challenge.fromJSON(e));
    ...
    toJSON(message: Certificate): unknown {
        ...
        message.status !== undefined && (obj.status = certificate_StatusToJSON(message.status));
        ...
        message.incompleteChain !== undefined && (obj.incompleteChain = message.incompleteChain);
        return obj;
    },
...
export const Certificate_LabelsEntry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Certificate_LabelsEntry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseCertificate_LabelsEntry } as Certificate_LabelsEntry;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const Challenge = {
    ...
    toJSON(message: Challenge): unknown {
        ...
        message.type !== undefined && (obj.type = challengeTypeToJSON(message.type));
        message.createdAt !== undefined && (obj.createdAt = message.createdAt.toISOString());
        message.updatedAt !== undefined && (obj.updatedAt = message.updatedAt.toISOString());
        message.status !== undefined && (obj.status = challenge_StatusToJSON(message.status));
