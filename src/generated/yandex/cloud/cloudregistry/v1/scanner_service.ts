...
import {
    ...
    ScanResult,
    Vulnerability,
    scanResult_StatusFromJSON,
    scanResult_StatusToJSON,
    vulnerability_SeverityFromJSON,
    vulnerability_SeverityToJSON,
} from './scanner';
...
export interface ListScanResultsFilter {
...
export interface ListVulnerabilitiesRequest {
    ...
    filter?: ListVulnerabilitiesFilter;
    /**
     * An order expression that orders resources listed in the response.
     * The expression must specify:
...
export interface ListVulnerabilitiesFilter {
...
const baseScanRequest: object = { artifactId: '' };
...
const baseScanMetadata: object = { artifactId: '' };
...
export const GetScanResultRequest: {
    ...
    toJSON(message: GetScanResultRequest): unknown {
        const obj: any = {};
        message.scanResultId !== undefined && (obj.scanResultId = message.scanResultId);
        return obj;
    },
...
const baseGetLastScanResultRequest: object = { artifactId: '' };
...
export const GetLastScanResultRequest: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): GetLastScanResultRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseGetLastScanResultRequest } as GetLastScanResultRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListScanResultsRequest: {
    ...
    encode(message: ListScanResultsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.filter !== undefined) {
            ListScanResultsFilter.encode(message.filter, writer.uint32(34).fork()).ldelim();
        }
        if (message.orderBy !== '') {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.filter = ListScanResultsFilter.decode(reader, reader.uint32());
                    break;
                case 5:
    ...
    fromJSON(object: any): ListScanResultsRequest {
        ...
        message.filter =
            object.filter !== undefined && object.filter !== null
                ? ListScanResultsFilter.fromJSON(object.filter)
                : undefined;
        message.orderBy =
    ...
    toJSON(message: ListScanResultsRequest): unknown {
        ...
        message.filter !== undefined &&
            (obj.filter = message.filter
                ? ListScanResultsFilter.toJSON(message.filter)
                : undefined);
    ...
    fromPartial<I extends Exact<DeepPartial<ListScanResultsRequest>, I>>(
        ...
        message.filter =
            object.filter !== undefined && object.filter !== null
                ? ListScanResultsFilter.fromPartial(object.filter)
                : undefined;
...
const baseListScanResultsFilter: object = { status: 0 };

export const ListScanResultsFilter: {
    encode(message: ListScanResultsFilter, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): ListScanResultsFilter;
    fromJSON(object: any): ListScanResultsFilter;
    toJSON(message: ListScanResultsFilter): unknown;
    fromPartial<I extends Exact<DeepPartial<ListScanResultsFilter>, I>>(object: I): ListScanResultsFilter;
} = {
    encode(message: ListScanResultsFilter, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        if (message.status !== 0) {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListScanResultsFilter {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListScanResultsFilter } as ListScanResultsFilter;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromPartial<I extends Exact<DeepPartial<ListScanResultsFilter>, I>>(
        object: I,
    ): ListScanResultsFilter {
        const message = { ...baseListScanResultsFilter } as ListScanResultsFilter;
...
export const ListScanResultsResponse: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListScanResultsResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListScanResultsResponse } as ListScanResultsResponse;
        message.scanResults = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object: any): ListScanResultsResponse {
        const message = { ...baseListScanResultsResponse } as ListScanResultsResponse;
        message.scanResults = (object.scanResults ?? []).map((e: any) => ScanResult.fromJSON(e));
...
export const ListVulnerabilitiesRequest: {
    ...
    encode(
        ...
        if (message.filter !== undefined) {
            ListVulnerabilitiesFilter.encode(message.filter, writer.uint32(34).fork()).ldelim();
        }
        if (message.orderBy !== '') {
            writer.uint32(42).string(message.orderBy);
        }
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListVulnerabilitiesRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListVulnerabilitiesRequest } as ListVulnerabilitiesRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.filter = ListVulnerabilitiesFilter.decode(reader, reader.uint32());
                    break;
                case 5:
                    message.orderBy = reader.string();
                    break;
    ...
    fromJSON(object: any): ListVulnerabilitiesRequest {
        ...
        message.filter =
            object.filter !== undefined && object.filter !== null
                ? ListVulnerabilitiesFilter.fromJSON(object.filter)
                : undefined;
        message.orderBy =
            object.orderBy !== undefined && object.orderBy !== null ? String(object.orderBy) : '';
        return message;
    ...
    toJSON(message: ListVulnerabilitiesRequest): unknown {
        ...
        message.filter !== undefined &&
            (obj.filter = message.filter
                ? ListVulnerabilitiesFilter.toJSON(message.filter)
                : undefined);
        message.orderBy !== undefined && (obj.orderBy = message.orderBy);
        return obj;
    },
    ...
    fromPartial<I extends Exact<DeepPartial<ListVulnerabilitiesRequest>, I>>(
        ...
        message.filter =
            object.filter !== undefined && object.filter !== null
                ? ListVulnerabilitiesFilter.fromPartial(object.filter)
                : undefined;
        message.orderBy = object.orderBy ?? '';
        return message;
    },
...
const baseListVulnerabilitiesFilter: object = { severity: 0, name: '' };

export const ListVulnerabilitiesFilter: {
    encode(message: ListVulnerabilitiesFilter, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): ListVulnerabilitiesFilter;
    fromJSON(object: any): ListVulnerabilitiesFilter;
    toJSON(message: ListVulnerabilitiesFilter): unknown;
    fromPartial<I extends Exact<DeepPartial<ListVulnerabilitiesFilter>, I>>(object: I): ListVulnerabilitiesFilter;
} = {
    encode(
        message: ListVulnerabilitiesFilter,
        writer: _m0.Writer = _m0.Writer.create(),
    ): _m0.Writer {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListVulnerabilitiesFilter {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListVulnerabilitiesFilter } as ListVulnerabilitiesFilter;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromPartial<I extends Exact<DeepPartial<ListVulnerabilitiesFilter>, I>>(
        object: I,
...
export const ListVulnerabilitiesResponse: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListVulnerabilitiesResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListVulnerabilitiesResponse } as ListVulnerabilitiesResponse;
...
export const ScannerServiceService = {
    ...
    scan: {
        path: '/yandex.cloud.cloudregistry.v1.ScannerService/Scan',
        requestStream: false,
     ...
     */
    get: {
        path: '/yandex.cloud.cloudregistry.v1.ScannerService/Get',
        requestStream: false,
        responseStream: false,
    ...
    getLast: {
        path: '/yandex.cloud.cloudregistry.v1.ScannerService/GetLast',
        requestStream: false,
        responseStream: false,
    ...
    list: {
        path: '/yandex.cloud.cloudregistry.v1.ScannerService/List',
        requestStream: false,
        responseStream: false,
    ...
    listVulnerabilities: {
        path: '/yandex.cloud.cloudregistry.v1.ScannerService/ListVulnerabilities',
        requestStream: false,
        responseStream: false,
...
export const ScannerServiceClient = makeGenericClientConstructor(
    ...
    'yandex.cloud.cloudregistry.v1.ScannerService',
) as unknown as {
    new (
        address: string,
