...
export const GetScanPolicyRequest: {
    ...
    toJSON(message: GetScanPolicyRequest): unknown {
        const obj: any = {};
        message.scanPolicyId !== undefined && (obj.scanPolicyId = message.scanPolicyId);
        return obj;
    },
...
export const GetScanPolicyByRegistryRequest: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): GetScanPolicyByRegistryRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseGetScanPolicyByRegistryRequest } as GetScanPolicyByRegistryRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const CreateScanPolicyRequest: {
    ...
    encode(message: CreateScanPolicyRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.scanLangPackages === true) {
            writer.uint32(32).bool(message.scanLangPackages);
        }
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): CreateScanPolicyRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseCreateScanPolicyRequest } as CreateScanPolicyRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const UpdateScanPolicyRequest: {
    ...
    encode(message: UpdateScanPolicyRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.scanLangPackages === true) {
            writer.uint32(40).bool(message.scanLangPackages);
        }
        if (message.rules !== undefined) {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): UpdateScanPolicyRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseUpdateScanPolicyRequest } as UpdateScanPolicyRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const DeleteScanPolicyRequest: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): DeleteScanPolicyRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseDeleteScanPolicyRequest } as DeleteScanPolicyRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const CreateScanPolicyMetadata: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): CreateScanPolicyMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseCreateScanPolicyMetadata } as CreateScanPolicyMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const UpdateScanPolicyMetadata: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): UpdateScanPolicyMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseUpdateScanPolicyMetadata } as UpdateScanPolicyMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const DeleteScanPolicyMetadata: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): DeleteScanPolicyMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseDeleteScanPolicyMetadata } as DeleteScanPolicyMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ScanPolicyServiceService = {
    ...
    get: {
        path: '/yandex.cloud.cloudregistry.v1.ScanPolicyService/Get',
        requestStream: false,
    ...
    getByRegistry: {
        path: '/yandex.cloud.cloudregistry.v1.ScanPolicyService/GetByRegistry',
        requestStream: false,
        responseStream: false,
    ...
    create: {
        path: '/yandex.cloud.cloudregistry.v1.ScanPolicyService/Create',
        requestStream: false,
        responseStream: false,
    ...
    update: {
        path: '/yandex.cloud.cloudregistry.v1.ScanPolicyService/Update',
        requestStream: false,
        responseStream: false,
    ...
    delete: {
        path: '/yandex.cloud.cloudregistry.v1.ScanPolicyService/Delete',
        requestStream: false,
        responseStream: false,
...
export const ScanPolicyServiceClient = makeGenericClientConstructor(
    ...
    'yandex.cloud.cloudregistry.v1.ScanPolicyService',
) as unknown as {
    new (
        address: string,
