...
export const ListDirectoryResponse = {
    ...
    fromPartial<I extends Exact<DeepPartial<ListDirectoryResponse>, I>>(
        ...
        const message = { ...baseListDirectoryResponse } as ListDirectoryResponse;
        message.items =
            object.items?.map((e) => ListDirectoryResponse_FilesystemItem.fromPartial(e)) || [];
        return message;
    },
};
...
export const CreateDirectoryMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): CreateDirectoryMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseCreateDirectoryMetadata } as CreateDirectoryMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListResourceOperationsRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListResourceOperationsRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListResourceOperationsRequest } as ListResourceOperationsRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ResourceServiceService = {
    ...
    listOperations: {
        ...
        requestDeserialize: (value: Buffer) => ListResourceOperationsRequest.decode(value),
