...
export const protobufPackage =
  "yandex.cloud.marketplace.licensemanager.saas.v1";
...
export const EnsureLockRequest = {
  $type:
    "yandex.cloud.marketplace.licensemanager.saas.v1.EnsureLockRequest" as const,
  ...
  toJSON(message: EnsureLockRequest): unknown {
    const obj: any = {};
    message.instanceToken !== undefined &&
      (obj.instanceToken = message.instanceToken);
...
export const EnsureLockMetadata = {
  $type:
    "yandex.cloud.marketplace.licensemanager.saas.v1.EnsureLockMetadata" as const,
...
export const GetLockRequest = {
  $type:
    "yandex.cloud.marketplace.licensemanager.saas.v1.GetLockRequest" as const,
