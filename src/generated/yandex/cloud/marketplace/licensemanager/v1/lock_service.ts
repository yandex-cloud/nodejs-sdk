...
export const ListLocksRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListLocksRequest>, I>>(
    object: I
  ): ListLocksRequest {
    const message = { ...baseListLocksRequest } as ListLocksRequest;
    message.resourceId = object.resourceId ?? "";
...
export const ListLocksResponse = {
  $type:
    "yandex.cloud.marketplace.licensemanager.v1.ListLocksResponse" as const,
  ...
  fromPartial<I extends Exact<DeepPartial<ListLocksResponse>, I>>(
    object: I
  ): ListLocksResponse {
    const message = { ...baseListLocksResponse } as ListLocksResponse;
