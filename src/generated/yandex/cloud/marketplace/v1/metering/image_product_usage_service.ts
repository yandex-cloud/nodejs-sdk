...
export const WriteImageProductUsageRequest = {
  $type:
    "yandex.cloud.marketplace.v1.metering.WriteImageProductUsageRequest" as const,
...
export const WriteImageProductUsageResponse = {
  $type:
    "yandex.cloud.marketplace.v1.metering.WriteImageProductUsageResponse" as const,
