...
export const ListResourceRulesRequest = {
  ...
  decode(
    ...
    const message = {
      ...baseListResourceRulesRequest,
    } as ListResourceRulesRequest;
...
export const ListResourceRulesResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListResourceRulesResponse,
    } as ListResourceRulesResponse;
    message.rules = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
messageTypeRegistry.set(
  ListResourceRulesResponse.$type,
  ListResourceRulesResponse
);
...
export const CreateResourceRuleRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCreateResourceRuleRequest,
    } as CreateResourceRuleRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  CreateResourceRuleRequest.$type,
  CreateResourceRuleRequest
);
...
export const CreateResourceRuleMetadata = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCreateResourceRuleMetadata,
...
messageTypeRegistry.set(
  CreateResourceRuleMetadata.$type,
  CreateResourceRuleMetadata
);
...
export const UpdateResourceRuleRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpdateResourceRuleRequest,
    } as UpdateResourceRuleRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  UpdateResourceRuleRequest.$type,
  UpdateResourceRuleRequest
);
...
export const UpdateResourceRuleMetadata = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpdateResourceRuleMetadata,
    } as UpdateResourceRuleMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  UpdateResourceRuleMetadata.$type,
  UpdateResourceRuleMetadata
);
...
export const DeleteResourceRuleRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseDeleteResourceRuleRequest,
    } as DeleteResourceRuleRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  DeleteResourceRuleRequest.$type,
  DeleteResourceRuleRequest
);
...
export const DeleteResourceRuleMetadata = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseDeleteResourceRuleMetadata,
    } as DeleteResourceRuleMetadata;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  DeleteResourceRuleMetadata.$type,
  DeleteResourceRuleMetadata
);
...
export const ResourceRulesServiceService = {
  ...
  create: {
    ...
    requestDeserialize: (value: Buffer) =>
      CreateResourceRuleRequest.decode(value),
  ...
  update: {
    ...
    requestDeserialize: (value: Buffer) =>
      UpdateResourceRuleRequest.decode(value),
    responseSerialize: (value: Operation) =>
      Buffer.from(Operation.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Operation.decode(value),
  },
  ...
  delete: {
    ...
    requestDeserialize: (value: Buffer) =>
      DeleteResourceRuleRequest.decode(value),
    responseSerialize: (value: Operation) =>
      Buffer.from(Operation.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Operation.decode(value),
  },
...
export interface ResourceRulesServiceServer
