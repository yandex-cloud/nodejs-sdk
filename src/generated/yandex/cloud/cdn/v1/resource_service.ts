    ...
    fromJSON(object: any): CreateResourceRequest {
        ...
        message.origin =
            object.origin !== undefined && object.origin !== null
                ...
                : undefined;
        message.secondaryHostnames =
            object.secondaryHostnames !== undefined && object.secondaryHostnames !== null
...
export const CreateResourceRequest_Origin = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): CreateResourceRequest_Origin {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseCreateResourceRequest_Origin } as CreateResourceRequest_Origin;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object: any): CreateResourceRequest_Origin {
        ...
        message.originSource =
            object.originSource !== undefined && object.originSource !== null
                ...
                : undefined;
        message.originSourceParams =
            object.originSourceParams !== undefined && object.originSourceParams !== null
    ...
    toJSON(message: CreateResourceRequest_Origin): unknown {
        ...
        message.originSource !== undefined && (obj.originSource = message.originSource);
...
export const UpdateResourceRequest = {
    ...
    toJSON(message: UpdateResourceRequest): unknown {
        const obj: any = {};
        message.resourceId !== undefined && (obj.resourceId = message.resourceId);
        message.originGroupId !== undefined && (obj.originGroupId = message.originGroupId);
        message.secondaryHostnames !== undefined &&
            (obj.secondaryHostnames = message.secondaryHostnames
                ? SecondaryHostnames.toJSON(message.secondaryHostnames)
                : undefined);
...
export const GetProviderCNameRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): GetProviderCNameRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseGetProviderCNameRequest } as GetProviderCNameRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const GetProviderCNameResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): GetProviderCNameResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseGetProviderCNameResponse } as GetProviderCNameResponse;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
