    ...
    fromJSON(object: any): Origin {
        ...
        message.enabled =
            object.enabled !== undefined && object.enabled !== null
                ...
                : false;
        message.backup =
            object.backup !== undefined && object.backup !== null ? Boolean(object.backup) : false;
        message.meta =
...
export const OriginMeta = {
    ...
    toJSON(message: OriginMeta): unknown {
        ...
        message.common !== undefined &&
            (obj.common = message.common ? OriginNamedMeta.toJSON(message.common) : undefined);
        message.bucket !== undefined &&
            (obj.bucket = message.bucket ? OriginNamedMeta.toJSON(message.bucket) : undefined);
        message.website !== undefined &&
            (obj.website = message.website ? OriginNamedMeta.toJSON(message.website) : undefined);
