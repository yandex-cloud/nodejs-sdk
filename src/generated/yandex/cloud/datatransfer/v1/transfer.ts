...
export const Runtime = {
  ...
  toJSON(message: Runtime): unknown {
    ...
    message.ycRuntime !== undefined &&
      (obj.ycRuntime = message.ycRuntime
        ? YcRuntime.toJSON(message.ycRuntime)
        : undefined);
    return obj;
  },
...
export const ShardingUploadParams = {
  ...
  fromJSON(object: any): ShardingUploadParams {
    const message = { ...baseShardingUploadParams } as ShardingUploadParams;
    message.jobCount =
      object.jobCount !== undefined && object.jobCount !== null
        ? Number(object.jobCount)
        : 0;
  ...
  toJSON(message: ShardingUploadParams): unknown {
    ...
    message.processCount !== undefined &&
...
export const YcRuntime = {
  ...
  fromJSON(object: any): YcRuntime {
    ...
    message.jobCount =
      object.jobCount !== undefined && object.jobCount !== null
        ...
        : 0;
    message.uploadShardParams =
      object.uploadShardParams !== undefined &&
      object.uploadShardParams !== null
  ...
  fromPartial<I extends Exact<DeepPartial<YcRuntime>, I>>(
    object: I
  ): YcRuntime {
    const message = { ...baseYcRuntime } as YcRuntime;
    message.jobCount = object.jobCount ?? 0;
...
export const MaskFunction = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MaskFunction {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.maskFunctionHash = MaskFunctionHash.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromPartial<I extends Exact<DeepPartial<MaskFunction>, I>>(
    object: I
  ): MaskFunction {
    const message = { ...baseMaskFunction } as MaskFunction;
    message.maskFunctionHash =
...
export const MaskFunctionHash = {
  ...
  toJSON(message: MaskFunctionHash): unknown {
    const obj: any = {};
    message.userDefinedSalt !== undefined &&
      (obj.userDefinedSalt = message.userDefinedSalt);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<MaskFunctionHash>, I>>(
    object: I
  ): MaskFunctionHash {
    const message = { ...baseMaskFunctionHash } as MaskFunctionHash;
...
export const TablesFilter = {
  ...
  fromPartial<I extends Exact<DeepPartial<TablesFilter>, I>>(
    object: I
  ): TablesFilter {
    const message = { ...baseTablesFilter } as TablesFilter;
...
export const ColumnsFilter = {
  ...
  fromJSON(object: any): ColumnsFilter {
    const message = { ...baseColumnsFilter } as ColumnsFilter;
    message.includeColumns = (object.includeColumns ?? []).map((e: any) =>
      String(e)
    );
    message.excludeColumns = (object.excludeColumns ?? []).map((e: any) =>
      String(e)
    );
    return message;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ColumnsFilter>, I>>(
    object: I
  ): ColumnsFilter {
    const message = { ...baseColumnsFilter } as ColumnsFilter;
  ...
  toJSON(message: MaskFieldTransformer): unknown {
    ...
    message.tables !== undefined &&
      (obj.tables = message.tables
        ? TablesFilter.toJSON(message.tables)
        : undefined);
    if (message.columns) {
    ...
    message.function !== undefined &&
      (obj.function = message.function
        ? MaskFunction.toJSON(message.function)
        : undefined);
    return obj;
  },
...
export const FilterColumnsTransformer = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseFilterColumnsTransformer,
    } as FilterColumnsTransformer;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: FilterColumnsTransformer): unknown {
    ...
    message.columns !== undefined &&
      (obj.columns = message.columns
        ? ColumnsFilter.toJSON(message.columns)
        : undefined);
    return obj;
  },
...
messageTypeRegistry.set(
  FilterColumnsTransformer.$type,
  FilterColumnsTransformer
);

const baseTable: object = {
  $type: "yandex.cloud.datatransfer.v1.Table",
  nameSpace: "",
  name: "",
};
  ...
  toJSON(message: RenameTable): unknown {
    ...
    message.newName !== undefined &&
      (obj.newName = message.newName
        ? Table.toJSON(message.newName)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<RenameTable>, I>>(
    object: I
  ): RenameTable {
    const message = { ...baseRenameTable } as RenameTable;
    message.originalName =
...
export const RenameTablesTransformer = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseRenameTablesTransformer,
    } as RenameTablesTransformer;
    message.renameTables = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.renameTables.push(
            RenameTable.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  fromJSON(object: any): RenameTablesTransformer {
    ...
    message.renameTables = (object.renameTables ?? []).map((e: any) =>
      RenameTable.fromJSON(e)
    );
    return message;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<RenameTablesTransformer>, I>>(
    ...
    message.renameTables =
      object.renameTables?.map((e) => RenameTable.fromPartial(e)) || [];
    return message;
  },
};
...
export const ReplacePrimaryKeyTransformer = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseReplacePrimaryKeyTransformer,
    } as ReplacePrimaryKeyTransformer;
    message.keys = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
messageTypeRegistry.set(
  ReplacePrimaryKeyTransformer.$type,
  ReplacePrimaryKeyTransformer
);
...
export const TableSplitterTransformer = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseTableSplitterTransformer,
    } as TableSplitterTransformer;
    message.columns = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
export const Transformer = {
  ...
  encode(
    ...
    if (message.renameTables !== undefined) {
      RenameTablesTransformer.encode(
        message.renameTables,
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Transformer {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.maskField = MaskFieldTransformer.decode(
            reader,
            reader.uint32()
          );
          break;
        case 2:
          ...
          break;
        case 4:
          message.renameTables = RenameTablesTransformer.decode(
            reader,
            reader.uint32()
          );
          break;
        case 6:
          ...
          break;
        case 7:
          message.convertToString = ToStringTransformer.decode(
            reader,
            reader.uint32()
          );
          break;
        case 9:
          message.sharderTransformer = SharderTransformer.decode(
            reader,
            reader.uint32()
          );
          break;
        case 13:
          ...
          break;
        case 14:
          message.filterRows = FilterRowsTransformer.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): Transformer {
    ...
    message.renameTables =
      object.renameTables !== undefined && object.renameTables !== null
        ...
        : undefined;
    message.replacePrimaryKey =
      object.replacePrimaryKey !== undefined &&
      object.replacePrimaryKey !== null
    ...
    message.convertToString =
      object.convertToString !== undefined && object.convertToString !== null
        ...
        : undefined;
    message.sharderTransformer =
      object.sharderTransformer !== undefined &&
  ...
  fromPartial<I extends Exact<DeepPartial<Transformer>, I>>(
    object: I
  ): Transformer {
    const message = { ...baseTransformer } as Transformer;
    message.maskField =
...
export const Transformation = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Transformation {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.transformers.push(
            Transformer.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  fromJSON(object: any): Transformation {
    const message = { ...baseTransformation } as Transformation;
    message.transformers = (object.transformers ?? []).map((e: any) =>
      Transformer.fromJSON(e)
    );
    return message;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Transformation>, I>>(
    object: I
  ): Transformation {
    const message = { ...baseTransformation } as Transformation;
    message.transformers =
      object.transformers?.map((e) => Transformer.fromPartial(e)) || [];
    return message;
  },
};
