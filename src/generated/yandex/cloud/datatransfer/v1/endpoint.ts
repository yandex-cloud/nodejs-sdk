...
export const EndpointSettings = {
    encode(message: EndpointSettings, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.metrikaSource !== undefined) {
            MetrikaSource.encode(message.metrikaSource, writer.uint32(1170).fork()).ldelim();
        }
    ...
    toJSON(message: EndpointSettings): unknown {
        ...
        message.ydbSource !== undefined &&
            (obj.ydbSource = message.ydbSource ? YdbSource.toJSON(message.ydbSource) : undefined);
        message.ydsSource !== undefined &&
            (obj.ydsSource = message.ydsSource ? YDSSource.toJSON(message.ydsSource) : undefined);
        ...
        message.ydbTarget !== undefined &&
            (obj.ydbTarget = message.ydbTarget ? YdbTarget.toJSON(message.ydbTarget) : undefined);
        ...
        message.ydsTarget !== undefined &&
            (obj.ydsTarget = message.ydsTarget ? YDSTarget.toJSON(message.ydsTarget) : undefined);
        return obj;
    },
