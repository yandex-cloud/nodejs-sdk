...
export const OnPremiseClickhouse = {
    ...
    fromJSON(object: any): OnPremiseClickhouse {
        const message = { ...baseOnPremiseClickhouse } as OnPremiseClickhouse;
        message.shards = (object.shards ?? []).map((e: any) => ClickhouseShard.fromJSON(e));
        message.httpPort =
    ...
    toJSON(message: OnPremiseClickhouse): unknown {
        const obj: any = {};
        if (message.shards) {
            obj.shards = message.shards.map((e) => (e ? ClickhouseShard.toJSON(e) : undefined));
        } else {
            obj.shards = [];
        }
        message.httpPort !== undefined && (obj.httpPort = Math.round(message.httpPort));
        message.nativePort !== undefined && (obj.nativePort = Math.round(message.nativePort));
...
export const ClickhouseConnectionOptions = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ClickhouseConnectionOptions {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseClickhouseConnectionOptions } as ClickhouseConnectionOptions;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 2:
...
export const ClickhouseSharding = {
    ...
    toJSON(message: ClickhouseSharding): unknown {
        ...
        message.transferId !== undefined &&
            (obj.transferId = message.transferId ? Empty.toJSON(message.transferId) : undefined);
        message.roundRobin !== undefined &&
            (obj.roundRobin = message.roundRobin ? Empty.toJSON(message.roundRobin) : undefined);
        return obj;
    },
    ...
    toJSON(message: ClickhouseSharding_ColumnValueMapping): unknown {
        ...
        if (message.mapping) {
            obj.mapping = message.mapping.map((e) =>
                e ? ClickhouseSharding_ColumnValueMapping_ValueToShard.toJSON(e) : undefined,
            );
        } else {
            obj.mapping = [];
        }
...
export const ClickhouseSharding_ColumnValueMapping_ValueToShard = {
    ...
    fromPartial<
        I extends Exact<DeepPartial<ClickhouseSharding_ColumnValueMapping_ValueToShard>, I>,
...
export const ClickhouseTarget = {
    ...
    fromJSON(object: any): ClickhouseTarget {
        ...
        message.subnetId =
            object.subnetId !== undefined && object.subnetId !== null
                ? String(object.subnetId)
                : '';
        message.altNames = (object.altNames ?? []).map((e: any) => AltName.fromJSON(e));
    ...
    toJSON(message: ClickhouseTarget): unknown {
        ...
        message.subnetId !== undefined && (obj.subnetId = message.subnetId);
        if (message.altNames) {
            obj.altNames = message.altNames.map((e) => (e ? AltName.toJSON(e) : undefined));
        } else {
            obj.altNames = [];
        }
