    ...
    fromJSON(object: any): Parser {
        ...
        message.jsonParser =
            object.jsonParser !== undefined && object.jsonParser !== null
                ...
                : undefined;
        message.auditTrailsV1Parser =
            object.auditTrailsV1Parser !== undefined && object.auditTrailsV1Parser !== null
                ? AuditTrailsV1Parser.fromJSON(object.auditTrailsV1Parser)
                : undefined;
        message.cloudLoggingParser =
            object.cloudLoggingParser !== undefined && object.cloudLoggingParser !== null
...
export const GenericParserCommon = {
    ...
    fromJSON(object: any): GenericParserCommon {
        ...
        message.unescapeStringValues =
            object.unescapeStringValues !== undefined && object.unescapeStringValues !== null
    ...
    toJSON(message: GenericParserCommon): unknown {
        ...
        message.dataSchema !== undefined &&
            (obj.dataSchema = message.dataSchema
                ...
                : undefined);
        message.nullKeysAllowed !== undefined && (obj.nullKeysAllowed = message.nullKeysAllowed);
        message.addRestColumn !== undefined && (obj.addRestColumn = message.addRestColumn);
