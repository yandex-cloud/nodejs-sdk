...
export const DebeziumSerializerParameter = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): DebeziumSerializerParameter {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseDebeziumSerializerParameter } as DebeziumSerializerParameter;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const SerializerDebezium = {
    ...
    fromJSON(object: any): SerializerDebezium {
        const message = { ...baseSerializerDebezium } as SerializerDebezium;
        message.serializerParameters = (object.serializerParameters ?? []).map((e: any) =>
            DebeziumSerializerParameter.fromJSON(e),
        );
        return message;
    },
    ...
    fromJSON(object: any): Serializer {
        ...
        message.serializerJson =
            object.serializerJson !== undefined && object.serializerJson !== null
                ...
                : undefined;
        message.serializerDebezium =
            object.serializerDebezium !== undefined && object.serializerDebezium !== null
