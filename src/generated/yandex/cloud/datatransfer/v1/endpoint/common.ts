    ...
    fromJSON(object: any): AltName {
        ...
        message.fromName =
            object.fromName !== undefined && object.fromName !== null
                ...
                : '';
        message.toName =
            object.toName !== undefined && object.toName !== null ? String(object.toName) : '';
        return message;
    },
...
export const Secret = {
    ...
    fromJSON(object: any): Secret {
        const message = { ...baseSecret } as Secret;
        message.raw =
            object.raw !== undefined && object.raw !== null ? String(object.raw) : undefined;
        return message;
    },
...
export const ColSchema = {
    ...
    fromJSON(object: any): ColSchema {
        ...
        message.type =
            object.type !== undefined && object.type !== null ? columnTypeFromJSON(object.type) : 0;
        message.key = object.key !== undefined && object.key !== null ? Boolean(object.key) : false;
        message.required =
...
export const TLSMode = {
    ...
    toJSON(message: TLSMode): unknown {
        ...
        message.enabled !== undefined &&
            (obj.enabled = message.enabled ? TLSConfig.toJSON(message.enabled) : undefined);
        return obj;
    },
...
export const DataTransformationOptions = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): DataTransformationOptions {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseDataTransformationOptions } as DataTransformationOptions;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object: any): DataTransformationOptions {
        ...
        message.bufferFlushInterval =
            object.bufferFlushInterval !== undefined && object.bufferFlushInterval !== null
                ? String(object.bufferFlushInterval)
                : '';
        message.invocationTimeout =
            object.invocationTimeout !== undefined && object.invocationTimeout !== null
    ...
    toJSON(message: DataTransformationOptions): unknown {
        const obj: any = {};
        message.cloudFunction !== undefined && (obj.cloudFunction = message.cloudFunction);
...
export const FieldList = {
    ...
    fromJSON(object: any): FieldList {
        const message = { ...baseFieldList } as FieldList;
        message.fields = (object.fields ?? []).map((e: any) => ColSchema.fromJSON(e));
        return message;
    },
    ...
    toJSON(message: FieldList): unknown {
        const obj: any = {};
        if (message.fields) {
            obj.fields = message.fields.map((e) => (e ? ColSchema.toJSON(e) : undefined));
        } else {
            obj.fields = [];
        }
        return obj;
...
export const DataSchema = {
    ...
    toJSON(message: DataSchema): unknown {
        ...
        message.fields !== undefined &&
            (obj.fields = message.fields ? FieldList.toJSON(message.fields) : undefined);
        return obj;
    },
