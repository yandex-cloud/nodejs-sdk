...
export const ReadRequest = {
    ...
    toJSON(message: ReadRequest): unknown {
        ...
        message.criteria !== undefined &&
            (obj.criteria = message.criteria ? Criteria.toJSON(message.criteria) : undefined);
        return obj;
    },
    ...
    fromJSON(object: any): ReadResponse {
        ...
        message.logGroupId =
            object.logGroupId !== undefined && object.logGroupId !== null
                ...
                : '';
        message.entries = (object.entries ?? []).map((e: any) => LogEntry.fromJSON(e));
        message.nextPageToken =
            object.nextPageToken !== undefined && object.nextPageToken !== null
                ? String(object.nextPageToken)
                : '';
        message.previousPageToken =
            object.previousPageToken !== undefined && object.previousPageToken !== null
