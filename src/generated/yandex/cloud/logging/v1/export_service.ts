...
export const ListExportsResponse = {
    ...
    fromJSON(object: any): ListExportsResponse {
        const message = { ...baseListExportsResponse } as ListExportsResponse;
        message.exports = (object.exports ?? []).map((e: any) => Export.fromJSON(e));
    ...
    toJSON(message: ListExportsResponse): unknown {
        const obj: any = {};
        if (message.exports) {
            obj.exports = message.exports.map((e) => (e ? Export.toJSON(e) : undefined));
        } else {
            obj.exports = [];
        }
...
export const ListExportOperationsRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListExportOperationsRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListExportOperationsRequest } as ListExportOperationsRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListExportOperationsResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListExportOperationsResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListExportOperationsResponse } as ListExportOperationsResponse;
        message.operations = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
