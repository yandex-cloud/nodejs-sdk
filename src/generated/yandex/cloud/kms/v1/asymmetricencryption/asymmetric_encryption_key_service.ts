        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    const entry4 = CreateAsymmetricEncryptionKeyRequest_LabelsEntry.decode(
                        reader,
                        reader.uint32(),
                    );
...
export const ListAsymmetricEncryptionKeysResponse = {
    ...
    fromJSON(object: any): ListAsymmetricEncryptionKeysResponse {
        ...
        message.keys = (object.keys ?? []).map((e: any) => AsymmetricEncryptionKey.fromJSON(e));
    ...
    toJSON(message: ListAsymmetricEncryptionKeysResponse): unknown {
        const obj: any = {};
        if (message.keys) {
            obj.keys = message.keys.map((e) => (e ? AsymmetricEncryptionKey.toJSON(e) : undefined));
        } else {
            obj.keys = [];
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    const entry6 = UpdateAsymmetricEncryptionKeyRequest_LabelsEntry.decode(
                        reader,
                        reader.uint32(),
                    );
