...
export function routingInstance_StatusFromJSON(
  object: any
): RoutingInstance_Status {
  switch (object) {
    case 0:
...
export function routingInstance_StatusToJSON(
  object: RoutingInstance_Status
): string {
  switch (object) {
...
export const RoutingInstance = {
  ...
  encode(
    ...
    for (const v of message.cicPrivateConnectionInfo) {
      RoutingInstance_CicPrivateConnectionInfo.encode(
        v!,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          break;
        case 7:
          message.vpcInfo.push(
            RoutingInstance_VpcInfo.decode(reader, reader.uint32())
          );
          break;
        case 8:
          message.cicPrivateConnectionInfo.push(
            RoutingInstance_CicPrivateConnectionInfo.decode(
              reader,
              reader.uint32()
            )
          );
        ...
        case 9:
          ...
          break;
        case 24:
          const entry24 = RoutingInstance_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
  ...
  fromJSON(object: any): RoutingInstance {
    ...
    message.cicPrivateConnectionInfo = (
      object.cicPrivateConnectionInfo ?? []
    ).map((e: any) => RoutingInstance_CicPrivateConnectionInfo.fromJSON(e));
    message.status =
  ...
  toJSON(message: RoutingInstance): unknown {
    ...
    message.status !== undefined &&
      (obj.status = routingInstance_StatusToJSON(message.status));
    obj.labels = {};
    if (message.labels) {
  ...
  fromPartial<I extends Exact<DeepPartial<RoutingInstance>, I>>(
    object: I
  ): RoutingInstance {
    const message = { ...baseRoutingInstance } as RoutingInstance;
    ...
    message.vpcInfo =
      object.vpcInfo?.map((e) => RoutingInstance_VpcInfo.fromPartial(e)) || [];
    message.cicPrivateConnectionInfo =
...
export const RoutingInstance_LabelsEntry = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseRoutingInstance_LabelsEntry,
    } as RoutingInstance_LabelsEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  RoutingInstance_LabelsEntry.$type,
  RoutingInstance_LabelsEntry
);
...
export const RoutingInstance_CicPrivateConnectionInfo = {
  $type:
    "yandex.cloud.cloudrouter.v1.RoutingInstance.CicPrivateConnectionInfo" as const,
  ...
  fromJSON(object: any): RoutingInstance_CicPrivateConnectionInfo {
    ...
    message.cicPrivateConnectionId =
      object.cicPrivateConnectionId !== undefined &&
      object.cicPrivateConnectionId !== null
  ...
  fromPartial<
    I extends Exact<DeepPartial<RoutingInstance_CicPrivateConnectionInfo>, I>
  >(object: I): RoutingInstance_CicPrivateConnectionInfo {
    const message = {
      ...baseRoutingInstance_CicPrivateConnectionInfo,
    } as RoutingInstance_CicPrivateConnectionInfo;
...
export const RoutingInstance_VpcInfo = {
  ...
  encode(
    message: RoutingInstance_VpcInfo,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseRoutingInstance_VpcInfo,
    } as RoutingInstance_VpcInfo;
    message.azInfos = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.azInfos.push(
            RoutingInstance_VpcAzInfo.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  toJSON(message: RoutingInstance_VpcInfo): unknown {
    const obj: any = {};
    message.vpcNetworkId !== undefined &&
      (obj.vpcNetworkId = message.vpcNetworkId);
    if (message.azInfos) {
...
export const RoutingInstance_VpcAzInfo = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseRoutingInstance_VpcAzInfo,
    } as RoutingInstance_VpcAzInfo;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 2:
...
messageTypeRegistry.set(
  RoutingInstance_VpcAzInfo.$type,
  RoutingInstance_VpcAzInfo
);
...
export const RoutingInstance_VpcManualInfo = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseRoutingInstance_VpcManualInfo,
    } as RoutingInstance_VpcManualInfo;
    message.prefixes = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromJSON(object: any): RoutingInstance_VpcManualInfo {
    ...
    message.azId =
      object.azId !== undefined && object.azId !== null
        ? String(object.azId)
        : "";
...
messageTypeRegistry.set(
  RoutingInstance_VpcManualInfo.$type,
  RoutingInstance_VpcManualInfo
);
...
export const RoutingInstance_VpcAutomaticInfo = {
  $type:
    "yandex.cloud.cloudrouter.v1.RoutingInstance.VpcAutomaticInfo" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<RoutingInstance_VpcAutomaticInfo>, I>
  >(object: I): RoutingInstance_VpcAutomaticInfo {
    const message = {
      ...baseRoutingInstance_VpcAutomaticInfo,
    } as RoutingInstance_VpcAutomaticInfo;
    message.azId = object.azId ?? "";
...
messageTypeRegistry.set(
  RoutingInstance_VpcAutomaticInfo.$type,
  RoutingInstance_VpcAutomaticInfo
);
