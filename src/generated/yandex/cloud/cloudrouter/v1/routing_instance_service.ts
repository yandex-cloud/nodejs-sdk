...
export const GetRoutingInstanceRequest = {
  ...
  fromJSON(object: any): GetRoutingInstanceRequest {
    ...
    message.routingInstanceId =
      object.routingInstanceId !== undefined &&
      object.routingInstanceId !== null
...
messageTypeRegistry.set(
  GetRoutingInstanceRequest.$type,
  GetRoutingInstanceRequest
);

const baseGetRoutingInstanceByCicPrivateConnectionIdRequest: object = {
  $type:
    "yandex.cloud.cloudrouter.v1.GetRoutingInstanceByCicPrivateConnectionIdRequest",
  cicPrivateConnectionId: "",
};

export const GetRoutingInstanceByCicPrivateConnectionIdRequest = {
  $type:
    "yandex.cloud.cloudrouter.v1.GetRoutingInstanceByCicPrivateConnectionIdRequest" as const,
  ...
  fromPartial<
    I extends Exact<
      DeepPartial<GetRoutingInstanceByCicPrivateConnectionIdRequest>,
      I
    >
  >(object: I): GetRoutingInstanceByCicPrivateConnectionIdRequest {
    const message = {
      ...baseGetRoutingInstanceByCicPrivateConnectionIdRequest,
    } as GetRoutingInstanceByCicPrivateConnectionIdRequest;
...
export const GetRoutingInstanceByVpcNetworkIdRequest = {
  $type:
    "yandex.cloud.cloudrouter.v1.GetRoutingInstanceByVpcNetworkIdRequest" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<GetRoutingInstanceByVpcNetworkIdRequest>, I>
  >(object: I): GetRoutingInstanceByVpcNetworkIdRequest {
    const message = {
      ...baseGetRoutingInstanceByVpcNetworkIdRequest,
    } as GetRoutingInstanceByVpcNetworkIdRequest;
...
export const ListRoutingInstancesRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListRoutingInstancesRequest,
...
messageTypeRegistry.set(
  ListRoutingInstancesRequest.$type,
  ListRoutingInstancesRequest
);
...
export const ListRoutingInstancesResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListRoutingInstancesResponse,
    } as ListRoutingInstancesResponse;
    message.routingInstances = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.routingInstances.push(
            RoutingInstance.decode(reader, reader.uint32())
          );
          break;
        case 2:
...
messageTypeRegistry.set(
  ListRoutingInstancesResponse.$type,
  ListRoutingInstancesResponse
);
...
export const RoutingInstanceServiceService = {
  ...
  get: {
    ...
    requestDeserialize: (value: Buffer) =>
      GetRoutingInstanceRequest.decode(value),
  ...
  getByVpcNetworkId: {
    ...
    requestSerialize: (value: GetRoutingInstanceByVpcNetworkIdRequest) =>
      Buffer.from(
        GetRoutingInstanceByVpcNetworkIdRequest.encode(value).finish()
      ),
    requestDeserialize: (value: Buffer) =>
  ...
  getByCicPrivateConnectionId: {
    ...
    responseStream: false,
    requestSerialize: (
      value: GetRoutingInstanceByCicPrivateConnectionIdRequest
    ) =>
      Buffer.from(
        GetRoutingInstanceByCicPrivateConnectionIdRequest.encode(value).finish()
      ),
    requestDeserialize: (value: Buffer) =>
  ...
  list: {
    ...
    requestDeserialize: (value: Buffer) =>
      ListRoutingInstancesRequest.decode(value),
    responseSerialize: (value: ListRoutingInstancesResponse) =>
      Buffer.from(ListRoutingInstancesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) =>
      ListRoutingInstancesResponse.decode(value),
  },
} as const;

export interface RoutingInstanceServiceServer
   ...
   * To get the list of available RoutingInstance resources, make a [List] request.
   */
  getByVpcNetworkId: handleUnaryCall<
    GetRoutingInstanceByVpcNetworkIdRequest,
    RoutingInstance
  >;
  /**
...
export interface RoutingInstanceServiceClient extends Client {
  ...
  list(
    ...
    callback: (
      ...
      response: ListRoutingInstancesResponse
    ) => void
  ): ClientUnaryCall;
  list(
    request: ListRoutingInstancesRequest,
