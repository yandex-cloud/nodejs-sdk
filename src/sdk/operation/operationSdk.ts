...
export class OperationSdk {
    ...
    constructor(session: SessionArg) {
        this.operationClient = session.client(OperationServiceClient);
    }
    ...
    public get(params: GetOperationProps, args?: ClientCallArgs) {
        return this.operationClient.get(GetOperationRequest.fromPartial(params), args);
    }

    public cancel(params: CancelOperationProps, args?: ClientCallArgs) {
        return this.operationClient.cancel(CancelOperationRequest.fromPartial(params), args);
    }
}
