    ...
    fromJSON(object: any): WriteRequest {
        ...
        message.resource =
            object.resource !== undefined && object.resource !== null
                ...
                : undefined;
        message.entries = (object.entries ?? []).map((e: any) => IncomingLogEntry.fromJSON(e));
        message.defaults =
...
export const WriteResponse = {
    ...
    fromJSON(object: any): WriteResponse {
        const message = { ...baseWriteResponse } as WriteResponse;
        message.errors = Object.entries(object.errors ?? {}).reduce<{ [key: number]: Status }>(
            (acc, [key, value]) => {
...
export const WriteResponse_ErrorsEntry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): WriteResponse_ErrorsEntry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseWriteResponse_ErrorsEntry } as WriteResponse_ErrorsEntry;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
