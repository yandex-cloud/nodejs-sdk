...
export const Trigger = {
    ...
    toJSON(message: Trigger): unknown {
        ...
        message.status !== undefined && (obj.status = trigger_StatusToJSON(message.status));
        return obj;
    },
...
const baseTrigger_Rule: object = { $type: 'yandex.cloud.serverless.triggers.v1.Trigger.Rule' };
...
export const Trigger_Rule = {
    ...
    fromJSON(object: any): Trigger_Rule {
        ...
        message.objectStorage =
            object.objectStorage !== undefined && object.objectStorage !== null
                ...
                : undefined;
        message.containerRegistry =
            object.containerRegistry !== undefined && object.containerRegistry !== null
    ...
    toJSON(message: Trigger_Rule): unknown {
        ...
        message.timer !== undefined &&
            (obj.timer = message.timer ? Trigger_Timer.toJSON(message.timer) : undefined);
        ...
        message.logging !== undefined &&
            (obj.logging = message.logging ? Trigger_Logging.toJSON(message.logging) : undefined);
...
export const Trigger_MessageQueue = {
    ...
    fromJSON(object: any): Trigger_MessageQueue {
        const message = { ...baseTrigger_MessageQueue } as Trigger_MessageQueue;
        message.queueId =
            object.queueId !== undefined && object.queueId !== null ? String(object.queueId) : '';
...
export const Trigger_IoTBrokerMessage = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Trigger_IoTBrokerMessage {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseTrigger_IoTBrokerMessage } as Trigger_IoTBrokerMessage;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const Trigger_ObjectStorage = {
    ...
    fromJSON(object: any): Trigger_ObjectStorage {
        ...
        message.suffix =
            object.suffix !== undefined && object.suffix !== null ? String(object.suffix) : '';
        message.batchSettings =
            object.batchSettings !== undefined && object.batchSettings !== null
                ? BatchSettings.fromJSON(object.batchSettings)
                : undefined;
...
export const Trigger_ContainerRegistry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Trigger_ContainerRegistry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseTrigger_ContainerRegistry } as Trigger_ContainerRegistry;
        message.eventType = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object: any): Trigger_Logging {
        ...
        message.logGroupId =
            object.logGroupId !== undefined && object.logGroupId !== null
                ...
                : '';
        message.resourceType = (object.resourceType ?? []).map((e: any) => String(e));
...
export const InvokeFunctionWithRetry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): InvokeFunctionWithRetry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseInvokeFunctionWithRetry } as InvokeFunctionWithRetry;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const InvokeContainerWithRetry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): InvokeContainerWithRetry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseInvokeContainerWithRetry } as InvokeContainerWithRetry;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const GatewayWebsocketBroadcast = {
    $type: 'yandex.cloud.serverless.triggers.v1.GatewayWebsocketBroadcast' as const,
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): GatewayWebsocketBroadcast {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseGatewayWebsocketBroadcast } as GatewayWebsocketBroadcast;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
messageTypeRegistry.set(GatewayWebsocketBroadcast.$type, GatewayWebsocketBroadcast);
...
export const DataStreamBatchSettings = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): DataStreamBatchSettings {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseDataStreamBatchSettings } as DataStreamBatchSettings;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ObjectStorageBucketSettings = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ObjectStorageBucketSettings {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseObjectStorageBucketSettings } as ObjectStorageBucketSettings;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseMail: object = { $type: 'yandex.cloud.serverless.triggers.v1.Mail', email: '' };
    ...
    fromJSON(object: any): Mail {
        ...
        message.batchSettings =
            object.batchSettings !== undefined && object.batchSettings !== null
                ...
                : undefined;
        message.attachmentsBucket =
            object.attachmentsBucket !== undefined && object.attachmentsBucket !== null
