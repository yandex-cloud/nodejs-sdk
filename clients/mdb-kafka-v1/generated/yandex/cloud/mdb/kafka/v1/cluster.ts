...
export const Cluster = {
    ...
    toJSON(message: Cluster): unknown {
        ...
        message.config !== undefined &&
            (obj.config = message.config ? ConfigSpec.toJSON(message.config) : undefined);
...
export const ConfigSpec = {
    ...
    toJSON(message: ConfigSpec): unknown {
        ...
        message.kafka !== undefined &&
            (obj.kafka = message.kafka ? ConfigSpec_Kafka.toJSON(message.kafka) : undefined);
        ...
        message.brokersCount !== undefined && (obj.brokersCount = message.brokersCount);
        message.assignPublicIp !== undefined && (obj.assignPublicIp = message.assignPublicIp);
        message.unmanagedTopics !== undefined && (obj.unmanagedTopics = message.unmanagedTopics);
        message.schemaRegistry !== undefined && (obj.schemaRegistry = message.schemaRegistry);
...
const baseConfigSpec_Kafka: object = { $type: 'yandex.cloud.mdb.kafka.v1.ConfigSpec.Kafka' };
...
export const ConfigSpec_RestAPIConfig = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ConfigSpec_RestAPIConfig {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseConfigSpec_RestAPIConfig } as ConfigSpec_RestAPIConfig;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const Kafkaconfig28 = {
    ...
    toJSON(message: Kafkaconfig28): unknown {
        ...
        message.logPreallocate !== undefined && (obj.logPreallocate = message.logPreallocate);
...
const baseAccess: object = { $type: 'yandex.cloud.mdb.kafka.v1.Access', dataTransfer: false };
