...
export const DescriptiveStatistics = {
    ...
    fromJSON(object: any): DescriptiveStatistics {
        ...
        message.quantiles = (object.quantiles ?? []).map((e: any) => Quantile.fromJSON(e));
        return message;
    },
    ...
    toJSON(message: DescriptiveStatistics): unknown {
        ...
        if (message.quantiles) {
            obj.quantiles = message.quantiles.map((e) => (e ? Quantile.toJSON(e) : undefined));
        } else {
            obj.quantiles = [];
        }
        return obj;
    ...
    fromPartial<I extends Exact<DeepPartial<DescriptiveStatistics>, I>>(
        ...
        message.quantiles = object.quantiles?.map((e) => Quantile.fromPartial(e)) || [];
        return message;
    },
};
