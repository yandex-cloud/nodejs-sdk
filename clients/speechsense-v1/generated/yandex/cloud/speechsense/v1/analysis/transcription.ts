...
const baseTranscription: object = { $type: 'yandex.cloud.speechsense.v1.analysis.Transcription' };
...
export const Transcription = {
    ...
    fromJSON(object: any): Transcription {
        const message = { ...baseTranscription } as Transcription;
        message.phrases = (object.phrases ?? []).map((e: any) => Phrase.fromJSON(e));
        message.algorithmsMetadata = (object.algorithmsMetadata ?? []).map((e: any) =>
            AlgorithmMetadata.fromJSON(e),
        );
        return message;
    },
    ...
    toJSON(message: Transcription): unknown {
        const obj: any = {};
        if (message.phrases) {
            obj.phrases = message.phrases.map((e) => (e ? Phrase.toJSON(e) : undefined));
        } else {
            obj.phrases = [];
        }
...
export const Phrase = {
    ...
    encode(message: Phrase, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.statistics !== undefined) {
            PhraseStatistics.encode(message.statistics, writer.uint32(42).fork()).ldelim();
        }
    ...
    toJSON(message: Phrase): unknown {
        ...
        message.phrase !== undefined &&
            (obj.phrase = message.phrase ? PhraseText.toJSON(message.phrase) : undefined);
    ...
    fromPartial<I extends Exact<DeepPartial<Phrase>, I>>(object: I): Phrase {
        ...
        message.statistics =
            object.statistics !== undefined && object.statistics !== null
                ...
                : undefined;
        message.classifiers =
            object.classifiers?.map((e) => RecognitionClassifierResult.fromPartial(e)) || [];
        return message;
    },
};
...
export const PhraseText = {
    ...
    toJSON(message: PhraseText): unknown {
        ...
        message.normalizedText !== undefined && (obj.normalizedText = message.normalizedText);
        if (message.words) {
...
export const AlgorithmMetadata = {
    ...
    fromJSON(object: any): AlgorithmMetadata {
        ...
        message.completedTaskDate =
            object.completedTaskDate !== undefined && object.completedTaskDate !== null
        ...
        message.error =
            object.error !== undefined && object.error !== null
                ...
                : undefined;
        message.traceId =
            object.traceId !== undefined && object.traceId !== null ? String(object.traceId) : '';
...
export const PhraseStatistics = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): PhraseStatistics {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.statistics = UtteranceStatistics.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
