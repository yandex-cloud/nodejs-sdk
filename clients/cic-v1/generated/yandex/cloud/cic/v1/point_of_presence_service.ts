...
export const GetPointOfPresenceRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): GetPointOfPresenceRequest {
        ...
        const message = { ...baseGetPointOfPresenceRequest } as GetPointOfPresenceRequest;
...
export const ListPointOfPresencesRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListPointOfPresencesRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListPointOfPresencesRequest } as ListPointOfPresencesRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 2:
...
export const ListPointOfPresencesResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListPointOfPresencesResponse {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.pointOfPresences.push(PointOfPresence.decode(reader, reader.uint32()));
                    break;
                case 2:
...
export const PointOfPresenceServiceService = {
    ...
    get: {
        ...
        requestDeserialize: (value: Buffer) => GetPointOfPresenceRequest.decode(value),
    ...
    list: {
        ...
        requestDeserialize: (value: Buffer) => ListPointOfPresencesRequest.decode(value),
        responseSerialize: (value: ListPointOfPresencesResponse) =>
            Buffer.from(ListPointOfPresencesResponse.encode(value).finish()),
        responseDeserialize: (value: Buffer) => ListPointOfPresencesResponse.decode(value),
    },
} as const;

export interface PointOfPresenceServiceServer extends UntypedServiceImplementation {
    /**
     * Returns the specified PointOfPresence resource.
     *
     * To get the list of available PointOfPresence resources, make a [List] request.
    ...
    /** Retrieves the list of PointOfPresence resources in the specified folder. */
    list: handleUnaryCall<ListPointOfPresencesRequest, ListPointOfPresencesResponse>;
}
...
export interface PointOfPresenceServiceClient extends Client {
    ...
    list(
        ...
        callback: (error: ServiceError | null, response: ListPointOfPresencesResponse) => void,
    ): ClientUnaryCall;
    list(
        request: ListPointOfPresencesRequest,
        metadata: Metadata,
