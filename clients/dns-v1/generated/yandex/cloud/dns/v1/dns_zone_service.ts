    ...
    fromJSON(object: any): UpdateDnsZonePrivateNetworksRequest {
        ...
        message.dnsZoneId =
            object.dnsZoneId !== undefined && object.dnsZoneId !== null
                ...
                : '';
        message.privateNetworkIdAdditions = (object.privateNetworkIdAdditions ?? []).map((e: any) =>
            String(e),
        );
        message.privateNetworkIdDeletions = (object.privateNetworkIdDeletions ?? []).map((e: any) =>
            String(e),
        );
        return message;
    },
...
export const ListDnsZonesResponse = {
    ...
    fromJSON(object: any): ListDnsZonesResponse {
        const message = { ...baseListDnsZonesResponse } as ListDnsZonesResponse;
        message.dnsZones = (object.dnsZones ?? []).map((e: any) => DnsZone.fromJSON(e));
...
export const CreateDnsZoneRequest = {
    ...
    fromJSON(object: any): CreateDnsZoneRequest {
        ...
        message.zone = object.zone !== undefined && object.zone !== null ? String(object.zone) : '';
        message.privateVisibility =
            object.privateVisibility !== undefined && object.privateVisibility !== null
...
export const GetDnsZoneRecordSetRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): GetDnsZoneRecordSetRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseGetDnsZoneRecordSetRequest } as GetDnsZoneRecordSetRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListDnsZoneRecordSetsRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListDnsZoneRecordSetsRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListDnsZoneRecordSetsRequest } as ListDnsZoneRecordSetsRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListDnsZoneRecordSetsResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListDnsZoneRecordSetsResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListDnsZoneRecordSetsResponse } as ListDnsZoneRecordSetsResponse;
        message.recordSets = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object: any): ListDnsZoneRecordSetsResponse {
        const message = { ...baseListDnsZoneRecordSetsResponse } as ListDnsZoneRecordSetsResponse;
        message.recordSets = (object.recordSets ?? []).map((e: any) => RecordSet.fromJSON(e));
        message.nextPageToken =
            object.nextPageToken !== undefined && object.nextPageToken !== null
                ? String(object.nextPageToken)
                : '';
...
export const UpdateRecordSetsRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): UpdateRecordSetsRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseUpdateRecordSetsRequest } as UpdateRecordSetsRequest;
        message.deletions = [];
        message.additions = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
    ...
    fromJSON(object: any): UpdateRecordSetsRequest {
        ...
        message.dnsZoneId =
            object.dnsZoneId !== undefined && object.dnsZoneId !== null
                ? String(object.dnsZoneId)
                : '';
        message.deletions = (object.deletions ?? []).map((e: any) => RecordSet.fromJSON(e));
        message.additions = (object.additions ?? []).map((e: any) => RecordSet.fromJSON(e));
        return message;
    },
...
export const UpdateRecordSetsMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): UpdateRecordSetsMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseUpdateRecordSetsMetadata } as UpdateRecordSetsMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
export const UpsertRecordSetsRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): UpsertRecordSetsRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseUpsertRecordSetsRequest } as UpsertRecordSetsRequest;
        message.deletions = [];
    ...
    fromJSON(object: any): UpsertRecordSetsRequest {
        ...
        message.dnsZoneId =
            object.dnsZoneId !== undefined && object.dnsZoneId !== null
                ...
                : '';
        message.deletions = (object.deletions ?? []).map((e: any) => RecordSet.fromJSON(e));
        message.replacements = (object.replacements ?? []).map((e: any) => RecordSet.fromJSON(e));
        message.merges = (object.merges ?? []).map((e: any) => RecordSet.fromJSON(e));
        return message;
    },
...
export const UpsertRecordSetsMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): UpsertRecordSetsMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseUpsertRecordSetsMetadata } as UpsertRecordSetsMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
const baseRecordSetDiff: object = { $type: 'yandex.cloud.dns.v1.RecordSetDiff' };
...
export const ListDnsZoneOperationsRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListDnsZoneOperationsRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListDnsZoneOperationsRequest } as ListDnsZoneOperationsRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListDnsZoneOperationsResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListDnsZoneOperationsResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListDnsZoneOperationsResponse } as ListDnsZoneOperationsResponse;
        message.operations = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
