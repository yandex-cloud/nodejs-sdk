...
export interface Thumbnail {
    $type: 'yandex.cloud.video.v1.Thumbnail';
    /** ID of the thumbnail. */
    id: string;
...
const baseThumbnail: object = { $type: 'yandex.cloud.video.v1.Thumbnail', id: '', channelId: '' };

export const Thumbnail = {
    $type: 'yandex.cloud.video.v1.Thumbnail' as const,
...
messageTypeRegistry.set(Thumbnail.$type, Thumbnail);
