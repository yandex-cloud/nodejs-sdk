...
export const Stream = {
    ...
    encode(message: Stream, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.publishTime !== undefined) {
            Timestamp.encode(toTimestamp(message.publishTime), writer.uint32(82).fork()).ldelim();
        }
    ...
    toJSON(message: Stream): unknown {
        ...
        message.status !== undefined && (obj.status = stream_StreamStatusToJSON(message.status));
