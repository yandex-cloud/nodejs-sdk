...
export const CreateSecretRequest = {
    ...
    fromJSON(object: any): CreateSecretRequest {
        ...
        message.versionDescription =
            object.versionDescription !== undefined && object.versionDescription !== null
                ...
                : '';
        message.versionPayloadEntries = (object.versionPayloadEntries ?? []).map((e: any) =>
    ...
    fromPartial<I extends Exact<DeepPartial<CreateSecretRequest>, I>>(
        ...
        message.versionPayloadEntries =
            object.versionPayloadEntries?.map((e) => PayloadEntryChange.fromPartial(e)) || [];
...
export const DeactivateSecretRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): DeactivateSecretRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseDeactivateSecretRequest } as DeactivateSecretRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const DeactivateSecretMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): DeactivateSecretMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseDeactivateSecretMetadata } as DeactivateSecretMetadata;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListSecretOperationsRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListSecretOperationsRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListSecretOperationsRequest } as ListSecretOperationsRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListSecretOperationsResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListSecretOperationsResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListSecretOperationsResponse } as ListSecretOperationsResponse;
        message.operations = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
