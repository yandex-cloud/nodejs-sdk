...
export const YandexPassportUserAccount = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): YandexPassportUserAccount {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseYandexPassportUserAccount } as YandexPassportUserAccount;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    toJSON(message: YandexPassportUserAccount): unknown {
        ...
        message.defaultEmail !== undefined && (obj.defaultEmail = message.defaultEmail);
        return obj;
    },
    ...
    fromJSON(object: any): SamlUserAccount {
        ...
        message.federationId =
            object.federationId !== undefined && object.federationId !== null
                ...
                : '';
        message.nameId =
            object.nameId !== undefined && object.nameId !== null ? String(object.nameId) : '';
...
export const SamlUserAccount_Attribute = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): SamlUserAccount_Attribute {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseSamlUserAccount_Attribute } as SamlUserAccount_Attribute;
        message.value = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
