...
export const GroupMappingItem = {
    ...
    toJSON(message: GroupMappingItem): unknown {
        const obj: any = {};
        message.externalGroupId !== undefined && (obj.externalGroupId = message.externalGroupId);
        message.internalGroupId !== undefined && (obj.internalGroupId = message.internalGroupId);
        return obj;
    },
