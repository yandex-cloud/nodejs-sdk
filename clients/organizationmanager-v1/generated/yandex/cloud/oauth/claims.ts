...
export const SubjectClaims = {
    ...
    fromJSON(object: any): SubjectClaims {
        const message = { ...baseSubjectClaims } as SubjectClaims;
        message.sub = object.sub !== undefined && object.sub !== null ? String(object.sub) : '';
        ...
        message.preferredUsername =
            object.preferredUsername !== undefined && object.preferredUsername !== null
                ? String(object.preferredUsername)
                : '';
        message.picture =
            object.picture !== undefined && object.picture !== null ? String(object.picture) : '';
        message.email =
        ...
        message.zoneinfo =
            object.zoneinfo !== undefined && object.zoneinfo !== null
                ...
                : '';
        message.locale =
            object.locale !== undefined && object.locale !== null ? String(object.locale) : '';
        message.phoneNumber =
    ...
    toJSON(message: SubjectClaims): unknown {
        ...
        message.subType !== undefined && (obj.subType = subjectTypeToJSON(message.subType));
