...
export const LongRunningRecognitionRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): LongRunningRecognitionRequest {
        ...
        const message = { ...baseLongRunningRecognitionRequest } as LongRunningRecognitionRequest;
    ...
    toJSON(message: LongRunningRecognitionRequest): unknown {
        ...
        message.config !== undefined &&
            (obj.config = message.config ? RecognitionConfig.toJSON(message.config) : undefined);
        message.audio !== undefined &&
            (obj.audio = message.audio ? RecognitionAudio.toJSON(message.audio) : undefined);
        return obj;
    },
...
export const LongRunningRecognitionResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): LongRunningRecognitionResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseLongRunningRecognitionResponse } as LongRunningRecognitionResponse;
        message.chunks = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object: any): LongRunningRecognitionResponse {
        const message = { ...baseLongRunningRecognitionResponse } as LongRunningRecognitionResponse;
        message.chunks = (object.chunks ?? []).map((e: any) => SpeechRecognitionResult.fromJSON(e));
        return message;
    },
...
export const StreamingRecognitionRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): StreamingRecognitionRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseStreamingRecognitionRequest } as StreamingRecognitionRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const StreamingRecognitionResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): StreamingRecognitionResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseStreamingRecognitionResponse } as StreamingRecognitionResponse;
        message.chunks = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object: any): StreamingRecognitionResponse {
        const message = { ...baseStreamingRecognitionResponse } as StreamingRecognitionResponse;
        message.chunks = (object.chunks ?? []).map((e: any) => SpeechRecognitionChunk.fromJSON(e));
        return message;
    },
...
const baseRecognitionAudio: object = { $type: 'yandex.cloud.ai.stt.v2.RecognitionAudio' };
...
export const RecognitionSpec = {
    ...
    toJSON(message: RecognitionSpec): unknown {
        ...
        message.partialResults !== undefined && (obj.partialResults = message.partialResults);
        message.singleUtterance !== undefined && (obj.singleUtterance = message.singleUtterance);
...
export const SpeechRecognitionChunk = {
    ...
    fromJSON(object: any): SpeechRecognitionChunk {
        ...
        message.final =
            object.final !== undefined && object.final !== null ? Boolean(object.final) : false;
    ...
    toJSON(message: SpeechRecognitionChunk): unknown {
        ...
        message.endOfUtterance !== undefined && (obj.endOfUtterance = message.endOfUtterance);
        return obj;
    },
    ...
    fromPartial<I extends Exact<DeepPartial<SpeechRecognitionChunk>, I>>(
        ...
        const message = { ...baseSpeechRecognitionChunk } as SpeechRecognitionChunk;
        message.alternatives =
            object.alternatives?.map((e) => SpeechRecognitionAlternative.fromPartial(e)) || [];
...
export const SpeechRecognitionResult = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): SpeechRecognitionResult {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseSpeechRecognitionResult } as SpeechRecognitionResult;
        message.alternatives = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    toJSON(message: SpeechRecognitionResult): unknown {
        ...
        message.channelTag !== undefined && (obj.channelTag = Math.round(message.channelTag));
        return obj;
    },
...
export const SpeechRecognitionAlternative = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): SpeechRecognitionAlternative {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseSpeechRecognitionAlternative } as SpeechRecognitionAlternative;
        message.words = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
const baseWordInfo: object = { $type: 'yandex.cloud.ai.stt.v2.WordInfo', word: '', confidence: 0 };
...
export const WordInfo = {
    ...
    fromJSON(object: any): WordInfo {
        ...
        message.endTime =
            object.endTime !== undefined && object.endTime !== null
                ...
                : undefined;
        message.word = object.word !== undefined && object.word !== null ? String(object.word) : '';
        message.confidence =
            object.confidence !== undefined && object.confidence !== null
                ? Number(object.confidence)
                : 0;
    ...
    toJSON(message: WordInfo): unknown {
        ...
        message.startTime !== undefined &&
            (obj.startTime = message.startTime ? Duration.toJSON(message.startTime) : undefined);
        message.endTime !== undefined &&
            (obj.endTime = message.endTime ? Duration.toJSON(message.endTime) : undefined);
