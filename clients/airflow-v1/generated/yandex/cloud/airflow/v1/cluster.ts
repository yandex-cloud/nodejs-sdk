...
export const Cluster = {
    ...
    encode(message: Cluster, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            Cluster_LabelsEntry.encode(
                { $type: 'yandex.cloud.airflow.v1.Cluster.LabelsEntry', key: key as any, value },
        ...
        if (message.codeSync !== undefined) {
            CodeSyncConfig.encode(message.codeSync, writer.uint32(106).fork()).ldelim();
        }
    ...
    toJSON(message: Cluster): unknown {
        ...
        message.webserverUrl !== undefined && (obj.webserverUrl = message.webserverUrl);
...
const baseAirflowConfig: object = { $type: 'yandex.cloud.airflow.v1.AirflowConfig' };
...
export const AirflowConfig = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): AirflowConfig {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    const entry1 = AirflowConfig_ConfigEntry.decode(reader, reader.uint32());
    ...
    fromJSON(object: any): AirflowConfig {
        const message = { ...baseAirflowConfig } as AirflowConfig;
        message.config = Object.entries(object.config ?? {}).reduce<{ [key: string]: string }>(
            (acc, [key, value]) => {
                acc[key] = String(value);
                return acc;
            },
...
export const AirflowConfig_ConfigEntry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): AirflowConfig_ConfigEntry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseAirflowConfig_ConfigEntry } as AirflowConfig_ConfigEntry;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
messageTypeRegistry.set(AirflowConfig_ConfigEntry.$type, AirflowConfig_ConfigEntry);

const baseWebserverConfig: object = { $type: 'yandex.cloud.airflow.v1.WebserverConfig', count: 0 };
...
const baseSchedulerConfig: object = { $type: 'yandex.cloud.airflow.v1.SchedulerConfig', count: 0 };
...
const baseTriggererConfig: object = { $type: 'yandex.cloud.airflow.v1.TriggererConfig', count: 0 };
...
const baseS3Config: object = { $type: 'yandex.cloud.airflow.v1.S3Config', bucket: '' };
...
const baseCodeSyncConfig: object = { $type: 'yandex.cloud.airflow.v1.CodeSyncConfig' };
