...
export const StaticRoute = {
    ...
    fromJSON(object: any): StaticRoute {
        ...
        message.destinationPrefix =
            object.destinationPrefix !== undefined && object.destinationPrefix !== null
    ...
    toJSON(message: StaticRoute): unknown {
        ...
        message.nextHopAddress !== undefined && (obj.nextHopAddress = message.nextHopAddress);
...
export const StaticRoute_LabelsEntry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): StaticRoute_LabelsEntry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseStaticRoute_LabelsEntry } as StaticRoute_LabelsEntry;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
