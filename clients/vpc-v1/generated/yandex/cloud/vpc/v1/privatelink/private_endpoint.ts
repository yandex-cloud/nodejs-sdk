...
export function privateEndpoint_StatusFromJSON(object: any): PrivateEndpoint_Status {
    switch (object) {
        case 0:
...
export function privateEndpoint_StatusToJSON(object: PrivateEndpoint_Status): string {
    switch (object) {
...
export const PrivateEndpoint = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    const entry6 = PrivateEndpoint_LabelsEntry.decode(reader, reader.uint32());
    ...
    toJSON(message: PrivateEndpoint): unknown {
        ...
        message.status !== undefined && (obj.status = privateEndpoint_StatusToJSON(message.status));
...
export const PrivateEndpoint_LabelsEntry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): PrivateEndpoint_LabelsEntry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...basePrivateEndpoint_LabelsEntry } as PrivateEndpoint_LabelsEntry;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const PrivateEndpoint_ObjectStorage = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): PrivateEndpoint_ObjectStorage {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...basePrivateEndpoint_ObjectStorage } as PrivateEndpoint_ObjectStorage;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
export const PrivateEndpoint_DnsOptions = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): PrivateEndpoint_DnsOptions {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...basePrivateEndpoint_DnsOptions } as PrivateEndpoint_DnsOptions;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
