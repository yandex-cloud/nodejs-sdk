...
export const Template = {
    ...
    toJSON(message: Template): unknown {
        ...
        message.publisherId !== undefined && (obj.publisherId = message.publisherId);
        message.productId !== undefined && (obj.productId = message.productId);
        message.tariffId !== undefined && (obj.tariffId = message.tariffId);
        message.licenseSkuId !== undefined && (obj.licenseSkuId = message.licenseSkuId);
        message.period !== undefined && (obj.period = message.period);
        message.createdAt !== undefined && (obj.createdAt = message.createdAt.toISOString());
        message.updatedAt !== undefined && (obj.updatedAt = message.updatedAt.toISOString());
        message.state !== undefined && (obj.state = template_StateToJSON(message.state));
        return obj;
    },
