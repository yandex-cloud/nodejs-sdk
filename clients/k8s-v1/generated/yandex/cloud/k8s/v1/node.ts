...
export const Node = {
    ...
    toJSON(message: Node): unknown {
        const obj: any = {};
        message.status !== undefined && (obj.status = node_StatusToJSON(message.status));
...
export const Node_KubernetesStatus = {
    ...
    fromJSON(object: any): Node_KubernetesStatus {
        ...
        message.conditions = (object.conditions ?? []).map((e: any) => Condition.fromJSON(e));
...
export const Condition = {
    ...
    fromJSON(object: any): Condition {
        ...
        message.lastHeartbeatTime =
            object.lastHeartbeatTime !== undefined && object.lastHeartbeatTime !== null
...
const baseTaint: object = { $type: 'yandex.cloud.k8s.v1.Taint', key: '', value: '', effect: 0 };
...
export const Taint = {
    ...
    toJSON(message: Taint): unknown {
        ...
        message.effect !== undefined && (obj.effect = taint_EffectToJSON(message.effect));
        return obj;
    },
...
export const AttachedVolume = {
    ...
    toJSON(message: AttachedVolume): unknown {
        ...
        message.volumeHandle !== undefined && (obj.volumeHandle = message.volumeHandle);
        return obj;
    },
    ...
    encode(message: NodeTemplate, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        Object.entries(message.metadata).forEach(([key, value]) => {
            NodeTemplate_MetadataEntry.encode(
                { $type: 'yandex.cloud.k8s.v1.NodeTemplate.MetadataEntry', key: key as any, value },
                writer.uint32(34).fork(),
            ).ldelim();
        });
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 11:
                    ...
                    break;
                case 12:
                    message.containerRuntimeSettings = NodeTemplate_ContainerRuntimeSettings.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
                case 16:
                    message.containerNetworkSettings = NodeTemplate_ContainerNetworkSettings.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    toJSON(message: NodeTemplate): unknown {
        ...
        message.containerRuntimeSettings !== undefined &&
            (obj.containerRuntimeSettings = message.containerRuntimeSettings
                ? NodeTemplate_ContainerRuntimeSettings.toJSON(message.containerRuntimeSettings)
                : undefined);
        message.containerNetworkSettings !== undefined &&
            (obj.containerNetworkSettings = message.containerNetworkSettings
                ? NodeTemplate_ContainerNetworkSettings.toJSON(message.containerNetworkSettings)
                : undefined);
...
export const NodeTemplate_LabelsEntry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): NodeTemplate_LabelsEntry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseNodeTemplate_LabelsEntry } as NodeTemplate_LabelsEntry;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const NodeTemplate_MetadataEntry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): NodeTemplate_MetadataEntry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseNodeTemplate_MetadataEntry } as NodeTemplate_MetadataEntry;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const NodeTemplate_NetworkSettings = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): NodeTemplate_NetworkSettings {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseNodeTemplate_NetworkSettings } as NodeTemplate_NetworkSettings;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const NodeTemplate_ContainerNetworkSettings = {
    ...
    fromJSON(object: any): NodeTemplate_ContainerNetworkSettings {
        ...
        message.podMtu =
            object.podMtu !== undefined && object.podMtu !== null ? Number(object.podMtu) : 0;
        return message;
    },
...
const baseNodeAddressSpec: object = { $type: 'yandex.cloud.k8s.v1.NodeAddressSpec' };
...
const baseOneToOneNatSpec: object = { $type: 'yandex.cloud.k8s.v1.OneToOneNatSpec', ipVersion: 0 };
...
const baseDiskSpec: object = { $type: 'yandex.cloud.k8s.v1.DiskSpec', diskTypeId: '', diskSize: 0 };
