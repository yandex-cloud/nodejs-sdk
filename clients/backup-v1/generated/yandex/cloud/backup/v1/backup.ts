...
export const Archive = {
    ...
    fromJSON(object: any): Archive {
        ...
        message.vaultId =
            object.vaultId !== undefined && object.vaultId !== null ? String(object.vaultId) : '';
        message.attributes =
        ...
        message.compressedDataSize =
            object.compressedDataSize !== undefined && object.compressedDataSize !== null
                ? Number(object.compressedDataSize)
                : 0;
        message.dataSize =
            object.dataSize !== undefined && object.dataSize !== null ? Number(object.dataSize) : 0;
        ...
        message.lastBackupCreatedAt =
            object.lastBackupCreatedAt !== undefined && object.lastBackupCreatedAt !== null
        ...
        message.protectedByPassword =
            object.protectedByPassword !== undefined && object.protectedByPassword !== null
                ? Boolean(object.protectedByPassword)
                : false;
        message.encryptionAlgorithm =
            object.encryptionAlgorithm !== undefined && object.encryptionAlgorithm !== null
                ? archive_EncryptionAlgorithmFromJSON(object.encryptionAlgorithm)
                : 0;
        message.actions = (object.actions ?? []).map((e: any) => archive_ActionFromJSON(e));
    ...
    toJSON(message: Archive): unknown {
        ...
        message.logicalSize !== undefined && (obj.logicalSize = Math.round(message.logicalSize));
        ...
        message.backupPlanId !== undefined && (obj.backupPlanId = message.backupPlanId);
        message.backupPlanName !== undefined && (obj.backupPlanName = message.backupPlanName);
...
export const Archive_ArchiveAttributes = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Archive_ArchiveAttributes {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseArchive_ArchiveAttributes } as Archive_ArchiveAttributes;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object: any): Archive_ArchiveAttributes {
        const message = { ...baseArchive_ArchiveAttributes } as Archive_ArchiveAttributes;
        message.aaib = object.aaib !== undefined && object.aaib !== null ? String(object.aaib) : '';
...
export const Volume = {
    ...
    toJSON(message: Volume): unknown {
        const obj: any = {};
        message.freeSpace !== undefined && (obj.freeSpace = Math.round(message.freeSpace));
...
export const Backup_BackupAttributes = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Backup_BackupAttributes {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseBackup_BackupAttributes } as Backup_BackupAttributes;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const BackupFile = {
    ...
    toJSON(message: BackupFile): unknown {
        ...
        message.type !== undefined && (obj.type = backupFile_TypeToJSON(message.type));
...
export const BackupFile_Actions = {
    ...
    toJSON(message: BackupFile_Actions): unknown {
        const obj: any = {};
        message.restoreToDisk !== undefined && (obj.restoreToDisk = message.restoreToDisk);
        message.goToLocation !== undefined && (obj.goToLocation = message.goToLocation);
        return obj;
    },
