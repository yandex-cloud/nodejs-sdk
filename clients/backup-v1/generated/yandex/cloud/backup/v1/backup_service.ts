...
export const ListArchivesResponse = {
    ...
    fromJSON(object: any): ListArchivesResponse {
        const message = { ...baseListArchivesResponse } as ListArchivesResponse;
        message.archives = (object.archives ?? []).map((e: any) => Archive.fromJSON(e));
        return message;
    },
    ...
    toJSON(message: ListArchivesResponse): unknown {
        const obj: any = {};
        if (message.archives) {
            obj.archives = message.archives.map((e) => (e ? Archive.toJSON(e) : undefined));
        } else {
            obj.archives = [];
        }
        return obj;
...
export const ListFilesResponse = {
    ...
    fromJSON(object: any): ListFilesResponse {
        const message = { ...baseListFilesResponse } as ListFilesResponse;
        message.files = (object.files ?? []).map((e: any) => BackupFile.fromJSON(e));
        return message;
    },
    ...
    toJSON(message: ListFilesResponse): unknown {
        const obj: any = {};
        if (message.files) {
            obj.files = message.files.map((e) => (e ? BackupFile.toJSON(e) : undefined));
        } else {
            obj.files = [];
        }
        return obj;
...
export const StartRecoveryMetadata = {
    ...
    fromJSON(object: any): StartRecoveryMetadata {
        ...
        message.progressPercentage =
            object.progressPercentage !== undefined && object.progressPercentage !== null
        ...
        message.dstComputeInstanceId =
            object.dstComputeInstanceId !== undefined && object.dstComputeInstanceId !== null
    ...
    toJSON(message: StartRecoveryMetadata): unknown {
        ...
        message.srcBackupId !== undefined && (obj.srcBackupId = message.srcBackupId);
...
export const StartFilesRecoveryRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): StartFilesRecoveryRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseStartFilesRecoveryRequest } as StartFilesRecoveryRequest;
        message.sourceIds = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    toJSON(message: StartFilesRecoveryRequest): unknown {
        ...
        message.opts !== undefined &&
            (obj.opts = message.opts ? FilesRecoveryOptions.toJSON(message.opts) : undefined);
...
export const StartFilesRecoveryMetadata = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): StartFilesRecoveryMetadata {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseStartFilesRecoveryMetadata } as StartFilesRecoveryMetadata;
        message.sourceIds = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
