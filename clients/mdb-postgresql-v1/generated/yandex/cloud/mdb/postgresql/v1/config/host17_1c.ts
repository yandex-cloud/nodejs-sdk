 ...
 */
export interface Postgresqlhostconfig171c {
    $type: 'yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig17_1C';
    /** in milliseconds. */
    ...
    constraintExclusion: Postgresqlhostconfig171c_ConstraintExclusion;
    cursorTupleFraction?: number;
    fromCollapseLimit?: number;
    joinCollapseLimit?: number;
    debugParallelQuery: Postgresqlhostconfig171c_DebugParallelQuery;
    clientMinMessages: Postgresqlhostconfig171c_LogLevel;
    logMinMessages: Postgresqlhostconfig171c_LogLevel;
    logMinErrorStatement: Postgresqlhostconfig171c_LogLevel;
    /** in milliseconds. */
    ...
    logDuration?: boolean;
    logErrorVerbosity: Postgresqlhostconfig171c_LogErrorVerbosity;
    logLockWaits?: boolean;
    logStatement: Postgresqlhostconfig171c_LogStatement;
    logTempFiles?: number;
    searchPath: string;
    rowSecurity?: boolean;
    defaultTransactionIsolation: Postgresqlhostconfig171c_TransactionIsolation;
    /** in milliseconds. */
    ...
    byteaOutput: Postgresqlhostconfig171c_ByteaOutput;
    xmlbinary: Postgresqlhostconfig171c_XmlBinary;
    xmloption: Postgresqlhostconfig171c_XmlOption;
    /** in bytes. */
    ...
    arrayNulls?: boolean;
    backslashQuote: Postgresqlhostconfig171c_BackslashQuote;
...
export enum Postgresqlhostconfig171c_BackslashQuote {
...
export function postgresqlhostconfig171c_BackslashQuoteFromJSON(
    object: any,
): Postgresqlhostconfig171c_BackslashQuote {
    switch (object) {
        case 0:
        case 'BACKSLASH_QUOTE_UNSPECIFIED':
            return Postgresqlhostconfig171c_BackslashQuote.BACKSLASH_QUOTE_UNSPECIFIED;
        case 1:
        case 'BACKSLASH_QUOTE':
            return Postgresqlhostconfig171c_BackslashQuote.BACKSLASH_QUOTE;
        case 2:
        case 'BACKSLASH_QUOTE_ON':
            return Postgresqlhostconfig171c_BackslashQuote.BACKSLASH_QUOTE_ON;
        case 3:
        case 'BACKSLASH_QUOTE_OFF':
            return Postgresqlhostconfig171c_BackslashQuote.BACKSLASH_QUOTE_OFF;
        case 4:
        case 'BACKSLASH_QUOTE_SAFE_ENCODING':
            return Postgresqlhostconfig171c_BackslashQuote.BACKSLASH_QUOTE_SAFE_ENCODING;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return Postgresqlhostconfig171c_BackslashQuote.UNRECOGNIZED;
    }
}

export function postgresqlhostconfig171c_BackslashQuoteToJSON(
    object: Postgresqlhostconfig171c_BackslashQuote,
): string {
    switch (object) {
        case Postgresqlhostconfig171c_BackslashQuote.BACKSLASH_QUOTE_UNSPECIFIED:
            return 'BACKSLASH_QUOTE_UNSPECIFIED';
        case Postgresqlhostconfig171c_BackslashQuote.BACKSLASH_QUOTE:
            return 'BACKSLASH_QUOTE';
        case Postgresqlhostconfig171c_BackslashQuote.BACKSLASH_QUOTE_ON:
            return 'BACKSLASH_QUOTE_ON';
        case Postgresqlhostconfig171c_BackslashQuote.BACKSLASH_QUOTE_OFF:
            return 'BACKSLASH_QUOTE_OFF';
        case Postgresqlhostconfig171c_BackslashQuote.BACKSLASH_QUOTE_SAFE_ENCODING:
...
export enum Postgresqlhostconfig171c_ByteaOutput {
...
export function postgresqlhostconfig171c_ByteaOutputFromJSON(
    object: any,
): Postgresqlhostconfig171c_ByteaOutput {
    switch (object) {
        case 0:
        case 'BYTEA_OUTPUT_UNSPECIFIED':
            return Postgresqlhostconfig171c_ByteaOutput.BYTEA_OUTPUT_UNSPECIFIED;
        case 1:
        case 'BYTEA_OUTPUT_HEX':
            return Postgresqlhostconfig171c_ByteaOutput.BYTEA_OUTPUT_HEX;
        case 2:
        case 'BYTEA_OUTPUT_ESCAPED':
            return Postgresqlhostconfig171c_ByteaOutput.BYTEA_OUTPUT_ESCAPED;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return Postgresqlhostconfig171c_ByteaOutput.UNRECOGNIZED;
    }
}

export function postgresqlhostconfig171c_ByteaOutputToJSON(
    object: Postgresqlhostconfig171c_ByteaOutput,
): string {
    switch (object) {
        case Postgresqlhostconfig171c_ByteaOutput.BYTEA_OUTPUT_UNSPECIFIED:
            return 'BYTEA_OUTPUT_UNSPECIFIED';
        case Postgresqlhostconfig171c_ByteaOutput.BYTEA_OUTPUT_HEX:
            return 'BYTEA_OUTPUT_HEX';
        case Postgresqlhostconfig171c_ByteaOutput.BYTEA_OUTPUT_ESCAPED:
...
export enum Postgresqlhostconfig171c_ConstraintExclusion {
...
export function postgresqlhostconfig171c_ConstraintExclusionFromJSON(
    object: any,
): Postgresqlhostconfig171c_ConstraintExclusion {
    switch (object) {
        case 0:
        case 'CONSTRAINT_EXCLUSION_UNSPECIFIED':
            return Postgresqlhostconfig171c_ConstraintExclusion.CONSTRAINT_EXCLUSION_UNSPECIFIED;
        case 1:
        case 'CONSTRAINT_EXCLUSION_ON':
            return Postgresqlhostconfig171c_ConstraintExclusion.CONSTRAINT_EXCLUSION_ON;
        case 2:
        case 'CONSTRAINT_EXCLUSION_OFF':
            return Postgresqlhostconfig171c_ConstraintExclusion.CONSTRAINT_EXCLUSION_OFF;
        case 3:
        case 'CONSTRAINT_EXCLUSION_PARTITION':
            return Postgresqlhostconfig171c_ConstraintExclusion.CONSTRAINT_EXCLUSION_PARTITION;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return Postgresqlhostconfig171c_ConstraintExclusion.UNRECOGNIZED;
    }
}

export function postgresqlhostconfig171c_ConstraintExclusionToJSON(
    object: Postgresqlhostconfig171c_ConstraintExclusion,
): string {
    switch (object) {
        case Postgresqlhostconfig171c_ConstraintExclusion.CONSTRAINT_EXCLUSION_UNSPECIFIED:
            return 'CONSTRAINT_EXCLUSION_UNSPECIFIED';
        case Postgresqlhostconfig171c_ConstraintExclusion.CONSTRAINT_EXCLUSION_ON:
            return 'CONSTRAINT_EXCLUSION_ON';
        case Postgresqlhostconfig171c_ConstraintExclusion.CONSTRAINT_EXCLUSION_OFF:
            return 'CONSTRAINT_EXCLUSION_OFF';
        case Postgresqlhostconfig171c_ConstraintExclusion.CONSTRAINT_EXCLUSION_PARTITION:
...
export enum Postgresqlhostconfig171c_DebugParallelQuery {
...
export function postgresqlhostconfig171c_DebugParallelQueryFromJSON(
    object: any,
): Postgresqlhostconfig171c_DebugParallelQuery {
    switch (object) {
        case 0:
        case 'DEBUG_PARALLEL_QUERY_UNSPECIFIED':
            return Postgresqlhostconfig171c_DebugParallelQuery.DEBUG_PARALLEL_QUERY_UNSPECIFIED;
        case 1:
        case 'DEBUG_PARALLEL_QUERY_ON':
            return Postgresqlhostconfig171c_DebugParallelQuery.DEBUG_PARALLEL_QUERY_ON;
        case 2:
        case 'DEBUG_PARALLEL_QUERY_OFF':
            return Postgresqlhostconfig171c_DebugParallelQuery.DEBUG_PARALLEL_QUERY_OFF;
        case 3:
        case 'DEBUG_PARALLEL_QUERY_REGRESS':
            return Postgresqlhostconfig171c_DebugParallelQuery.DEBUG_PARALLEL_QUERY_REGRESS;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return Postgresqlhostconfig171c_DebugParallelQuery.UNRECOGNIZED;
    }
}

export function postgresqlhostconfig171c_DebugParallelQueryToJSON(
    object: Postgresqlhostconfig171c_DebugParallelQuery,
): string {
    switch (object) {
        case Postgresqlhostconfig171c_DebugParallelQuery.DEBUG_PARALLEL_QUERY_UNSPECIFIED:
            return 'DEBUG_PARALLEL_QUERY_UNSPECIFIED';
        case Postgresqlhostconfig171c_DebugParallelQuery.DEBUG_PARALLEL_QUERY_ON:
            return 'DEBUG_PARALLEL_QUERY_ON';
        case Postgresqlhostconfig171c_DebugParallelQuery.DEBUG_PARALLEL_QUERY_OFF:
            return 'DEBUG_PARALLEL_QUERY_OFF';
        case Postgresqlhostconfig171c_DebugParallelQuery.DEBUG_PARALLEL_QUERY_REGRESS:
...
export enum Postgresqlhostconfig171c_ForceParallelMode {
...
export function postgresqlhostconfig171c_ForceParallelModeFromJSON(
    object: any,
): Postgresqlhostconfig171c_ForceParallelMode {
    switch (object) {
        case 0:
        case 'FORCE_PARALLEL_MODE_UNSPECIFIED':
            return Postgresqlhostconfig171c_ForceParallelMode.FORCE_PARALLEL_MODE_UNSPECIFIED;
        case 1:
        case 'FORCE_PARALLEL_MODE_ON':
            return Postgresqlhostconfig171c_ForceParallelMode.FORCE_PARALLEL_MODE_ON;
        case 2:
        case 'FORCE_PARALLEL_MODE_OFF':
            return Postgresqlhostconfig171c_ForceParallelMode.FORCE_PARALLEL_MODE_OFF;
        case 3:
        case 'FORCE_PARALLEL_MODE_REGRESS':
            return Postgresqlhostconfig171c_ForceParallelMode.FORCE_PARALLEL_MODE_REGRESS;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return Postgresqlhostconfig171c_ForceParallelMode.UNRECOGNIZED;
    }
}

export function postgresqlhostconfig171c_ForceParallelModeToJSON(
    object: Postgresqlhostconfig171c_ForceParallelMode,
): string {
    switch (object) {
        case Postgresqlhostconfig171c_ForceParallelMode.FORCE_PARALLEL_MODE_UNSPECIFIED:
            return 'FORCE_PARALLEL_MODE_UNSPECIFIED';
        case Postgresqlhostconfig171c_ForceParallelMode.FORCE_PARALLEL_MODE_ON:
            return 'FORCE_PARALLEL_MODE_ON';
        case Postgresqlhostconfig171c_ForceParallelMode.FORCE_PARALLEL_MODE_OFF:
            return 'FORCE_PARALLEL_MODE_OFF';
        case Postgresqlhostconfig171c_ForceParallelMode.FORCE_PARALLEL_MODE_REGRESS:
...
export enum Postgresqlhostconfig171c_LogErrorVerbosity {
...
export function postgresqlhostconfig171c_LogErrorVerbosityFromJSON(
    object: any,
): Postgresqlhostconfig171c_LogErrorVerbosity {
    switch (object) {
        case 0:
        case 'LOG_ERROR_VERBOSITY_UNSPECIFIED':
            return Postgresqlhostconfig171c_LogErrorVerbosity.LOG_ERROR_VERBOSITY_UNSPECIFIED;
        case 1:
        case 'LOG_ERROR_VERBOSITY_TERSE':
            return Postgresqlhostconfig171c_LogErrorVerbosity.LOG_ERROR_VERBOSITY_TERSE;
        case 2:
        case 'LOG_ERROR_VERBOSITY_DEFAULT':
            return Postgresqlhostconfig171c_LogErrorVerbosity.LOG_ERROR_VERBOSITY_DEFAULT;
        case 3:
        case 'LOG_ERROR_VERBOSITY_VERBOSE':
            return Postgresqlhostconfig171c_LogErrorVerbosity.LOG_ERROR_VERBOSITY_VERBOSE;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return Postgresqlhostconfig171c_LogErrorVerbosity.UNRECOGNIZED;
    }
}

export function postgresqlhostconfig171c_LogErrorVerbosityToJSON(
    object: Postgresqlhostconfig171c_LogErrorVerbosity,
): string {
    switch (object) {
        case Postgresqlhostconfig171c_LogErrorVerbosity.LOG_ERROR_VERBOSITY_UNSPECIFIED:
            return 'LOG_ERROR_VERBOSITY_UNSPECIFIED';
        case Postgresqlhostconfig171c_LogErrorVerbosity.LOG_ERROR_VERBOSITY_TERSE:
            return 'LOG_ERROR_VERBOSITY_TERSE';
        case Postgresqlhostconfig171c_LogErrorVerbosity.LOG_ERROR_VERBOSITY_DEFAULT:
            return 'LOG_ERROR_VERBOSITY_DEFAULT';
        case Postgresqlhostconfig171c_LogErrorVerbosity.LOG_ERROR_VERBOSITY_VERBOSE:
...
export enum Postgresqlhostconfig171c_LogLevel {
...
export function postgresqlhostconfig171c_LogLevelFromJSON(
    object: any,
): Postgresqlhostconfig171c_LogLevel {
    switch (object) {
        case 0:
        case 'LOG_LEVEL_UNSPECIFIED':
            return Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_UNSPECIFIED;
        case 1:
        case 'LOG_LEVEL_DEBUG5':
            return Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_DEBUG5;
        case 2:
        case 'LOG_LEVEL_DEBUG4':
            return Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_DEBUG4;
        case 3:
        case 'LOG_LEVEL_DEBUG3':
            return Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_DEBUG3;
        case 4:
        case 'LOG_LEVEL_DEBUG2':
            return Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_DEBUG2;
        case 5:
        case 'LOG_LEVEL_DEBUG1':
            return Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_DEBUG1;
        case 12:
        case 'LOG_LEVEL_INFO':
            return Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_INFO;
        case 6:
        case 'LOG_LEVEL_LOG':
            return Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_LOG;
        case 7:
        case 'LOG_LEVEL_NOTICE':
            return Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_NOTICE;
        case 8:
        case 'LOG_LEVEL_WARNING':
            return Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_WARNING;
        case 9:
        case 'LOG_LEVEL_ERROR':
            return Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_ERROR;
        case 10:
        case 'LOG_LEVEL_FATAL':
            return Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_FATAL;
        case 11:
        case 'LOG_LEVEL_PANIC':
            return Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_PANIC;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return Postgresqlhostconfig171c_LogLevel.UNRECOGNIZED;
    }
}

export function postgresqlhostconfig171c_LogLevelToJSON(
    object: Postgresqlhostconfig171c_LogLevel,
): string {
    switch (object) {
        case Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_UNSPECIFIED:
            return 'LOG_LEVEL_UNSPECIFIED';
        case Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_DEBUG5:
            return 'LOG_LEVEL_DEBUG5';
        case Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_DEBUG4:
            return 'LOG_LEVEL_DEBUG4';
        case Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_DEBUG3:
            return 'LOG_LEVEL_DEBUG3';
        case Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_DEBUG2:
            return 'LOG_LEVEL_DEBUG2';
        case Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_DEBUG1:
            return 'LOG_LEVEL_DEBUG1';
        case Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_INFO:
            return 'LOG_LEVEL_INFO';
        case Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_LOG:
            return 'LOG_LEVEL_LOG';
        case Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_NOTICE:
            return 'LOG_LEVEL_NOTICE';
        case Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_WARNING:
            return 'LOG_LEVEL_WARNING';
        case Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_ERROR:
            return 'LOG_LEVEL_ERROR';
        case Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_FATAL:
            return 'LOG_LEVEL_FATAL';
        case Postgresqlhostconfig171c_LogLevel.LOG_LEVEL_PANIC:
...
export enum Postgresqlhostconfig171c_LogStatement {
...
export function postgresqlhostconfig171c_LogStatementFromJSON(
    object: any,
): Postgresqlhostconfig171c_LogStatement {
    switch (object) {
        case 0:
        case 'LOG_STATEMENT_UNSPECIFIED':
            return Postgresqlhostconfig171c_LogStatement.LOG_STATEMENT_UNSPECIFIED;
        case 1:
        case 'LOG_STATEMENT_NONE':
            return Postgresqlhostconfig171c_LogStatement.LOG_STATEMENT_NONE;
        case 2:
        case 'LOG_STATEMENT_DDL':
            return Postgresqlhostconfig171c_LogStatement.LOG_STATEMENT_DDL;
        case 3:
        case 'LOG_STATEMENT_MOD':
            return Postgresqlhostconfig171c_LogStatement.LOG_STATEMENT_MOD;
        case 4:
        case 'LOG_STATEMENT_ALL':
            return Postgresqlhostconfig171c_LogStatement.LOG_STATEMENT_ALL;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return Postgresqlhostconfig171c_LogStatement.UNRECOGNIZED;
    }
}

export function postgresqlhostconfig171c_LogStatementToJSON(
    object: Postgresqlhostconfig171c_LogStatement,
): string {
    switch (object) {
        case Postgresqlhostconfig171c_LogStatement.LOG_STATEMENT_UNSPECIFIED:
            return 'LOG_STATEMENT_UNSPECIFIED';
        case Postgresqlhostconfig171c_LogStatement.LOG_STATEMENT_NONE:
            return 'LOG_STATEMENT_NONE';
        case Postgresqlhostconfig171c_LogStatement.LOG_STATEMENT_DDL:
            return 'LOG_STATEMENT_DDL';
        case Postgresqlhostconfig171c_LogStatement.LOG_STATEMENT_MOD:
            return 'LOG_STATEMENT_MOD';
        case Postgresqlhostconfig171c_LogStatement.LOG_STATEMENT_ALL:
...
export enum Postgresqlhostconfig171c_TransactionIsolation {
...
export function postgresqlhostconfig171c_TransactionIsolationFromJSON(
    object: any,
): Postgresqlhostconfig171c_TransactionIsolation {
    switch (object) {
        case 0:
        case 'TRANSACTION_ISOLATION_UNSPECIFIED':
            return Postgresqlhostconfig171c_TransactionIsolation.TRANSACTION_ISOLATION_UNSPECIFIED;
        case 1:
        case 'TRANSACTION_ISOLATION_READ_UNCOMMITTED':
            return Postgresqlhostconfig171c_TransactionIsolation.TRANSACTION_ISOLATION_READ_UNCOMMITTED;
        case 2:
        case 'TRANSACTION_ISOLATION_READ_COMMITTED':
            return Postgresqlhostconfig171c_TransactionIsolation.TRANSACTION_ISOLATION_READ_COMMITTED;
        case 3:
        case 'TRANSACTION_ISOLATION_REPEATABLE_READ':
            return Postgresqlhostconfig171c_TransactionIsolation.TRANSACTION_ISOLATION_REPEATABLE_READ;
        case 4:
        case 'TRANSACTION_ISOLATION_SERIALIZABLE':
            return Postgresqlhostconfig171c_TransactionIsolation.TRANSACTION_ISOLATION_SERIALIZABLE;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return Postgresqlhostconfig171c_TransactionIsolation.UNRECOGNIZED;
    }
}

export function postgresqlhostconfig171c_TransactionIsolationToJSON(
    object: Postgresqlhostconfig171c_TransactionIsolation,
): string {
    switch (object) {
        case Postgresqlhostconfig171c_TransactionIsolation.TRANSACTION_ISOLATION_UNSPECIFIED:
            return 'TRANSACTION_ISOLATION_UNSPECIFIED';
        case Postgresqlhostconfig171c_TransactionIsolation.TRANSACTION_ISOLATION_READ_UNCOMMITTED:
            return 'TRANSACTION_ISOLATION_READ_UNCOMMITTED';
        case Postgresqlhostconfig171c_TransactionIsolation.TRANSACTION_ISOLATION_READ_COMMITTED:
            return 'TRANSACTION_ISOLATION_READ_COMMITTED';
        case Postgresqlhostconfig171c_TransactionIsolation.TRANSACTION_ISOLATION_REPEATABLE_READ:
            return 'TRANSACTION_ISOLATION_REPEATABLE_READ';
        case Postgresqlhostconfig171c_TransactionIsolation.TRANSACTION_ISOLATION_SERIALIZABLE:
...
export enum Postgresqlhostconfig171c_XmlBinary {
...
export function postgresqlhostconfig171c_XmlBinaryFromJSON(
    object: any,
): Postgresqlhostconfig171c_XmlBinary {
    switch (object) {
        case 0:
        case 'XML_BINARY_UNSPECIFIED':
            return Postgresqlhostconfig171c_XmlBinary.XML_BINARY_UNSPECIFIED;
        case 1:
        case 'XML_BINARY_BASE64':
            return Postgresqlhostconfig171c_XmlBinary.XML_BINARY_BASE64;
        case 2:
        case 'XML_BINARY_HEX':
            return Postgresqlhostconfig171c_XmlBinary.XML_BINARY_HEX;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return Postgresqlhostconfig171c_XmlBinary.UNRECOGNIZED;
    }
}

export function postgresqlhostconfig171c_XmlBinaryToJSON(
    object: Postgresqlhostconfig171c_XmlBinary,
): string {
    switch (object) {
        case Postgresqlhostconfig171c_XmlBinary.XML_BINARY_UNSPECIFIED:
            return 'XML_BINARY_UNSPECIFIED';
        case Postgresqlhostconfig171c_XmlBinary.XML_BINARY_BASE64:
            return 'XML_BINARY_BASE64';
        case Postgresqlhostconfig171c_XmlBinary.XML_BINARY_HEX:
...
export enum Postgresqlhostconfig171c_XmlOption {
...
export function postgresqlhostconfig171c_XmlOptionFromJSON(
    object: any,
): Postgresqlhostconfig171c_XmlOption {
    switch (object) {
        case 0:
        case 'XML_OPTION_UNSPECIFIED':
            return Postgresqlhostconfig171c_XmlOption.XML_OPTION_UNSPECIFIED;
        case 1:
        case 'XML_OPTION_DOCUMENT':
            return Postgresqlhostconfig171c_XmlOption.XML_OPTION_DOCUMENT;
        case 2:
        case 'XML_OPTION_CONTENT':
            return Postgresqlhostconfig171c_XmlOption.XML_OPTION_CONTENT;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return Postgresqlhostconfig171c_XmlOption.UNRECOGNIZED;
    }
}

export function postgresqlhostconfig171c_XmlOptionToJSON(
    object: Postgresqlhostconfig171c_XmlOption,
): string {
    switch (object) {
        case Postgresqlhostconfig171c_XmlOption.XML_OPTION_UNSPECIFIED:
            return 'XML_OPTION_UNSPECIFIED';
        case Postgresqlhostconfig171c_XmlOption.XML_OPTION_DOCUMENT:
            return 'XML_OPTION_DOCUMENT';
        case Postgresqlhostconfig171c_XmlOption.XML_OPTION_CONTENT:
...
const basePostgresqlhostconfig171c: object = {
    $type: 'yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig17_1C',
...
export const Postgresqlhostconfig171c = {
    $type: 'yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig17_1C' as const,

    encode(
        message: Postgresqlhostconfig171c,
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Postgresqlhostconfig171c {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...basePostgresqlhostconfig171c } as Postgresqlhostconfig171c;
    ...
    fromJSON(object: any): Postgresqlhostconfig171c {
        const message = { ...basePostgresqlhostconfig171c } as Postgresqlhostconfig171c;
        ...
        message.constraintExclusion =
            object.constraintExclusion !== undefined && object.constraintExclusion !== null
                ? postgresqlhostconfig171c_ConstraintExclusionFromJSON(object.constraintExclusion)
                : 0;
        ...
        message.debugParallelQuery =
            object.debugParallelQuery !== undefined && object.debugParallelQuery !== null
                ? postgresqlhostconfig171c_DebugParallelQueryFromJSON(object.debugParallelQuery)
                : 0;
        message.clientMinMessages =
            object.clientMinMessages !== undefined && object.clientMinMessages !== null
                ? postgresqlhostconfig171c_LogLevelFromJSON(object.clientMinMessages)
                : 0;
        message.logMinMessages =
            object.logMinMessages !== undefined && object.logMinMessages !== null
                ? postgresqlhostconfig171c_LogLevelFromJSON(object.logMinMessages)
                : 0;
        message.logMinErrorStatement =
            object.logMinErrorStatement !== undefined && object.logMinErrorStatement !== null
                ? postgresqlhostconfig171c_LogLevelFromJSON(object.logMinErrorStatement)
                : 0;
        ...
        message.logErrorVerbosity =
            object.logErrorVerbosity !== undefined && object.logErrorVerbosity !== null
                ? postgresqlhostconfig171c_LogErrorVerbosityFromJSON(object.logErrorVerbosity)
                : 0;
        ...
        message.logStatement =
            object.logStatement !== undefined && object.logStatement !== null
                ? postgresqlhostconfig171c_LogStatementFromJSON(object.logStatement)
                : 0;
        ...
        message.defaultTransactionIsolation =
            ...
            object.defaultTransactionIsolation !== null
                ? postgresqlhostconfig171c_TransactionIsolationFromJSON(
        ...
        message.byteaOutput =
            object.byteaOutput !== undefined && object.byteaOutput !== null
                ? postgresqlhostconfig171c_ByteaOutputFromJSON(object.byteaOutput)
                : 0;
        message.xmlbinary =
            object.xmlbinary !== undefined && object.xmlbinary !== null
                ? postgresqlhostconfig171c_XmlBinaryFromJSON(object.xmlbinary)
                : 0;
        message.xmloption =
            object.xmloption !== undefined && object.xmloption !== null
                ? postgresqlhostconfig171c_XmlOptionFromJSON(object.xmloption)
                : 0;
        ...
        message.backslashQuote =
            object.backslashQuote !== undefined && object.backslashQuote !== null
                ? postgresqlhostconfig171c_BackslashQuoteFromJSON(object.backslashQuote)
                : 0;
    ...
    toJSON(message: Postgresqlhostconfig171c): unknown {
        const obj: any = {};
        ...
        message.constraintExclusion !== undefined &&
            (obj.constraintExclusion = postgresqlhostconfig171c_ConstraintExclusionToJSON(
                message.constraintExclusion,
            ));
        ...
        message.debugParallelQuery !== undefined &&
            (obj.debugParallelQuery = postgresqlhostconfig171c_DebugParallelQueryToJSON(
                message.debugParallelQuery,
            ));
        message.clientMinMessages !== undefined &&
            (obj.clientMinMessages = postgresqlhostconfig171c_LogLevelToJSON(
                message.clientMinMessages,
            ));
        message.logMinMessages !== undefined &&
            (obj.logMinMessages = postgresqlhostconfig171c_LogLevelToJSON(message.logMinMessages));
        message.logMinErrorStatement !== undefined &&
            (obj.logMinErrorStatement = postgresqlhostconfig171c_LogLevelToJSON(
                message.logMinErrorStatement,
            ));
        ...
        message.logErrorVerbosity !== undefined &&
            (obj.logErrorVerbosity = postgresqlhostconfig171c_LogErrorVerbosityToJSON(
                message.logErrorVerbosity,
            ));
        message.logLockWaits !== undefined && (obj.logLockWaits = message.logLockWaits);
        message.logStatement !== undefined &&
            (obj.logStatement = postgresqlhostconfig171c_LogStatementToJSON(message.logStatement));
        ...
        message.defaultTransactionIsolation !== undefined &&
            (obj.defaultTransactionIsolation = postgresqlhostconfig171c_TransactionIsolationToJSON(
                message.defaultTransactionIsolation,
            ));
        ...
        message.byteaOutput !== undefined &&
            (obj.byteaOutput = postgresqlhostconfig171c_ByteaOutputToJSON(message.byteaOutput));
        message.xmlbinary !== undefined &&
            (obj.xmlbinary = postgresqlhostconfig171c_XmlBinaryToJSON(message.xmlbinary));
        message.xmloption !== undefined &&
            (obj.xmloption = postgresqlhostconfig171c_XmlOptionToJSON(message.xmloption));
        ...
        message.backslashQuote !== undefined &&
            (obj.backslashQuote = postgresqlhostconfig171c_BackslashQuoteToJSON(
                message.backslashQuote,
            ));
    ...
    fromPartial<I extends Exact<DeepPartial<Postgresqlhostconfig171c>, I>>(
        object: I,
    ): Postgresqlhostconfig171c {
        const message = { ...basePostgresqlhostconfig171c } as Postgresqlhostconfig171c;
...
messageTypeRegistry.set(Postgresqlhostconfig171c.$type, Postgresqlhostconfig171c);
