...
export interface Postgresqlconfigset171c {
    $type: 'yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet17_1C';
    /**
...
export const Postgresqlconfig171c = {
    $type: 'yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig17_1C' as const,
...
messageTypeRegistry.set(Postgresqlconfig171c.$type, Postgresqlconfig171c);
...
export const Postgresqlconfigset171c = {
    $type: 'yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet17_1C' as const,
...
messageTypeRegistry.set(Postgresqlconfigset171c.$type, Postgresqlconfigset171c);
