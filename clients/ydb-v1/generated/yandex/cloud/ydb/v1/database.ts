...
export const Database = {
    ...
    fromJSON(object: any): Database {
        ...
        message.dedicatedDatabase =
            object.dedicatedDatabase !== undefined && object.dedicatedDatabase !== null
                ? DedicatedDatabase.fromJSON(object.dedicatedDatabase)
                : undefined;
        message.serverlessDatabase =
            object.serverlessDatabase !== undefined && object.serverlessDatabase !== null
        ...
        message.documentApiEndpoint =
            object.documentApiEndpoint !== undefined && object.documentApiEndpoint !== null
                ? String(object.documentApiEndpoint)
                : '';
        message.kinesisApiEndpoint =
            object.kinesisApiEndpoint !== undefined && object.kinesisApiEndpoint !== null
    ...
    toJSON(message: Database): unknown {
        ...
        message.status !== undefined && (obj.status = database_StatusToJSON(message.status));
        ...
        message.kafkaApiEndpoint !== undefined && (obj.kafkaApiEndpoint = message.kafkaApiEndpoint);
...
export const AlertParameter = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): AlertParameter {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.doubleParameterValue = AlertParameter_DoubleParameterValue.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
                case 2:
                    message.integerParameterValue = AlertParameter_IntegerParameterValue.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
                case 3:
                    ...
                    break;
                case 4:
                    message.textListParameterValue = AlertParameter_TextListParameterValue.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
                case 5:
                    message.labelListParameterValue = AlertParameter_LabelListParameterValue.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    fromJSON(object: any): AlertParameter {
        const message = { ...baseAlertParameter } as AlertParameter;
        message.doubleParameterValue =
            object.doubleParameterValue !== undefined && object.doubleParameterValue !== null
        ...
        message.integerParameterValue =
            object.integerParameterValue !== undefined && object.integerParameterValue !== null
                ...
                : undefined;
        message.textParameterValue =
            object.textParameterValue !== undefined && object.textParameterValue !== null
...
export const NotificationChannel = {
    ...
    fromJSON(object: any): NotificationChannel {
        ...
        message.notificationChannelId =
            object.notificationChannelId !== undefined && object.notificationChannelId !== null
                ? String(object.notificationChannelId)
                : '';
        message.notifyAboutStatuses = (object.notifyAboutStatuses ?? []).map((e: any) =>
            alertEvaluationStatusFromJSON(e),
        );
        message.repeateNotifyDelayMs =
            object.repeateNotifyDelayMs !== undefined && object.repeateNotifyDelayMs !== null
...
export const Alert = {
    ...
    fromJSON(object: any): Alert {
        const message = { ...baseAlert } as Alert;
        message.alertId =
            object.alertId !== undefined && object.alertId !== null ? String(object.alertId) : '';
        ...
        message.description =
            object.description !== undefined && object.description !== null
                ? String(object.description)
                : '';
        message.notificationChannels = (object.notificationChannels ?? []).map((e: any) =>
    ...
    toJSON(message: Alert): unknown {
        ...
        message.alertTemplateId !== undefined && (obj.alertTemplateId = message.alertTemplateId);
        message.name !== undefined && (obj.name = message.name);
        message.description !== undefined && (obj.description = message.description);
    ...
    fromPartial<I extends Exact<DeepPartial<Alert>, I>>(object: I): Alert {
        ...
        message.description = object.description ?? '';
        message.notificationChannels =
            object.notificationChannels?.map((e) => NotificationChannel.fromPartial(e)) || [];
        message.alertParameters =
...
export const ServerlessDatabase = {
    ...
    fromJSON(object: any): ServerlessDatabase {
        ...
        message.throttlingRcuLimit =
            object.throttlingRcuLimit !== undefined && object.throttlingRcuLimit !== null
        ...
        message.provisionedRcuLimit =
            object.provisionedRcuLimit !== undefined && object.provisionedRcuLimit !== null
...
export const StorageOption = {
    ...
    toJSON(message: StorageOption): unknown {
        const obj: any = {};
        message.storageTypeId !== undefined && (obj.storageTypeId = message.storageTypeId);
