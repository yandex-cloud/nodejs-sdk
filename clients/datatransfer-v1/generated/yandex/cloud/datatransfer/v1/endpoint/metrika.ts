...
export const MetrikaStream = {
    ...
    toJSON(message: MetrikaStream): unknown {
        const obj: any = {};
        message.type !== undefined && (obj.type = metrikaStreamTypeToJSON(message.type));
        if (message.columns) {
...
export const MetrikaSource = {
    ...
    fromJSON(object: any): MetrikaSource {
        ...
        message.token =
            object.token !== undefined && object.token !== null
                ...
                : undefined;
        message.streams = (object.streams ?? []).map((e: any) => MetrikaStream.fromJSON(e));
        return message;
    },
    ...
    toJSON(message: MetrikaSource): unknown {
        ...
        if (message.streams) {
            obj.streams = message.streams.map((e) => (e ? MetrikaStream.toJSON(e) : undefined));
        } else {
            obj.streams = [];
        }
        return obj;
    ...
    fromPartial<I extends Exact<DeepPartial<MetrikaSource>, I>>(object: I): MetrikaSource {
        ...
        message.token =
            object.token !== undefined && object.token !== null
                ...
                : undefined;
        message.streams = object.streams?.map((e) => MetrikaStream.fromPartial(e)) || [];
        return message;
    },
};
