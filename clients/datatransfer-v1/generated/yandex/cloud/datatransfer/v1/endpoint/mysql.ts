...
export const MysqlObjectTransferSettings = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): MysqlObjectTransferSettings {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMysqlObjectTransferSettings } as MysqlObjectTransferSettings;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    toJSON(message: MysqlObjectTransferSettings): unknown {
        ...
        message.routine !== undefined && (obj.routine = objectTransferStageToJSON(message.routine));
        message.trigger !== undefined && (obj.trigger = objectTransferStageToJSON(message.trigger));
        message.tables !== undefined && (obj.tables = objectTransferStageToJSON(message.tables));
        return obj;
    },
...
export const MysqlSource = {
    ...
    fromJSON(object: any): MysqlSource {
        ...
        message.objectTransferSettings =
            object.objectTransferSettings !== undefined && object.objectTransferSettings !== null
                ...
                : undefined;
        message.includeTablesRegex = (object.includeTablesRegex ?? []).map((e: any) => String(e));
        message.excludeTablesRegex = (object.excludeTablesRegex ?? []).map((e: any) => String(e));
    ...
    toJSON(message: MysqlSource): unknown {
        ...
        message.serviceDatabase !== undefined && (obj.serviceDatabase = message.serviceDatabase);
        return obj;
    },
    ...
    fromJSON(object: any): MysqlTarget {
        ...
        message.password =
            object.password !== undefined && object.password !== null
                ...
                : undefined;
        message.sqlMode =
            object.sqlMode !== undefined && object.sqlMode !== null ? String(object.sqlMode) : '';
        message.skipConstraintChecks =
            object.skipConstraintChecks !== undefined && object.skipConstraintChecks !== null
