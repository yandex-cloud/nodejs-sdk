...
export interface Mongodconfig60Enterprise_Storage_WiredTiger {
    ...
    indexConfig?: Mongodconfig60Enterprise_Storage_WiredTiger_IndexConfig;
}
...
export interface Mongodconfig60Enterprise_Network {
    ...
    compression?: Mongodconfig60Enterprise_Network_Compression;
}
...
export function mongodconfig60Enterprise_Network_Compression_CompressorFromJSON(
    ...
    switch (object) {
        ...
        case 4:
        case 'DISABLED':
            return Mongodconfig60Enterprise_Network_Compression_Compressor.DISABLED;
        case -1:
        case 'UNRECOGNIZED':
        default:
...
export function mongodconfig60Enterprise_Network_Compression_CompressorToJSON(
    ...
    switch (object) {
        ...
        case Mongodconfig60Enterprise_Network_Compression_Compressor.ZSTD:
            return 'ZSTD';
        case Mongodconfig60Enterprise_Network_Compression_Compressor.DISABLED:
            return 'DISABLED';
        default:
            return 'UNKNOWN';
    }
...
export function mongosconfig60Enterprise_Network_Compression_CompressorFromJSON(
    ...
    switch (object) {
        ...
        case 4:
        case 'DISABLED':
            return Mongosconfig60Enterprise_Network_Compression_Compressor.DISABLED;
        case -1:
        case 'UNRECOGNIZED':
        default:
...
export function mongosconfig60Enterprise_Network_Compression_CompressorToJSON(
    ...
    switch (object) {
        ...
        case Mongosconfig60Enterprise_Network_Compression_Compressor.ZSTD:
            return 'ZSTD';
        case Mongosconfig60Enterprise_Network_Compression_Compressor.DISABLED:
            return 'DISABLED';
        default:
            return 'UNKNOWN';
    }
...
export const Mongodconfig60Enterprise = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongodconfig60Enterprise {
        ...
        const message = { ...baseMongodconfig60Enterprise } as Mongodconfig60Enterprise;
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.operationProfiling = Mongodconfig60Enterprise_OperationProfiling.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    toJSON(message: Mongodconfig60Enterprise): unknown {
        ...
        message.operationProfiling !== undefined &&
            (obj.operationProfiling = message.operationProfiling
                ? Mongodconfig60Enterprise_OperationProfiling.toJSON(message.operationProfiling)
                : undefined);
...
export const Mongodconfig60Enterprise_Storage = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongodconfig60Enterprise_Storage {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.wiredTiger = Mongodconfig60Enterprise_Storage_WiredTiger.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig60Enterprise_Storage>, I>>(
        object: I,
...
export const Mongodconfig60Enterprise_Storage_WiredTiger = {
    ...
    encode(
        ...
        if (message.indexConfig !== undefined) {
            Mongodconfig60Enterprise_Storage_WiredTiger_IndexConfig.encode(
                message.indexConfig,
    ...
    decode(
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    message.indexConfig =
                        Mongodconfig60Enterprise_Storage_WiredTiger_IndexConfig.decode(
                            reader,
                            reader.uint32(),
                        );
                    break;
    ...
    fromJSON(object: any): Mongodconfig60Enterprise_Storage_WiredTiger {
        ...
        message.indexConfig =
            object.indexConfig !== undefined && object.indexConfig !== null
                ? Mongodconfig60Enterprise_Storage_WiredTiger_IndexConfig.fromJSON(
                      object.indexConfig,
                  )
                : undefined;
        return message;
    ...
    toJSON(message: Mongodconfig60Enterprise_Storage_WiredTiger): unknown {
        ...
        message.indexConfig !== undefined &&
            (obj.indexConfig = message.indexConfig
                ? Mongodconfig60Enterprise_Storage_WiredTiger_IndexConfig.toJSON(
                      message.indexConfig,
                  )
                : undefined);
        return obj;
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig60Enterprise_Storage_WiredTiger>, I>>(
        object: I,
    ): Mongodconfig60Enterprise_Storage_WiredTiger {
        const message = {
            ...baseMongodconfig60Enterprise_Storage_WiredTiger,
        ...
        message.indexConfig =
            object.indexConfig !== undefined && object.indexConfig !== null
                ? Mongodconfig60Enterprise_Storage_WiredTiger_IndexConfig.fromPartial(
                      object.indexConfig,
                  )
                : undefined;
        return message;
...
export const Mongodconfig60Enterprise_Storage_WiredTiger_EngineConfig = {
    ...
    fromPartial<
        I extends Exact<DeepPartial<Mongodconfig60Enterprise_Storage_WiredTiger_EngineConfig>, I>,
...
export const Mongodconfig60Enterprise_Storage_WiredTiger_IndexConfig = {
    ...
    decode(
        ...
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = {
            ...baseMongodconfig60Enterprise_Storage_WiredTiger_IndexConfig,
        } as Mongodconfig60Enterprise_Storage_WiredTiger_IndexConfig;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromPartial<
        I extends Exact<DeepPartial<Mongodconfig60Enterprise_Storage_WiredTiger_IndexConfig>, I>,
    >(object: I): Mongodconfig60Enterprise_Storage_WiredTiger_IndexConfig {
        const message = {
            ...baseMongodconfig60Enterprise_Storage_WiredTiger_IndexConfig,
        } as Mongodconfig60Enterprise_Storage_WiredTiger_IndexConfig;
...
export const Mongodconfig60Enterprise_Storage_Journal = {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig60Enterprise_Storage_Journal>, I>>(
        object: I,
    ): Mongodconfig60Enterprise_Storage_Journal {
        const message = {
            ...baseMongodconfig60Enterprise_Storage_Journal,
...
export const Mongodconfig60Enterprise_OperationProfiling = {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig60Enterprise_OperationProfiling>, I>>(
        object: I,
    ): Mongodconfig60Enterprise_OperationProfiling {
        const message = {
            ...baseMongodconfig60Enterprise_OperationProfiling,
...
export const Mongodconfig60Enterprise_Network = {
    ...
    encode(
        ...
        if (message.compression !== undefined) {
            Mongodconfig60Enterprise_Network_Compression.encode(
                message.compression,
                writer.uint32(18).fork(),
            ).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.compression = Mongodconfig60Enterprise_Network_Compression.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    toJSON(message: Mongodconfig60Enterprise_Network): unknown {
        ...
        message.compression !== undefined &&
            (obj.compression = message.compression
                ? Mongodconfig60Enterprise_Network_Compression.toJSON(message.compression)
                : undefined);
        return obj;
    },

    fromPartial<I extends Exact<DeepPartial<Mongodconfig60Enterprise_Network>, I>>(
        object: I,
...
const baseMongodconfig60Enterprise_Network_Compression: object = {
    $type: 'yandex.cloud.mdb.mongodb.v1.config.MongodConfig6_0_enterprise.Network.Compression',
    compressors: 0,
};
...
export const Mongodconfig60Enterprise_Network_Compression = {
    ...
    decode(
        ...
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = {
            ...baseMongodconfig60Enterprise_Network_Compression,
        } as Mongodconfig60Enterprise_Network_Compression;
        message.compressors = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object: any): Mongodconfig60Enterprise_Network_Compression {
        ...
        message.compressors = (object.compressors ?? []).map((e: any) =>
            mongodconfig60Enterprise_Network_Compression_CompressorFromJSON(e),
        );
        return message;
    },
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig60Enterprise_Network_Compression>, I>>(
        object: I,
    ): Mongodconfig60Enterprise_Network_Compression {
        const message = {
            ...baseMongodconfig60Enterprise_Network_Compression,
...
export const Mongodconfig60Enterprise_Security = {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig60Enterprise_Security>, I>>(
        object: I,
...
export const Mongodconfig60Enterprise_Security_KMIP = {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig60Enterprise_Security_KMIP>, I>>(
        object: I,
    ): Mongodconfig60Enterprise_Security_KMIP {
        const message = {
            ...baseMongodconfig60Enterprise_Security_KMIP,
...
export const Mongodconfig60Enterprise_AuditLog = {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig60Enterprise_AuditLog>, I>>(
        object: I,
...
export const Mongodconfig60Enterprise_SetParameter = {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongodconfig60Enterprise_SetParameter>, I>>(
        object: I,
...
export const Mongocfgconfig60Enterprise = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongocfgconfig60Enterprise {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMongocfgconfig60Enterprise } as Mongocfgconfig60Enterprise;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    toJSON(message: Mongocfgconfig60Enterprise): unknown {
        ...
        message.operationProfiling !== undefined &&
            (obj.operationProfiling = message.operationProfiling
                ? Mongocfgconfig60Enterprise_OperationProfiling.toJSON(message.operationProfiling)
                : undefined);
        message.net !== undefined &&
            (obj.net = message.net
...
export const Mongocfgconfig60Enterprise_Storage = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongocfgconfig60Enterprise_Storage {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.wiredTiger = Mongocfgconfig60Enterprise_Storage_WiredTiger.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    toJSON(message: Mongocfgconfig60Enterprise_Storage): unknown {
        ...
        message.wiredTiger !== undefined &&
            (obj.wiredTiger = message.wiredTiger
                ? Mongocfgconfig60Enterprise_Storage_WiredTiger.toJSON(message.wiredTiger)
                : undefined);
        return obj;
    },

    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig60Enterprise_Storage>, I>>(
        object: I,
...
export const Mongocfgconfig60Enterprise_Storage_WiredTiger = {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig60Enterprise_Storage_WiredTiger>, I>>(
        object: I,
    ): Mongocfgconfig60Enterprise_Storage_WiredTiger {
        const message = {
            ...baseMongocfgconfig60Enterprise_Storage_WiredTiger,
...
export const Mongocfgconfig60Enterprise_Storage_WiredTiger_EngineConfig = {
    ...
    fromPartial<
        I extends Exact<DeepPartial<Mongocfgconfig60Enterprise_Storage_WiredTiger_EngineConfig>, I>,
...
export const Mongocfgconfig60Enterprise_OperationProfiling = {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig60Enterprise_OperationProfiling>, I>>(
        object: I,
    ): Mongocfgconfig60Enterprise_OperationProfiling {
        const message = {
            ...baseMongocfgconfig60Enterprise_OperationProfiling,
...
export const Mongocfgconfig60Enterprise_Network = {
    ...
    fromPartial<I extends Exact<DeepPartial<Mongocfgconfig60Enterprise_Network>, I>>(
        object: I,
...
export const Mongosconfig60Enterprise_Network = {
    ...
    encode(
        ...
        if (message.compression !== undefined) {
            Mongosconfig60Enterprise_Network_Compression.encode(
                message.compression,
                writer.uint32(18).fork(),
            ).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.compression = Mongosconfig60Enterprise_Network_Compression.decode(
                        reader,
                        reader.uint32(),
                    );
                    break;
    ...
    toJSON(message: Mongosconfig60Enterprise_Network): unknown {
        ...
        message.compression !== undefined &&
            (obj.compression = message.compression
                ? Mongosconfig60Enterprise_Network_Compression.toJSON(message.compression)
                : undefined);
        return obj;
    },

    fromPartial<I extends Exact<DeepPartial<Mongosconfig60Enterprise_Network>, I>>(
        object: I,
...
const baseMongosconfig60Enterprise_Network_Compression: object = {
    $type: 'yandex.cloud.mdb.mongodb.v1.config.MongosConfig6_0_enterprise.Network.Compression',
    compressors: 0,
};
...
export const Mongosconfig60Enterprise_Network_Compression = {
    ...
    decode(
        ...
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = {
            ...baseMongosconfig60Enterprise_Network_Compression,
        } as Mongosconfig60Enterprise_Network_Compression;
        message.compressors = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object: any): Mongosconfig60Enterprise_Network_Compression {
        ...
        message.compressors = (object.compressors ?? []).map((e: any) =>
            mongosconfig60Enterprise_Network_Compression_CompressorFromJSON(e),
        );
        return message;
    },
    ...
    fromPartial<I extends Exact<DeepPartial<Mongosconfig60Enterprise_Network_Compression>, I>>(
        object: I,
    ): Mongosconfig60Enterprise_Network_Compression {
        const message = {
            ...baseMongosconfig60Enterprise_Network_Compression,
...
export const Mongodconfigset60Enterprise = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongodconfigset60Enterprise {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMongodconfigset60Enterprise } as Mongodconfigset60Enterprise;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const Mongocfgconfigset60Enterprise = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongocfgconfigset60Enterprise {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMongocfgconfigset60Enterprise } as Mongocfgconfigset60Enterprise;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const Mongosconfigset60Enterprise = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Mongosconfigset60Enterprise {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMongosconfigset60Enterprise } as Mongosconfigset60Enterprise;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
