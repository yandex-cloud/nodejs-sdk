    ...
    fromJSON(object: any): CreateDiskRequest {
        ...
        message.diskPlacementPolicy =
            object.diskPlacementPolicy !== undefined && object.diskPlacementPolicy !== null
                ...
                : undefined;
        message.snapshotScheduleIds = (object.snapshotScheduleIds ?? []).map((e: any) => String(e));
        message.hardwareGeneration =
...
export const CreateDiskRequest_LabelsEntry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): CreateDiskRequest_LabelsEntry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseCreateDiskRequest_LabelsEntry } as CreateDiskRequest_LabelsEntry;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const UpdateDiskRequest_LabelsEntry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): UpdateDiskRequest_LabelsEntry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseUpdateDiskRequest_LabelsEntry } as UpdateDiskRequest_LabelsEntry;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListDiskOperationsRequest = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListDiskOperationsRequest {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListDiskOperationsRequest } as ListDiskOperationsRequest;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const ListDiskOperationsResponse = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ListDiskOperationsResponse {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseListDiskOperationsResponse } as ListDiskOperationsResponse;
        message.operations = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
