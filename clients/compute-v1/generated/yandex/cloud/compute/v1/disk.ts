...
export const Disk = {
    ...
    toJSON(message: Disk): unknown {
        ...
        message.status !== undefined && (obj.status = disk_StatusToJSON(message.status));
        message.sourceImageId !== undefined && (obj.sourceImageId = message.sourceImageId);
        message.sourceSnapshotId !== undefined && (obj.sourceSnapshotId = message.sourceSnapshotId);
...
export const DiskPlacementPolicyChange = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): DiskPlacementPolicyChange {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseDiskPlacementPolicyChange } as DiskPlacementPolicyChange;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
