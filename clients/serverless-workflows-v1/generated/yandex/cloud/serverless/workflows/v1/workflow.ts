...
export const Workflow = {
    ...
    encode(message: Workflow, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.specification !== undefined) {
            WorkflowSpecification.encode(message.specification, writer.uint32(26).fork()).ldelim();
        }
    ...
    toJSON(message: Workflow): unknown {
        ...
        message.status !== undefined && (obj.status = workflow_StatusToJSON(message.status));
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    const entry6 = WorkflowPreview_LabelsEntry.decode(reader, reader.uint32());
...
export const WorkflowPreview_LabelsEntry = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): WorkflowPreview_LabelsEntry {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseWorkflowPreview_LabelsEntry } as WorkflowPreview_LabelsEntry;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
