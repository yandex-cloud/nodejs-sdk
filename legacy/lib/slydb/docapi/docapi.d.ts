...
export class DocAPIService {
    ...
    createTable(
        params: DynamoDB.DocumentClient.CreateTableInput
    ): Promise<DynamoDB.DocumentClient.CreateTableOutput>;
    deleteTable(
        params: DynamoDB.DocumentClient.DeleteTableInput
    ): Promise<DynamoDB.DocumentClient.DeleteTableOutput>;
    describeTable(
        params: DynamoDB.DocumentClient.DescribeTableInput
    ): Promise<DynamoDB.DocumentClient.DescribeTableOutput>;
    listTables(
        params: DynamoDB.DocumentClient.ListTablesInput
    ): Promise<DynamoDB.DocumentClient.ListTablesOutput>;
