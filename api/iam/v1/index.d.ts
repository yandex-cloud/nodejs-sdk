...
export class ApiKeyService {
   ...
   */
  delete(request: DeleteApiKeyRequest): Promise<protobuf.Empty>;
}
...
export class KeyService {
   ...
   */
  delete(request: DeleteKeyRequest): Promise<protobuf.Empty>;
}
...
export class ServiceAccountService {
   ...
   */
  list(request: ListServiceAccountsRequest): Promise<ListServiceAccountsResponse>;
   ...
   */
  listOperations(request: ListServiceAccountOperationsRequest): Promise<ListServiceAccountOperationsResponse>;
}
