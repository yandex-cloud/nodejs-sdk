...
export class InstanceGroupService {
   ...
   */
  list(request: ListInstanceGroupsRequest): Promise<ListInstanceGroupsResponse>;
   ...
   * This method starts an operation that can be cancelled by another operation.
   */
  createFromYaml(request: CreateInstanceGroupFromYamlRequest): Promise<operation.Operation>;
   ...
   * This method starts an operation that can be cancelled by another operation.
   */
  updateFromYaml(request: UpdateInstanceGroupFromYamlRequest): Promise<operation.Operation>;
   ...
   */
  listInstances(request: ListInstanceGroupInstancesRequest): Promise<ListInstanceGroupInstancesResponse>;

  /**
   * Lists operations for the specified instance group.
   */
  listOperations(request: ListInstanceGroupOperationsRequest): Promise<ListInstanceGroupOperationsResponse>;

  /**
   * Lists logs for the specified instance group.
   */
  listLogRecords(request: ListInstanceGroupLogRecordsRequest): Promise<ListInstanceGroupLogRecordsResponse>;
}
