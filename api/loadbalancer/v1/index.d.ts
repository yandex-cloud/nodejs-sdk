...
export class NetworkLoadBalancerService {
   ...
   */
  list(request: ListNetworkLoadBalancersRequest): Promise<ListNetworkLoadBalancersResponse>;

  /**
   * Creates a network load balancer in the specified folder using the data specified in the request.
   */
  create(request: CreateNetworkLoadBalancerRequest): Promise<operation.Operation>;

  /**
   * Updates the specified network load balancer.
   */
  update(request: UpdateNetworkLoadBalancerRequest): Promise<operation.Operation>;

  /**
   * Deletes the specified network load balancer.
   */
  delete(request: DeleteNetworkLoadBalancerRequest): Promise<operation.Operation>;
   ...
   */
  start(request: StartNetworkLoadBalancerRequest): Promise<operation.Operation>;
   ...
   */
  attachTargetGroup(request: AttachNetworkLoadBalancerTargetGroupRequest): Promise<operation.Operation>;

  /**
   * Detaches the target group from the specified network load balancer.
   */
  detachTargetGroup(request: DetachNetworkLoadBalancerTargetGroupRequest): Promise<operation.Operation>;

  /**
   * Gets states of target resources in the attached target group.
   */
  getTargetStates(request: GetTargetStatesRequest): Promise<GetTargetStatesResponse>;

  /**
   * Adds a listener to the specified network load balancer.
   */
  addListener(request: AddNetworkLoadBalancerListenerRequest): Promise<operation.Operation>;

  /**
   * Removes the listener from the specified network load balancer.
   */
  removeListener(request: RemoveNetworkLoadBalancerListenerRequest): Promise<operation.Operation>;

  /**
   * Lists operations for the specified network load balancer.
   */
  listOperations(request: ListNetworkLoadBalancerOperationsRequest): Promise<ListNetworkLoadBalancerOperationsResponse>;
}
...
export class TargetGroupService {
   ...
   */
  listOperations(request: ListTargetGroupOperationsRequest): Promise<ListTargetGroupOperationsResponse>;
}
